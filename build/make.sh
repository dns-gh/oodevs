...
files=`diff -qrN --ignore-file-name-case -x "*.svn" -I "(http://www.obj-sys.com)" -I "This file was generated by ASN1C" $tmpDir $generatedDir | sed -r "s/^.*($escapedTmpDir\\/\w*(\.cpp|\.h)).*$/\\1/"`
