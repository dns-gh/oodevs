...
Section "C-Sword"
    ...
    CreateShortCut "$SMPROGRAMS\C-Sword\France\C-Sword simulation.lnk" "$INSTDIR\applications\simulation_app.exe" "--exercise=empty-france"
    CreateShortCut "$SMPROGRAMS\C-Sword\France\C-Sword preparation.lnk" "$INSTDIR\applications\preparation_app.exe" "--exercise=empty-france"
    CreateShortCut "$SMPROGRAMS\C-Sword\France\C-Sword gaming.lnk" "$INSTDIR\applications\gaming_app.exe" "--exercise=empty-france"
...
Section "Uninstall"
    ...
    Delete "$SMPROGRAMS\C-Sword\WorldWide\C-Sword simulation.lnk"
    Delete "$SMPROGRAMS\C-Sword\WorldWide\C-Sword preparation.lnk"
    Delete "$SMPROGRAMS\C-Sword\WorldWide\C-Sword gaming.lnk"
