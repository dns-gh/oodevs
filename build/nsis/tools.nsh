...
!macro OT.AddOptionalComponent ComponentName
    ...
    Section "${ComponentName}"
        ...
        ExecWait '"$INSTDIR\installation files\SWORD ${ComponentName}_${PLATFORM}.exe" /S /D=$INSTDIR\${ComponentName} /LANG=$LANGUAGE /PRODUCT_NAME=${PRODUCT_NAME} /COMPANY_NAME=${COMPANY_NAME} /INSTDIR_REG_ROOT=${INSTDIR_REG_ROOT}'
    SectionEnd
