...
!macro OT.AddDocumentation
    ...
    CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\Documentation\English\Sword General User Guide.lnk" "$INSTDIR\doc\en\Sword_General_User_Guide.pdf"
    !insertmacro UNINSTALL.LOG_CLOSE_INSTALL
...
!macro OT.AddOptionalComponent ComponentName
    ...
    Section "${ComponentName}"
        ...
        CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\$(OT_WKP).lnk" "$INSTDIR\Terrain\applications\terrain_workshop_app.exe" "" "$INSTDIR\applications\sword-ot.ico"
