...
!endif
    ...
    File "${OUTDIR}\release\applications\gaming_app\*.pdb"
    File "${OUTDIR}\release\applications\launcher_app\*.pdb"
    File "${OUTDIR}\release\applications\preparation_app\*.pdb"
    File "${OUTDIR}\release\applications\replayer_app\*.pdb"
    File "${OUTDIR}\release\applications\selftraining_app\*.pdb"
    File "${OUTDIR}\release\applications\shield_app\*.pdb"
    File "${OUTDIR}\release\applications\simulation_app\*.pdb"

    File "${OUTDIR}\release\libraries\3a\*.pdb"
    File "${OUTDIR}\release\libraries\aar_plugin\*.pdb"
    File "${OUTDIR}\release\libraries\actions\*.pdb"
    File "${OUTDIR}\release\libraries\actions_gui\*.pdb"
    File "${OUTDIR}\release\libraries\client_proxy\*.pdb"
    File "${OUTDIR}\release\libraries\clients_gui\*.pdb"
    File "${OUTDIR}\release\libraries\clients_kernel\*.pdb"
    File "${OUTDIR}\release\libraries\dispatcher\*.pdb"
    File "${OUTDIR}\release\libraries\dispatcher_dll\*.pdb"
    File "${OUTDIR}\release\libraries\ENT\*.pdb"
    File "${OUTDIR}\release\libraries\frontend\*.pdb"
    File "${OUTDIR}\release\libraries\gaming\*.pdb"
    File "${OUTDIR}\release\libraries\geostore\*.pdb"
    File "${OUTDIR}\release\libraries\indicators\*.pdb"
    File "${OUTDIR}\release\libraries\launcher_dll\*.pdb"
    File "${OUTDIR}\release\libraries\logger_plugin\*.pdb"
    File "${OUTDIR}\release\libraries\messenger_plugin\*.pdb"
    File "${OUTDIR}\release\libraries\meteo\*.pdb"
    File "${OUTDIR}\release\libraries\MT_Tools\*.pdb"
    File "${OUTDIR}\release\libraries\preparation\*.pdb"
    File "${OUTDIR}\release\libraries\protocol\*.pdb"
    File "${OUTDIR}\release\libraries\replay_plugin\*.pdb"
    File "${OUTDIR}\release\libraries\reports\*.pdb"
    File "${OUTDIR}\release\libraries\resource_network\*.pdb"
    File "${OUTDIR}\release\libraries\saver_plugin\*.pdb"
    File "${OUTDIR}\release\libraries\shield\*.pdb"
    File "${OUTDIR}\release\libraries\simulation_kernel\*.pdb"
    File "${OUTDIR}\release\libraries\simulation_terrain\*.pdb"
    File "${OUTDIR}\release\libraries\tools\*.pdb"
