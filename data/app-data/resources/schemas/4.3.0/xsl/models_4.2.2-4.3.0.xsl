...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://exslt.org/sets">
    ...
    <xsl:template match="@dia-type[.='net.masagroup.sword.military.platoon.combat.support.engineer.roles.Engineer']">
        <xsl:attribute name="dia-type">net.masagroup.sword.france.military.platoon.combat.support.engineer.roles.Engineer</xsl:attribute>
    </xsl:template>
