      ...
      <xsl:copy>
          <xsl:attribute name="key">
            <xsl:choose>
                ...
                <xsl:when test="@id=407">eRC_ObjectiveAlerted</xsl:when>
                <xsl:when test="@id=408">eRC_UrbanCollisionStarted</xsl:when>
                <xsl:when test="@id=409">eRC_UrbanCollisionStopped</xsl:when>
                <xsl:when test="@id=410">eRC_ObjectiveIsNoLongerConfined</xsl:when>
                <xsl:when test="@id=411">eRC_ObjectiveEvacuated</xsl:when>
                <xsl:when test="@id=412">eRC_ObjectiveIsNoLongerEvacuated</xsl:when>
                <xsl:when test="@id=413">eRC_StartingToProduceResource</xsl:when>
                <xsl:when test="@id=414">eRC_ResourceProductionStopped</xsl:when>
                <xsl:when test="@id=415">eRC_ResourceNodeProductionEnhanced</xsl:when>
                <xsl:when test="@id=416">eRC_ResourceNodeProductionDamaged</xsl:when>
                <xsl:when test="@id=417">eRC_PrisSousTirIED</xsl:when>
                <xsl:when test="@id=418">eRC_ResourceNodeEnabled</xsl:when>
                <xsl:when test="@id=419">eRC_NoResourceNodesWithinArea</xsl:when>
                <xsl:when test="@id=420">eRC_Questionning</xsl:when>
                <xsl:when test="@id=421">eRC_NoCrowdsWithinArea</xsl:when>
                <xsl:when test="@id=422">eRC_VictimsEvacuated</xsl:when>
                <xsl:when test="@id=423">eRC_FragOrderReceived</xsl:when>
                <xsl:when test="@id=424">eRC_VictimsCannotBeEvacuated</xsl:when>
                <xsl:when test="@id=425">eRC_VictimsCannotBeExtracted</xsl:when>
                <xsl:when test="@id=426">eRC_StartingToReduceResourceProduction</xsl:when>
                <xsl:when test="@id=427">eRC_FireObserver</xsl:when>
                <xsl:when test="@id=428">eRC_NoWoundedVictims</xsl:when>
                <xsl:when test="@id=429">eRC_ElementCannotBeLoaded</xsl:when>
                <xsl:when test="@id=430">eRC_ElementCannotBeUnloaded</xsl:when>
                <xsl:when test="@id=431">eRC_ElementLoaded</xsl:when>
                <xsl:when test="@id=432">eRC_ElementUnloaded</xsl:when>
                <xsl:when test="@id=433">eRC_NoPopulationInUrbanBlock</xsl:when>
                <xsl:when test="@id=434">eRC_ImpossibleToExtinguishFire</xsl:when>
                <xsl:when test="@id=435">eRC_NoFiresWithinArea</xsl:when>
                <xsl:when test="@id=436">eRC_StartingToDecontaminate</xsl:when>
                <xsl:when test="@id=437">eRC_DecontaminationDone</xsl:when>
                <xsl:when test="@id=438">eRC_StartingToHealCrowd</xsl:when>
                <xsl:when test="@id=439">eRC_WoundedPersonsHealed</xsl:when>
                <xsl:when test="@id=440">eRC_StartingToExtractVictimsFromCrowd</xsl:when>
                <xsl:when test="@id=441">eRC_WoundedCannotBeHealed</xsl:when>
                <xsl:when test="@id=442">eRC_ControlPointEstablished</xsl:when>
                <xsl:when test="@id=443">eRC_SystemIsBeingOperated</xsl:when>
                <xsl:when test="@id=444">eRC_PrisSousTirEclairant</xsl:when>
                <xsl:when test="@id=445">eRC_PrisSousTirFumigene</xsl:when>
                <xsl:when test="@id=446">eRC_EntityHasBeenOrderedToFollow</xsl:when>
                <xsl:when test="@id=447">eRC_StartingToCreateResourceLink</xsl:when>
                <xsl:when test="@id=448">eRC_ResouceLinkCreated</xsl:when>
                ...
                <xsl:when test="@id=456">eRC_TrafficablePositionFindingInZone</xsl:when>
                <xsl:when test="@id=457">eRC_ResourceNodeDisabled</xsl:when>
                <xsl:when test="@id=458">eRC_ObjectiveIsNoLongerAlerted</xsl:when>
                <xsl:when test="@id=459">eRC_ObjectiveConfined</xsl:when>
                <xsl:when test="@id=460">eRC_NotInSameUndergroundNetwork</xsl:when>
                <xsl:when test="@id=461">eRC_FireIsBeingExtinguished</xsl:when>
                <xsl:when test="@id=462">eRC_TerroristDropped</xsl:when>
                <xsl:when test="@id=463">eRC_ImpossibleToOperateObject</xsl:when>
                <xsl:when test="@id=464">eRC_NoUrbanBlocksWithinArea</xsl:when>
                <xsl:when test="@id=465">eRC_criticalIntelligenceImpossible</xsl:when>
                <xsl:when test="@id=466">eRC_InvalidTarget</xsl:when>
                <xsl:when test="@id=467">eRC_VictimsExtracted</xsl:when>
                <xsl:when test="@id=468">eRC_FurtifModeOn</xsl:when>
                <xsl:when test="@id=469">eRC_FurtifModeOff</xsl:when>
                <xsl:when test="@id=470">eRC_ObstacleNonActivable</xsl:when>
                <xsl:when test="@id=471">eRC_ResourceReductionStopped</xsl:when>
                <xsl:when test="@id=472">eRC_ImpossibleActivateIED</xsl:when>
                <xsl:when test="@id=473">eRC_Jammed</xsl:when>
                <xsl:when test="@id=474">eRC_PCJammed</xsl:when>
                <xsl:when test="@id=475">eRC_IEDNotReady</xsl:when>
                <xsl:when test="@id=476">eRC_IEDReadyForFiring</xsl:when>
                <xsl:when test="@id=477">eRC_FollowingUnitIsDead</xsl:when>
                <xsl:when test="@id=478">eRC_CombatSupportUnitIsDead</xsl:when>
                <xsl:when test="@id=479">eRC_NoUnitsInParameter</xsl:when>
                <xsl:when test="@id=480">eRC_CaptureEnd</xsl:when>
                <xsl:when test="@id=481">eRC_LimaParameterNotPresent</xsl:when>
                <xsl:when test="@id=482">eRC_EntityCannotFollow</xsl:when>
                <xsl:when test="@id=483">eRC_OfficersKilled</xsl:when>
                <xsl:when test="@id=484">eRC_UnitNotCaptured</xsl:when>
                <xsl:when test="@id=485">eRC_CannotDismount</xsl:when>
                <xsl:when test="@id=486">eRC_DecrochageFaceAIncendie</xsl:when>
                <xsl:when test="@id=487">eRC_RandomCurious</xsl:when>
                <xsl:when test="@id=488">eRC_RandomFlee</xsl:when>
                <xsl:when test="@id=489">eRC_RandomStay</xsl:when>
                <xsl:when test="@id=490">eRC_Capture</xsl:when>
                <xsl:when test="@id=491">eRC_TakeHostage</xsl:when>
                <xsl:when test="@id=492">eRC_AttenteOrdrePoursuivreConvoi</xsl:when>
                <xsl:when test="@id=493">eRC_DebutDevalorisation</xsl:when>
                <xsl:when test="@id=494">eRC_FinDevalorisation</xsl:when>
                <xsl:when test="@id=495">eRC_PasTenueNBC</xsl:when>
                <xsl:when test="@id=496">eRC_TenueProtectionNiveauNRBC</xsl:when>
                <xsl:when test="@id=497">eRC_UndergroundNetworkExitActivated</xsl:when>
                <xsl:when test="@id=498">eRC_UndergroundNetworkExitDeactivated</xsl:when>
                <xsl:when test="@id=499">eRC_ObjectCannotDecontaminate</xsl:when>
                <xsl:when test="@id=500">eRC_FleeCBRN</xsl:when>
                <xsl:when test="@id=501">eRC_SafePositionReached</xsl:when>
                <xsl:when test="@id=502">eRC_FleeBecauseContamination</xsl:when>
              <xsl:otherwise/>
            </xsl:choose>
          </xsl:attribute>
          <xsl:apply-templates select="node()|@*"/>
