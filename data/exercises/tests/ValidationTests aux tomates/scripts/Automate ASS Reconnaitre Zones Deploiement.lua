...
scriptName = "Automate ASS Reconnaitre Zones Deploiement"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ASS Reconnaitre Zones Deploiement C1 - 1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ASS Reconnaitre Zones Deploiement" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ASS Reconnaitre Zones Deploiement" then
					runStep()
				end
			end
		},
