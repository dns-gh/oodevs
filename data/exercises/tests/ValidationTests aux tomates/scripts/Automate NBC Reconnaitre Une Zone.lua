...
scriptName = "Automate NBC Reconnaitre Une Zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate NBC Reconnaitre Une Zone C1 - 1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate NBC Reconnaitre Une Zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate NBC Reconnaitre Une Zone" then
					runStep()
				end
			end
		},
