...
scriptName = "Automate ABC Appuyer sur position"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ABC Appuyer sur position 1" )
end,
[400] = function()
	actions:IssueOrder( "Automate ABC Appuyer sur position 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Appuyer sur position" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Appuyer sur position" then
					runStep()
				end
			end
		},
