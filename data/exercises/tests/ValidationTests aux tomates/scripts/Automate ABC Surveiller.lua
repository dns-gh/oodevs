...
scriptName = "Automate ABC Surveiller"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ABC Surveiller C1 - 1" )
end,
[120] = function()
	actions:IssueOrder( "Automate ABC Surveiller C1 - 2" )
end,

[2000+5] = function()
	Center( { coordinates = coord:UtmPosition( config.positions.center_ABC[2] ) } )
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ABC Surveiller C2 - 1" )
end,
[2000+120] = function()
	actions:IssueOrder( "Automate ABC Surveiller C2 - 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Surveiller" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Surveiller" then
					runStep()
				end
			end
		},
