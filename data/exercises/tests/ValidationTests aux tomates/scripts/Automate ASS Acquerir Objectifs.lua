...
scriptName = "Automate ASS Acquerir Objectifs"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ASS Acquerir Objectifs C1 - 1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ASS Acquerir Objectifs" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ASS Acquerir Objectifs" then
					runStep()
				end
			end
		},
