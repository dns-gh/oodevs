...
scriptName = "Automate ABC Relever En Depassant"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ABC Relever En Depassant C1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Relever En Depassant" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Relever En Depassant" then
					runStep()
				end
			end
		},
