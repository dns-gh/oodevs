...
scriptName = "Automate INF Freiner"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate INF Freiner C1 - 1" )
end,

[130] = function()
	actions:IssueOrder( "Automate INF Freiner C1 - 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Freiner" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Freiner" then
					runStep()
				end
			end
		},
