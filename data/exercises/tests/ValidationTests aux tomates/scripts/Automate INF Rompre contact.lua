...
scriptName = "Automate INF Rompre Contact"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate INF Rompre Contact C1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Rompre Contact" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Rompre Contact" then
					runStep()
				end
			end
		},
