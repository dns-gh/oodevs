...
scriptName = "Automate ABC Eclairer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ABC Eclairer C1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Eclairer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Eclairer" then
					runStep()
				end
			end
		},
