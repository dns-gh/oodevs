...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ABC Tenir C1 - 1" )
end,
[110] = function()
	actions:IssueOrder( "Automate ABC Tenir C1 - 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Tenir" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Tenir" then
					runStep()
				end
			end
		},
