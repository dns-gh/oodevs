...
scriptName = "Automate ABC Organiser Accueil Colonne Refugies"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "ABC Organiser Accueil Colonne Refugies C1" )
end,
[5+60] = function()
	actions:IssueOrder( "ABC Organiser Accueil Colonne Refugies Faire Mouvement C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Organiser Accueil Colonne Refugies" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Organiser Accueil Colonne Refugies" then
					runStep()
				end
			end
		},
