...
scriptName = "Automate ABC Semparer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "ABC Semparer C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Semparer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Semparer" then
					runStep()
				end
			end
		},
