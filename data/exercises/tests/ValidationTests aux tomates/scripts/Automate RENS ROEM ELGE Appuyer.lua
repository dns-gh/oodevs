...
scriptName = "Automate RENS ROEM Elge Appuyer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate RENS ROEM Elge Appuyer etape 1" )
end,
[5+60] = function()
	actions:IssueOrder( "Automate RENS ROEM Elge Appuyer etape 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate RENS ROEM Elge Appuyer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate RENS ROEM Elge Appuyer" then
					runStep()
				end
			end
		},
