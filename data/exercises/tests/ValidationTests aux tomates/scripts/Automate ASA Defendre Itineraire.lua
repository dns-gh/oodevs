...
scriptName = "Automate ASA Defendre Itineraire"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ASA Defendre Itineraire C1 - 1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ASA Defendre Itineraire" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ASA Defendre Itineraire" then
					runStep()
				end
			end
		},
