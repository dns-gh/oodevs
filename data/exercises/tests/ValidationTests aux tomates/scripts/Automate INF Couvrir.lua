...
scriptName = "Automate INF Couvrir"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate Couvrir INF Eclairer C1" )
	actions:IssueOrder( "Automate Couvrir INF Couvrir C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Couvrir" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Couvrir" then
					runStep()
				end
			end
		},
