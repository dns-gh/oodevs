...
scriptName = "Automate RENS ROHUM SExfiltrer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate RENS ROHUM SExfiltrer" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate RENS ROHUM SExfiltrer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate RENS ROHUM SExfiltrer" then
					runStep()
				end
			end
		},
