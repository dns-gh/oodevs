...
scriptName = "Automate INF Reconnaissance Offensive"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate INF Reconnaissance Offensive C1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Reconnaissance Offensive" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Reconnaissance Offensive" then
					runStep()
				end
			end
		},
