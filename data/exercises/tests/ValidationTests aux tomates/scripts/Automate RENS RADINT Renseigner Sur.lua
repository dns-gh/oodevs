...
scriptName = "Automate RENS RADINT Renseigner Sur"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate RENS RADINT Renseigner Sur" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate RENS RADINT Renseigner Sur" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate RENS RADINT Renseigner Sur" then
					runStep()
				end
			end
		},
