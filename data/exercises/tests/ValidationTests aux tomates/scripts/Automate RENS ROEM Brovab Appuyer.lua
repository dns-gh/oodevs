...
scriptName = "Automate RENS ROEM Brovab Appuyer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate RENS ROEM Brovab Appuyer etape 1" )
end,
[5+60] = function()
	actions:IssueOrder( "Automate RENS ROEM Brovab Appuyer etape 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate RENS ROEM Brovab Appuyer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate RENS ROEM Brovab Appuyer" then
					runStep()
				end
			end
		},
