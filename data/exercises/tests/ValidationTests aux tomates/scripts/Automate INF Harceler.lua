...
scriptName = "Automate INF Harceler"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate Harceler INF Harceler C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Harceler" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Harceler" then
					runStep()
				end
			end
		},
