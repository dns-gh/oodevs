...
scriptName = "Automate INF Appuyer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate INF Appuyer C1 - 1" )
end,

[120] = function()
	actions:IssueOrder( "Automate INF Appuyer C1 - 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Appuyer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Appuyer" then
					runStep()
				end
			end
		},
