...
scriptName = "Automate INF Flanc Garder"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate INF Flanc Garder Faire Mouvement C1" )
	actions:IssueOrder( "INF Flanc Garder C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Flanc Garder" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Flanc Garder" then
					runStep()
				end
			end
		},
