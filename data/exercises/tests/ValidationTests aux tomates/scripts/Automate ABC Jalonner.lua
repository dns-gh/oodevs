...
scriptName = "Automate ABC Jalonner"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ABC Jalonner Faire Mouvement C1" )
end,
[5+60] = function()
	actions:IssueOrder( "Automate ABC Jalonner ABC Attaquer C1" )
	actions:IssueOrder( "ABC Jalonner C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Jalonner" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Jalonner" then
					runStep()
				end
			end
		},
