...
scriptName = "Automate ABC Reduire"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ABC Reduire C1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Reduire" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Reduire" then
					runStep()
				end
			end
		},
