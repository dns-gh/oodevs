...
scriptName = "Automate INF Appuyer Un Freinage"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate INF Appuyer Un Freinage C1 - 1" )
end,

[130] = function()
	actions:IssueOrder( "Automate INF Appuyer Un Freinage C1 - 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Appuyer Un Freinage" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Appuyer Un Freinage" then
					runStep()
				end
			end
		},
