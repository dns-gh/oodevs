...
scriptName = "Automate Communes Faire Mouvement"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate Communes Faire Mouvement C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate Communes Faire Mouvement" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate Communes Faire Mouvement" then
					runStep()
				end
			end
		},
