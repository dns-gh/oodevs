...
scriptName = "Pion ASS Acquerir Lanceurs Eni"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion ASS Acquerir Lanceurs Eni" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion ASS Acquerir Lanceurs Eni" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion ASS Acquerir Lanceurs Eni" then
					runStep()
				end
			end
		},
