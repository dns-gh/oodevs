...
scriptName = "Pion ABC Flanc-garder"
...
[5] = function()
    ...
    actions:IssueOrder( "Pion ABC FlancGarder C1 ennemi" )
end,
[40] = function()
	 actions:IssueOrder( "Pion ABC FlancGarder C1" )
end,
[2000+5] = function() 
	...
	actions:IssueOrder( "Pion ABC FlancGarder C2 ennemi" )
end,
[2000+105+5] = function() --105
   actions:IssueOrder( "Pion ABC FlancGarder C2" )
end,
[4000] = function()
  Center( { coordinates = coord:UtmPosition( config.positions.center_ABC[3] ) } )
    ...
    actions:IssueOrder( "Pion ABC FlancGarder C3" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion ABC Flanc-garder" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion ABC Flanc-garder" then
					runStep()
				end
			end
		},
