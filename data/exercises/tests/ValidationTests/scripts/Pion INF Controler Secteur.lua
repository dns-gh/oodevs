...
scriptName = "Pion INF Controler Secteur"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Controler Secteur 1 - C1" )
end,

[100] = function ()
	actions:IssueOrder( "Pion INF Controler Secteur 2 - C1" )
end,
...
[2000+5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Controler Secteur 1 - C2" )
end,

[2000+100] = function ()
	actions:IssueOrder( "Pion INF Controler Secteur 2 - C2" )
end,
...
[4000+5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Controler Secteur 1 - C3" )
end,

[4000+100] = function ()
	actions:IssueOrder( "Pion INF Controler Secteur 2 - C3" )
end,
...
[6000+5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Controler Secteur 1 - C4" )
end,

[6000+100] = function ()
	actions:IssueOrder( "Pion INF Controler Secteur 2 - C4" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion INF Controler secteur" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion INF Controler secteur" then
					runStep()
				end
			end
		},
