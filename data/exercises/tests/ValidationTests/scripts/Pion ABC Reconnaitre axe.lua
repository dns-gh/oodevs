...
scriptName = "Pion ABC Reconnaitre axe"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion ABC Reconnaitre Axe 1 - C1 bis" )
end,

[30] = function()
	actions:IssueOrder( "Pion ABC Reconnaitre Axe 2 - C1 bis" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion ABC Reconnaitre axe" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion ABC Reconnaitre axe" then
					runStep()
				end
			end
		},
