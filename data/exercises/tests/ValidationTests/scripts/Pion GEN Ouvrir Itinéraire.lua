...
scriptName = "Pion GEN Ouvrir Itinéraire"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion GEN Ouvrir Itineraire 1" )
end,

[50+5] = function()
	actions:IssueOrder( "Pion GEN Ouvrir Itineraire 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion GENIE Ouvrir itinéraire" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion GENIE Ouvrir itinéraire" then
					runStep()
				end
			end
		},
