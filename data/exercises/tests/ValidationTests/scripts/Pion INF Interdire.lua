...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Interdire C1 preparation" )
end,

[25] = function()
	actions:IssueOrder( "Pion INF Interdire C1" )
end,
...
[2000+5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Pion INF Interdire C2 preparation" )
end,

[2000+25] = function()
	actions:IssueOrder( "Pion INF Interdire C2" )
end,
...
[4000+5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Interdire C3 preparation" )
end,

[4000+25] = function()
	actions:IssueOrder( "Pion INF Interdire C3" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion INF Interdire" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion INF Interdire" then
					runStep()
				end
			end
		},
