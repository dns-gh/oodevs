...
scriptName = "Pion Commun Soutenir sur position en mesure de"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission Commun Soutenir sur position en mesure de C1" )
end,
[5+2000] = function()
	Center( { coordinates = coord:UtmPosition( config.positions.center_INF[2] ) } )
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission Commun Soutenir Sur Position Faire Mouvement C2" )
end,
[5+100+2000] = function()
	actions:IssueOrder( "Mission Commun Soutenir sur position en mesure de C2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion Commun Soutenir sur position en mesure de" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion Commun Soutenir sur position en mesure de" then
					runStep()
				end
			end
		},
