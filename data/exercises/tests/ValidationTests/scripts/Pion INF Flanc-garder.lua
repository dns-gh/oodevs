...
scriptName = "Pion INF Flanc-garder"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF FlancGarder C1 preparation" )
end,

[80] = function()
	actions:IssueOrder( "Pion INF FlancGarder C1" )
end,

[2000+5] = function()
	Center( { coordinates = coord:UtmPosition( config.positions.center_INF[2] ) } )
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Pion INF FlancGarder C2 preparation" )
end,

[2000+90] = function()
	actions:IssueOrder( "Pion INF FlancGarder C2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion INF Flanc-garder" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion INF Flanc-garder" then
					runStep()
				end
			end
		},
