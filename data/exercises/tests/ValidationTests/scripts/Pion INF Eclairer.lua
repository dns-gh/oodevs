...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Eclairer - C1" )
end,
...
[2000+5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Eclairer 1 - C2" )
end,

[2000+30] = function()
	actions:IssueOrder( "Pion INF Eclairer 2 - C2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion INF Eclairer" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion INF Eclairer" then
					runStep()
				end
			end
		},
