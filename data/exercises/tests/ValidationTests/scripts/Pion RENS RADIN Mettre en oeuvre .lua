...
scriptName = "Pion RENS RADINT Mettre En Oeuvre"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion RENS RADINT Mettre En Oeuvre" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion RENS RADINT Mettre En Oeuvre" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion RENS RADINT Mettre En Oeuvre" then
					runStep()
				end
			end
		},
