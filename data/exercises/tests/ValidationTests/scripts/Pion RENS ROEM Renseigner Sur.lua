...
scriptName = "Pion RENS ROEM Renseigner Sur"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "RENS ROEM Renseigner Sur C5" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion RENS ROEM Renseigner Sur" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion RENS ROEM Renseigner Sur" then
					runStep()
				end
			end
		},
