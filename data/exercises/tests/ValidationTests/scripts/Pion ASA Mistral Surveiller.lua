...
scriptName = "Pion ASA Mistral Surveiller"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion ASA Mistral Surveiller 1" )
end,
[85] = function()
	actions:IssueOrder( "Pion ASA Mistral Surveiller 2" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion ASA MISTRAL Surveiller" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion ASA MISTRAL Surveiller" then
					runStep()
				end
			end
		},
