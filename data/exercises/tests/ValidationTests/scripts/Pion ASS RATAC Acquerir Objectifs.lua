...
scriptName = "Pion ASS RATAC Acquerir Objectifs"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion ASS RATAC Acquerir Objectifs" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion ASS RATAC Acquerir Objectifs" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion ASS RATAC Acquerir Objectifs" then
					runStep()
				end
			end
		},
