...
scriptName = "Pion Commun Securiser zone contre population"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion Commun Securiser zone contre population" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion Commun Sécuriser zone contre population" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion Commun Sécuriser zone contre population" then
					runStep()
				end
			end
		},
