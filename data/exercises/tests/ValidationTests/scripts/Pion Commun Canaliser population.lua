...
scriptName = "Pion Commun Canaliser population"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion Commun Canaliser population" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion Commun Canaliser population" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion Commun Canaliser population" then
					runStep()
				end
			end
		},
