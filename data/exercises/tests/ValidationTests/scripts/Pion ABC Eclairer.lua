...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion ABC Eclairer - C1" )
end,
...
[2000+5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion ABC Eclairer - C2 bis" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion ABC Eclairer" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion ABC Eclairer" then
					runStep()
				end
			end
		},
