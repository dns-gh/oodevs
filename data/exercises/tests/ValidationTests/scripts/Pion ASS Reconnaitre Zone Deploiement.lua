...
scriptName = "Pion ASS Reconnaitre Zone Deploiement"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion ASS Reconnaitre Zone Deploiement" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion ASS Reconnaitre Zone Deploiement" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion ASS Reconnaitre Zone Deploiement" then
					runStep()
				end
			end
		},
