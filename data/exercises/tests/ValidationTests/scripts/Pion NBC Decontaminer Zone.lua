...
scriptName = "Pion NBC Decontaminer Zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion NBC Decontaminer Zone" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion NBC Decontaminer zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion NBC Decontaminer zone" then
					runStep()
				end
			end
		},
