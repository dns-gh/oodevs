...
scriptName = "Pion RENS ROEM Brovab Appuyer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion RENS ROEM Brovab Appuyer etape 1" )
end,
[5+150] = function()
	actions:IssueOrder( "Pion RENS ROEM Brovab Appuyer etape 2" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion RENS ROEM Brovab Appuyer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion RENS ROEM Brovab Appuyer" then
					runStep()
				end
			end
		},
