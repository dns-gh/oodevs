...
scriptName = "Pion ABC Escorter des unités"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	sim:Engage(formation[1].automat[3].id,true)
	actions:IssueOrder( "Mission EscorterUnites Faire Mouvement C1" )
end,
[80] = function()
	actions:IssueOrder( "Mission EscorterUnites ABC Escorter Unites C1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion ABC Escorter des unités" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion ABC Escorter des unités" then
					runStep()
				end
			end
		},
