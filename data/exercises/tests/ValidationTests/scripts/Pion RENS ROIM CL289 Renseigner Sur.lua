...
scriptName = "Pion RENS ROIM CL289 Renseigner Sur"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion RENS ROIM CL289 Renseigner Sur etape 1" )
end,
[5+100] = function()
	actions:IssueOrder( "Pion RENS ROIM CL289 Renseigner Sur etape 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion RENS ROIM CL289 Renseigner Sur" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion RENS ROIM CL289 Renseigner Sur" then
					runStep()
				end
			end
		},
