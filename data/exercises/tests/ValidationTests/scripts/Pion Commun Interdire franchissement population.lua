...
scriptName = "Pion Commun Interdire franchissement population"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion Commun Interdire franchissement population" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion Commun Interdire franchissement population" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion Commun Interdire franchissement population" then
					runStep()
				end
			end
		},
