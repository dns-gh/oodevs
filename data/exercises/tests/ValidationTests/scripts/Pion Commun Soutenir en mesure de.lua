...
scriptName = "Pion Commun Soutenir en mesure de"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission Soutenir en mesure de Commun Soutenir En Mesure De C1" )
end,
[5+2000] = function()
	Center( { coordinates = coord:UtmPosition( config.positions.center_INF[2] ) } )
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission Soutenir en mesure de Commun Faire Mouvement C2" )
end,
[5+100+2000] = function()
	actions:IssueOrder( "Mission Soutenir en mesure de Commun Soutenir En Mesure De C2" )
end,

[5+4000] = function()
	Center( { coordinates = coord:UtmPosition( config.positions.center_INF[3] ) } )
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission Soutenir en mesure de Commun Faire Mouvement C3" )
end,
[5+100+4000] = function()
	actions:IssueOrder( "Mission Soutenir en mesure de Commun Soutenir En Mesure De C3" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion Commun Soutenir en mesure de" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion Commun Soutenir en mesure de" then
					runStep()
				end
			end
		},
