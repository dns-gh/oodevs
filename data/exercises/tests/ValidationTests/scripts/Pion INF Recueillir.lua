...
scriptName = "Pion INF Recueillir"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Recueillir C1 preparation" )
end,

[45] = function()
	actions:IssueOrder( "Pion INF Recueillir C1" )
end,
...
[2000+5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Pion INF Recueillir C2 preparation" )
end,

[2000+45] = function()
	actions:IssueOrder( "Pion INF Recueillir C2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion INF Recueillir" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion INF Recueillir" then
					runStep()
				end
			end
		},
