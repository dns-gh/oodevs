...
scriptName = "Pion RENS ROEM Mettre En Oeuvre"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "RENS ROEM Mettre En Oeuvre C5" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion RENS ROEM Mettre En Oeuvre" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion RENS ROEM Mettre En Oeuvre" then
					runStep()
				end
			end
		},
