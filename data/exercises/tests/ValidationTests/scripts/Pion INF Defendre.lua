...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Defendre C1 preparation" )
end,

[25] = function()
	actions:IssueOrder( "Pion INF Defendre C1" )
end,
...
[2000+5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Pion INF Defendre C2 preparation" )
end,

[2000+25] = function()
	actions:IssueOrder( "Pion INF Defendre C2" )
end,
...
[4000+5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Defendre C3 preparation" )
end,

[4000+25] = function()
	actions:IssueOrder( "Pion INF Defendre C3" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion INF Defendre" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion INF Defendre" then
					runStep()
				end
			end
		},
