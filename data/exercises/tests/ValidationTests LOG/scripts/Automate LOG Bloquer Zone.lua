...
scriptName = "Automate LOG Bloquer Zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Automate LOG Bloquer Zone" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate LOG Bloquer Zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate LOG Bloquer Zone" then
					runStep()
				end
			end
		},
