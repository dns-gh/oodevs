...
scriptName = "Pion LOG Appuyer Mouvement Dans Zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "LOG Appuyer Mouvement Zone ABC Semparer Zone C5" )
	actions:IssueOrder( "LOG Appuyer Mouvement Dans Zone C5" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion LOG Appuyer Mouvement Dans Zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion LOG Appuyer Mouvement Dans Zone" then
					runStep()
				end
			end
		},
