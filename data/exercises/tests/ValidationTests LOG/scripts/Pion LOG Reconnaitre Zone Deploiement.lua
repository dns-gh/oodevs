...
scriptName = "Pion LOG Reconnaitre Zone De Deploiement"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "LOG Reconnaitre Zone De Deploiement C5" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion LOG Reconnaitre Zone De Deploiement" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion LOG Reconnaitre Zone De Deploiement" then
					runStep()
				end
			end
		},
