...
scriptName = "Pion LOG Trier Blesses"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Pion LOG Trier Blesses Faire Mouvement C5" )
	actions:IssueOrder( "Pion LOG Trier Blesses ABC Attaquer C5" )
end,
[5+280] = function()
	actions:IssueOrder( "LOG Traiter Blesses C5" )
	actions:IssueOrder( "LOG Trier Blesses C5" )
	actions:IssueOrder( "LOG Trier Et Traiter Blesses C5" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion LOG Trier Blesses" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion LOG Trier Blesses" then
					runStep()
				end
			end
		},
