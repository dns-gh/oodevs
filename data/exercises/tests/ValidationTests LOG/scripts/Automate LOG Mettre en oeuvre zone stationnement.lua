...
scriptName = "Automate LOG Mettre En Oeuvre Zone Stationnement"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Automate LOG Mettre En Oeuvre Zone Stationnement" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate LOG Mettre En Oeuvre Zone Stationnement" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "AAutomate LOG Mettre En Oeuvre Zone Stationnement" then
					runStep()
				end
			end
		},
