...
scriptName = "Pion LOG Reconnaitre Zone Contaminee"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "LOG Reconnaitre Zone Contaminee C5" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion LOG Reconnaitre Zone Contaminee" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion LOG Reconnaitre Zone Contaminee" then
					runStep()
				end
			end
		},
