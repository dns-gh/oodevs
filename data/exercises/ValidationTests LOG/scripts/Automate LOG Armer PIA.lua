...
scriptName = "Automate LOG Armer PIAs"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Automate LOG Armer PIAs" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate LOG Armer PIAs" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate LOG Armer PIAs" then
					runStep()
				end
			end
		},
