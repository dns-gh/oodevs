...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "LOG Reparer ABC Attaquer C5" )
end,
[5+160] = function()
	actions:IssueOrder( "LOG Reparer C5" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion LOG Reparer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion LOG Reparer" then
					runStep()
				end
			end
		},
