...
scriptName = "Automate LOG Appuyer Franchissement Dans Zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Automate LOG Appuyer Franchissement Dans Zone" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate LOG Appuyer Franchissement Dans Zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate LOG Appuyer Franchissement Dans Zone" then
					runStep()
				end
			end
		},
