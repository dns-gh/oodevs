...
scriptName = "Automate LOG Appuyer Mouvement Dans Zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Automate LOG Appuyer Mouvement Dans Zone etape 1" )
end,

[5+40] = function()
	actions:IssueOrder( "Automate LOG Appuyer Mouvement Dans Zone etape 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate LOG Appuyer Mouvement Dans Zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate LOG Appuyer Mouvement Dans Zone" then
					runStep()
				end
			end
		},
