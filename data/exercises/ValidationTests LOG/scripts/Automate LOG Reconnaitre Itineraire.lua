...
scriptName = "Automate LOG Reconnaitre Itineraire"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Automate LOG Reconnaitre Itineraire" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate LOG Reconnaitre Itineraire" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate LOG Reconnaitre Itineraire" then
					runStep()
				end
			end
		},
