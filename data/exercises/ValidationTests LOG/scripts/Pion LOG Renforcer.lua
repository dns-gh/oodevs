...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "LOG Renforcer ABC Attaquer C5" )
	actions:IssueOrder( "LOG Renforcer C5" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion LOG Renforcer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion LOG Renforcer" then
					runStep()
				end
			end
		},
