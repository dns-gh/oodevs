...
scriptName = "Automate LOG Appuyer Mouvement"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Automate LOG Appuyer Mouvement etape 1" )
end,

[5+40] = function()
	actions:IssueOrder( "Automate LOG Appuyer Mouvement etape 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate LOG Appuyer Mouvement" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate LOG Appuyer Mouvement" then
					runStep()
				end
			end
		},
