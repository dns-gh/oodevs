...
scriptName = "Automate Communes Contrôler Populations dans Zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate Communes Controler Populations Dans Zone C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate Communes Contrôler Populations dans Zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate Communes Contrôler Populations dans Zone" then
					runStep()
				end
			end
		},
