...
scriptName = "Automate Communes Filtrer Populations"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate Communes Filtrer Populations C1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate Communes Filtrer Populations" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate Communes Filtrer Populations" then
					runStep()
				end
			end
		},
