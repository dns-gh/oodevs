...
scriptName = "Automate TRANS Commander"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate TRANS Commander" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate TRANS Commander" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate TRANS Commander" then
					runStep()
				end
			end
		},
