...
scriptName = "Pion GENIE Reconnaitre itinéraire"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission GEN Reconnaitre Itineraire C1" )
end,

[5+2000] = function()
	Center( { coordinates = coord:UtmPosition( config.positions.center_ABC[2] ) } )
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission GEN Reconnaitre Itinéraire Faire Mouvement C2" )
end,

[5+40+2000] = function()
	actions:IssueOrder( "Mission GEN Reconnaitre Itineraire C2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion GENIE Reconnaitre itinéraire" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion GENIE Reconnaitre itinéraire" then
					runStep()
				end
			end
		},
