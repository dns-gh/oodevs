...
scriptName = "Pion MILICE Harceler"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission INF Harceler C5" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion MILICE Harceler" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion MILICE Harceler" then
					runStep()
				end
			end
		},
