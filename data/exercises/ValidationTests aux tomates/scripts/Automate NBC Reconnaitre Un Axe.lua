...
scriptName = "Automate NBC Reconnaitre Un Axe"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate NBC Reconnaitre Un Axe C1 - 1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate NBC Reconnaitre Un Axe" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate NBC Reconnaitre Un Axe" then
					runStep()
				end
			end
		},
