...
scriptName = "Automate GEN Se Deployer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate GEN Se Deployer" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate GEN Se Deployer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate GEN Se Deployer" then
					runStep()
				end
			end
		},
