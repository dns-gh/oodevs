...
scriptName = "Automate INF Defendre Ferme"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate INF Defendre Ferme C1 etape 1" )
end,
[5+40] = function()
	actions:IssueOrder( "Automate INF Defendre Ferme C1 etape 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Defendre Ferme" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Defendre Ferme" then
					runStep()
				end
			end
		},
