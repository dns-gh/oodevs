...
scriptName = "Pion NBC Reconnaitre Itineraire"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion NBC Reconnaitre Itineraire" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion NBC Reconnaitre itineraire" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion NBC Reconnaitre itineraire" then
					runStep()
				end
			end
		},
