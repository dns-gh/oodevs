...
scriptName = "Automate INF Prendre Preciser Maintenir Contact"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "INF Prendre Preciser Maintenir Contact C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Prendre Preciser Maintenir Contact" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Prendre Preciser Maintenir Contact" then
					runStep()
				end
			end
		},
