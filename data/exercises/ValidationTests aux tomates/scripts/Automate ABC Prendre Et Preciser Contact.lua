...
scriptName = "Automate ABC Prendre Preciser Contact"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "ABC Prendre Preciser Contact C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Prendre Preciser Contact" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Prendre Preciser Contact" then
					runStep()
				end
			end
		},
