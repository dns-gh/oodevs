...
scriptName = "Automate GEN Retablir Itineraires"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate GEN Retablir Itineraires" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate GEN Retablir Itineraires" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate GEN Retablir Itineraires" then
					runStep()
				end
			end
		},
