...
scriptName = "Automate ABC Soutenir"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ABC Soutenir ABC Eclairer C1" )
	actions:IssueOrder( "Automate ABC Soutenir ABC Soutenir C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Soutenir" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Soutenir" then
					runStep()
				end
			end
		},
