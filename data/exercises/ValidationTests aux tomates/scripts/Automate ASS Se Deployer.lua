...
scriptName = "Automate ASS Se Deployer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ASS Se Deployer C1 - 1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ASS Se Deployer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ASS Se Deployer" then
					runStep()
				end
			end
		},
