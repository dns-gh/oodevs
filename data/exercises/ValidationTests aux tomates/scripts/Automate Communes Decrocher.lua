...
scriptName = "Automate Communes Decrocher"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate Communes Decrocher C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate Communes Decrocher" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate Communes Decrocher" then
					runStep()
				end
			end
		},
