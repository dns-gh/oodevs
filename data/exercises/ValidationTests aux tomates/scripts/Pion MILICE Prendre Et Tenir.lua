...
scriptName = "Pion MILICE Prendre Et Tenir"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission MILICE Prendre Et Tenir C5" )
end,
[5+80] = function()
	actions:IssueOrder( "Mission Faire Prendre Et Tenir Mouvement C5" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion MILICE Prendre Et Tenir" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion MILICE Prendre Et Tenir" then
					runStep()
				end
			end
		},
