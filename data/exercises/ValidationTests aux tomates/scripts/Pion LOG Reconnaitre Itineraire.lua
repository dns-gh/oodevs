...
scriptName = "Pion LOG Reconnaitre Itineraire"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "LOG Reconnaitre Itineraire Faire Mouvement C5" )
end,
[5+130] = function()
	actions:IssueOrder( "LOG Reconnaitre Itineraire C5" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion LOG Reconnaitre Itineraire" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion LOG Reconnaitre Itineraire" then
					runStep()
				end
			end
		},
