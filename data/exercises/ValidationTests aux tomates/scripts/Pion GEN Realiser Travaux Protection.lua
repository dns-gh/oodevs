...
scriptName = "Pion GEN Realiser Travaux Protection"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion GEN Realiser Travaux Protection" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion GENIE Réaliser travaux protection" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion GENIE Réaliser travaux protection" then
					runStep()
				end
			end
		},
