...
scriptName = "Pion GENIE Améliorer mobilité"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission pion GEN Ameliorer Mobilite C1" )
end,
[5+50] = function()
	actions:IssueOrder( "Mission pion GEN Renforcer C1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion GENIE Améliorer mobilité" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion GENIE Améliorer mobilité" then
					runStep()
				end
			end
		},
