...
scriptName = "Pion INF Organiser un Checkpoint"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Organiser un Checkpoint 1 - C1" )
end,

[70] = function()
	actions:IssueOrder( "Pion INF Organiser un Checkpoint 2 - C1" )
end,
...
[5+2000] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Organiser un Checkpoint 1 - C2" )
end,

[70+2000] = function()
	actions:IssueOrder( "Pion INF Organiser un Checkpoint 2 - C2" )
end,
...
[5+4000] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Organiser un Checkpoint 1 - C3" )
end,

[70+4000] = function()
	actions:IssueOrder( "Pion INF Organiser un Checkpoint 2 - C3" )
end,
...
[5+6000] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Organiser un Checkpoint 1 - C4" )
end,

[70+6000] = function()
	actions:IssueOrder( "Pion INF Organiser un Checkpoint 2 - C4" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion INF Organiser un checkpoint" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion INF Organiser un checkpoint" then
					runStep()
				end
			end
		},
