...
scriptName = "Pion GENIE Retablir Itineraire"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion GEN Retablir Itineraire" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion GENIE Rétablir Itinéraire" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion GENIE Rétablir Itinéraire" then
					runStep()
				end
			end
		},
