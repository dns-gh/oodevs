...
scriptName = "Automate ABC Appuyer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ABC Appuyer 1" )
end,
[20] = function()
	actions:IssueOrder( "Automate ABC Appuyer 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Appuyer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Appuyer" then
					runStep()
				end
			end
		},
