...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Freiner C1 preparation" )
end,

[85] = function()
	actions:IssueOrder( "Pion INF Freiner C1" )
end,
...
[2000+5] = function()
	...
	Zoom( { width = 35000 } )
    actions:IssueOrder( "Pion INF Freiner C2 preparation" )
end,

[2000+85] = function()
	actions:IssueOrder( "Pion INF Freiner C2" )
end,
...
[4000+5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Freiner C3" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion INF Freiner" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion INF Freiner" then
					runStep()
				end
			end
		},
