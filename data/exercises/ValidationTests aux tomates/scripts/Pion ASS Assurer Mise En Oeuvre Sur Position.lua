...
scriptName = "Pion ASS Assurer Mise En Oeuvre Sur Position"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion ASS Assurer Mise En Oeuvre Sur Position" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion ASS Assurer Mise En Oeuvre Sur Position" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion ASS Assurer Mise En Oeuvre Sur Position" then
					runStep()
				end
			end
		},
