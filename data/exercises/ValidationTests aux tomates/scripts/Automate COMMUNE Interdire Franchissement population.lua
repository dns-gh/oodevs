...
scriptName = "Automate Communes Interdire franchissement Populations"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate Communes Interdire franchissement Populations C1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate Communes Interdire franchissement Populations" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate Communes Interdire franchissement Populations" then
					runStep()
				end
			end
		},
