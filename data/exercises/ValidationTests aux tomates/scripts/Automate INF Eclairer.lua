...
scriptName = "Automate INF Eclairer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate INF Eclairer INF Eclairer C1" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Eclairer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Eclairer" then
					runStep()
				end
			end
		},
