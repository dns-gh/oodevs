...
scriptName = "Automate ABC Flanc Garder"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ABC Flanc Garder C1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ABC Flanc Garder" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ABC Flanc Garder" then
					runStep()
				end
			end
		},
