...
scriptName = "Automate ASA MISTRAL Defendre Zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ASA MISTRAL Defendre Zone C1 - 1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ASA MISTRAL Defendre Zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ASA MISTRAL Defendre Zone" then
					runStep()
				end
			end
		},
