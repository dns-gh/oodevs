...
scriptName = "Pion GEN Realiser Travaux Appui Deploiement"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion GEN Realiser Travaux Appui Deploiement" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion GENIE Réaliser Travaux Appui Déploiement" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion GENIE Réaliser Travaux Appui Déploiement" then
					runStep()
				end
			end
		},
