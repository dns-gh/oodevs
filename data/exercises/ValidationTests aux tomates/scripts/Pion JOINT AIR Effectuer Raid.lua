...
scriptName = "Pion JOINT AIR Effectuer Raid"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion JOINT AIR Effectuer Raid 1" )
end,

[70] = function()
	sim:ChangeTimeFactor(10)
	actions:IssueOrder( "Pion JOINT AIR Effectuer Raid 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion JOINT AIR Effectuer Raid" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion JOINT AIR Effectuer Raid" then
					runStep()
				end
			end
		},
