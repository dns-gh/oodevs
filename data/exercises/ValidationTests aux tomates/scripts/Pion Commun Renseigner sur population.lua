...
scriptName = "Pion Commun Renseigner sur population"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion Commun Renseigner sur population" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion Commun Renseigner sur population" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion Commun Renseigner sur population" then
					runStep()
				end
			end
		},
