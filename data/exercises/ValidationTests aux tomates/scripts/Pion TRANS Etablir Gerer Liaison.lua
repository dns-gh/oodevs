...
scriptName = "Pion TRANS Etablir Gerer Liaison"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion TRANS Etablir Gerer Liaison" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion TRANS Etablir Gerer Liaison" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion TRANS Etablir Gerer Liaison" then
					runStep()
				end
			end
		},
