...
scriptName = "Automate GEN Realiser Travaux"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate GEN Realiser Travaux" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate GEN Realiser Travaux" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate GEN Realiser Travaux" then
					runStep()
				end
			end
		},
