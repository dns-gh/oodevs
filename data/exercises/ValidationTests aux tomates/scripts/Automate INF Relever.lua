...
scriptName = "Automate INF Relever"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate INF Relever Faire Mouvement C1" )
end,
[5+60] = function()
	actions:IssueOrder( "INF Relever C1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate INF Relever" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate INF Relever" then
					runStep()
				end
			end
		},
