...
scriptName = "Automate GEN Ouvrir Itineraires"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate GEN Ouvrir Itineraires" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate GEN Ouvrir Itineraires" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate GEN Ouvrir Itineraires" then
					runStep()
				end
			end
		},
