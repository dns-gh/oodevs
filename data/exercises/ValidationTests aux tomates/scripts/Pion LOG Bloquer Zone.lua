...
scriptName = "Pion LOG Bloquer Zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "LOG Bloquer Zone C5" )
end,
[5+100] = function()
	actions:IssueOrder( "LOG Bloquer Zone Faire Mouvement C5" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion LOG Bloquer Zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion LOG Bloquer Zone" then
					runStep()
				end
			end
		},
