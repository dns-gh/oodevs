...
scriptName = "Pion NBC Reconnaitre Zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion NBC Reconnaitre Zone" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion NBC Reconnaitre zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion NBC Reconnaitre Zone" then
					runStep()
				end
			end
		},
