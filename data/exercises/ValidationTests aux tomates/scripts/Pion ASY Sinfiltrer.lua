...
scriptName = "Pion ASY S'infiltrer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission ASY SInfiltrer C5" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion ASY S'infiltrer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion ASY S'infiltrer" then
					runStep()
				end
			end
		},
