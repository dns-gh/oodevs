...
scriptName = "Automate ASA MISTRAL Surveiller"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ASA MISTRAL Surveiller C1 - 1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ASA MISTRAL Surveiller" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ASA MISTRAL Surveiller" then
					runStep()
				end
			end
		},
