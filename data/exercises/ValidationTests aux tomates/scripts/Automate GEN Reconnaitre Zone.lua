...
scriptName = "Automate GEN Reconnaitre Zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate GEN Reconnaitre Zone" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate GEN Reconnaitre Zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate GEN Reconnaitre Zone" then
					runStep()
				end
			end
		},
