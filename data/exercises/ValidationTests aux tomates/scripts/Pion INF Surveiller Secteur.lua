...
scriptName = "Pion INF Surveiller Secteur"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Surveiller Secteur 1 - C1" )
end,

[30] = function()
	actions:IssueOrder( "Pion INF Surveiller Secteur 2 - C1" )
end,
...
[5+2000] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Surveiller Secteur 1 - C2" )
end,

[30+2000] = function()
	actions:IssueOrder( "Pion INF Surveiller Secteur 2 - C2" )
end,
...
[5+4000] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Surveiller Secteur 1 - C3" )
end,

[30+4000] = function()
	actions:IssueOrder( "Pion INF Surveiller Secteur 2 - C3" )
end,
...
[5+6000] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Surveiller Secteur 1 - C4" )
end,

[30+6000] = function()
	actions:IssueOrder( "Pion INF Surveiller Secteur 2 - C4" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion INF Surveiller secteur" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion INF Surveiller secteur" then
					runStep()
				end
			end
		},
