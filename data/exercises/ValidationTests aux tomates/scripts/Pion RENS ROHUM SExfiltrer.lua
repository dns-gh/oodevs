...
scriptName = "Pion RENS ROHUM SExfiltrer"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion RENS ROHUM SExfiltrer" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion RENS ROHUM SExfiltrer" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion RENS ROHUM SExfiltrer" then
					runStep()
				end
			end
		},
