...
scriptName = "Pion Commun Controler population dans zone"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion Commun Controler population dans zone" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion Commun Controler population dans zone" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion Commun Controler population dans zone" then
					runStep()
				end
			end
		},
