...
scriptName = "Pion MILICE Detruire Embuscade"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Mission MILICE Detruire Embuscade C5" )
end,

[5+70] = function()
	actions:IssueOrder( "Mission Detruire Embuscade Faire Mouvement C5" )
end,
}
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion MILICE Detruire Embuscade" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion MILICE Detruire Embuscade" then
					runStep()
				end
			end
		},
