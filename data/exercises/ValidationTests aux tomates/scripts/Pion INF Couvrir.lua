...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Couvrir C1" )
end,
...
[2000+5] = function()
	...
	Zoom( { width = 35000 } )
    sim:Engage(formation[6].automat[1].id,true)
	actions:IssueOrder( "Pion INF Couvrir C2" )
end,
...
[4000+5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion INF Couvrir C3" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion INF Couvrir" then return end
				tick=0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion INF Couvrir" then
					runStep()
				end
			end
		},
