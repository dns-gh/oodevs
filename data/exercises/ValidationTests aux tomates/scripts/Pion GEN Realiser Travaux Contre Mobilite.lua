...
scriptName = "Pion GEN Realiser Travaux Contre Mobilite"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion GEN Realiser Travaux Contre Mobilite" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion GENIE Réaliser travaux contre mobilité" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion GENIE Réaliser travaux contre mobilité" then
					runStep()
				end
			end
		},
