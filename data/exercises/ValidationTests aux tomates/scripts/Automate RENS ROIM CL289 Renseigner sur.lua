...
scriptName = "Automate RENS ROIM CL289 Renseigner Sur"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate RENS ROIM CL289 Renseigner Sur etape 1" )
end,
[5+60] = function()
	actions:IssueOrder( "Automate RENS ROIM CL289 Renseigner Sur etape 2" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate RENS ROIM CL289 Renseigner Sur" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate RENS ROIM CL289 Renseigner Sur" then
					runStep()
				end
			end
		},
