...
scriptName = "Pion NBC Animer Un Plot De Decontamination"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Pion NBC Animer Un Plot De Decontamination" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Pion NBC Animer un plot de decontamination" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Pion NBC Animer un plot de decontamination" then
					runStep()
				end
			end
		},
