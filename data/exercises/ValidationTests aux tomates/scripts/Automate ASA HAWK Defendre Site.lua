...
scriptName = "Automate ASA HAWK Defendre Site"
...
[5] = function()
	...
	Zoom( { width = 35000 } )
	actions:IssueOrder( "Automate ASA HAWK Defendre Site C1 - 1" )
end,
    ...
    {
		{
            ...
            function( client, profile )
                if profile ~= "Automate ASA HAWK Defendre Site" then return end
				tick = 0
		...
		{ "Missions_Init" },
			function()
				if profile ~= "Automate ASA HAWK Defendre Site" then
					runStep()
				end
			end
		},
