...
{    
    ...
    getReachable = function( self, params )
        if params.position ~= NIL then
            ...
            if masalife.brain.core.class.isOfType( params.position, world_elements.Area) then
            ...
            elseif masalife.brain.core.class.isOfType( params.position, world_elements.Point ) then
