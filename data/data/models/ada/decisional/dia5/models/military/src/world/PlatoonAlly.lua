...
-- $$$ MIA TODO rapatrier les mï¿½thodes ici.
...
return
{
    ...
    -- --------------------------------------------------------------------------------
    -- $$$ MIA TODO rpatrier les mï¿½thodes ici.
    ...
    destructionPriority = function( self )
        return 0 -- $$$ Pour le moment pas appelï¿½ car on ne dï¿½truit pas d'amis dans SCIPIO
    end,
    canDestroyIt = function( self )
        return false -- $$$ Pour le moment pas appelï¿½ car on ne dï¿½truit pas d'amis dans SCIPIO
    end,
    ...
    neutralizeIt = function( self )
        return false -- $$$ Pour le moment pas appelï¿½ car on ne neutralise pas d'amis dans SCIPIO
    end,
    ...
    -- -------------------------------------------------------------------------------- 
    -- Integrations and spï¿½cifics methods
    -- --------------------------------------------------------------------------------
    ...
    computeSupportCapability = function( self, objective, position )
        -- Hypothï¿½se simplificatrice:plus la position est proche de l'objectif, 
    ...
    computeLoadCapability = function( self, objective, position )
         return position:getProximity( objective ) -- hypothï¿½se simplificatrice 
    end,
