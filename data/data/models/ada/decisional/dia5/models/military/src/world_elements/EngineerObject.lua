return
{
    ...
    getProximity = function( self, reachable )
        if masalife.brain.core.class.isOfType( reachable, world_elements.Direction ) then
    ...
    getMyPosition = function( self )
        return CreateKnowledge( world_elements.Point, self:getPosition() )
    end,
    ...
    { 
        start = function( self )
            integration.startBuildIt( self, world_elements.Object )
        end, 
    ...
    plannedworkToWork = function( self )
        ...
        if element then
            return CreateKnowledge( world_elements.Object, element )
        end  
        return self
    end,
