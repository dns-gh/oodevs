...
(function() {
  var UserItem, UserItemView, UserList, UserListView, ajax, diff_models, display_error, get_url, on_user_modal, pajax, parse_parameters, print_error, raw_ajax, set_spinner, text_compare, toggle_input_error, transform_to_spinner, user_error_template, user_settings, user_template, user_view,
  ...
  UserItem = (function(_super) {
    ...
    UserItem.prototype.sync = function(method, model, options) {
      ...
      if (method === "create") {
        ...
        return pajax("/api/create_user", params, options.success, options.error);
      }
      if (method === "read") {
  ...
  UserItemView = (function(_super) {
    ...
    UserItemView.prototype["delete"] = function() {
      var _this = this;
      this.toggle_load();
    ...
    UserItemView.prototype.config = function(evt) {
      if ($(evt.currentTarget).hasClass("disabled")) {
        return;
      }
      on_user_modal($(this.el).find(".user_settings"), this.model.attributes);
      return $(this.el).find(".user_settings").modal("show");
    };
  ...
  on_user_modal = function(container) {
    return container.html(user_settings());
  };
