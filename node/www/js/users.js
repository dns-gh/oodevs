...
(function() {
  var UserItem, UserItemView, UserList, UserListView, ajax, diff_models, display_error, get_url, pajax, parse_parameters, pop_settings, print_error, raw_ajax, set_spinner, text_compare, toggle_input_error, transform_to_spinner, update_model, user_error_template, user_settings, user_template, user_view,
  ...
  UserItemView = (function(_super) {
    ...
    UserItemView.prototype.edit = function(evt) {
      ...
      _ref = pop_settings(this.model.attributes), ui = _ref[0], mod = _ref[1];
      return ui.find(".add").click(function(e) {
        var data, err, name, tmp, user;
