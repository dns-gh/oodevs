...
(function() {
  var Package, PackageView, ajax, attach_checkbox_and_input, bytes_to_size, convert_to_boolean, diff_models, display_error, duration_reduce, force_input_regexp, get_double, get_ms_duration_from, get_number, get_url, is_clipped, is_disabled, link_checkbox_to_input, load_url, modal_confirm, ms_to_duration, on_input_event, package_template, package_view, pad, pajax, parse_parameters, parse_scalar, print_error, raw_ajax, select_attributes, set_checkbox, set_spinner, text_compare, toggle_input_error, toggle_spinner, toggle_upload, update_model, upload_error_template, _ref, _ref1,
    __slice = [].slice,
  ...
  Package = (function(_super) {
    ...
    function Package() {
      this.sync = __bind(this.sync, this);      _ref = Package.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  PackageView = (function(_super) {
    ...
    function PackageView() {
      ...
      this.reset = __bind(this.reset, this);      _ref1 = PackageView.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
    ...
    PackageView.prototype.render = function() {
      var disable_list, discard, it, save, _i, _j, _len, _len1, _ref2, _ref3,
        _this = this;
      ...
      _ref2 = $(this.el).find(".action .more");
      ...
      save.click(function() {
        var btns, id, list, _k, _len2, _ref4;
        ...
        list = [];
        btns = [];
        _ref4 = $(_this.el).find(".action .add, .action .update");
