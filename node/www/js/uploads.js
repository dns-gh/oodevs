...
(function() {
  var Package, PackageView, ajax, diff_models, display_error, get_url, package_template, package_view, print_error, set_spinner, text_compare, toggle_load, upload_error_template,
    ...
    PackageView.prototype.render = function() {
      ...
      if (this.model.attributes.name != null) {
        ...
        $(".form-actions .save").click(function() {
          var id, list, spin, _k, _len2, _ref2;
          list = [];
