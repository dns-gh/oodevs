...
(function() {
  ...
  Handlebars.registerHelper("each_pair", function(list, options) {
    var ret;
    ret = "";
  ...
  set_plugins = function(data) {
    var included, it, next, plugins, _i, _len;
    plugins = [];
    for (_i = 0, _len = plugin_list.length; _i < _len; _i++) {
      ...
      included = _.isArray(data.plugins) && __indexOf.call(data.plugins, it) >= 0;
      included |= _.isObject(data.plugins) && it in data.plugins;
      if (included) {
