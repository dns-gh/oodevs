...
(function() {
  ...
  print_warning = function(text) {
    return display_error("node_error", node_warning_template, text);
  };
        ...
        return _this.model.save(data, {
          ...
          success: function() {
            if (data.name !== previous) {
              return print_warning("Please restart node " + _this.model.get("ident") + " to apply changes");
            }
          },
          error: function() {
