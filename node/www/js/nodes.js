...
(function() {
  var NodeItem, NodeItemView, NodeList, NodeListView, ajax, attach_checkbox_and_input, bytes_to_size, diff_models, display_error, duration_reduce, force_input_regexp, get_double, get_ms_duration_from, get_number, get_url, is_clipped, is_disabled, link_checkbox_to_input, ms_to_duration, node_default, node_error_template, node_settings, node_template, node_view, on_input_event, pad, pajax, parse_parameters, parse_scalar, pop_settings, print_error, raw_ajax, set_checkbox, set_spinner, text_compare, toggle_input_error, transform_to_spinner, update_model, validate_input_node, validate_number, validate_settings,
