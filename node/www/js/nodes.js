...
(function() {
  ...
  NodeItem = (function(_super) {
    ...
    function NodeItem() {
      this.sync = __bind(this.sync, this);      _ref = NodeItem.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  NodeList = (function(_super) {
    ...
    function NodeList() {
      ...
      this.sync = __bind(this.sync, this);      _ref1 = NodeList.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  NodeItemView = (function(_super) {
    ...
    function NodeItemView() {
      ...
      this.render = __bind(this.render, this);      _ref2 = NodeItemView.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
    ...
    NodeItemView.prototype.render = function() {
      var data, is_open, _ref3;

      is_open = (_ref3 = $(this.el).find(".collapse")) != null ? _ref3.hasClass("in") : void 0;
      $(this.el).empty();
    ...
    NodeItemView.prototype.edit = function(evt) {
      ...
      _ref3 = pop_settings($("#node_settings"), this.model.attributes), ui = _ref3[0], mod = _ref3[1];
  ...
  NodeListView = (function(_super) {
    ...
    function NodeListView() {
      ...
      this.reset = __bind(this.reset, this);      _ref3 = NodeListView.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  $("#node_edit").click(function() {
    ...
    _ref4 = pop_settings($("#node_settings"), node_default.attributes), ui = _ref4[0], mod = _ref4[1];
    return mod.find(".apply").click(function() {
      var data;
