...
(function() {
  ...
  $(".log_in").click(function() {
    ...
    return pajax("/api/login", {}, {
      ...
      return load_url(uri + window.location.hash);
    }, function() {
