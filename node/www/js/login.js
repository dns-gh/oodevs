...
(function() {
  var ajax, diff_models, display_error, error_template, get_url, pajax, parse_parameters, print_error, raw_ajax, set_spinner, text_compare, transform_to_spinner;
  ...
  print_error = function(text) {
    return display_error("error_login", error_template, text);
  };
  ...
  $(".log_in").click(function() {
    return pajax("/api/login", {
      ...
      return print_error("Invalid username/email password combination");
    });
  });
