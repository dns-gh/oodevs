...
(function() {
  ...
  SessionItem = (function(_super) {
    ...
    function SessionItem() {
      this.sync = __bind(this.sync, this);      _ref = SessionItem.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  SessionList = (function(_super) {
    ...
    function SessionList() {
      ...
      this.sync = __bind(this.sync, this);      _ref1 = SessionList.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
    ...
    SessionList.prototype.comparator = function(lhs, rhs) {
      ...
      if (left.id !== right.id) {
        _ref2 = [left, right], lhs = _ref2[0], rhs = _ref2[1];
      }
  ...
  SessionItemView = (function(_super) {
    ...
    function SessionItemView() {
      ...
      this.is_filtered = __bind(this.is_filtered, this);      _ref2 = SessionItemView.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
    ...
    SessionItemView.prototype.is_filtered = function(item) {
      var filter, status, _i, _len, _ref3;
    ...
    SessionItemView.prototype.is_skip_render = function(item) {
      ...
      _ref3 = item.attributes.replay.list;
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        id = _ref3[_i];
    ...
    SessionItemView.prototype.render = function() {
      var current, data, duration, start, _ref3,
        _this = this;
      ...
      if ((_ref3 = data.start_time) != null ? _ref3.length : void 0) {
    ...
    SessionItemView.prototype.edit = function(evt) {
      ...
      _ref3 = pop_settings($("#settings"), data), ui = _ref3[0], mod = _ref3[1];
      return mod.find(".apply").click(function() {
        ...
        if ((_ref4 = data.checkpoints) != null) {
          _ref4.frequency *= 60;
        }
  ...
  SessionListView = (function(_super) {
    ...
    function SessionListView() {
      ...
      this.reset = __bind(this.reset, this);      _ref3 = SessionListView.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
    ...
    SessionListView.prototype.add = function(item) {
      ...
      item.view = view;
      previous = (_ref4 = this.model.at(this.model.indexOf(item) - 1)) != null ? _ref4.view : void 0;
      if (previous) {
    ...
    SessionListView.prototype.set_filter = function() {
      var it, list, _i, _len, _ref4;

      list = get_filters();
      _ref4 = this.model.models;
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        it = _ref4[_i];
    ...
    SessionListView.prototype.clone = function(data) {
      var cur, it, max, regexp, tab, _i, _len, _ref4;
  ...
  ExerciseListItem = (function(_super) {
    ...
    function ExerciseListItem() {
      this.sync = __bind(this.sync, this);      _ref4 = ExerciseListItem.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  ExerciseListItemView = (function(_super) {
    ...
    function ExerciseListItemView() {
      this.delta = __bind(this.delta, this);
      this.render = __bind(this.render, this);      _ref5 = ExerciseListItemView.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
    ...
    ExerciseListItemView.prototype.render = function() {
      var it, _i, _len, _ref6;

      $(this.el).children().remove().end();
      _ref6 = this.model.get("exercises");
  ...
  $("#session_create").click(function() {
    var exercise, name, _ref6;

    name = $("#session_name");
    if (!validate_input_session(name, (_ref6 = name.val()) != null ? _ref6.length : void 0, "Missing name")) {
      return;
    }
    exercise = $("#exercises");
