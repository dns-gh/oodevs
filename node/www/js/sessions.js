...
(function() {
  var ExerciseListItem, ExerciseListItemView, SessionItem, SessionItemView, SessionList, SessionListView, ajax, attach_checkbox_and_input, bytes_to_size, check_value, contains, convert_to_boolean, diff_models, display_error, duration_reduce, exercise_view, force_input_regexp, get_double, get_filters, get_ms_duration_from, get_number, get_replay_root, get_search, get_url, has_element, init_plugins, is_clipped, is_disabled, item, link_checkbox_to_input, load_url, ms_to_duration, on_input_event, pad, pajax, parse_parameters, parse_scalar, pop_settings, print_error, raw_ajax, select_attributes, session_error_template, session_plugins, session_settings_template, session_template, session_view, set_checkbox, set_spinner, set_ui_plugins, status_order, text_compare, toggle_input_error, toggle_spinner, update_model, validate_double, validate_input_session, validate_number, validate_plugins, validate_rng, validate_settings, _i, _len, _ref,
  ...
  validate_plugins = function(data) {
    var id, it, next, tab, _i, _len, _ref;
    tab = $("#tab_plugins");
