...
(function() {
  ...
  PackageView = (function(_super) {
    ...
    function PackageView() {
      ...
      this.toggle_load = __bind(this.toggle_load, this);      _ref1 = PackageView.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
    ...
    PackageView.prototype.render = function() {
      var it, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref2, _ref3, _ref4, _ref5,
        _this = this;
      ...
      _ref2 = $(this.el).find(".package_header .remove_all a");
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        $(it).click(function() {
          return modal_confirm({
            ...
            var btn, items, _j, _len1, _ref3;

            items = [];
            _ref3 = $(_this.el).find(".action .delete");
      ...
      _ref3 = $(this.el).find(".action .more");
      for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
        it = _ref3[_j];
        $(it).click(function() {
      ...
      _ref5 = $(this.el).find(".action .delete");
