...
EXTERN int asn1PE_MsgUnitAttributes (ASN1CTXT* ctxt_p, ASN1T_MsgUnitAttributes* pvalue)
{
   ...
   if (pvalue->m.renduPresent) {
      ...
      stat = asn1PE_Camp (ctxt_p, pvalue->rendu);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }
...
EXTERN int asn1PD_MsgUnitAttributes (ASN1CTXT* ctxt_p, ASN1T_MsgUnitAttributes* pvalue)
{
   ...
   if (pvalue->m.renduPresent) {
      ...
      stat = asn1PD_Camp (ctxt_p, &pvalue->rendu);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
ASN1C_MsgPionDestruction::ASN1C_MsgPionDestruction (
...
EXTERN int asn1PE_MsgPionDestruction (ASN1CTXT* ctxt_p, ASN1T_MsgPionDestruction value)
{
   ...
   rtdiag ("asn1PE_MsgPionDestruction: start\n");

   stat = asn1PE_OID (ctxt_p, value);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   rtdiag ("asn1PE_MsgPionDestruction: end\n");
   return (stat);
}

int ASN1C_MsgPionDestruction::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgPionDestruction (mpContext->GetPtr(), msgData);
   return stat;
}
...
EXTERN int asn1PD_MsgPionDestruction (ASN1CTXT* ctxt_p, ASN1T_MsgPionDestruction* pvalue)
{
   ...
   rtdiag ("asn1PD_MsgPionDestruction: start\n");

   stat = asn1PD_OID (ctxt_p, pvalue);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   rtdiag ("asn1PD_MsgPionDestruction: end\n");

   return (stat);
}

int ASN1C_MsgPionDestruction::Decode ()
{
   return asn1PD_MsgPionDestruction (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PD_MagicActionSeRendre (ASN1CTXT* ctxt_p, ASN1T_MagicActionSeRendre* pvalue)
{
   ...
   stat = asn1PD_Camp (ctxt_p, pvalue);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
ASN1C_MagicActionAnnulerReddition::ASN1C_MagicActionAnnulerReddition (
   ASN1MessageBuffer& msgBuf) :
   ASN1CType(msgBuf)
{}
...
EXTERN int asn1PE_MagicActionAnnulerReddition (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_MagicActionAnnulerReddition: start\n");

   /* NULL */

   rtdiag ("asn1PE_MagicActionAnnulerReddition: end\n");
   return (stat);
}

int ASN1C_MagicActionAnnulerReddition::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MagicActionAnnulerReddition (mpContext->GetPtr());
   return stat;
}
...
EXTERN int asn1PD_MagicActionAnnulerReddition (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_MagicActionAnnulerReddition: start\n");

   /* NULL */

   rtdiag ("asn1PD_MagicActionAnnulerReddition: end\n");

   return (stat);
}

int ASN1C_MagicActionAnnulerReddition::Decode ()
{
   return asn1PD_MagicActionAnnulerReddition (mpContext->GetPtr());
}
...
EXTERN int asn1PE_MsgUnitMagicAction_action (ASN1CTXT* ctxt_p, ASN1T_MsgUnitMagicAction_action* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      case 10:
         ...
         stat = asn1PE_MagicActionAnnulerReddition (ctxt_p);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MsgUnitMagicAction_action (ASN1CTXT* ctxt_p, ASN1T_MsgUnitMagicAction_action* pvalue)
{
   ...
   switch (ui) {
      ...
      case 9:
         ...
         stat = asn1PD_MagicActionAnnulerReddition (ctxt_p);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
ASN1C_MsgPionChangeSuperiorAck::ASN1C_MsgPionChangeSuperiorAck (
...
EXTERN int asn1PE_MsgPionChangeSuperiorAck (ASN1CTXT* ctxt_p, ASN1T_MsgPionChangeSuperiorAck* pvalue)
{
   ...
   rtdiag ("asn1PE_MsgPionChangeSuperiorAck: start\n");
   ...
   rtdiag ("asn1PE_MsgPionChangeSuperiorAck: end\n");
   return (stat);
}

int ASN1C_MsgPionChangeSuperiorAck::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgPionChangeSuperiorAck (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_MsgPionChangeSuperiorAck (ASN1CTXT* ctxt_p, ASN1T_MsgPionChangeSuperiorAck* pvalue)
{
   ...
   rtdiag ("asn1PD_MsgPionChangeSuperiorAck: start\n");
   ...
   rtdiag ("asn1PD_MsgPionChangeSuperiorAck: end\n");

   return (stat);
}

int ASN1C_MsgPionChangeSuperiorAck::Decode ()
{
   return asn1PD_MsgPionChangeSuperiorAck (mpContext->GetPtr(), &msgData);
}
...
ASN1C_MsgPionChangeSuperior::ASN1C_MsgPionChangeSuperior (
...
EXTERN int asn1PE_MsgPionChangeSuperior (ASN1CTXT* ctxt_p, ASN1T_MsgPionChangeSuperior* pvalue)
{
   ...
   rtdiag ("asn1PE_MsgPionChangeSuperior: start\n");
   ...
   rtdiag ("asn1PE_MsgPionChangeSuperior: end\n");
   return (stat);
}

int ASN1C_MsgPionChangeSuperior::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgPionChangeSuperior (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_MsgPionChangeSuperior (ASN1CTXT* ctxt_p, ASN1T_MsgPionChangeSuperior* pvalue)
{
   ...
   rtdiag ("asn1PD_MsgPionChangeSuperior: start\n");
   ...
   rtdiag ("asn1PD_MsgPionChangeSuperior: end\n");

   return (stat);
}

int ASN1C_MsgPionChangeSuperior::Decode ()
{
   return asn1PD_MsgPionChangeSuperior (mpContext->GetPtr(), &msgData);
}
