...
ASN1C_MsgCtrlSkipToTick::ASN1C_MsgCtrlSkipToTick (
   ASN1MessageBuffer& msgBuf, ASN1T_MsgCtrlSkipToTick& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_MsgCtrlSkipToTick (ASN1CTXT* ctxt_p, ASN1T_MsgCtrlSkipToTick value)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_MsgCtrlSkipToTick: start\n");

   stat = pe_UnconsInteger (ctxt_p, value);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   rtdiag ("asn1PE_MsgCtrlSkipToTick: end\n");
   return (stat);
}

int ASN1C_MsgCtrlSkipToTick::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgCtrlSkipToTick (mpContext->GetPtr(), msgData);
   return stat;
}

EXTERN int asn1PD_MsgCtrlSkipToTick (ASN1CTXT* ctxt_p, ASN1T_MsgCtrlSkipToTick* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_MsgCtrlSkipToTick: start\n");

   stat = pd_UnconsInteger (ctxt_p, pvalue);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   rtdiag ("asn1PD_MsgCtrlSkipToTick: end\n");

   return (stat);
}

int ASN1C_MsgCtrlSkipToTick::Decode ()
{
   return asn1PD_MsgCtrlSkipToTick (mpContext->GetPtr(), &msgData);
}

/**************************************************************/
/*                                                            */
/*  MsgCtrlSkipToTickAck                                      */
/*                                                            */
/**************************************************************/

ASN1C_MsgCtrlSkipToTickAck::ASN1C_MsgCtrlSkipToTickAck (
   ASN1MessageBuffer& msgBuf, ASN1T_MsgCtrlSkipToTickAck& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_MsgCtrlSkipToTickAck (ASN1CTXT* ctxt_p, ASN1T_MsgCtrlSkipToTickAck* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_MsgCtrlSkipToTickAck: start\n");
   ...
   rtdiag ("asn1PE_MsgCtrlSkipToTickAck: end\n");
   return (stat);
}

int ASN1C_MsgCtrlSkipToTickAck::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgCtrlSkipToTickAck (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_MsgCtrlSkipToTickAck (ASN1CTXT* ctxt_p, ASN1T_MsgCtrlSkipToTickAck* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_MsgCtrlSkipToTickAck: start\n");
   ...
   rtdiag ("asn1PD_MsgCtrlSkipToTickAck: end\n");

   return (stat);
}

int ASN1C_MsgCtrlSkipToTickAck::Decode ()
{
   return asn1PD_MsgCtrlSkipToTickAck (mpContext->GetPtr(), &msgData);
}
...
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgCtrlClientAnnouncement (mpContext->GetPtr());
   return stat;
}
...
{
   return asn1PD_MsgCtrlClientAnnouncement (mpContext->GetPtr());
}
...
ASN1C_MsgCtrlReplayInfo::ASN1C_MsgCtrlReplayInfo (
   ASN1MessageBuffer& msgBuf, ASN1T_MsgCtrlReplayInfo& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_MsgCtrlReplayInfo (ASN1CTXT* ctxt_p, ASN1T_MsgCtrlReplayInfo* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_MsgCtrlReplayInfo: start\n");
   ...
   rtdiag ("asn1PE_MsgCtrlReplayInfo: end\n");
   return (stat);
}

int ASN1C_MsgCtrlReplayInfo::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgCtrlReplayInfo (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_MsgCtrlReplayInfo (ASN1CTXT* ctxt_p, ASN1T_MsgCtrlReplayInfo* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_MsgCtrlReplayInfo: start\n");
   ...
   rtdiag ("asn1PD_MsgCtrlReplayInfo: end\n");

   return (stat);
}

int ASN1C_MsgCtrlReplayInfo::Decode ()
{
   return asn1PD_MsgCtrlReplayInfo (mpContext->GetPtr(), &msgData);
}
