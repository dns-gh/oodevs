...
typedef ASN1INT  ASN1T_MsgCtrlSkipToTick;

class EXTERN ASN1C_MsgCtrlSkipToTick : public ASN1CType {
public:
   ASN1T_MsgCtrlSkipToTick& msgData;
   ASN1C_MsgCtrlSkipToTick (
...
EXTERN void asn1Print_MsgCtrlSkipToTick (ASN1ConstCharPtr name, ASN1T_MsgCtrlSkipToTick* pvalue);
...
typedef struct EXTERN ASN1T_MsgCtrlSkipToTickAck {
   ASN1INT   tick;
   ASN1T_EnumCtrlErrorCode  error_code;
} ASN1T_MsgCtrlSkipToTickAck;

class EXTERN ASN1C_MsgCtrlSkipToTickAck : public ASN1CType {
public:
   ASN1T_MsgCtrlSkipToTickAck& msgData;
   ASN1C_MsgCtrlSkipToTickAck (
...
EXTERN void asn1Print_MsgCtrlSkipToTickAck (ASN1ConstCharPtr name, ASN1T_MsgCtrlSkipToTickAck* pvalue);
...
typedef struct EXTERN ASN1T_MsgCtrlReplayInfo {
   ASN1INT   current_tick;
   ASN1INT   tick_duration;
   ASN1INT   time_factor;
   ASN1T_EnumEtatSim  etat;
   ASN1INT   tick_count;
} ASN1T_MsgCtrlReplayInfo;

class EXTERN ASN1C_MsgCtrlReplayInfo : public ASN1CType {
public:
   ASN1T_MsgCtrlReplayInfo& msgData;
   ASN1C_MsgCtrlReplayInfo (
...
EXTERN void asn1Print_MsgCtrlReplayInfo (ASN1ConstCharPtr name, ASN1T_MsgCtrlReplayInfo* pvalue);
