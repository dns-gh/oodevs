/* This file was generated by ASN1C V5.31 on 24-Apr-2007 */
...
void asn1Print_MsgPionDestruction (ASN1ConstCharPtr name, ASN1T_MsgPionDestruction* pvalue)
{
   asn1Print_OID (name, pvalue);
}

void ASN1C_MsgPionDestruction::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgPionDestruction (name, &msgData);
}
