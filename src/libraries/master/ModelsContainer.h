...
public:
    //! @name Types
    //@{
    typedef typename std::map< K, T* >          T_ModelMap;
...
public:
    ...
    //@{
    template< typename P >
    T&    Create ( K key, P& param );
    template< typename P1, typename P2 >
    T&    Create ( K key, P1& param1, P2& param2 );
    template< typename P1, typename P2, typename P3 >
    T&    Create ( K key, P1& param1, P2& param2, P3& param3 );
    void  Destroy( K key );
    T&    Get    ( K key ) const;
    T*    Find   ( K key ) const;    
    void  Clear  ();
...
private:
    ...
    //! @name Tools
    //@{
    void ThrowError( K key, const std::string& strMessage ) const;
    //@}
