...
{
    // Unit Magic Actions
    RegisterActionType( *new MagicActionType( "teleport", sword::move_to ) );
    RegisterActionType( *new MagicActionType( "surrender", sword::surrender_to ) );
    RegisterActionType( *new MagicActionType( "cancel_surrender", sword::cancel_surrender ) );
    RegisterActionType( *new MagicActionType( "recover_transporters", sword::recover_transporters) );
    RegisterActionType( *new MagicActionType( "destroy_component", sword::destroy_component ) );
    RegisterActionType( *new MagicActionType( "recover_all", sword::recover_all ) );
    ...
    RegisterActionType( *new MagicActionType( "automat_creation", sword::automat_creation ) );
    RegisterActionType( *new MagicActionType( "crowd_creation", sword::crowd_creation ) );
    RegisterActionType( *new MagicActionType( "formation_creation", sword::formation_creation ) );
    RegisterActionType( *new MagicActionType( "unit_creation", sword::unit_creation ) );
    RegisterActionType( *new MagicActionType( "fire_order", sword::create_fire_order ) );
    RegisterActionType( *new MagicActionType( "change_knowledge_group", sword::change_knowledge_group ) );
    RegisterActionType( *new MagicActionType( "unit_change_superior", sword::unit_change_superior ) );
    RegisterActionType( *new MagicActionType( "change_automat_superior", sword::change_automat_superior ) );
    RegisterActionType( *new MagicActionType( "change_formation_superior", sword::change_formation_superior ) );
    RegisterActionType( *new MagicActionType( "change_logistic_links", sword::change_logistic_links ) );
    RegisterActionType( *new MagicActionType( "automat_log_supply_push_flow", sword::log_supply_push_flow ) );
    RegisterActionType( *new MagicActionType( "automat_log_supply_pull_flow", sword::log_supply_pull_flow ) );
    RegisterActionType( *new MagicActionType( "automat_log_supply_change_quotas", sword::log_supply_change_quotas ) );
    RegisterActionType( *new MagicActionType( "formation_log_supply_push_flow", sword::log_supply_push_flow ) );
    RegisterActionType( *new MagicActionType( "formation_log_supply_pull_flow", sword::log_supply_pull_flow ) );
    RegisterActionType( *new MagicActionType( "formation_log_supply_change_quotas", sword::log_supply_change_quotas ) );
    RegisterActionType( *new MagicActionType( "crowd_total_destruction", sword::crowd_total_destruction ) );
    RegisterActionType( *new MagicActionType( "crowd_change_attitude", sword::crowd_change_attitude ) );
    RegisterActionType( *new MagicActionType( "crowd_change_health_state", sword::crowd_change_health_state ) );
    RegisterActionType( *new MagicActionType( "crowd_change_affinities", sword::crowd_change_affinities ) );
    RegisterActionType( *new MagicActionType( "crowd_change_armed_individuals", sword::crowd_change_armed_individuals ) );
    RegisterActionType( *new MagicActionType( "inhabitant_change_health_state", sword::inhabitant_change_health_state ) );
    RegisterActionType( *new MagicActionType( "inhabitant_change_affinities", sword::inhabitant_change_affinities ) );
    RegisterActionType( *new MagicActionType( "inhabitant_change_alerted_state", sword::inhabitant_change_alerted_state ) );
    RegisterActionType( *new MagicActionType( "inhabitant_change_confined_state", sword::inhabitant_change_confined_state ) );
    RegisterActionType( *new MagicActionType( "unit_change_affinities", sword::unit_change_affinities ) );
    RegisterActionType( *new MagicActionType( "change_extension", sword::change_extension ) );
    RegisterActionType( *new MagicActionType( "change_critical_intelligence", sword::change_critical_intelligence ) );
    RegisterActionType( *new MagicActionType( "transfer_equipment", sword::transfer_equipment ) );
    RegisterActionType( *new MagicActionType( "reload_brain", sword::reload_brain ) );
    RegisterActionType( *new MagicActionType( "change_equipment_state", sword::change_equipment_state ) );
    ...
    RegisterActionType( *new MagicActionType( "knowledge_group_update_side", sword::update_party ) );
    RegisterActionType( *new MagicActionType( "knowledge_group_update_side_parent", sword::update_party_parent ) );
    RegisterActionType( *new MagicActionType( "knowledge_group_update_type", sword::update_type ) );
    RegisterActionType( *new MagicActionType( "knowledge_group_add_knowledge", sword::add_knowledge ) );

    // Object Magic Actions
    RegisterActionType( *new MagicActionType( "create_object", sword::create ) );
    RegisterActionType( *new MagicActionType( "update_object", sword::update ) );
    RegisterActionType( *new MagicActionType( "destroy_object", sword::destroy ) );

    // Other Magic Actions
    RegisterActionType( *new MagicActionType( "global_weather", sword::global_weather_type ) );
    RegisterActionType( *new MagicActionType( "local_weather", sword::local_weather ) );
    RegisterActionType( *new MagicActionType( "local_weather_destruction", sword::local_weather_destruction ) );
    RegisterActionType( *new MagicActionType( "change_diplomacy", sword::change_diplomacy ) );
    RegisterActionType( *new MagicActionType( "create_knowledge_group", sword::create_knowledge_group ) );
    RegisterActionType( *new MagicActionType( "change_resource_links", sword::change_resource_network_properties ) );
    RegisterActionType( *new MagicActionType( "fire_order_on_location", sword::create_fire_order_on_location ) );
