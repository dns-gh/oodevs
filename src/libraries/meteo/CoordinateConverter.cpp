...
// -----------------------------------------------------------------------------
// Name: CoordinateConverter::ReadPoint
// Created: HBD 2010-03-12
// -----------------------------------------------------------------------------
void CoordinateConverter::ReadPoint( const Common::MsgCoordLatLong& msg ) const
{
    ConvertFromGeo( msg.longitude(), msg.latitude() );
}
