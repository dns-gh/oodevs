...
namespace legacy
{
    ...
    void load_construct_data( Archive& archive, sword::legacy::RolePion_Decision* role, const unsigned int /*version*/ )
    {
        ...
        archive >> pion
                >> gcPause
                >> gcMult;
        ::new( role )sword::legacy::RolePion_Decision( *pion, gcPause, gcMult );
    }
}
}
...
// -----------------------------------------------------------------------------
RolePion_Decision::RolePion_Decision( MIL_AgentPion& pion, unsigned int gcPause, unsigned int gcMult )
...
void RolePion_Decision::RegisterPerception()
{
    ...
    RegisterFunction( "DEC_Perception_ActiverDesastre", boost::bind( &DEC_PerceptionFunctions::EnableDisasterPerception, boost::ref( GetPion() ) ) );
    RegisterFunction( "DEC_Perception_DesactiverDesastre", boost::bind( &DEC_PerceptionFunctions::DisableDisasterPerception, boost::ref( GetPion() ) ) );
