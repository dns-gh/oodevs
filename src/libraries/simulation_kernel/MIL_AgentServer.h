...
public:
    ...
    virtual void SetTimeFactor( int32_t timeFactor, unsigned int nCtx, unsigned int clientId );
    ...
    TER_Pathfinder& GetPathFindManager() const;
...
private:
    ...
    boost::shared_ptr< TER_Pathfinder > pPathFindManager_;
