...
#ifndef __MIL_RC_PopulationDetectee_h_
#define __MIL_RC_PopulationDetectee_h_
...
// Created: JVT 2004-08-03
// =============================================================================
class MIL_RC_PopulationDetectee : public MIL_RC
{
    MT_COPYNOTALLOWED( MIL_RC_PopulationDetectee )

public:   
    MIL_RC_PopulationDetectee( E_RC nRC, int nAsnID );
    virtual ~MIL_RC_PopulationDetectee();
...
#endif // __MIL_RC_PopulationDetectee_h_
