...
#ifndef __MIL_RC_RiposteContreAgressionParPopulation_h_
#define __MIL_RC_RiposteContreAgressionParPopulation_h_
...
// Created: JVT 2004-08-03
// =============================================================================
class MIL_RC_RiposteContreAgressionParPopulation : public MIL_RC
{
    MT_COPYNOTALLOWED( MIL_RC_RiposteContreAgressionParPopulation )

public:   
    MIL_RC_RiposteContreAgressionParPopulation( E_RC nRC, int nAsnID );
    virtual ~MIL_RC_RiposteContreAgressionParPopulation();
...
#endif // __MIL_RC_RiposteContreAgressionParPopulation_h_
