...
#ifndef __MIL_RC_PriseAPartieParPopulation_h_
#define __MIL_RC_PriseAPartieParPopulation_h_
...
// Created: JVT 2004-08-03
// =============================================================================
class MIL_RC_PriseAPartieParPopulation : public MIL_RC
{
    MT_COPYNOTALLOWED( MIL_RC_PriseAPartieParPopulation )

public:   
    MIL_RC_PriseAPartieParPopulation( E_RC nRC, int nAsnID );
    virtual ~MIL_RC_PriseAPartieParPopulation();
...
#endif // __MIL_RC_PriseAPartieParPopulation_h_
