...
#ifndef __MIL_RC_AgressionParPopulation_h_
#define __MIL_RC_AgressionParPopulation_h_
...
// Created: JVT 2004-08-03
// =============================================================================
class MIL_RC_AgressionParPopulation : public MIL_RC
{
    MT_COPYNOTALLOWED( MIL_RC_AgressionParPopulation )

public:   
    MIL_RC_AgressionParPopulation( E_RC nRC, int nAsnID );
    virtual ~MIL_RC_AgressionParPopulation();
...
#endif // __MIL_RC_AgressionParPopulation_h_
