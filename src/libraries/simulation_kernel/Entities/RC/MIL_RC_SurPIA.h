...
// $Archive: /MVW_v10/Build/SDK/MIL/Src/Entities/Rc/MIL_RC_SurPIA.h $
// $Author: Nld $
// $Modtime: 9/03/05 15:20 $
// $Revision: 3 $
// $Workfile: MIL_RC_SurPIA.h $
//
// *****************************************************************************

#ifndef __MIL_RC_SurPIA_h_
#define __MIL_RC_SurPIA_h_
...
// Created: JVT 2004-08-03
// =============================================================================
class MIL_RC_SurPIA : public MIL_RC
{
    MT_COPYNOTALLOWED( MIL_RC_SurPIA )

public:   
    MIL_RC_SurPIA( E_RC nRC, int nAsnID );
    virtual ~MIL_RC_SurPIA();
