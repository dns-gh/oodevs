...
// -----------------------------------------------------------------------------
inline
MIL_RealObject_ABC& MIL_ZoneMobiliteAmelioree::Create( const MIL_RealObjectType& type, uint nID, MIL_Army& army )
{
    return *new MIL_ZoneMobiliteAmelioree( type, nID, army );
}
