...
// -----------------------------------------------------------------------------
inline
MIL_RealObject_ABC& MIL_ZoneBrouillageBromure::Create( const MIL_RealObjectType& type, uint nID, MIL_Army& army )
{
    return *new MIL_ZoneBrouillageBromure( type, nID, army );
}
