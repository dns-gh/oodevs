...
// -----------------------------------------------------------------------------
inline
MIL_RealObject_ABC& MIL_SiteDecontamination::Create( const MIL_RealObjectType& type, uint nID, MIL_Army& army )
{
    return *new MIL_SiteDecontamination( type, nID, army );
}
