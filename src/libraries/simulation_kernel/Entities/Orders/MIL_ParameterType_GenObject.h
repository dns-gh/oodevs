...
#ifndef __MIL_ParameterType_GenObject_h_
#define __MIL_ParameterType_GenObject_h_
...
// =============================================================================
/** @class  MIL_ParameterType_GenObject
    @brief  MIL_ParameterType_GenObject
*/
// Created: NLD 2006-11-14
// =============================================================================
class MIL_ParameterType_GenObject : public MIL_ParameterType_ABC
{
public:
    //! @name Constructors/Destructor
    //@{
             MIL_ParameterType_GenObject();
    virtual ~MIL_ParameterType_GenObject();
    //@}
...
#endif // __MIL_ParameterType_GenObject_h_
