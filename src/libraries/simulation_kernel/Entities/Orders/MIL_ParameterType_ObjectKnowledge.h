...
// =============================================================================
/** @class  MIL_ParameterType_ObjectKnowledge
    @brief  MIL_ParameterType_ObjectKnowledge
*/
// Created: NLD 2006-11-14
// =============================================================================
class MIL_ParameterType_ObjectKnowledge : public MIL_ParameterType_ABC
{
public:
    //! @name Constructors/Destructor
    //@{
             MIL_ParameterType_ObjectKnowledge();
    virtual ~MIL_ParameterType_ObjectKnowledge();
    //@}
...
#endif // __MIL_ParameterType_ObjectKnowledge_h_
