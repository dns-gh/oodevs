...
#ifndef __MIL_ParameterType_Objective_h_
#define __MIL_ParameterType_Objective_h_
...
// =============================================================================
/** @class  MIL_ParameterType_Objective
    @brief  MIL_ParameterType_Objective
*/
// Created: NLD 2006-11-14
// =============================================================================
class MIL_ParameterType_Objective : public MIL_ParameterType_ABC
{
public:
    //! @name Constructors/Destructor
    //@{
             MIL_ParameterType_Objective();
    virtual ~MIL_ParameterType_Objective();
    //@}
...
#endif // __MIL_ParameterType_Objective_h_
