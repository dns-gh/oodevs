...
public:
    ...
    enum E_DecisionalReport
    {
        ...
        eRC_ActiveProtectionCounter = 327,
        eRC_ActiveProtectionHardKill = 328,
        eRC_Poisoned = 329,
        eRC_Contaminated = 330,
...
private:
    ...
    //@{
    template< typename T >
    static void PostEvent( const T& receiver, E_DecisionalReport nReport, std::vector< boost::shared_ptr< MIL_MissionParameter_ABC > >& parameters );
