...
public:
    ...
    template< typename T > static void PostEvent( const T& receiver, E_EngineReport nReport, const std::string& nParam );
    ...
    template< typename T > static void PostEvent( const T& receiver, E_EngineReport nReport, boost::shared_ptr< DEC_Knowledge_Population >& populationKnowledge );
