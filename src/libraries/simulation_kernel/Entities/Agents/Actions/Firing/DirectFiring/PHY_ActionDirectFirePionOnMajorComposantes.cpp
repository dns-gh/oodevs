...
// -----------------------------------------------------------------------------
PHY_ActionDirectFirePionOnMajorComposantes::PHY_ActionDirectFirePionOnMajorComposantes( MIL_AgentPion& pion, boost::shared_ptr< DEC_Knowledge_Agent > pEnemy, MT_Float percentage, int firingMode, int ammoDotationClass )
