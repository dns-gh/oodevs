...
void PHY_RoleAction_Objects_CapabilityComputer::operator() ( PHY_ComposantePion& composante )
{
    ...
    switch( nOperation_ )
    {
        ...
        case eDestroy  : bHasCapability_ = composante.CanDestroy( objectType_, bWithLoaded_ ); break;
        case eMine     : bHasCapability_ = composante.CanMine( objectType_, bWithLoaded_ ); break;
        case eDemine   : bHasCapability_ = composante.CanDemine( objectType_, bWithLoaded_ ); break;
        case eBypass   : bHasCapability_ = composante.CanBypass( objectType_, false, bWithLoaded_ ); break;
