...
void DEC_RolePion_Decision::RegisterUserFunctions( sword::Brain& brain )
{
    ...
    RegisterFunction( "DEC_StartTirIndirectSurPosition",
        boost::function< unsigned int ( const PHY_DotationCategory*, float, MT_Vector2D* ) >( boost::bind( &DEC_ActionFunctions::StartAction  < PHY_ActionIndirectFire_Position, const PHY_DotationCategory*, float, MT_Vector2D*, DEC_Decision_ABC* >, boost::ref( GetPion() ), _1, _2, _3, nullptr ) ) );
    ...
    RegisterFunction( "DEC_Agent_GetFuelDotationCapacity", boost::function< double ( const DEC_Decision_ABC* ) >( boost::bind( &DEC_AgentFunctions::GetFuelDotationCapacity, boost::ref( GetPion() ), _1 ) ) );
