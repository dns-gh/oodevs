...
void DEC_RolePion_Decision::RegisterUserFunctions( directia::brain::Brain& brain )
{
    ...
    brain[ "DEC_StartCreateObjectInstantaneously" ] =
    ...
    brain[ "DEC_CrowdKnowledge_CanLoadCrowdConcentration" ] = &DEC_KnowledgePopulationFunctions::CanLoadCrowdConcentration;
    ...
    brain[ "DEC_ConnaissanceUrbanBlock_NiveauDeReconnaissanceCourant" ] = boost::function< float( MIL_UrbanObject_ABC* )>( boost::bind( &DEC_UrbanObjectFunctions::GetCurrentRecceProgress, boost::ref( GetPion() ), _1 ) );
