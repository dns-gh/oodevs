...
// Missions
    ...
    brain.RegisterFunction( "DEC_DonnerMissionPionVersPion",
    ...
    brain.RegisterFunction( "DEC_IsMissionPionAvailable", &DEC_OrdersFunctions::IsMissionAvailable );
    ...
    brain.RegisterFunction( "DEC_Detection_Distance",
    ...
    brain.RegisterFunction( "DEC_Suicide", boost::bind( &DEC_AgentFunctions::Suicide, boost::ref( GetPion() ) ) );
