...
// Actions
    ...
    brain.RegisterFunction( "DEC_StartCreerObjet",
    ...
    brain.RegisterFunction( "DEC_Geometry_SplitLocalisation",
        boost::function<  std::vector< boost::shared_ptr< TER_Localisation > >( TER_Localisation*, unsigned int ) >( boost::bind( &DEC_GeometryFunctions::SplitLocalisationInParts< MIL_AgentPion >, boost::ref( GetPion() ), _1, _2 ) ) );
