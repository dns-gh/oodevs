...
void DEC_RolePion_Decision::RegisterUserFunctions( directia::brain::Brain& brain )
{
    ...
    brain[ "DEC_Agent_PeutConstruireObjetAvecLocalisation" ] =
    ...
    brain[ "DEC_Agent_PeutConstruireObjetSansRenfortsAvecLocalisation" ] =
    ...
    brain[ "DEC_Agent_PeutConstruireObjetEmbarqueAvecLocalisation" ] =
    ...
    brain[ "DEC_Agent_GetFuelDotationNumber" ] =  boost::function< double ( const DEC_Decision_ABC* ) >( boost::bind( &DEC_AgentFunctions::GetFuelDotationNumber, boost::ref( GetPion() ), _1 ) );
    ...
    brain[ "DEC_Agent_PasserEnSilenceRadioPartiel" ] = boost::bind( &DEC_AgentFunctions::ActivatePartialBlackout, boost::ref( GetPion() ), true );
    ...
    brain[ "DEC_Agent_PasserEnEmissionRestreinte" ] = boost::bind( &DEC_AgentFunctions::ActivatePartialBlackout, boost::ref( GetPion() ), false );
    brain[ "DEC_Agent_ArreterEmissionRestreinte" ] = boost::bind( &DEC_AgentFunctions::DeactivateBlackout, boost::ref( GetPion() ) );
    ...
    brain[ "DEC_EnableSharedPerceptionWithKnowledge" ] = &DEC_AgentFunctions::EnableSharedPerceptionWithKnowledge;
    brain[ "DEC_DisabledSharedPerceptionWithKnowledge" ] = &DEC_AgentFunctions::DisabledSharedPerceptionWithKnowledge;
    ...
    brain[ "DEC_Knowledges_AllObjectsInCircle" ] =
    ...
    brain[ "DEC_Agent_TransportNombreAllerRetour" ] =
