...
public:
    ...
    virtual void NotifyPerception( MIL_Object_ABC& object, const MT_Vector2D& position );
    //@}
    ...
    virtual bool IsReconnoitering( const MIL_UrbanObject_ABC* pUrbanBlock ) const;
    //@}
