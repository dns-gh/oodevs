...
// $Archive: /MVW_v10/Build/SDK/MIL/src/Entities/Agents/Roles/Logistic/PHY_MedicalSortingConsign.h $
// $Author: Nld $
...
{
public:
             PHY_MedicalSortingConsign( MIL_Agent_ABC& medical, PHY_MedicalHumanState& humanState );
...
BOOST_CLASS_EXPORT_KEY( PHY_MedicalSortingConsign )
