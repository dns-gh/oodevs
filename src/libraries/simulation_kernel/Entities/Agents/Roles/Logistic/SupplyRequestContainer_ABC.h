...
public:
    ...
    virtual void SetPathToRecipient           ( SupplyRecipient_ABC& recipient, const sword::Pathfind& pathfind ) = 0;
    virtual void SetPathToTransportersProvider( const sword::Pathfind& pathfind ) = 0;
    virtual void SetPathToSupplier            ( const sword::Pathfind& pathfind ) = 0;
