...
void MIL_AgentTypePion::InitializeDiaFunctions()
{
    ...
    DEC_RegisterDIACallFunctor( GetFunctionTable(), &DEC_KnowledgeAgentFunctions::GetMajorOperationalState                  < MIL_AgentPion >, "DEC_ConnaissanceAgent_EstDetruitTactique"              );
