...
// -----------------------------------------------------------------------------
MIL_Automate& MIL_AutomateTypeLOG::InstanciateAutomate( unsigned int nID, MIL_Entity_ABC& parent, xml::xistream& xis, unsigned int gcPause, unsigned int gcMult ) const
{
...
// -----------------------------------------------------------------------------
MIL_Automate& MIL_AutomateTypeLOG::InstanciateAutomate( unsigned int nID, MIL_Entity_ABC& parent, unsigned int knowledgeGroup, const std::string& name, unsigned int gcPause, unsigned int gcMult, unsigned int context, const MIL_DictionaryExtensions& extensions ) const
{
...
void MIL_AutomateTypeLOG::RegisterFunctions( directia::brain::Brain& brain, MIL_Automate& automat ) const
{
    ...
    brain[ "DEC_Maintenance_Priorites" ] =
        boost::function< std::vector< const PHY_ComposanteTypePion* >() >( boost::bind( &DEC_LogisticFunctions::GetAutomateMaintenancePriorities, boost::ref( automat ) ) );
    ...
    brain[ "DEC_Maintenance_PrioritesTactiques" ] =
        boost::function< std::vector< const DEC_Decision_ABC* >() >( boost::bind( &DEC_LogisticFunctions::GetAutomateMaintenanceTacticalPriorities, boost::ref( automat ) ) );
    ...
    brain[ "DEC_Maintenance_RegimeTravail" ] =
        boost::function< int() >( boost::bind( &DEC_LogisticFunctions::GetAutomateMaintenanceWorkRate, boost::ref( automat ) ) );
    ...
    brain[ "DEC_Sante_Priorites" ] =
        boost::function< std::vector< const PHY_HumanWound* >() >( boost::bind( &DEC_LogisticFunctions::GetAutomateMedicalPriorities, boost::ref( automat ) ) );
    ...
    brain[ "DEC_Sante_PrioritesTactiques" ] =
        boost::function< std::vector< const DEC_Decision_ABC* >() >( boost::bind( &DEC_LogisticFunctions::GetAutomateMedicalTacticalPriorities, boost::ref( automat ) ) );
