...
// -----------------------------------------------------------------------------
void MIL_AgentTypePionLOGMaintenance::RegisterRoles( MIL_AgentPion& pion, DEC_DataBase& database, unsigned int gcPause, unsigned int gcMult ) const
{
    MIL_AgentTypePion::RegisterRoles( pion, database, gcPause, gcMult );
