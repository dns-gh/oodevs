...
public:
             MIL_AgentPionLOGSupply( const MIL_AgentTypePion& type, uint nID, MIL_InputArchive& archive );
             MIL_AgentPionLOGSupply( MIL_Automate& automate, MIL_InputArchive& archive );
