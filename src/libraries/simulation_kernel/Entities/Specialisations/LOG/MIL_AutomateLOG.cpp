...
void MIL_AutomateLOG::serialize( Archive& ar, const unsigned int )
{
    ...
    ar & boost::serialization::base_object< logistic::SupplySupplier_ABC >( *this );
    ar & pAssociatedAutomate_;
    ar & pAssociatedFormation_;
    ar & pLogisticHierarchy_;
    ar & supplyRequests_;
    ar & supplyConsigns_;
    ar & maintenanceManual_;
    ar & supplyManual_;
    ar & magicSupplyRequests_;
}
...
// -----------------------------------------------------------------------------
void MIL_AutomateLOG::ResetConsignsForConvoyPion( const MIL_Agent_ABC& pion )
{
...
// -----------------------------------------------------------------------------
void MIL_AutomateLOG::ResetConsignsForProvider( const MIL_Agent_ABC& pion )
{
...
// -----------------------------------------------------------------------------
MIL_Automate* MIL_AutomateLOG::GetStockAutomat( const PHY_DotationCategory& dotationCategory,
