...
// -----------------------------------------------------------------------------
MIL_Effect_DetectionRange::MIL_Effect_DetectionRange( T_IdVector& perceiversIds, int resourceId, T_IdVector& fireEffectsIds, double rDeploymentDuration )
    : nDeploymentTimeStep_( MIL_AgentServer::GetWorkspace().GetCurrentTimeStep() + static_cast< unsigned int >( rDeploymentDuration ) )
{
...
{
    if( nDeploymentTimeStep_ <= MIL_AgentServer::GetWorkspace().GetCurrentTimeStep() )
    {
