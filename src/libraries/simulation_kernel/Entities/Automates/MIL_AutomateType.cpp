...
void MIL_AutomateType::InitializeDiaFunctions()
{
    ...
    DEC_RegisterDIACallFunctor( GetFunctionTable(), &DEC_KnowledgeAgentFunctions ::GetMajorOperationalState              < MIL_Automate >, "DEC_ConnaissanceAgent_EstDetruitTactique"                   );
    ...
    DEC_RegisterDIACallFunctor( GetFunctionTable(), &DEC_GeometryFunctions::ComputePointBeforeLimaInFuseau                  < MIL_Automate >, "DEC_Geometrie_CalculerPositionParRapportALimaDansFuseau"             );
