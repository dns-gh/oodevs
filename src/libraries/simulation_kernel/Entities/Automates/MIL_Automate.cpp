...
// -----------------------------------------------------------------------------
MIL_Automate::MIL_Automate( const MIL_AutomateType& type, unsigned int nID, MIL_Entity_ABC& parent, xml::xistream& xis, unsigned int gcPause, unsigned int gcMult, bool logEnabled )
    : MIL_Entity_ABC         ( xis )
    , pType_                 ( &type )
    , nID_                   ( nID )
...
{
    Initialize( xis, gcPause, gcMult, logEnabled );
...
MIL_Automate::MIL_Automate( const MIL_AutomateType& type, unsigned int nID, MIL_Entity_ABC& parent, unsigned int knowledgeGroup, const std::string& name,
                            unsigned int gcPause, unsigned int gcMult, bool logEnabled, unsigned int context, const MIL_DictionaryExtensions& extensions )
    : MIL_Entity_ABC         ( name )
    , pType_                 ( &type )
    , nID_                   ( nID )
    , pParentFormation_      ( dynamic_cast< MIL_Formation* >( &parent ) )
    ...
    , pExtensions_           ( new MIL_DictionaryExtensions( extensions ) )
{
    ...
    RegisterRole( *new DEC_AutomateDecision( *this, gcPause, gcMult, logEnabled ) ) ;
...
// -----------------------------------------------------------------------------
void MIL_Automate::Initialize( xml::xistream& xis, unsigned int gcPause, unsigned int gcMult, bool logEnabled )
{
