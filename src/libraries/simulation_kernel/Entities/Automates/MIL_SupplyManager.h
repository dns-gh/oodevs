...
private:
    //! @name Types
    //@{
    typedef std::map< const PHY_DotationCategory*, T_Requesters > T_DotationNotifications;
    //@}

private:
    //! @name Member data
    //@{
    T_DotationNotifications currentDotationNotifications_;
    T_DotationNotifications previousDotationNotifications_;
