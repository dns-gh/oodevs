...
// $Archive: /MVW_v10/Build/SDK/MIL/Src/Network/NET_ASN_Types.h $
// $Author: Nld $
// $Modtime: 25/10/04 11:16 $
// $Revision: 2 $
// $Workfile: NET_ASN_Types.h $
//
//*****************************************************************************

#ifndef __NET_ASN_Types_h_
#define __NET_ASN_Types_h_
