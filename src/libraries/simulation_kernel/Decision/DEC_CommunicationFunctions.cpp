...
// -----------------------------------------------------------------------------
void DEC_CommunicationFunctions::Register( sword::Brain& brain )
{
    //
    ...
    brain.RegisterFunction( "F_Pion_GetNewEscorted", &F_Pion_GetNewEscorted );
    brain.RegisterFunction( "F_Pion_SetNewEscorted", &F_Pion_SetNewEscorted );
    brain.RegisterFunction( "F_Pion_GetNeedReinforcement", &F_Pion_GetNeedReinforcement );
    brain.RegisterFunction( "F_Pion_SetNeedReinforcement", &F_Pion_SetNeedReinforcement );
    brain.RegisterFunction( "F_Pion_GetEnemyAttackedBy", &F_Pion_GetEnemyAttackedBy );
