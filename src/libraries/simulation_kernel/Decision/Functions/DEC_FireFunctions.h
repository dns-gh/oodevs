...
public:
    //! @name Functions
    //@{
    static float GetMaxRangeToFireOnEnemy                 ( const MIL_AgentPion& callerAgent, DEC_Knowledge_Agent* pKnowledge, float rWantedPH );
    static float GetMinRangeToFireOnEnemy                 ( const MIL_AgentPion& callerAgent, DEC_Knowledge_Agent* pKnowledge, float rWantedPH );
    static float GetMaxRangeToFireOnEnemyActualPosture    ( const MIL_AgentPion& callerAgent, DEC_Knowledge_Agent* pKnowledge, float rWantedPH );
    static float GetMinRangeToFireOnEnemyActualPosture    ( const MIL_AgentPion& callerAgent, DEC_Knowledge_Agent* pKnowledge, float rWantedPH );
    static float GetMaxRangeToFireOnEnemyWhenUnloaded     ( const MIL_AgentPion& callerAgent, DEC_Knowledge_Agent* pKnowledge, float rWantedPH );
    static float GetMaxRangeToBeFiredByEnemy              ( const MIL_AgentPion& callerAgent, DEC_Knowledge_Agent* pKnowledge, float rWantedPH );
    ...
    static void  ThrowSmokeOnKnowledgeAgent               ( MIL_AgentPion& callerAgent, DEC_Knowledge_Agent* pTarget );
