...
public:
    ...
    // Terrain keypoint
    static void GetCrossroads( const directia::Brain& brain, directia::ScriptRef& knowledgeCreateFunction, float x, float y, float z, float radius, const directia::ScriptRef& table ); 
    // BMArea
