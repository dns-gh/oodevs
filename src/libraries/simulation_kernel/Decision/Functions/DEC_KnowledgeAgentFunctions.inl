...
void DEC_KnowledgeAgentFunctions::GetMajorOperationalState( DIA_Call_ABC& call, const T& caller )
{
    ...
    if( !pKnowledge )
        ...
        call.GetResult().SetValue( 0 == pKnowledge->GetMajorOperationalState() );
}
...
{
    DEC_Knowledge_Agent* pKnowledge = DEC_FunctionsTools::GetKnowledgeAgentFromDia( call.GetParameter( 0 ), caller.GetKnowledgeGroup() );
    call.GetResult().SetValue( pKnowledge && pKnowledge->GetAltitude() > MIL_Tools::GetAltitude( pKnowledge->GetPosition() ) );
}
...
{
    DEC_Knowledge_Agent* pKnowledge = DEC_FunctionsTools::GetKnowledgeAgentFromDia( call.GetParameter( 0 ), caller.GetKnowledgeGroup() );
    call.GetResult().SetValue( pKnowledge && pKnowledge->IsPrisoner() );
}
...
{
    DEC_Knowledge_Agent* pKnowledge = DEC_FunctionsTools::GetKnowledgeAgentFromDia( call.GetParameter( 0 ), caller.GetKnowledgeGroup() );
    call.GetResult().SetValue( pKnowledge && pKnowledge->IsDead() );
}
