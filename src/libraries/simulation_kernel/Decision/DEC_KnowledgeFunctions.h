...
public:
    ...
    template< typename T > static T_KnowledgeObjectDiaIDVector GetObjectsInZoneWithCapacity( const T& caller, const TER_Localisation* pLoc, const std::string& capacity );
