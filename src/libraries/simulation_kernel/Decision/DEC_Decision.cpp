...
void RegisterPopulationFunctions( directia::brain::Brain& brain )
{
    ...
    brain[ "DEC_Agent_UndoEvacuate" ] = &DEC_AgentFunctions::UndoEvacuateInhabitants;
...
void RegisterResourceNetworkFunctions( directia::brain::Brain& brain )
{
    ...
    brain[ "DEC_CreerLienObjetVersReseau" ] = &DEC_ResourceNetworkFunctions::CreateResourceNetworkObjectAndLinkReturn; // obsolete?
    brain[ "DEC_DetruireObjetResourceSansDelais" ] = &DEC_ResourceNetworkFunctions::DestroyResourceNetworkObjectLink; // obsolete?
...
namespace
{
    ...
    {
        return (*pArchetypeBrain)[ "include" ]( bfs::path( bfs::path( "./resources", bfs::native ) / file ).native_file_string() );
    }
}
