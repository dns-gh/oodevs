...
public:
    ...
    // Returns the convex hull of a list of locations. Shapes other than lines and polygons are first converted into their boundign box.
    static boost::shared_ptr< TER_Localisation > ComputeConvexHull( std::vector< boost::shared_ptr< TER_Localisation > > locations );
