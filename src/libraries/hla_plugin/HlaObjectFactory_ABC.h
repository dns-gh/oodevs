...
public:
    ...
    //! @name Operations
    //@{
    virtual std::auto_ptr< HlaObject_ABC > CreateAggregate( Agent_ABC& agent, const std::string& name, short identifier, rpr::ForceIdentifier force, const rpr::EntityType& type ) const = 0;
    //@}
};
