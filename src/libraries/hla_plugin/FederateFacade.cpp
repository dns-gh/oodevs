...
FederateFacade::FederateFacade( xml::xisubstream xis, tools::MessageController_ABC< sword::SimToClient_Content >& controller,
    ...
    , rprAggregateClass_ ( xis.attribute< bool >( "netn", true ) ? fomBuilder_->CreateRprAggregateClass() : std::unique_ptr< HlaClass >( nullptr ) )
    , rprSurfaceVesselClass_ ( xis.attribute< bool >( "netn", true ) ? fomBuilder_->CreateRprSurfaceVesselClass() : std::unique_ptr< HlaClass >( nullptr ) )
    , rprAircraftClass_  ( xis.attribute< bool >( "netn", true ) ? fomBuilder_->CreateRprAircraftClass() : std::unique_ptr< HlaClass >( nullptr ) )
