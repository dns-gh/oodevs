...
#ifndef plugins_hla_RawDataHazardContourGroup_H_
#define plugins_hla_RawDataHazardContourGroup_H_
...
/// @brief RawDataHazardContourGroup
...
public:
    ...
    //@{
    RawDataHazardContourGroup( TacticalObject_ABC& object, unsigned int identifier, const std::string& name, rpr::ForceIdentifier force, const rpr::EntityType& type,
        const rpr::EntityIdentifier& entityId, const std::string& rtiId );
    RawDataHazardContourGroup( const std::string& identifier, EntityIdentifierResolver_ABC& entityIdentifierResolver, FOM_Serializer_ABC& fomSerializer );
    virtual  ~RawDataHazardContourGroup();
    //@}
...
#endif // plugins_hla_RawDataHazardContourGroup_H_
