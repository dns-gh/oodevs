...
ASN1C_ScipioBaseIncludes::ASN1C_ScipioBaseIncludes (
   ASN1MessageBuffer& msgBuf, ASN1T_ScipioBaseIncludes& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_ScipioBaseIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioBaseIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioBaseIncludes: start\n");


   rtdiag ("asn1PE_ScipioBaseIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioBaseIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioBaseIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_ScipioBaseIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioBaseIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioBaseIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioBaseIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioBaseIncludes::Decode ()
{
   return asn1PD_ScipioBaseIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioBaseExports::ASN1C_ScipioBaseExports (
   ASN1MessageBuffer& msgBuf) :
   ASN1CType(msgBuf)
{}

EXTERN int asn1PE_ScipioBaseExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioBaseExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioBaseExports: end\n");
   return (stat);
}

int ASN1C_ScipioBaseExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioBaseExports (mpContext->GetPtr());
   return stat;
}

EXTERN int asn1PD_ScipioBaseExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioBaseExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioBaseExports: end\n");

   return (stat);
}

int ASN1C_ScipioBaseExports::Decode ()
{
   return asn1PD_ScipioBaseExports (mpContext->GetPtr());
}
