...
/**************************************************************/
/*                                                            */
/*  ScipioPopulationIncludes                                  */
/*                                                            */
/**************************************************************/

ASN1C_ScipioPopulationIncludes::ASN1C_ScipioPopulationIncludes (
   ASN1MessageBuffer& msgBuf, ASN1T_ScipioPopulationIncludes& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_ScipioPopulationIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioPopulationIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioPopulationIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioPopulationIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioPopulationIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioPopulationIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_ScipioPopulationIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioPopulationIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioPopulationIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioPopulationIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioPopulationIncludes::Decode ()
{
   return asn1PD_ScipioPopulationIncludes (mpContext->GetPtr(), &msgData);
}

/**************************************************************/
/*                                                            */
/*  ScipioPopulationExports                                   */
/*                                                            */
/**************************************************************/

ASN1C_ScipioPopulationExports::ASN1C_ScipioPopulationExports (
   ASN1MessageBuffer& msgBuf) :
   ASN1CType(msgBuf)
{}

EXTERN int asn1PE_ScipioPopulationExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioPopulationExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioPopulationExports: end\n");
   return (stat);
}

int ASN1C_ScipioPopulationExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioPopulationExports (mpContext->GetPtr());
   return stat;
}

EXTERN int asn1PD_ScipioPopulationExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioPopulationExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioPopulationExports: end\n");

   return (stat);
}

int ASN1C_ScipioPopulationExports::Decode ()
{
   return asn1PD_ScipioPopulationExports (mpContext->GetPtr());
}
...
ASN1C_MagicActionPopulationTuer::ASN1C_MagicActionPopulationTuer (
...
EXTERN int asn1PE_MagicActionPopulationTuer (ASN1CTXT* ctxt_p, ASN1T_MagicActionPopulationTuer value)
{
   ...
   rtdiag ("asn1PE_MagicActionPopulationTuer: start\n");

   stat = pe_UnconsInteger (ctxt_p, value);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   rtdiag ("asn1PE_MagicActionPopulationTuer: end\n");
   return (stat);
}

int ASN1C_MagicActionPopulationTuer::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MagicActionPopulationTuer (mpContext->GetPtr(), msgData);
   return stat;
}
...
EXTERN int asn1PD_MagicActionPopulationTuer (ASN1CTXT* ctxt_p, ASN1T_MagicActionPopulationTuer* pvalue)
{
   ...
   rtdiag ("asn1PD_MagicActionPopulationTuer: start\n");

   stat = pd_UnconsInteger (ctxt_p, pvalue);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   rtdiag ("asn1PD_MagicActionPopulationTuer: end\n");

   return (stat);
}

int ASN1C_MagicActionPopulationTuer::Decode ()
{
   return asn1PD_MagicActionPopulationTuer (mpContext->GetPtr(), &msgData);
}
...
ASN1C_MagicActionPopulationRessusciter::ASN1C_MagicActionPopulationRessusciter (
...
EXTERN int asn1PE_MagicActionPopulationRessusciter (ASN1CTXT* ctxt_p, ASN1T_MagicActionPopulationRessusciter value)
{
   ...
   rtdiag ("asn1PE_MagicActionPopulationRessusciter: start\n");

   stat = pe_UnconsInteger (ctxt_p, value);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   rtdiag ("asn1PE_MagicActionPopulationRessusciter: end\n");
   return (stat);
}

int ASN1C_MagicActionPopulationRessusciter::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MagicActionPopulationRessusciter (mpContext->GetPtr(), msgData);
   return stat;
}
...
EXTERN int asn1PD_MagicActionPopulationRessusciter (ASN1CTXT* ctxt_p, ASN1T_MagicActionPopulationRessusciter* pvalue)
{
   ...
   rtdiag ("asn1PD_MagicActionPopulationRessusciter: start\n");

   stat = pd_UnconsInteger (ctxt_p, pvalue);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   rtdiag ("asn1PD_MagicActionPopulationRessusciter: end\n");

   return (stat);
}

int ASN1C_MagicActionPopulationRessusciter::Decode ()
{
   return asn1PD_MagicActionPopulationRessusciter (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_MsgPopulationMagicAction_action (ASN1CTXT* ctxt_p, ASN1T_MsgPopulationMagicAction_action* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      /* tuer */
      case 4:
         PU_PUSHNAME (ctxt_p, "u.tuer");

         stat = asn1PE_MagicActionPopulationTuer (ctxt_p, pvalue->u.tuer);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
      ...
      /* ressusciter */
      case 5:
         PU_PUSHNAME (ctxt_p, "u.ressusciter");

         stat = asn1PE_MagicActionPopulationRessusciter (ctxt_p, pvalue->u.ressusciter);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MsgPopulationMagicAction_action (ASN1CTXT* ctxt_p, ASN1T_MsgPopulationMagicAction_action* pvalue)
{
   ...
   switch (ui) {
      ...
      case 3:
         ...
         stat = asn1PD_MagicActionPopulationTuer (ctxt_p, &pvalue->u.tuer);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 4:
         ...
         stat = asn1PD_MagicActionPopulationRessusciter (ctxt_p, &pvalue->u.ressusciter);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
