...
void asn1Print_ScipioLimaLimiteIncludes (ASN1ConstCharPtr name, ASN1T_ScipioLimaLimiteIncludes* pvalue)
{
   char namebuf[512];
...
void ASN1C_ScipioLimaLimiteIncludes::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioLimaLimiteIncludes (name, &msgData);
}

void asn1Print_ScipioLimaLimiteExports (ASN1ConstCharPtr name)
{
}

void ASN1C_ScipioLimaLimiteExports::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioLimaLimiteExports (name);
}
