...
ASN1C_ScipioArmyIncludes::ASN1C_ScipioArmyIncludes (
   ASN1MessageBuffer& msgBuf, ASN1T_ScipioArmyIncludes& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_ScipioArmyIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioArmyIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioArmyIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioArmyIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioArmyIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioArmyIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_ScipioArmyIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioArmyIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioArmyIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioArmyIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioArmyIncludes::Decode ()
{
   return asn1PD_ScipioArmyIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioArmyExports::ASN1C_ScipioArmyExports (
   ASN1MessageBuffer& msgBuf) :
   ASN1CType(msgBuf)
{}

EXTERN int asn1PE_ScipioArmyExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioArmyExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioArmyExports: end\n");
   return (stat);
}

int ASN1C_ScipioArmyExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioArmyExports (mpContext->GetPtr());
   return stat;
}

EXTERN int asn1PD_ScipioArmyExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioArmyExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioArmyExports: end\n");

   return (stat);
}

int ASN1C_ScipioArmyExports::Decode ()
{
   return asn1PD_ScipioArmyExports (mpContext->GetPtr());
}
