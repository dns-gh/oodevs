...
ASN1C_ScipioLogMaintenanceIncludes::ASN1C_ScipioLogMaintenanceIncludes (
...
EXTERN int asn1PE_ScipioLogMaintenanceIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioLogMaintenanceIncludes* pvalue)
{
   ...
   rtdiag ("asn1PE_ScipioLogMaintenanceIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioLogMaintenanceIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioLogMaintenanceIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioLogMaintenanceIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_ScipioLogMaintenanceIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioLogMaintenanceIncludes* pvalue)
{
   ...
   rtdiag ("asn1PD_ScipioLogMaintenanceIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioLogMaintenanceIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioLogMaintenanceIncludes::Decode ()
{
   return asn1PD_ScipioLogMaintenanceIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioLogMaintenanceExports::ASN1C_ScipioLogMaintenanceExports (
...
EXTERN int asn1PE_ScipioLogMaintenanceExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_ScipioLogMaintenanceExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioLogMaintenanceExports: end\n");
   return (stat);
}

int ASN1C_ScipioLogMaintenanceExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioLogMaintenanceExports (mpContext->GetPtr());
   return stat;
}
...
EXTERN int asn1PD_ScipioLogMaintenanceExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_ScipioLogMaintenanceExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioLogMaintenanceExports: end\n");

   return (stat);
}

int ASN1C_ScipioLogMaintenanceExports::Decode ()
{
   return asn1PD_ScipioLogMaintenanceExports (mpContext->GetPtr());
}
