...
typedef struct EXTERN ASN1T_ScipioLogSanteIncludes {
} ASN1T_ScipioLogSanteIncludes;

class EXTERN ASN1C_ScipioLogSanteIncludes : public ASN1CType {
public:
   ASN1T_ScipioLogSanteIncludes& msgData;
   ASN1C_ScipioLogSanteIncludes (
...
EXTERN void asn1Print_ScipioLogSanteIncludes (ASN1ConstCharPtr name, ASN1T_ScipioLogSanteIncludes* pvalue);
...
class EXTERN ASN1C_ScipioLogSanteExports : public ASN1CType {
public:
   ASN1C_ScipioLogSanteExports (
...
EXTERN void asn1Print_ScipioLogSanteExports (ASN1ConstCharPtr name);
