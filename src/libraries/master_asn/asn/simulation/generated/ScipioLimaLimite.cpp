...
/**************************************************************/
/*                                                            */
/*  ScipioLimaLimiteIncludes                                  */
/*                                                            */
/**************************************************************/

ASN1C_ScipioLimaLimiteIncludes::ASN1C_ScipioLimaLimiteIncludes (
   ASN1MessageBuffer& msgBuf, ASN1T_ScipioLimaLimiteIncludes& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_ScipioLimaLimiteIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioLimaLimiteIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioLimaLimiteIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioLimaLimiteIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioLimaLimiteIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioLimaLimiteIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_ScipioLimaLimiteIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioLimaLimiteIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioLimaLimiteIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioLimaLimiteIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioLimaLimiteIncludes::Decode ()
{
   return asn1PD_ScipioLimaLimiteIncludes (mpContext->GetPtr(), &msgData);
}

/**************************************************************/
/*                                                            */
/*  ScipioLimaLimiteExports                                   */
/*                                                            */
/**************************************************************/

ASN1C_ScipioLimaLimiteExports::ASN1C_ScipioLimaLimiteExports (
   ASN1MessageBuffer& msgBuf) :
   ASN1CType(msgBuf)
{}

EXTERN int asn1PE_ScipioLimaLimiteExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioLimaLimiteExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioLimaLimiteExports: end\n");
   return (stat);
}

int ASN1C_ScipioLimaLimiteExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioLimaLimiteExports (mpContext->GetPtr());
   return stat;
}

EXTERN int asn1PD_ScipioLimaLimiteExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioLimaLimiteExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioLimaLimiteExports: end\n");

   return (stat);
}

int ASN1C_ScipioLimaLimiteExports::Decode ()
{
   return asn1PD_ScipioLimaLimiteExports (mpContext->GetPtr());
}
