...
typedef struct EXTERN ASN1T_ScipioLimaLimiteIncludes {
} ASN1T_ScipioLimaLimiteIncludes;

class EXTERN ASN1C_ScipioLimaLimiteIncludes : public ASN1CType {
public:
   ASN1T_ScipioLimaLimiteIncludes& msgData;
   ASN1C_ScipioLimaLimiteIncludes (
...
EXTERN void asn1Print_ScipioLimaLimiteIncludes (ASN1ConstCharPtr name, ASN1T_ScipioLimaLimiteIncludes* pvalue);
...
class EXTERN ASN1C_ScipioLimaLimiteExports : public ASN1CType {
public:
   ASN1C_ScipioLimaLimiteExports (
...
EXTERN void asn1Print_ScipioLimaLimiteExports (ASN1ConstCharPtr name);
