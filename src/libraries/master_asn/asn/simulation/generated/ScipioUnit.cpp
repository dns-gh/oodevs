...
ASN1C_ScipioUnitIncludes::ASN1C_ScipioUnitIncludes (
...
EXTERN int asn1PE_ScipioUnitIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioUnitIncludes* pvalue)
{
   ...
   rtdiag ("asn1PE_ScipioUnitIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioUnitIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioUnitIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioUnitIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_ScipioUnitIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioUnitIncludes* pvalue)
{
   ...
   rtdiag ("asn1PD_ScipioUnitIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioUnitIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioUnitIncludes::Decode ()
{
   return asn1PD_ScipioUnitIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioUnitExports::ASN1C_ScipioUnitExports (
...
EXTERN int asn1PE_ScipioUnitExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_ScipioUnitExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioUnitExports: end\n");
   return (stat);
}

int ASN1C_ScipioUnitExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioUnitExports (mpContext->GetPtr());
   return stat;
}
...
EXTERN int asn1PD_ScipioUnitExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_ScipioUnitExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioUnitExports: end\n");

   return (stat);
}

int ASN1C_ScipioUnitExports::Decode ()
{
   return asn1PD_ScipioUnitExports (mpContext->GetPtr());
}
