...
ASN1C_ScipioFireIncludes::ASN1C_ScipioFireIncludes (
...
EXTERN int asn1PE_ScipioFireIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioFireIncludes* pvalue)
{
   ...
   rtdiag ("asn1PE_ScipioFireIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioFireIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioFireIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioFireIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_ScipioFireIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioFireIncludes* pvalue)
{
   ...
   rtdiag ("asn1PD_ScipioFireIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioFireIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioFireIncludes::Decode ()
{
   return asn1PD_ScipioFireIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioFireExports::ASN1C_ScipioFireExports (
...
EXTERN int asn1PE_ScipioFireExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_ScipioFireExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioFireExports: end\n");
   return (stat);
}

int ASN1C_ScipioFireExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioFireExports (mpContext->GetPtr());
   return stat;
}
...
EXTERN int asn1PD_ScipioFireExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_ScipioFireExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioFireExports: end\n");

   return (stat);
}

int ASN1C_ScipioFireExports::Decode ()
{
   return asn1PD_ScipioFireExports (mpContext->GetPtr());
}
