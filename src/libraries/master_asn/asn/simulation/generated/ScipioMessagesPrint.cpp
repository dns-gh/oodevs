...
void asn1Print_ScipioMessagesIncludes (ASN1ConstCharPtr name, ASN1T_ScipioMessagesIncludes* pvalue)
{
   char namebuf[512];

   sprintf (namebuf, "%s.scipioBaseExports", name);

   sprintf (namebuf, "%s.scipioLimaLimiteExports", name);

   sprintf (namebuf, "%s.scipioOrderExports", name);

   sprintf (namebuf, "%s.scipioControlExports", name);

   sprintf (namebuf, "%s.scipioKnowledgeGroupExports", name);

   sprintf (namebuf, "%s.scipioFormationExports", name);

   sprintf (namebuf, "%s.scipioFireExports", name);

   sprintf (namebuf, "%s.scipioUnitExports", name);

   sprintf (namebuf, "%s.scipioUnitKnowledgeExports", name);

   sprintf (namebuf, "%s.scipioObjectExports", name);

   sprintf (namebuf, "%s.scipioObjectKnowledgeExports", name);

   sprintf (namebuf, "%s.scipioPopulationExports", name);

   sprintf (namebuf, "%s.scipioPopulationKnowledgeExports", name);

   sprintf (namebuf, "%s.scipioLogMaintenanceExports", name);

   sprintf (namebuf, "%s.scipioLogRavitaillementExports", name);

   sprintf (namebuf, "%s.scipioLogSanteExports", name);

   sprintf (namebuf, "%s.scipioAutomateExports", name);

   sprintf (namebuf, "%s.scipioArmyExports", name);

   sprintf (namebuf, "%s.scipioAuthExports", name);

}

void ASN1C_ScipioMessagesIncludes::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioMessagesIncludes (name, &msgData);
}

void asn1Print_ScipioMessagesExports (ASN1ConstCharPtr name)
{
}

void ASN1C_ScipioMessagesExports::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioMessagesExports (name);
}
