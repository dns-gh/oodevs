...
/**************************************************************/
/*                                                            */
/*  ScipioLogRavitaillementIncludes                           */
/*                                                            */
/**************************************************************/

ASN1C_ScipioLogRavitaillementIncludes::ASN1C_ScipioLogRavitaillementIncludes (
   ASN1MessageBuffer& msgBuf, ASN1T_ScipioLogRavitaillementIncludes& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_ScipioLogRavitaillementIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioLogRavitaillementIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioLogRavitaillementIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioLogRavitaillementIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioLogRavitaillementIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioLogRavitaillementIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_ScipioLogRavitaillementIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioLogRavitaillementIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioLogRavitaillementIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioLogRavitaillementIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioLogRavitaillementIncludes::Decode ()
{
   return asn1PD_ScipioLogRavitaillementIncludes (mpContext->GetPtr(), &msgData);
}

/**************************************************************/
/*                                                            */
/*  ScipioLogRavitaillementExports                            */
/*                                                            */
/**************************************************************/

ASN1C_ScipioLogRavitaillementExports::ASN1C_ScipioLogRavitaillementExports (
   ASN1MessageBuffer& msgBuf) :
   ASN1CType(msgBuf)
{}

EXTERN int asn1PE_ScipioLogRavitaillementExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioLogRavitaillementExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioLogRavitaillementExports: end\n");
   return (stat);
}

int ASN1C_ScipioLogRavitaillementExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioLogRavitaillementExports (mpContext->GetPtr());
   return stat;
}

EXTERN int asn1PD_ScipioLogRavitaillementExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioLogRavitaillementExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioLogRavitaillementExports: end\n");

   return (stat);
}

int ASN1C_ScipioLogRavitaillementExports::Decode ()
{
   return asn1PD_ScipioLogRavitaillementExports (mpContext->GetPtr());
}
...
EXTERN int asn1PE_EnumLogRavitaillementTraitementEtat (ASN1CTXT* ctxt_p, ASN1T_EnumLogRavitaillementTraitementEtat value)
{
   ...
   switch (value) {
      ...
      case EnumLogRavitaillementTraitementEtat::convoi_constitution: ui = 1; break;
      case EnumLogRavitaillementTraitementEtat::convoi_deplacement_vers_point_chargement: ui = 2; break;
      case EnumLogRavitaillementTraitementEtat::convoi_chargement: ui = 3; break;
      case EnumLogRavitaillementTraitementEtat::convoi_deplacement_vers_point_dechargement: ui = 4; break;
      case EnumLogRavitaillementTraitementEtat::convoi_dechargement: ui = 5; break;
      case EnumLogRavitaillementTraitementEtat::convoi_deplacement_retour: ui = 6; break;
      case EnumLogRavitaillementTraitementEtat::termine: ui = 7; break;
...
EXTERN int asn1PD_EnumLogRavitaillementTraitementEtat (ASN1CTXT* ctxt_p, ASN1T_EnumLogRavitaillementTraitementEtat* pvalue)
{
   ...
   switch (ui) {
      ...
      case 1: *pvalue = EnumLogRavitaillementTraitementEtat::convoi_constitution; break;
      case 2: *pvalue = EnumLogRavitaillementTraitementEtat::convoi_deplacement_vers_point_chargement; break;
      case 3: *pvalue = EnumLogRavitaillementTraitementEtat::convoi_chargement; break;
      case 4: *pvalue = EnumLogRavitaillementTraitementEtat::convoi_deplacement_vers_point_dechargement; break;
      case 5: *pvalue = EnumLogRavitaillementTraitementEtat::convoi_dechargement; break;
      case 6: *pvalue = EnumLogRavitaillementTraitementEtat::convoi_deplacement_retour; break;
      case 7: *pvalue = EnumLogRavitaillementTraitementEtat::termine; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }
