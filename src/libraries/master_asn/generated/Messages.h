...
#define T_MsgsInMaster_msg_msg_exercise_creation_request 2
#define T_MsgsInMaster_msg_msg_exercise_update_request 3
#define T_MsgsInMaster_msg_msg_exercise_destruction_request 4
