...
namespace
{
    ...
    {
        to->mutable_obstacle()->set_type( from.obstacle().type() == sword::ObstacleType::preliminary ? Common::ObstacleType::preliminary : Common::ObstacleType::reserved );
