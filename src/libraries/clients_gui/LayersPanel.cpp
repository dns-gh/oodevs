...
//    {
//        // ListView
//        layersListView_ = new QTreeView();
//        layersListView_->setObjectName( "layers-list" );
//        layersListView_->setRootIsDecorated( false );
//        layersListView_->header()->hide();
//        layersListView_->setModel( layersModel_ );
//        connect( layersListView_->selectionModel(), SIGNAL( currentChanged( const QModelIndex&, const QModelIndex& ) ), SLOT( OnSelectionChanged() ) );
//
//        // Buttons
...
//void LayersPanel::OnRemoveDynamicLayer()
//{
//    QStandardItem* item = layersModel_->itemFromIndex( layersListView_->selectionModel()->currentIndex() );
//    if( !item )
//        return;
...
//    {
//        QItemSelectionModel* selectionModel = layersListView_->selectionModel();
...
//{
//    QModelIndex index = layersListView_->selectionModel()->currentIndex();
...
//        layersListView_->selectionModel()->select( item->index(), QItemSelectionModel::Select );
//    UpdateLeastAndMostVisible();
//}
//
//// -----------------------------------------------------------------------------
