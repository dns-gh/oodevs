...
FloodPrototype_ABC::FloodPrototype_ABC( QWidget* parent )
    : ObjectAttributePrototype_ABC( parent, tools::translate( "FloodPrototype_ABC", "Flood" ) )
{
    new QLabel( tools::translate( "FloodPrototype_ABC", "Depth:" ), this );
    ...
    new QLabel( tools::translate( "FloodPrototype_ABC", "Reference distance:" ), this );
