...
// -----------------------------------------------------------------------------
TextureRenderPass::TextureRenderPass( GlWidget& widget, const std::string& name, kernel::Controllers& controllers, const std::string& option /*= ""*/ )
...
// -----------------------------------------------------------------------------
void TextureRenderPass::Render( GlWidget& widget )
{
    if( !enabled_ )
        return;
    if( !texture_ )
