...
public:
    ...
    void Draw( const geometry::Point2f& where, const Viewport_ABC& viewport, GlTools_ABC& tools )
    {
        drawer.Draw( where, viewport, tools );
    }

    void Pick( const geometry::Point2f& where, const Viewport_ABC& viewport, GlTools_ABC& tools )
    {
