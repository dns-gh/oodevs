...
public:
    ...
    void Clear();
    void Draw( gui::GlTools_ABC& tools, const boost::optional< Hover >& hover, bool picking ) const;

    bool HasPath() const;
    bool HasWaypoints() const;

    boost::optional< Hover > PickWaypoint( const gui::GlTools_ABC& tools, const geometry::Point2f& where ) const;
    boost::optional< Hover > PickSegment( const gui::GlTools_ABC& tools, const geometry::Point2f& where ) const;
...
private:
    ...
    void DrawPoints( gui::GlTools_ABC& tools, const QColor& current, const boost::optional< Hover >& hover, bool picking ) const;
