...
{
    const bool displayPath = viewport.IsVisible( plannedBox_ ) && tools.GetCurrentOptions().ShouldDisplay( "Paths" );
    const bool displayOldPath = viewport.IsVisible( previousBox_ ) && tools.GetCurrentOptions().ShouldDisplay( "OldPaths" );
