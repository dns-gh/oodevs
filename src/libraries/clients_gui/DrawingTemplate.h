...
public:
    ...
    void GenerateSamplePixmap( float r = -1, float g = -1, float b = -1, float sampleMarkerRatio = 1.f );

    void Draw( const T_PointVector& points, svg::RenderingContext_ABC& context, const GLView_ABC* view = 0, float zoom = 1.f ) const;
    void Draw( const geometry::Point2f& point, svg::RenderingContext_ABC& context, const GLView_ABC* view = 0, float zoom = 1.f ) const;
