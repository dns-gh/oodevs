...
HierarchyTreeView< Hierarchy >::HierarchyTreeView( kernel::Controllers& controllers, const kernel::Profile_ABC& profile, const EntitySymbols& symbols, QWidget* parent /*= 0*/ )
    : HierarchyTreeView_ABC( controllers, profile, symbols, parent )
