...
void asn1Print_MsgAutomateChangeGroupeConnaissance (ASN1ConstCharPtr name, ASN1T_MsgAutomateChangeGroupeConnaissance* pvalue)
{
   char namebuf[512];
...
void ASN1C_MsgAutomateChangeGroupeConnaissance::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgAutomateChangeGroupeConnaissance (name, &msgData);
}

void asn1Print_MsgAutomateChangeGroupeConnaissanceAck (ASN1ConstCharPtr name, ASN1T_MsgAutomateChangeGroupeConnaissanceAck* pvalue)
{
   char namebuf[512];
...
void ASN1C_MsgAutomateChangeGroupeConnaissanceAck::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgAutomateChangeGroupeConnaissanceAck (name, &msgData);
}

void asn1Print_MsgAutomateChangeLiensLogistiques (ASN1ConstCharPtr name, ASN1T_MsgAutomateChangeLiensLogistiques* pvalue)
{
   char namebuf[512];
...
void ASN1C_MsgAutomateChangeLiensLogistiques::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgAutomateChangeLiensLogistiques (name, &msgData);
}

void asn1Print_MsgAutomateChangeLiensLogistiquesAck (ASN1ConstCharPtr name, ASN1T_MsgAutomateChangeLiensLogistiquesAck* pvalue)
{
   char namebuf[512];
...
void ASN1C_MsgAutomateChangeLiensLogistiquesAck::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgAutomateChangeLiensLogistiquesAck (name, &msgData);
}
