 ...
 * (http://www.obj-sys.com).  Version: 5.31, Date: 27-Feb-2007.
 */
...
EXTERN int asn1PE_PopulationIncludes (ASN1CTXT* ctxt_p, ASN1T_PopulationIncludes* pvalue)
{
   ...
   rtdiag ("asn1PE_PopulationIncludes: start\n");
   ...
   rtdiag ("asn1PE_PopulationIncludes: end\n");
   return (stat);
}
...
EXTERN int asn1PD_PopulationIncludes (ASN1CTXT* ctxt_p, ASN1T_PopulationIncludes* pvalue)
{
   ...
   rtdiag ("asn1PD_PopulationIncludes: start\n");
   ...
   rtdiag ("asn1PD_PopulationIncludes: end\n");
...
EXTERN int asn1PE_PopulationExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_PopulationExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_PopulationExports: end\n");
   return (stat);
}
...
EXTERN int asn1PD_PopulationExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_PopulationExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_PopulationExports: end\n");
