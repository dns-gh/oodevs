...
typedef struct EXTERN ASN1T_MsgObjectKnowledgeCreation {
   ...
   ASN1T_ObjectKnowledge  oid_connaissance;
   ASN1T_Team  oid_camp_possesseur;
   ASN1T_OID  oid_objet_reel;
   ASN1T_EnumObjectType  type;
   ASN1T_EnumObstacleType  type_obstacle;
   ASN1BOOL  obstacle_de_manoeuvre_active;
   ASN1T_DotationType  type_dotation_construction;
   ASN1T_DotationType  type_dotation_valorisation;

   ASN1T_MsgObjectKnowledgeCreation () {
      m.type_obstaclePresent = 0;
      m.obstacle_de_manoeuvre_activePresent = 0;
...
typedef struct EXTERN ASN1T_MsgObjectKnowledgeUpdate {
   ...
   ASN1BOOL  obstacle_de_manoeuvre_active;
   ASN1BOOL  est_percu;
   ASN1T_ObjectAttributesSpecific  attributs_specifiques;
