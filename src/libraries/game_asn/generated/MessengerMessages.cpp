...
EXTERN int asn1PE_MessengerMessagesIncludes (ASN1CTXT* ctxt_p, ASN1T_MessengerMessagesIncludes* pvalue)
{
   ...
   stat = asn1PE_NotesExports (ctxt_p);
   if (stat != ASN_OK) return stat;
...
EXTERN int asn1PD_MessengerMessagesIncludes (ASN1CTXT* ctxt_p, ASN1T_MessengerMessagesIncludes* pvalue)
{
   ...
   stat = asn1PD_NotesExports (ctxt_p);
   if (stat != ASN_OK) return stat;
...
EXTERN int asn1PE_MsgsMessengerToClient (ASN1CTXT* ctxt_p, ASN1T_MsgsMessengerToClient* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      /* msg_note_creation */
      case 25:
         stat = asn1PE_MsgNoteCreation (ctxt_p, pvalue->u.msg_note_creation);
         if (stat != ASN_OK) return stat;
         break;

      /* msg_note_update */
      case 26:
         stat = asn1PE_MsgNoteUpdate (ctxt_p, pvalue->u.msg_note_update);
         if (stat != ASN_OK) return stat;
         break;

      /* msg_note_destruction */
      case 27:
         stat = asn1PE_MsgNoteDestruction (ctxt_p, pvalue->u.msg_note_destruction);
         if (stat != ASN_OK) return stat;
         break;
...
EXTERN int asn1PD_MsgsMessengerToClient (ASN1CTXT* ctxt_p, ASN1T_MsgsMessengerToClient* pvalue)
{
   ...
   switch (ui) {
      ...
      /* msg_note_creation */
      case 24:
         pvalue->u.msg_note_creation = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgNoteCreation);

         stat = asn1PD_MsgNoteCreation (ctxt_p, pvalue->u.msg_note_creation);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_note_update */
      case 25:
         pvalue->u.msg_note_update = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgNoteUpdate);

         stat = asn1PD_MsgNoteUpdate (ctxt_p, pvalue->u.msg_note_update);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_note_destruction */
      case 26:
         pvalue->u.msg_note_destruction = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgNoteDestruction);

         stat = asn1PD_MsgNoteDestruction (ctxt_p, pvalue->u.msg_note_destruction);
         if (stat != ASN_OK) return stat;
...
EXTERN int asn1PE_MsgsClientToMessenger (ASN1CTXT* ctxt_p, ASN1T_MsgsClientToMessenger* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->t - 1, 0, 15);
   if (stat != ASN_OK) return stat;
   ...
   switch (pvalue->t)
   {
      ...
      /* msg_note_creation_request */
      case 13:
         stat = asn1PE_MsgNoteCreationRequest (ctxt_p, pvalue->u.msg_note_creation_request);
         if (stat != ASN_OK) return stat;
         break;

      /* msg_note_destruction_request */
      case 14:
         stat = asn1PE_MsgNoteDestructionRequest (ctxt_p, pvalue->u.msg_note_destruction_request);
         if (stat != ASN_OK) return stat;
         break;

      /* msg_note_update_request */
      case 15:
         stat = asn1PE_MsgNoteUpdateRequest (ctxt_p, pvalue->u.msg_note_update_request);
         if (stat != ASN_OK) return stat;
         break;
...
EXTERN int asn1PD_MsgsClientToMessenger (ASN1CTXT* ctxt_p, ASN1T_MsgsClientToMessenger* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 15);
   if (stat != ASN_OK) return stat;
   else pvalue->t = ui + 1;
   ...
   switch (ui) {
      ...
      /* msg_note_creation_request */
      case 12:
         pvalue->u.msg_note_creation_request = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgNoteCreationRequest);

         stat = asn1PD_MsgNoteCreationRequest (ctxt_p, pvalue->u.msg_note_creation_request);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_note_destruction_request */
      case 13:
         pvalue->u.msg_note_destruction_request = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgNoteDestructionRequest);

         stat = asn1PD_MsgNoteDestructionRequest (ctxt_p, pvalue->u.msg_note_destruction_request);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_note_update_request */
      case 14:
         pvalue->u.msg_note_update_request = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgNoteUpdateRequest);

         stat = asn1PD_MsgNoteUpdateRequest (ctxt_p, pvalue->u.msg_note_update_request);
         if (stat != ASN_OK) return stat;
