...
ASN1C_MsgAutomatChangeSuperiorAck_oid_superior::ASN1C_MsgAutomatChangeSuperiorAck_oid_superior (
...
int ASN1C_MsgAutomatChangeSuperiorAck_oid_superior::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgAutomatChangeSuperiorAck_oid_superior (mpContext->GetPtr(), &msgData);
   return stat;
}
...
int ASN1C_MsgAutomatChangeSuperiorAck_oid_superior::Decode ()
{
   return asn1PD_MsgAutomatChangeSuperiorAck_oid_superior (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_MsgAutomatChangeSuperiorAck (ASN1CTXT* ctxt_p, ASN1T_MsgAutomatChangeSuperiorAck* pvalue)
{
   ...
   stat = asn1PE_MsgAutomatChangeSuperiorAck_oid_superior (ctxt_p, &pvalue->oid_superior);
   if (stat != ASN_OK) return stat;
...
EXTERN int asn1PD_MsgAutomatChangeSuperiorAck (ASN1CTXT* ctxt_p, ASN1T_MsgAutomatChangeSuperiorAck* pvalue)
{
   ...
   stat = asn1PD_MsgAutomatChangeSuperiorAck_oid_superior (ctxt_p, &pvalue->oid_superior);
   if (stat != ASN_OK) return stat;
