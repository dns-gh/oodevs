...
typedef struct EXTERN ASN1T_PlannedWork {
   ...
   ASN1T_EnumDemolitionTargetType  type_obstacle;
   ASN1REAL  densite;
   ASN1T_Automat  tc2;
   ASN1INT   activity_time;

   ASN1T_PlannedWork () {
      type_obstacle = EnumDemolitionTargetType::preliminary;
      densite = 0;
      tc2 = 0;
      activity_time = 0;
   }
...
#define T_MissionParameter_value_line   34
#define T_MissionParameter_value_limasOrder 35
#define T_MissionParameter_value_intelligenceList 36
#define T_MissionParameter_value_urbanBlock 37
...
typedef struct EXTERN ASN1T_MissionParameter_value {
   ...
   union {
      ...
      ASN1T_Line *line;
      /* t = 35 */
      ASN1T_LimasOrder *limasOrder;
      /* t = 36 */
      ASN1T_IntelligenceList *intelligenceList;
      /* t = 37 */
      ASN1T_UrbanBlock  urbanBlock;
   } u;
