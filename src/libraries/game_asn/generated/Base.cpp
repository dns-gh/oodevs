...
ASN1C_ColorRGBA::ASN1C_ColorRGBA (
   ASN1MessageBuffer& msgBuf, ASN1T_ColorRGBA& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_ColorRGBA (ASN1CTXT* ctxt_p, ASN1T_ColorRGBA* pvalue)
{
   int stat = ASN_OK;

   /* encode red */

   stat = pe_UnconsInteger (ctxt_p, pvalue->red);
   if (stat != ASN_OK) return stat;

   /* encode green */

   stat = pe_UnconsInteger (ctxt_p, pvalue->green);
   if (stat != ASN_OK) return stat;

   /* encode blue */

   stat = pe_UnconsInteger (ctxt_p, pvalue->blue);
   if (stat != ASN_OK) return stat;

   /* encode alpha */

   stat = pe_Real (ctxt_p, pvalue->alpha);if (stat != ASN_OK) return stat;

   return (stat);
}

int ASN1C_ColorRGBA::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ColorRGBA (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_ColorRGBA (ASN1CTXT* ctxt_p, ASN1T_ColorRGBA* pvalue)
{
   int stat = ASN_OK;

   /* decode red */

   stat = pd_UnconsInteger (ctxt_p, &pvalue->red);
   if (stat != ASN_OK) return stat;

   /* decode green */

   stat = pd_UnconsInteger (ctxt_p, &pvalue->green);
   if (stat != ASN_OK) return stat;

   /* decode blue */

   stat = pd_UnconsInteger (ctxt_p, &pvalue->blue);
   if (stat != ASN_OK) return stat;

   /* decode alpha */

   stat = pd_Real (ctxt_p, &pvalue->alpha);if (stat != ASN_OK) return stat;


   return (stat);
}

int ASN1C_ColorRGBA::Decode ()
{
   return asn1PD_ColorRGBA (mpContext->GetPtr(), &msgData);
}
...
ASN1C_KnowledgeGroupType::ASN1C_KnowledgeGroupType (
...
int ASN1C_KnowledgeGroupType::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_KnowledgeGroupType (mpContext->GetPtr(), msgData);
   return stat;
}
...
int ASN1C_KnowledgeGroupType::Decode ()
{
   return asn1PD_KnowledgeGroupType (mpContext->GetPtr(), &msgData);
}
