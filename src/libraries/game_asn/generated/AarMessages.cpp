...
EXTERN int asn1PE_MsgsAarToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsAarToClient_msg* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      /* msg_plot_result */
      case 2:
         stat = asn1PE_MsgPlotResult (ctxt_p, pvalue->u.msg_plot_result);
         if (stat != ASN_OK) return stat;
         break;

      /* msg_indicator */
      case 3:
         stat = asn1PE_MsgIndicator (ctxt_p, pvalue->u.msg_indicator);
         if (stat != ASN_OK) return stat;
         break;
...
EXTERN int asn1PD_MsgsAarToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsAarToClient_msg* pvalue)
{
   ...
   switch (ui) {
      ...
      /* msg_plot_result */
      case 1:
         pvalue->u.msg_plot_result = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgPlotResult);

         stat = asn1PD_MsgPlotResult (ctxt_p, pvalue->u.msg_plot_result);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_indicator */
      case 2:
         pvalue->u.msg_indicator = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgIndicator);

         stat = asn1PD_MsgIndicator (ctxt_p, pvalue->u.msg_indicator);
         if (stat != ASN_OK) return stat;
...
EXTERN int asn1PE_MsgsClientToAar_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsClientToAar_msg* pvalue)
{
   ...
   switch (pvalue->t)
   {
      /* msg_plot_request */
      case 1:
         stat = asn1PE_MsgPlotRequest (ctxt_p, pvalue->u.msg_plot_request);
         if (stat != ASN_OK) return stat;
         break;
...
EXTERN int asn1PD_MsgsClientToAar_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsClientToAar_msg* pvalue)
{
   ...
   switch (ui) {
      /* msg_plot_request */
      case 0:
         pvalue->u.msg_plot_request = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgPlotRequest);

         stat = asn1PD_MsgPlotRequest (ctxt_p, pvalue->u.msg_plot_request);
         if (stat != ASN_OK) return stat;
