...
typedef struct EXTERN ASN1T_UnitFireDamages {
   ASN1T_Unit  cible;
   ASN1T__SeqOfUnitHumanFireDamage  humains;
   ASN1T__SeqOfUnitEquipmentFireDamage  equipements;
...
#define T_MsgStartUnitFire_cible_pion   1
#define T_MsgStartUnitFire_cible_population 2
#define T_MsgStartUnitFire_cible_position 3

typedef struct EXTERN ASN1T_MsgStartUnitFire_cible {
   int t;
   union {
      /* t = 1 */
      ASN1T_Unit  pion;
...
} ASN1T_MsgStartUnitFire_cible;

class EXTERN ASN1C_MsgStartUnitFire_cible : public ASN1CType {
public:
   ASN1T_MsgStartUnitFire_cible& msgData;
   ASN1C_MsgStartUnitFire_cible (
...
EXTERN void asn1Print_MsgStartUnitFire_cible (ASN1ConstCharPtr name, ASN1T_MsgStartUnitFire_cible* pvalue);
...
typedef struct EXTERN ASN1T_MsgStartUnitFire {
   ...
   ASN1T_Unit  tireur;
   ASN1T_MsgStartUnitFire_cible  cible;
...
typedef struct EXTERN ASN1T_MsgStopUnitFire {
   ASN1T_UnitFire  oid_tir;
   ASN1T_UnitsFireDamages  degats_pions;
   ASN1T_PopulationsFireDamages  degats_populations;
