...
void asn1Print_ScipioLogMaintenanceIncludes (ASN1ConstCharPtr name, ASN1T_ScipioLogMaintenanceIncludes* pvalue)
{
   char namebuf[512];
...
void ASN1C_ScipioLogMaintenanceIncludes::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioLogMaintenanceIncludes (name, &msgData);
}

void asn1Print_ScipioLogMaintenanceExports (ASN1ConstCharPtr name)
{
}

void ASN1C_ScipioLogMaintenanceExports::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioLogMaintenanceExports (name);
}
