...
ASN1C_ScipioAutomateIncludes::ASN1C_ScipioAutomateIncludes (
...
EXTERN int asn1PE_ScipioAutomateIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioAutomateIncludes* pvalue)
{
   ...
   rtdiag ("asn1PE_ScipioAutomateIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioAutomateIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioAutomateIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioAutomateIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_ScipioAutomateIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioAutomateIncludes* pvalue)
{
   ...
   rtdiag ("asn1PD_ScipioAutomateIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioAutomateIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioAutomateIncludes::Decode ()
{
   return asn1PD_ScipioAutomateIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioAutomateExports::ASN1C_ScipioAutomateExports (
...
EXTERN int asn1PE_ScipioAutomateExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_ScipioAutomateExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioAutomateExports: end\n");
   return (stat);
}

int ASN1C_ScipioAutomateExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioAutomateExports (mpContext->GetPtr());
   return stat;
}
...
EXTERN int asn1PD_ScipioAutomateExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_ScipioAutomateExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioAutomateExports: end\n");

   return (stat);
}

int ASN1C_ScipioAutomateExports::Decode ()
{
   return asn1PD_ScipioAutomateExports (mpContext->GetPtr());
}
