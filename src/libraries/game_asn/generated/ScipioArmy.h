...
typedef struct EXTERN ASN1T_ScipioArmyIncludes {
} ASN1T_ScipioArmyIncludes;

class EXTERN ASN1C_ScipioArmyIncludes : public ASN1CType {
public:
   ASN1T_ScipioArmyIncludes& msgData;
   ASN1C_ScipioArmyIncludes (
...
EXTERN void asn1Print_ScipioArmyIncludes (ASN1ConstCharPtr name, ASN1T_ScipioArmyIncludes* pvalue);
...
class EXTERN ASN1C_ScipioArmyExports : public ASN1CType {
public:
   ASN1C_ScipioArmyExports (
...
EXTERN void asn1Print_ScipioArmyExports (ASN1ConstCharPtr name);
