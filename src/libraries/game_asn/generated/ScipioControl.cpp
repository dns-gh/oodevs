...
ASN1C_ScipioControlIncludes::ASN1C_ScipioControlIncludes (
...
EXTERN int asn1PE_ScipioControlIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioControlIncludes* pvalue)
{
   ...
   rtdiag ("asn1PE_ScipioControlIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioControlIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioControlIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioControlIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_ScipioControlIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioControlIncludes* pvalue)
{
   ...
   rtdiag ("asn1PD_ScipioControlIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioControlIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioControlIncludes::Decode ()
{
   return asn1PD_ScipioControlIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioControlExports::ASN1C_ScipioControlExports (
...
EXTERN int asn1PE_ScipioControlExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_ScipioControlExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioControlExports: end\n");
   return (stat);
}

int ASN1C_ScipioControlExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioControlExports (mpContext->GetPtr());
   return stat;
}
...
EXTERN int asn1PD_ScipioControlExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_ScipioControlExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioControlExports: end\n");

   return (stat);
}

int ASN1C_ScipioControlExports::Decode ()
{
   return asn1PD_ScipioControlExports (mpContext->GetPtr());
}
