...
void asn1Print_ContaminationState (ASN1ConstCharPtr name, ASN1T_ContaminationState* pvalue)
{
   char namebuf[512];

   sprintf (namebuf, "%s.percentage", name);
   asn1Print_Percentage (namebuf, &pvalue->percentage);
...
void ASN1C_ContaminationState::Print (ASN1ConstCharPtr name)

{
   asn1Print_ContaminationState (name, &msgData);
}
...
void asn1Print_MsgUnitAttributes (ASN1ConstCharPtr name, ASN1T_MsgUnitAttributes* pvalue)
{
   ...
   printf ("%s.m.altitudePresent = %d\n", name, (int)pvalue->m.altitudePresent);
   ...
   if (pvalue->m.altitudePresent) {
      ...
      asn1Print_Height (namebuf, &pvalue->altitude);
   }
   ...
   if (pvalue->m.etat_contaminationPresent) {
      ...
      asn1Print_ContaminationState (namebuf, &pvalue->etat_contamination);
   }
...
void asn1Print_MsgUnitEnvironmentType (ASN1ConstCharPtr name, ASN1T_MsgUnitEnvironmentType* pvalue)
{
   char namebuf[512];
   ...
   sprintf (namebuf, "%s.area", name);
   rtPrintInteger (namebuf, pvalue->area);

   sprintf (namebuf, "%s.left", name);
   rtPrintInteger (namebuf, pvalue->left);

   sprintf (namebuf, "%s.right", name);
   rtPrintInteger (namebuf, pvalue->right);

   sprintf (namebuf, "%s.linear", name);
   rtPrintInteger (namebuf, pvalue->linear);

}

void ASN1C_MsgUnitEnvironmentType::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgUnitEnvironmentType (name, &msgData);
}
...
void asn1Print__SeqOfHeading (ASN1ConstCharPtr name, ASN1T__SeqOfHeading* pvalue)
{
   char namebuf[512];
   ...
   for (xx1 = 0; xx1 < pvalue->n; xx1++) {
      sprintf (namebuf, "%s.elem[%d]", name, xx1);
      asn1Print_Heading (namebuf, &pvalue->elem[xx1]);
   }
   }

}

void ASN1C__SeqOfHeading::Print (ASN1ConstCharPtr name)

{
   asn1Print__SeqOfHeading (name, &msgData);
}

void asn1Print_VisionCone (ASN1ConstCharPtr name, ASN1T_VisionCone* pvalue)
{
   char namebuf[512];
   ...
   sprintf (namebuf, "%s.sensor", name);
   rtPrintCharStr (namebuf, pvalue->sensor);

   sprintf (namebuf, "%s.directions", name);
   asn1Print__SeqOfHeading (namebuf, &pvalue->directions);

}

void ASN1C_VisionCone::Print (ASN1ConstCharPtr name)

{
   asn1Print_VisionCone (name, &msgData);
}

void asn1Print__SeqOfVisionCone (ASN1ConstCharPtr name, ASN1T__SeqOfVisionCone* pvalue)
{
   char namebuf[512];
   ...
   for (xx1 = 0; xx1 < pvalue->n; xx1++) {
      sprintf (namebuf, "%s.elem[%d]", name, xx1);
      asn1Print_VisionCone (namebuf, &pvalue->elem[xx1]);
   }
   }

}

void ASN1C__SeqOfVisionCone::Print (ASN1ConstCharPtr name)

{
   asn1Print__SeqOfVisionCone (name, &msgData);
}

void asn1Print_MsgUnitVisionCones (ASN1ConstCharPtr name, ASN1T_MsgUnitVisionCones* pvalue)
{
   char namebuf[512];
   ...
   sprintf (namebuf, "%s.cones", name);
   asn1Print__SeqOfVisionCone (namebuf, &pvalue->cones);

   sprintf (namebuf, "%s.elongation", name);
   rtPrintReal (namebuf, pvalue->elongation);

}

void ASN1C_MsgUnitVisionCones::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgUnitVisionCones (name, &msgData);
}

void asn1Print_MsgUnitDetection (ASN1ConstCharPtr name, ASN1T_MsgUnitDetection* pvalue)
{
   char namebuf[512];
   ...
   sprintf (namebuf, "%s.detected_unit_oid", name);
   asn1Print_Unit (namebuf, &pvalue->detected_unit_oid);

   sprintf (namebuf, "%s.current_visibility", name);
   asn1Print_EnumUnitVisibility (namebuf, &pvalue->current_visibility);

   sprintf (namebuf, "%s.max_visibility", name);
   asn1Print_EnumUnitVisibility (namebuf, &pvalue->max_visibility);

}

void ASN1C_MsgUnitDetection::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgUnitDetection (name, &msgData);
}

void asn1Print_MsgObjectDetection (ASN1ConstCharPtr name, ASN1T_MsgObjectDetection* pvalue)
{
   char namebuf[512];
   ...
   sprintf (namebuf, "%s.visibility", name);
   asn1Print_EnumUnitVisibility (namebuf, &pvalue->visibility);

}

void ASN1C_MsgObjectDetection::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgObjectDetection (name, &msgData);
}

void asn1Print_MsgUrbanDetection (ASN1ConstCharPtr name, ASN1T_MsgUrbanDetection* pvalue)
{
   char namebuf[512];
   ...
   sprintf (namebuf, "%s.urban_oid", name);
   asn1Print_OID (namebuf, &pvalue->urban_oid);
...
void ASN1C_MsgUrbanDetection::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgUrbanDetection (name, &msgData);
}

void asn1Print_MsgPopulationConcentrationDetection (ASN1ConstCharPtr name, ASN1T_MsgPopulationConcentrationDetection* pvalue)
{
   char namebuf[512];
   ...
   sprintf (namebuf, "%s.population_oid", name);
   asn1Print_OID (namebuf, &pvalue->population_oid);

   sprintf (namebuf, "%s.concentration_oid", name);
   asn1Print_OID (namebuf, &pvalue->concentration_oid);
...
void ASN1C_MsgPopulationConcentrationDetection::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgPopulationConcentrationDetection (name, &msgData);
}

void asn1Print_MsgPopulationFlowDetection (ASN1ConstCharPtr name, ASN1T_MsgPopulationFlowDetection* pvalue)
{
   char namebuf[512];
   ...
   sprintf (namebuf, "%s.flow_oid", name);
   asn1Print_OID (namebuf, &pvalue->flow_oid);

   sprintf (namebuf, "%s.visible_flow", name);
   asn1Print_Path (namebuf, &pvalue->visible_flow);

}

void ASN1C_MsgPopulationFlowDetection::Print (ASN1ConstCharPtr name)
