/* This file was generated by ASN1C V5.31 on 18-Oct-2007 */
...
void asn1Print_MsgAutomatChangeSuperiorAck_oid_superior (ASN1ConstCharPtr name, ASN1T_MsgAutomatChangeSuperiorAck_oid_superior* pvalue)
{
   char namebuf[512];
...
void ASN1C_MsgAutomatChangeSuperiorAck_oid_superior::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgAutomatChangeSuperiorAck_oid_superior (name, &msgData);
}
...
void asn1Print_MsgAutomatChangeSuperiorAck (ASN1ConstCharPtr name, ASN1T_MsgAutomatChangeSuperiorAck* pvalue)
{
   ...
   sprintf (namebuf, "%s.oid_superior", name);
   asn1Print_MsgAutomatChangeSuperiorAck_oid_superior (namebuf, &pvalue->oid_superior);
