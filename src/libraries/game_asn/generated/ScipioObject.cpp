...
/**************************************************************/
/*                                                            */
/*  ScipioObjectIncludes                                      */
/*                                                            */
/**************************************************************/

ASN1C_ScipioObjectIncludes::ASN1C_ScipioObjectIncludes (
   ASN1MessageBuffer& msgBuf, ASN1T_ScipioObjectIncludes& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_ScipioObjectIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioObjectIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioObjectIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioObjectIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioObjectIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioObjectIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_ScipioObjectIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioObjectIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioObjectIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioObjectIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioObjectIncludes::Decode ()
{
   return asn1PD_ScipioObjectIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioObjectExports::ASN1C_ScipioObjectExports (
   ASN1MessageBuffer& msgBuf) :
   ASN1CType(msgBuf)
{}

EXTERN int asn1PE_ScipioObjectExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioObjectExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioObjectExports: end\n");
   return (stat);
}

int ASN1C_ScipioObjectExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioObjectExports (mpContext->GetPtr());
   return stat;
}

EXTERN int asn1PD_ScipioObjectExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioObjectExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioObjectExports: end\n");

   return (stat);
}

int ASN1C_ScipioObjectExports::Decode ()
{
   return asn1PD_ScipioObjectExports (mpContext->GetPtr());
}
