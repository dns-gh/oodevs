...
void asn1Print_ScipioPopulationKnowledgeIncludes (ASN1ConstCharPtr name, ASN1T_ScipioPopulationKnowledgeIncludes* pvalue)
{
   char namebuf[512];
...
void ASN1C_ScipioPopulationKnowledgeIncludes::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioPopulationKnowledgeIncludes (name, &msgData);
}

void asn1Print_ScipioPopulationKnowledgeExports (ASN1ConstCharPtr name)
{
}

void ASN1C_ScipioPopulationKnowledgeExports::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioPopulationKnowledgeExports (name);
}
