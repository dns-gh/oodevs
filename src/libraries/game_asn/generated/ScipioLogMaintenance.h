...
/**************************************************************/
/*                                                            */
/*  ScipioLogMaintenanceIncludes                              */
/*                                                            */
/**************************************************************/

typedef struct EXTERN ASN1T_ScipioLogMaintenanceIncludes {
} ASN1T_ScipioLogMaintenanceIncludes;

class EXTERN ASN1C_ScipioLogMaintenanceIncludes : public ASN1CType {
public:
   ASN1T_ScipioLogMaintenanceIncludes& msgData;
   ASN1C_ScipioLogMaintenanceIncludes (
      ASN1MessageBuffer& msgBuf, ASN1T_ScipioLogMaintenanceIncludes& data);
   int Encode ();
   int Decode ();
   void Print (ASN1ConstCharPtr name);
} ;

EXTERN int asn1PE_ScipioLogMaintenanceIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioLogMaintenanceIncludes* pvalue);
EXTERN int asn1PD_ScipioLogMaintenanceIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioLogMaintenanceIncludes* pvalue);

EXTERN void asn1Print_ScipioLogMaintenanceIncludes (ASN1ConstCharPtr name, ASN1T_ScipioLogMaintenanceIncludes* pvalue);

/**************************************************************/
/*                                                            */
/*  ScipioLogMaintenanceExports                               */
/*                                                            */
/**************************************************************/

class EXTERN ASN1C_ScipioLogMaintenanceExports : public ASN1CType {
public:
   ASN1C_ScipioLogMaintenanceExports (
...
EXTERN int asn1PE_ScipioLogMaintenanceExports (ASN1CTXT* ctxt_p);
EXTERN int asn1PD_ScipioLogMaintenanceExports (ASN1CTXT* ctxt_p);

EXTERN void asn1Print_ScipioLogMaintenanceExports (ASN1ConstCharPtr name);
