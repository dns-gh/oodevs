...
typedef ASN1INT  ASN1T_MsgControlBeginTick;
...
typedef struct EXTERN ASN1T_MsgControlInformation {
   ...
   ASN1T_EnumSimulationState  etat;
...
typedef struct EXTERN ASN1T_MeteoAttributes {
   ASN1INT   temperature;
   ASN1T_Speed  vitesse_vent;
   ASN1T_Heading  direction_vent;
   ASN1T_Elevation  plancher_couverture_nuageuse;
   ASN1T_Elevation  plafond_couverture_nuageuse;
   ASN1T_Percentage  densite_moyenne_couverture_nuageuse;
...
typedef struct EXTERN ASN1T_MsgControlGlobalMeteo {
   ASN1T_MeteoAttributes  attributs;
...
#define T_MsgControlLocalMeteo_meteo_attributs 1
#define T_MsgControlLocalMeteo_meteo_globale 2
