...
typedef struct EXTERN ASN1T_ScipioLogRavitaillementIncludes {
} ASN1T_ScipioLogRavitaillementIncludes;

class EXTERN ASN1C_ScipioLogRavitaillementIncludes : public ASN1CType {
public:
   ASN1T_ScipioLogRavitaillementIncludes& msgData;
   ASN1C_ScipioLogRavitaillementIncludes (
...
EXTERN void asn1Print_ScipioLogRavitaillementIncludes (ASN1ConstCharPtr name, ASN1T_ScipioLogRavitaillementIncludes* pvalue);
...
class EXTERN ASN1C_ScipioLogRavitaillementExports : public ASN1CType {
public:
   ASN1C_ScipioLogRavitaillementExports (
...
EXTERN void asn1Print_ScipioLogRavitaillementExports (ASN1ConstCharPtr name);
