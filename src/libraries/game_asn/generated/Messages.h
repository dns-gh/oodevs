 ...
 * (http://www.obj-sys.com).  Version: 5.31, Date: 27-Aug-2007.
 */
#ifndef MESSAGES_H
#define MESSAGES_H
...
#define T_MsgsSimToClient_msg_msg_folk_graph_edge_update 116
...
typedef struct EXTERN ASN1T_MsgsSimToClient_msg {
   ...
   union {
      ...
      /* t = 116 */
      ASN1T_MsgFolkGraphEdgeUpdate *msg_folk_graph_edge_update;
   } u;
