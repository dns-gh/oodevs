...
#define T_MsgsMiddleToClient_msg_msg_control_replay_information 1
#define T_MsgsMiddleToClient_msg_msg_control_skip_to_tick_ack 2
...
#define T_MsgsClientToMiddle_msg_msg_control_skip_to_tick 1
