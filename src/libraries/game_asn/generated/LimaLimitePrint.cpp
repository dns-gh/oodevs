/* This file was generated by ASN1C V5.31 on 12-Oct-2007 */
...
void asn1Print_EnumLimaType (ASN1ConstCharPtr name, ASN1T_EnumLimaType* pvalue)
{
   printf ("%s = ", name);
   switch (*pvalue) {
...
void ASN1C_EnumLimaType::Print (ASN1ConstCharPtr name)

{
   asn1Print_EnumLimaType (name, &msgData);
}
...
void asn1Print__SeqOfEnumLimaType (ASN1ConstCharPtr name, ASN1T__SeqOfEnumLimaType* pvalue)
{
   char namebuf[512];
   ...
   for (xx1 = 0; xx1 < pvalue->n; xx1++) {
      ...
      asn1Print_EnumLimaType (namebuf, &pvalue->elem[xx1]);
   }
   }

}

void ASN1C__SeqOfEnumLimaType::Print (ASN1ConstCharPtr name)

{
   asn1Print__SeqOfEnumLimaType (name, &msgData);
}
...
void asn1Print_LimaOrder (ASN1ConstCharPtr name, ASN1T_LimaOrder* pvalue)
{
   ...
   asn1Print__SeqOfEnumLimaType (namebuf, &pvalue->fonctions);
...
void asn1Print_TacticalLine (ASN1ConstCharPtr name, ASN1T_TacticalLine* pvalue)
{
   ...
   sprintf (namebuf, "%s.geometry", name);
   asn1Print_Line (namebuf, &pvalue->geometry);
