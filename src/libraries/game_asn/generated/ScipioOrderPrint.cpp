...
void asn1Print_ScipioOrderIncludes (ASN1ConstCharPtr name, ASN1T_ScipioOrderIncludes* pvalue)
{
   char namebuf[512];
...
void ASN1C_ScipioOrderIncludes::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioOrderIncludes (name, &msgData);
}

void asn1Print_ScipioOrderExports (ASN1ConstCharPtr name)
{
}

void ASN1C_ScipioOrderExports::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioOrderExports (name);
}
