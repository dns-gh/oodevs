...
struct EXTERN EnumTypeObstacle {
   enum Root {
      preliminaire = 0,
      de_manoeuvre = 1
   } ;
...
typedef EnumTypeObstacle::Root ASN1T_EnumTypeObstacle;

class EXTERN ASN1C_EnumTypeObstacle : public ASN1CType {
public:
   ASN1T_EnumTypeObstacle& msgData;
   ASN1C_EnumTypeObstacle (
...
EXTERN void asn1Print_EnumTypeObstacle (ASN1ConstCharPtr name, ASN1T_EnumTypeObstacle* pvalue);
...
typedef struct EXTERN ASN1T_AttrObjectZoneMineeLineaire {
   ASN1REAL  densite;
   ASN1INT   delai_activite_mines;

   ASN1T_AttrObjectZoneMineeLineaire () {
      densite = 0;
      delai_activite_mines = 0;
   }
} ASN1T_AttrObjectZoneMineeLineaire;

class EXTERN ASN1C_AttrObjectZoneMineeLineaire : public ASN1CType {
public:
   ASN1T_AttrObjectZoneMineeLineaire& msgData;
   ASN1C_AttrObjectZoneMineeLineaire (
...
EXTERN void asn1Print_AttrObjectZoneMineeLineaire (ASN1ConstCharPtr name, ASN1T_AttrObjectZoneMineeLineaire* pvalue);
...
typedef struct EXTERN ASN1T_AttrObjectZoneMineeParDispersion {
   ASN1REAL  densite;
   ASN1INT   delai_activite_mines;

   ASN1T_AttrObjectZoneMineeParDispersion () {
      densite = 0;
      delai_activite_mines = 0;
   }
} ASN1T_AttrObjectZoneMineeParDispersion;

class EXTERN ASN1C_AttrObjectZoneMineeParDispersion : public ASN1CType {
public:
   ASN1T_AttrObjectZoneMineeParDispersion& msgData;
   ASN1C_AttrObjectZoneMineeParDispersion (
...
EXTERN void asn1Print_AttrObjectZoneMineeParDispersion (ASN1ConstCharPtr name, ASN1T_AttrObjectZoneMineeParDispersion* pvalue);
...
typedef struct EXTERN ASN1T_AttrObjectBouchonMines {
   ASN1INT   delai_activite_mines;

   ASN1T_AttrObjectBouchonMines () {
      delai_activite_mines = 0;
   }
} ASN1T_AttrObjectBouchonMines;

class EXTERN ASN1C_AttrObjectBouchonMines : public ASN1CType {
public:
   ASN1T_AttrObjectBouchonMines& msgData;
   ASN1C_AttrObjectBouchonMines (
...
EXTERN void asn1Print_AttrObjectBouchonMines (ASN1ConstCharPtr name, ASN1T_AttrObjectBouchonMines* pvalue);
...
#define T_AttrObjectSpecific_zone_minee_lineaire 8
#define T_AttrObjectSpecific_zone_minee_par_dispersion 9
#define T_AttrObjectSpecific_bouchon_mines 10
...
typedef struct EXTERN ASN1T_AttrObjectSpecific {
   ...
   union {
      ...
      /* t = 8 */
      ASN1T_AttrObjectZoneMineeLineaire *zone_minee_lineaire;
      /* t = 9 */
      ASN1T_AttrObjectZoneMineeParDispersion *zone_minee_par_dispersion;
      /* t = 10 */
      ASN1T_AttrObjectBouchonMines *bouchon_mines;
   } u;
