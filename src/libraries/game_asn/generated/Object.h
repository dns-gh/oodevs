...
#define T_ObjectAttributesSpecific_site_franchissement 1
#define T_ObjectAttributesSpecific_nuage_nbc 2
#define T_ObjectAttributesSpecific_rota 3
#define T_ObjectAttributesSpecific_zone_nbc 4
#define T_ObjectAttributesSpecific_itineraire_logistique 5
#define T_ObjectAttributesSpecific_camp_prisonniers 6
#define T_ObjectAttributesSpecific_camp_refugies 7
#define T_ObjectAttributesSpecific_zone_minee_lineaire 8
#define T_ObjectAttributesSpecific_zone_minee_par_dispersion 9
#define T_ObjectAttributesSpecific_bouchon_mines 10

typedef struct EXTERN ASN1T_ObjectAttributesSpecific {
   int t;
   union {
      /* t = 1 */
      ASN1T_ObjectAttributesCrossingSite *site_franchissement;
      /* t = 2 */
      ASN1T_ObjectAttributesNbcCloud *nuage_nbc;
      /* t = 3 */
      ASN1T_ObjectAttributesRota *rota;
      /* t = 4 */
      ASN1T_ObjectAttributesNbcZone *zone_nbc;
      /* t = 5 */
      ASN1T_ObjectAttributesLogisticRoute *itineraire_logistique;
      /* t = 6 */
      ASN1T_ObjectAttributesPrisonerCamp *camp_prisonniers;
      /* t = 7 */
      ASN1T_ObjectAttributesRefugeeCamp *camp_refugies;
      /* t = 8 */
      ASN1T_ObjectAttributesLinearMineArea *zone_minee_lineaire;
      /* t = 9 */
      ASN1T_ObjectAttributesDispersedMineArea *zone_minee_par_dispersion;
      /* t = 10 */
      ASN1T_ObjectAttributesMineJam *bouchon_mines;
   } u;
