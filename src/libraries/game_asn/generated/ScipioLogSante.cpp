...
/**************************************************************/
/*                                                            */
/*  ScipioLogSanteIncludes                                    */
/*                                                            */
/**************************************************************/

ASN1C_ScipioLogSanteIncludes::ASN1C_ScipioLogSanteIncludes (
   ASN1MessageBuffer& msgBuf, ASN1T_ScipioLogSanteIncludes& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_ScipioLogSanteIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioLogSanteIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioLogSanteIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioLogSanteIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioLogSanteIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioLogSanteIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_ScipioLogSanteIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioLogSanteIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioLogSanteIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioLogSanteIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioLogSanteIncludes::Decode ()
{
   return asn1PD_ScipioLogSanteIncludes (mpContext->GetPtr(), &msgData);
}

/**************************************************************/
/*                                                            */
/*  ScipioLogSanteExports                                     */
/*                                                            */
/**************************************************************/

ASN1C_ScipioLogSanteExports::ASN1C_ScipioLogSanteExports (
   ASN1MessageBuffer& msgBuf) :
   ASN1CType(msgBuf)
{}

EXTERN int asn1PE_ScipioLogSanteExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioLogSanteExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioLogSanteExports: end\n");
   return (stat);
}

int ASN1C_ScipioLogSanteExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioLogSanteExports (mpContext->GetPtr());
   return stat;
}

EXTERN int asn1PD_ScipioLogSanteExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioLogSanteExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioLogSanteExports: end\n");

   return (stat);
}

int ASN1C_ScipioLogSanteExports::Decode ()
{
   return asn1PD_ScipioLogSanteExports (mpContext->GetPtr());
}
...
EXTERN int asn1PE_EnumLogSanteTraitementEtat (ASN1CTXT* ctxt_p, ASN1T_EnumLogSanteTraitementEtat value)
{
   ...
   switch (value) {
      ...
      case EnumLogSanteTraitementEtat::hospitalisation: ui = 14; break;
      case EnumLogSanteTraitementEtat::attente_disponibilite_ambulance_ramassage: ui = 15; break;
      case EnumLogSanteTraitementEtat::ambulance_ramassage_chargement: ui = 16; break;
      case EnumLogSanteTraitementEtat::attente_chargement_complet_ambulance_ramassage: ui = 17; break;
      case EnumLogSanteTraitementEtat::ambulance_ramassage_deplacement_aller: ui = 18; break;
      case EnumLogSanteTraitementEtat::ambulance_ramassage_dechargement: ui = 19; break;
      case EnumLogSanteTraitementEtat::termine: ui = 20; break;
...
EXTERN int asn1PD_EnumLogSanteTraitementEtat (ASN1CTXT* ctxt_p, ASN1T_EnumLogSanteTraitementEtat* pvalue)
{
   ...
   switch (ui) {
      ...
      case 14: *pvalue = EnumLogSanteTraitementEtat::hospitalisation; break;
      case 15: *pvalue = EnumLogSanteTraitementEtat::attente_disponibilite_ambulance_ramassage; break;
      case 16: *pvalue = EnumLogSanteTraitementEtat::ambulance_ramassage_chargement; break;
      case 17: *pvalue = EnumLogSanteTraitementEtat::attente_chargement_complet_ambulance_ramassage; break;
      case 18: *pvalue = EnumLogSanteTraitementEtat::ambulance_ramassage_deplacement_aller; break;
      case 19: *pvalue = EnumLogSanteTraitementEtat::ambulance_ramassage_dechargement; break;
      case 20: *pvalue = EnumLogSanteTraitementEtat::termine; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }
