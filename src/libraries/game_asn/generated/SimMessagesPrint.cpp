/* This file was generated by ASN1C V5.31 on 28-Dec-2009 */
...
void asn1Print_SimMessagesIncludes (ASN1ConstCharPtr name, ASN1T_SimMessagesIncludes* pvalue)
{
   ...
   sprintf (namebuf, "%s.urbanKnowledgeExports", name);
...
void asn1Print_MsgsSimToClient_msg (ASN1ConstCharPtr name, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   switch (pvalue->t) {
      ...
      case 17:
         sprintf (namebuf, "%s.u.msg_knowledge_group_change_superior_ack", name);
         asn1Print_MsgKnowledgeGroupChangeSuperiorAck (namebuf, pvalue->u.msg_knowledge_group_change_superior_ack);
         break;

      case 18:
         sprintf (namebuf, "%s.u.msg_knowledge_group_delete_ack", name);
         asn1Print_MsgKnowledgeGroupDeleteAck (namebuf, pvalue->u.msg_knowledge_group_delete_ack);
         break;

      case 19:
         sprintf (namebuf, "%s.u.msg_knowledge_group_set_type_ack", name);
         asn1Print_MsgKnowledgeGroupSetTypeAck (namebuf, pvalue->u.msg_knowledge_group_set_type_ack);
         break;

      case 20:
         sprintf (namebuf, "%s.u.msg_knowledge_group_creation_ack", name);
         asn1Print_MsgKnowledgeGroupCreationAck (namebuf, pvalue->u.msg_knowledge_group_creation_ack);
         break;
      ...
      case 71:
         sprintf (namebuf, "%s.u.msg_urban_detection", name);
         asn1Print_MsgUrbanDetection (namebuf, pvalue->u.msg_urban_detection);
         break;
      ...
      case 116:
         sprintf (namebuf, "%s.u.msg_urban_knowledge_creation", name);
         asn1Print_MsgUrbanKnowledgeCreation (namebuf, pvalue->u.msg_urban_knowledge_creation);
         break;

      case 117:
         sprintf (namebuf, "%s.u.msg_urban_knowledge_update", name);
         asn1Print_MsgUrbanKnowledgeUpdate (namebuf, pvalue->u.msg_urban_knowledge_update);
         break;

      case 118:
         sprintf (namebuf, "%s.u.msg_urban_knowledge_destruction", name);
         asn1Print_MsgUrbanKnowledgeDestruction (namebuf, pvalue->u.msg_urban_knowledge_destruction);
         break;

      case 119:
         sprintf (namebuf, "%s.u.msg_knowledge_group_update", name);
         asn1Print_MsgKnowledgeGroupUpdate (namebuf, pvalue->u.msg_knowledge_group_update);
         break;

      case 120:
         sprintf (namebuf, "%s.u.msg_knowledge_group_delete", name);
         asn1Print_MsgKnowledgeGroupDelete (namebuf, pvalue->u.msg_knowledge_group_delete);
         break;
...
void asn1Print_MsgsClientToSim_msg (ASN1ConstCharPtr name, ASN1T_MsgsClientToSim_msg* pvalue)
{
   ...
   switch (pvalue->t) {
      ...
      case 27:
         sprintf (namebuf, "%s.u.msg_knowledge_group_change_superior", name);
         asn1Print_MsgKnowledgeGroupChangeSuperior (namebuf, pvalue->u.msg_knowledge_group_change_superior);
         break;
      ...
      case 30:
         sprintf (namebuf, "%s.u.msg_knowledge_group_set_type", name);
         asn1Print_MsgKnowledgeGroupSetType (namebuf, pvalue->u.msg_knowledge_group_set_type);
         break;

      case 31:
         sprintf (namebuf, "%s.u.msg_knowledge_group_enable", name);
         asn1Print_MsgKnowledgeGroupEnable (namebuf, pvalue->u.msg_knowledge_group_enable);
         break;
