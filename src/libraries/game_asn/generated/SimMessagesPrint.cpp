...
void asn1Print_SimMessagesIncludes (ASN1ConstCharPtr name, ASN1T_SimMessagesIncludes* pvalue)
{
   ...
   sprintf (namebuf, "%s.infoMessageExports", name);
...
void asn1Print_MsgsSimToClient_msg (ASN1ConstCharPtr name, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   switch (pvalue->t) {
      ...
      case 110:
         sprintf (namebuf, "%s.u.msg_xmlia_text_message", name);
         asn1Print_MsgXmliaTextMessage (namebuf, pvalue->u.msg_xmlia_text_message);
         break;
