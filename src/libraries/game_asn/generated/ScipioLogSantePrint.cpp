...
void asn1Print_ScipioLogSanteIncludes (ASN1ConstCharPtr name, ASN1T_ScipioLogSanteIncludes* pvalue)
{
   char namebuf[512];
...
void ASN1C_ScipioLogSanteIncludes::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioLogSanteIncludes (name, &msgData);
}

void asn1Print_ScipioLogSanteExports (ASN1ConstCharPtr name)
{
}

void ASN1C_ScipioLogSanteExports::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioLogSanteExports (name);
}
