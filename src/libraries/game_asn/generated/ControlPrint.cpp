...
void asn1Print_EnumControlErrorCode (ASN1ConstCharPtr name, ASN1T_EnumControlErrorCode* pvalue)
{
   ...
   switch (*pvalue) {
      ...
      case 6: printf ("error_invalid_date_time\n"); break;
      default: printf ("???\n");
   }
}
...
void asn1Print_MsgControlInformation (ASN1ConstCharPtr name, ASN1T_MsgControlInformation* pvalue)
{
   ...
   sprintf (namebuf, "%s.initial_date_time", name);
   asn1Print_DateTime (namebuf, &pvalue->initial_date_time);
...
void asn1Print_MsgControlCheckPointSaveEnd (ASN1ConstCharPtr name, ASN1T_MsgControlCheckPointSaveEnd* pvalue)
{
   char namebuf[512];
...
{
   asn1Print_MsgControlCheckPointSaveEnd (name, &msgData);
}
...
void asn1Print_MsgControlDatetimeChange (ASN1ConstCharPtr name, ASN1T_MsgControlDatetimeChange* pvalue)
{
   char namebuf[512];
...
void ASN1C_MsgControlDatetimeChange::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgControlDatetimeChange (name, &msgData);
}

void asn1Print_MsgControlDatetimeChangeAck (ASN1ConstCharPtr name, ASN1T_MsgControlDatetimeChangeAck* pvalue)
{
   asn1Print_EnumControlErrorCode (name, pvalue);
}

void ASN1C_MsgControlDatetimeChangeAck::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgControlDatetimeChangeAck (name, &msgData);
}
