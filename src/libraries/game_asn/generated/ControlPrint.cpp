...
void asn1Print_MsgCtrlSkipToTick (ASN1ConstCharPtr name, ASN1T_MsgCtrlSkipToTick* pvalue)
{
   rtPrintInteger (name, *pvalue);
}

void ASN1C_MsgCtrlSkipToTick::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgCtrlSkipToTick (name, &msgData);
}

void asn1Print_MsgCtrlSkipToTickAck (ASN1ConstCharPtr name, ASN1T_MsgCtrlSkipToTickAck* pvalue)
{
   char namebuf[512];
...
void ASN1C_MsgCtrlSkipToTickAck::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgCtrlSkipToTickAck (name, &msgData);
}
...
void asn1Print_MsgCtrlReplayInfo (ASN1ConstCharPtr name, ASN1T_MsgCtrlReplayInfo* pvalue)
{
   char namebuf[512];
...
void ASN1C_MsgCtrlReplayInfo::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgCtrlReplayInfo (name, &msgData);
}
