...
EXTERN int asn1PE_PlannedWork (ASN1CTXT* ctxt_p, ASN1T_PlannedWork* pvalue)
{
   ...
   stat = pe_bit (ctxt_p, (ASN1BOOL)(pvalue->type_obstacle != EnumObstacleType::preliminaire));
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   if (pvalue->type_obstacle != EnumObstacleType::preliminaire) {
...
EXTERN int asn1PD_PlannedWork (ASN1CTXT* ctxt_p, ASN1T_PlannedWork* pvalue)
{
   ...
   if (type_obstaclePresent) {
      ...
      pvalue->type_obstacle = EnumObstacleType::preliminaire;
   }
