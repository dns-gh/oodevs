 ...
 * (http://www.obj-sys.com).  Version: 5.31, Date: 22-May-2007.
 */
#include "Order.h"
...
EXTERN int asn1PE_MissionGenObject (ASN1CTXT* ctxt_p, ASN1T_MissionGenObject* pvalue)
{
   ...
   stat = pe_bit (ctxt_p, (ASN1BOOL)(pvalue->type_obstacle != EnumTypeObstacle::preliminaire));
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   if (pvalue->type_obstacle != EnumTypeObstacle::preliminaire) {
      PU_PUSHNAME (ctxt_p, "type_obstacle");

      stat = asn1PE_EnumTypeObstacle (ctxt_p, pvalue->type_obstacle);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }
...
EXTERN int asn1PD_MissionGenObject (ASN1CTXT* ctxt_p, ASN1T_MissionGenObject* pvalue)
{
   ...
   if (type_obstaclePresent) {
      ...
      stat = asn1PD_EnumTypeObstacle (ctxt_p, &pvalue->type_obstacle);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

      PU_POPNAME (ctxt_p);
   }
   else {
      pvalue->type_obstacle = EnumTypeObstacle::preliminaire;
   }
