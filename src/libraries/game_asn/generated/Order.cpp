...
EXTERN int asn1PE_EnumOrderState (ASN1CTXT* ctxt_p, ASN1T_EnumOrderState value)
{
   ...
   switch (value) {
      ...
      case EnumOrderState::stopped: ui = 1; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }
...
EXTERN int asn1PD_EnumOrderState (ASN1CTXT* ctxt_p, ASN1T_EnumOrderState* pvalue)
{
   ...
   switch (ui) {
      ...
      case 1: *pvalue = EnumOrderState::stopped; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }
...
EXTERN int asn1PE_MissionGenObject (ASN1CTXT* ctxt_p, ASN1T_MissionGenObject* pvalue)
{
   ...
   PU_PUSHNAME (ctxt_p, "oid_planifie");

   stat = asn1PE_OID (ctxt_p, pvalue->oid_planifie);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MissionGenObject (ASN1CTXT* ctxt_p, ASN1T_MissionGenObject* pvalue)
{
   ...
   stat = asn1PD_OID (ctxt_p, &pvalue->oid_planifie);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
ASN1C_MsgPopulationOrderManagement::ASN1C_MsgPopulationOrderManagement (
...
EXTERN int asn1PE_MsgPopulationOrderManagement (ASN1CTXT* ctxt_p, ASN1T_MsgPopulationOrderManagement* pvalue)
{
   ...
   rtdiag ("asn1PE_MsgPopulationOrderManagement: start\n");
   ...
   rtdiag ("asn1PE_MsgPopulationOrderManagement: end\n");
   return (stat);
}

int ASN1C_MsgPopulationOrderManagement::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgPopulationOrderManagement (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_MsgPopulationOrderManagement (ASN1CTXT* ctxt_p, ASN1T_MsgPopulationOrderManagement* pvalue)
{
   ...
   rtdiag ("asn1PD_MsgPopulationOrderManagement: start\n");
   ...
   rtdiag ("asn1PD_MsgPopulationOrderManagement: end\n");

   return (stat);
}

int ASN1C_MsgPopulationOrderManagement::Decode ()
{
   return asn1PD_MsgPopulationOrderManagement (mpContext->GetPtr(), &msgData);
}
