...
EXTERN int asn1PE_OrderContext (ASN1CTXT* ctxt_p, ASN1T_OrderContext* pvalue)
{
   ...
   pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.limite_gauchePresent);

   pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.limite_droitePresent);
   ...
   /* encode intelligences */

   stat = asn1PE_IntelligenceList (ctxt_p, &pvalue->intelligences);
   if (stat != ASN_OK) return stat;
...
EXTERN int asn1PD_OrderContext (ASN1CTXT* ctxt_p, ASN1T_OrderContext* pvalue)
{
   ...
   pvalue->m.limite_gauchePresent = optbit;

   pd_bit (ctxt_p, &optbit);
   pvalue->m.limite_droitePresent = optbit;
   ...
   /* decode intelligences */

   stat = asn1PD_IntelligenceList (ctxt_p, &pvalue->intelligences);
   if (stat != ASN_OK) return stat;
...
EXTERN int asn1PE_PlannedWork (ASN1CTXT* ctxt_p, ASN1T_PlannedWork* pvalue)
{
   ...
   pe_bit (ctxt_p, (ASN1BOOL)(pvalue->type_obstacle != EnumObstacleType::initial));
