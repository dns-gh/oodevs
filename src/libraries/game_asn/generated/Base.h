...
typedef struct EXTERN ASN1T_CoordUTMList {
   ASN1UINT n;
   ASN1T_CoordUTM *elem;
} ASN1T_CoordUTMList;

class EXTERN ASN1C_CoordUTMList : public ASN1CType {
public:
   ASN1T_CoordUTMList& msgData;
   ASN1C_CoordUTMList (
...
EXTERN void asn1Print_CoordUTMList (ASN1ConstCharPtr name, ASN1T_CoordUTMList* pvalue);
...
typedef ASN1INT  ASN1T_DateTime;
