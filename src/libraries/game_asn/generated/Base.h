...
typedef struct EXTERN ASN1T_ColorRGBA {
   ASN1INT   red;
   ASN1INT   green;
   ASN1INT   blue;
   ASN1REAL  alpha;
...
class EXTERN ASN1C_ColorRGBA : public ASN1CType {
public:
   ASN1T_ColorRGBA& msgData;
   ASN1C_ColorRGBA (
...
EXTERN void asn1Print_ColorRGBA (ASN1ConstCharPtr name, ASN1T_ColorRGBA* pvalue);
