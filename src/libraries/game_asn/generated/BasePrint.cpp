...
void asn1Print_ColorRGBA (ASN1ConstCharPtr name, ASN1T_ColorRGBA* pvalue)
{
   char namebuf[512];

   sprintf (namebuf, "%s.red", name);
   rtPrintInteger (namebuf, pvalue->red);

   sprintf (namebuf, "%s.green", name);
   rtPrintInteger (namebuf, pvalue->green);

   sprintf (namebuf, "%s.blue", name);
   rtPrintInteger (namebuf, pvalue->blue);

   sprintf (namebuf, "%s.alpha", name);
   rtPrintReal (namebuf, pvalue->alpha);

}

void ASN1C_ColorRGBA::Print (ASN1ConstCharPtr name)

{
   asn1Print_ColorRGBA (name, &msgData);
}
...
void asn1Print_UrbanBlock (ASN1ConstCharPtr name, ASN1T_UrbanBlock* pvalue)
{
   asn1Print_OID (name, pvalue);
}

void ASN1C_UrbanBlock::Print (ASN1ConstCharPtr name)

{
   asn1Print_UrbanBlock (name, &msgData);
}
...
void asn1Print_UrbanKnowledge (ASN1ConstCharPtr name, ASN1T_UrbanKnowledge* pvalue)
{
   asn1Print_OID (name, pvalue);
}

void ASN1C_UrbanKnowledge::Print (ASN1ConstCharPtr name)

{
   asn1Print_UrbanKnowledge (name, &msgData);
}
...
void asn1Print_KnowledgeGroupType (ASN1ConstCharPtr name, ASN1T_KnowledgeGroupType* pvalue)
{
   rtPrintCharStr (name, *pvalue);
}

void ASN1C_KnowledgeGroupType::Print (ASN1ConstCharPtr name)

{
   asn1Print_KnowledgeGroupType (name, &msgData);
}
