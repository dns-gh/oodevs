...
ASN1C_ScipioAuthIncludes::ASN1C_ScipioAuthIncludes (
...
EXTERN int asn1PE_ScipioAuthIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioAuthIncludes* pvalue)
{
   ...
   rtdiag ("asn1PE_ScipioAuthIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioAuthIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioAuthIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioAuthIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_ScipioAuthIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioAuthIncludes* pvalue)
{
   ...
   rtdiag ("asn1PD_ScipioAuthIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioAuthIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioAuthIncludes::Decode ()
{
   return asn1PD_ScipioAuthIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioAuthExports::ASN1C_ScipioAuthExports (
...
EXTERN int asn1PE_ScipioAuthExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_ScipioAuthExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioAuthExports: end\n");
   return (stat);
}

int ASN1C_ScipioAuthExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioAuthExports (mpContext->GetPtr());
   return stat;
}
...
EXTERN int asn1PD_ScipioAuthExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_ScipioAuthExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioAuthExports: end\n");

   return (stat);
}

int ASN1C_ScipioAuthExports::Decode ()
{
   return asn1PD_ScipioAuthExports (mpContext->GetPtr());
}
