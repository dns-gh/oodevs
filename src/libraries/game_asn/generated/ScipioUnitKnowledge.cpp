...
/**************************************************************/
/*                                                            */
/*  ScipioUnitKnowledgeIncludes                               */
/*                                                            */
/**************************************************************/

ASN1C_ScipioUnitKnowledgeIncludes::ASN1C_ScipioUnitKnowledgeIncludes (
   ASN1MessageBuffer& msgBuf, ASN1T_ScipioUnitKnowledgeIncludes& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_ScipioUnitKnowledgeIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioUnitKnowledgeIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioUnitKnowledgeIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioUnitKnowledgeIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioUnitKnowledgeIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioUnitKnowledgeIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_ScipioUnitKnowledgeIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioUnitKnowledgeIncludes* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioUnitKnowledgeIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioUnitKnowledgeIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioUnitKnowledgeIncludes::Decode ()
{
   return asn1PD_ScipioUnitKnowledgeIncludes (mpContext->GetPtr(), &msgData);
}

/**************************************************************/
/*                                                            */
/*  ScipioUnitKnowledgeExports                                */
/*                                                            */
/**************************************************************/

ASN1C_ScipioUnitKnowledgeExports::ASN1C_ScipioUnitKnowledgeExports (
   ASN1MessageBuffer& msgBuf) :
   ASN1CType(msgBuf)
{}

EXTERN int asn1PE_ScipioUnitKnowledgeExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_ScipioUnitKnowledgeExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioUnitKnowledgeExports: end\n");
   return (stat);
}

int ASN1C_ScipioUnitKnowledgeExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioUnitKnowledgeExports (mpContext->GetPtr());
   return stat;
}

EXTERN int asn1PD_ScipioUnitKnowledgeExports (ASN1CTXT* ctxt_p)
{
   int stat = ASN_OK;

   rtdiag ("asn1PD_ScipioUnitKnowledgeExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioUnitKnowledgeExports: end\n");

   return (stat);
}

int ASN1C_ScipioUnitKnowledgeExports::Decode ()
{
   return asn1PD_ScipioUnitKnowledgeExports (mpContext->GetPtr());
}
