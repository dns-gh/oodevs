...
EXTERN int asn1PE_MsgControlToggleVisionCones (ASN1CTXT* ctxt_p, ASN1T_MsgControlToggleVisionCones value)
{
   ...
   rtdiag ("asn1PE_MsgControlToggleVisionCones: start\n");
   ...
   rtdiag ("asn1PE_MsgControlToggleVisionCones: end\n");
   return (stat);
}
...
EXTERN int asn1PD_MsgControlToggleVisionCones (ASN1CTXT* ctxt_p, ASN1T_MsgControlToggleVisionCones* pvalue)
{
   ...
   rtdiag ("asn1PD_MsgControlToggleVisionCones: start\n");
   ...
   rtdiag ("asn1PD_MsgControlToggleVisionCones: end\n");
...
EXTERN int asn1PE_MsgControlProfilingInformation (ASN1CTXT* ctxt_p, ASN1T_MsgControlProfilingInformation* pvalue)
{
   ...
   rtdiag ("asn1PE_MsgControlProfilingInformation: start\n");

   /* encode perception */

   PU_PUSHNAME (ctxt_p, "perception");

   stat = pe_Real (ctxt_p, pvalue->perception);if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode decision */

   PU_PUSHNAME (ctxt_p, "decision");

   stat = pe_Real (ctxt_p, pvalue->decision);if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
   ...
   stat = pe_Real (ctxt_p, pvalue->action);if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode main_loop */

   PU_PUSHNAME (ctxt_p, "main_loop");

   stat = pe_Real (ctxt_p, pvalue->main_loop);if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);


   rtdiag ("asn1PE_MsgControlProfilingInformation: end\n");
   return (stat);
}
...
EXTERN int asn1PD_MsgControlProfilingInformation (ASN1CTXT* ctxt_p, ASN1T_MsgControlProfilingInformation* pvalue)
{
   ...
   rtdiag ("asn1PD_MsgControlProfilingInformation: start\n");

   /* decode perception */

   PU_PUSHNAME (ctxt_p, "perception");

   stat = pd_Real (ctxt_p, &pvalue->perception);if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_Real (ctxt_p, &pvalue->decision);if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_Real (ctxt_p, &pvalue->action);if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_Real (ctxt_p, &pvalue->main_loop);if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);


   rtdiag ("asn1PD_MsgControlProfilingInformation: end\n");
