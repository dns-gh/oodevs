...
EXTERN int asn1PE_MsgControlInformation (ASN1CTXT* ctxt_p, ASN1T_MsgControlInformation* pvalue)
{
   ...
   stat = asn1PE_EnumSimulationState (ctxt_p, pvalue->etat);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MsgControlInformation (ASN1CTXT* ctxt_p, ASN1T_MsgControlInformation* pvalue)
{
   ...
   stat = asn1PD_EnumSimulationState (ctxt_p, &pvalue->etat);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PE_MeteoAttributes (ASN1CTXT* ctxt_p, ASN1T_MeteoAttributes* pvalue)
{
   ...
   stat = asn1PE_Speed (ctxt_p, pvalue->vitesse_vent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
   ...
   stat = asn1PE_Heading (ctxt_p, pvalue->direction_vent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
   ...
   stat = asn1PE_Elevation (ctxt_p, pvalue->plancher_couverture_nuageuse);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
   ...
   stat = asn1PE_Elevation (ctxt_p, pvalue->plafond_couverture_nuageuse);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
   ...
   stat = asn1PE_Percentage (ctxt_p, pvalue->densite_moyenne_couverture_nuageuse);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MeteoAttributes (ASN1CTXT* ctxt_p, ASN1T_MeteoAttributes* pvalue)
{
   ...
   stat = asn1PD_Speed (ctxt_p, &pvalue->vitesse_vent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = asn1PD_Heading (ctxt_p, &pvalue->direction_vent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = asn1PD_Elevation (ctxt_p, &pvalue->plancher_couverture_nuageuse);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = asn1PD_Elevation (ctxt_p, &pvalue->plafond_couverture_nuageuse);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = asn1PD_Percentage (ctxt_p, &pvalue->densite_moyenne_couverture_nuageuse);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PE_MsgControlGlobalMeteo (ASN1CTXT* ctxt_p, ASN1T_MsgControlGlobalMeteo* pvalue)
{
   ...
   stat = asn1PE_MeteoAttributes (ctxt_p, &pvalue->attributs);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MsgControlGlobalMeteo (ASN1CTXT* ctxt_p, ASN1T_MsgControlGlobalMeteo* pvalue)
{
   ...
   stat = asn1PD_MeteoAttributes (ctxt_p, &pvalue->attributs);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PE_MsgControlLocalMeteo_meteo (ASN1CTXT* ctxt_p, ASN1T_MsgControlLocalMeteo_meteo* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      case 1:
         ...
         stat = asn1PE_MeteoAttributes (ctxt_p, pvalue->u.attributs);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MsgControlLocalMeteo_meteo (ASN1CTXT* ctxt_p, ASN1T_MsgControlLocalMeteo_meteo* pvalue)
{
   ...
   switch (ui) {
      ...
      case 0:
         ...
         pvalue->u.attributs = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MeteoAttributes);
         if (pvalue->u.attributs == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_MeteoAttributes (ctxt_p, pvalue->u.attributs);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
