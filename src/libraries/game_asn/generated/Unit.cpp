...
ASN1C_ContaminationState::ASN1C_ContaminationState (
   ASN1MessageBuffer& msgBuf, ASN1T_ContaminationState& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_ContaminationState (ASN1CTXT* ctxt_p, ASN1T_ContaminationState* pvalue)
{
   int stat = ASN_OK;

   /* encode percentage */

   stat = asn1PE_Percentage (ctxt_p, pvalue->percentage);
   if (stat != ASN_OK) return stat;
...
int ASN1C_ContaminationState::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ContaminationState (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_ContaminationState (ASN1CTXT* ctxt_p, ASN1T_ContaminationState* pvalue)
{
   int stat = ASN_OK;

   /* decode percentage */

   stat = asn1PD_Percentage (ctxt_p, &pvalue->percentage);
   if (stat != ASN_OK) return stat;
...
int ASN1C_ContaminationState::Decode ()
{
   return asn1PD_ContaminationState (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_MsgUnitAttributes (ASN1CTXT* ctxt_p, ASN1T_MsgUnitAttributes* pvalue)
{
   ...
   pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.altitudePresent);
   ...
   if (pvalue->m.altitudePresent) {
      stat = asn1PE_Height (ctxt_p, pvalue->altitude);
      if (stat != ASN_OK) return stat;
   }
   ...
   if (pvalue->m.etat_contaminationPresent) {
      stat = asn1PE_ContaminationState (ctxt_p, &pvalue->etat_contamination);
      if (stat != ASN_OK) return stat;
   }
...
EXTERN int asn1PD_MsgUnitAttributes (ASN1CTXT* ctxt_p, ASN1T_MsgUnitAttributes* pvalue)
{
   ...
   pd_bit (ctxt_p, &optbit);
   pvalue->m.altitudePresent = optbit;
   ...
   if (pvalue->m.altitudePresent) {
      stat = asn1PD_Height (ctxt_p, &pvalue->altitude);
      if (stat != ASN_OK) return stat;
   }
   ...
   if (pvalue->m.etat_contaminationPresent) {
      stat = asn1PD_ContaminationState (ctxt_p, &pvalue->etat_contamination);
      if (stat != ASN_OK) return stat;
   }
...
EXTERN int asn1PE_VisionCone (ASN1CTXT* ctxt_p, ASN1T_VisionCone* pvalue)
{
   ...
   stat = asn1PE_CoordLatLong (ctxt_p, &pvalue->origin);
   if (stat != ASN_OK) return stat;
...
EXTERN int asn1PD_VisionCone (ASN1CTXT* ctxt_p, ASN1T_VisionCone* pvalue)
{
   ...
   stat = asn1PD_CoordLatLong (ctxt_p, &pvalue->origin);
   if (stat != ASN_OK) return stat;
...
ASN1C_MsgUrbanDetection::ASN1C_MsgUrbanDetection (
   ASN1MessageBuffer& msgBuf, ASN1T_MsgUrbanDetection& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_MsgUrbanDetection (ASN1CTXT* ctxt_p, ASN1T_MsgUrbanDetection* pvalue)
{
   int stat = ASN_OK;
   ...
   stat = asn1PE_OID (ctxt_p, pvalue->urban_oid);
   if (stat != ASN_OK) return stat;
...
int ASN1C_MsgUrbanDetection::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgUrbanDetection (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_MsgUrbanDetection (ASN1CTXT* ctxt_p, ASN1T_MsgUrbanDetection* pvalue)
{
   int stat = ASN_OK;
   ...
   stat = asn1PD_OID (ctxt_p, &pvalue->urban_oid);
   if (stat != ASN_OK) return stat;
...
int ASN1C_MsgUrbanDetection::Decode ()
{
   return asn1PD_MsgUrbanDetection (mpContext->GetPtr(), &msgData);
}
