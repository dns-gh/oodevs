...
EXTERN int asn1PE_MsgObjectKnowledgeCreation (ASN1CTXT* ctxt_p, ASN1T_MsgObjectKnowledgeCreation* pvalue)
{
   ...
   stat = asn1PE_ObjectKnowledge (ctxt_p, pvalue->oid_connaissance);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
   ...
   stat = asn1PE_Team (ctxt_p, pvalue->oid_camp_possesseur);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MsgObjectKnowledgeCreation (ASN1CTXT* ctxt_p, ASN1T_MsgObjectKnowledgeCreation* pvalue)
{
   ...
   stat = asn1PD_ObjectKnowledge (ctxt_p, &pvalue->oid_connaissance);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = asn1PD_Team (ctxt_p, &pvalue->oid_camp_possesseur);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
