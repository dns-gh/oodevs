...
EXTERN int asn1PE_MsgsPluginToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsPluginToClient_msg* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      case 2:
         stat = asn1PE_MsgPluginIntelligenceCreation (ctxt_p, pvalue->u.plugin_intelligence_creation);
         if (stat != ASN_OK) return stat;
         break;
...
EXTERN int asn1PD_MsgsPluginToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsPluginToClient_msg* pvalue)
{
   ...
   switch (ui) {
      ...
      /* plugin_intelligence_creation */
      case 1:
         pvalue->u.plugin_intelligence_creation = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgPluginIntelligenceCreation);

         stat = asn1PD_MsgPluginIntelligenceCreation (ctxt_p, pvalue->u.plugin_intelligence_creation);
         if (stat != ASN_OK) return stat;
