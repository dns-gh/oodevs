...
ASN1C_ScipioOrderIncludes::ASN1C_ScipioOrderIncludes (
...
EXTERN int asn1PE_ScipioOrderIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioOrderIncludes* pvalue)
{
   ...
   rtdiag ("asn1PE_ScipioOrderIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioOrderIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioOrderIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioOrderIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_ScipioOrderIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioOrderIncludes* pvalue)
{
   ...
   rtdiag ("asn1PD_ScipioOrderIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioOrderIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioOrderIncludes::Decode ()
{
   return asn1PD_ScipioOrderIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioOrderExports::ASN1C_ScipioOrderExports (
...
EXTERN int asn1PE_ScipioOrderExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_ScipioOrderExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioOrderExports: end\n");
   return (stat);
}

int ASN1C_ScipioOrderExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioOrderExports (mpContext->GetPtr());
   return stat;
}
...
EXTERN int asn1PD_ScipioOrderExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_ScipioOrderExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioOrderExports: end\n");

   return (stat);
}

int ASN1C_ScipioOrderExports::Decode ()
{
   return asn1PD_ScipioOrderExports (mpContext->GetPtr());
}
