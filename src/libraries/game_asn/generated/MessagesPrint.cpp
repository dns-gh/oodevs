/* This file was generated by ASN1C V5.31 on 27-Aug-2007 */
...
void asn1Print_MsgsSimToClient_msg (ASN1ConstCharPtr name, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   switch (pvalue->t) {
      ...
      case 116:
         sprintf (namebuf, "%s.u.msg_folk_graph_edge_update", name);
         asn1Print_MsgFolkGraphEdgeUpdate (namebuf, pvalue->u.msg_folk_graph_edge_update);
         break;
