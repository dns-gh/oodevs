...
EXTERN int asn1PE_ObjectAttributesCrossingSite (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributesCrossingSite* pvalue)
{
   ...
   PU_PUSHNAME (ctxt_p, "banks_require_fitting");
...
EXTERN int asn1PE_ObjectAttributesRota (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributesRota* pvalue)
{
   ...
   PU_PUSHNAME (ctxt_p, "danger_level");

   if ( (pvalue->danger_level >= 0 && pvalue->danger_level <= 10) ) {
...
EXTERN int asn1PE_ObjectAttributesLinearMineArea (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributesLinearMineArea* pvalue)
{
   ...
   PU_NEWFIELD (ctxt_p, "densityPresent");

   stat = pe_bit (ctxt_p, (ASN1BOOL)(pvalue->density != 0));
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   if (pvalue->density != 0) {
      PU_PUSHNAME (ctxt_p, "density");

      stat = pe_Real (ctxt_p, pvalue->density);if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }
...
EXTERN int asn1PD_ObjectAttributesLinearMineArea (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributesLinearMineArea* pvalue)
{
   ...
   if (densityPresent) {
      ...
      stat = pd_Real (ctxt_p, &pvalue->density);if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PE_ObjectAttributesSpecific (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributesSpecific* pvalue)
{
   ...
   switch (pvalue->t)
   {
      /* crossing_site */
      case 1:
         PU_PUSHNAME (ctxt_p, "u.crossing_site");
      ...
      /* nbc_cloud */
      case 2:
         PU_PUSHNAME (ctxt_p, "u.nbc_cloud");
      ...
      /* logistic_route */
      case 5:
         PU_PUSHNAME (ctxt_p, "u.logistic_route");
      ...
      /* prisoner_camp */
      case 6:
         PU_PUSHNAME (ctxt_p, "u.prisoner_camp");
      ...
      /* refugee_camp */
      case 7:
         PU_PUSHNAME (ctxt_p, "u.refugee_camp");
      ...
      /* linear_mine_area */
      case 8:
         PU_PUSHNAME (ctxt_p, "u.linear_mine_area");
      ...
      /* dispersed_mine_area */
      case 9:
         PU_PUSHNAME (ctxt_p, "u.dispersed_mine_area");
...
EXTERN int asn1PD_ObjectAttributesSpecific (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributesSpecific* pvalue)
{
   ...
   switch (ui) {
      ...
      case 0:
         ...
         if (pvalue->u.crossing_site == NULL)
      ...
      case 4:
         ...
         if (pvalue->u.logistic_route == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);
      ...
      case 5:
         ...
         if (pvalue->u.prisoner_camp == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);
      ...
      case 7:
         ...
         if (pvalue->u.linear_mine_area == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);
      ...
      case 8:
         ...
         if (pvalue->u.dispersed_mine_area == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);
