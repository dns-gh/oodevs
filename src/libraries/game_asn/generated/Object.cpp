...
ASN1C_ObjectAttributeNBCType::ASN1C_ObjectAttributeNBCType (
...
EXTERN int asn1PE_ObjectAttributeNBCType (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributeNBCType* pvalue)
{
   ...
   stat = asn1PE_OID (ctxt_p, pvalue->agent_id);
   if (stat != ASN_OK) return stat;

   /* encode concentration */

   stat = pe_UnconsInteger (ctxt_p, pvalue->concentration);
   if (stat != ASN_OK) return stat;

   /* encode source_life_duration */

   stat = pe_UnconsInteger (ctxt_p, pvalue->source_life_duration);
   if (stat != ASN_OK) return stat;

   return (stat);
}

int ASN1C_ObjectAttributeNBCType::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ObjectAttributeNBCType (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_ObjectAttributeNBCType (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributeNBCType* pvalue)
{
   ...
   stat = asn1PD_OID (ctxt_p, &pvalue->agent_id);
   if (stat != ASN_OK) return stat;

   /* decode concentration */

   stat = pd_UnconsInteger (ctxt_p, &pvalue->concentration);
   if (stat != ASN_OK) return stat;

   /* decode source_life_duration */

   stat = pd_UnconsInteger (ctxt_p, &pvalue->source_life_duration);
   if (stat != ASN_OK) return stat;
...
int ASN1C_ObjectAttributeNBCType::Decode ()
{
   return asn1PD_ObjectAttributeNBCType (mpContext->GetPtr(), &msgData);
}
...
ASN1C_StockResource::ASN1C_StockResource (
...
EXTERN int asn1PE_StockResource (ASN1CTXT* ctxt_p, ASN1T_StockResource* pvalue)
{
   ...
   pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.maxPresent);
   ...
   stat = pe_UnconsInteger (ctxt_p, pvalue->current);
   if (stat != ASN_OK) return stat;

   /* encode max */

   if (pvalue->m.maxPresent) {
      stat = pe_UnconsInteger (ctxt_p, pvalue->max);
      if (stat != ASN_OK) return stat;
   }
...
int ASN1C_StockResource::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_StockResource (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_StockResource (ASN1CTXT* ctxt_p, ASN1T_StockResource* pvalue)
{
   ...
   stat = pd_UnconsInteger (ctxt_p, &pvalue->current);
   if (stat != ASN_OK) return stat;

   /* decode max */

   if (pvalue->m.maxPresent) {
      stat = pd_UnconsInteger (ctxt_p, &pvalue->max);
      if (stat != ASN_OK) return stat;
   }
...
int ASN1C_StockResource::Decode ()
{
   return asn1PD_StockResource (mpContext->GetPtr(), &msgData);
}
...
ASN1C_StockResourceList::ASN1C_StockResourceList (
...
EXTERN int asn1PE_StockResourceList (ASN1CTXT* ctxt_p, ASN1T_StockResourceList* pvalue)
{
   ...
   for (xx1 = 0; xx1 < pvalue->n; xx1++) {
      stat = asn1PE_StockResource (ctxt_p, &pvalue->elem[xx1]);
      if (stat != ASN_OK) return stat;
   }
   return (stat);
}

int ASN1C_StockResourceList::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_StockResourceList (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_StockResourceList (ASN1CTXT* ctxt_p, ASN1T_StockResourceList* pvalue)
{
   ...
   ALLOC_ASN1ARRAY (ctxt_p, pvalue, ASN1T_StockResource);

   for (xx1 = 0; xx1 < pvalue->n; xx1++) {
      stat = asn1PD_StockResource (ctxt_p, &pvalue->elem[xx1]);
      if (stat != ASN_OK) return stat;
   }
...
int ASN1C_StockResourceList::Decode ()
{
   return asn1PD_StockResourceList (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ObjectAttributeStock::ASN1C_ObjectAttributeStock (
...
EXTERN int asn1PE_ObjectAttributeStock (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributeStock* pvalue)
{
   ...
   stat = asn1PE_StockResourceList (ctxt_p, &pvalue->resources);
   if (stat != ASN_OK) return stat;

   return (stat);
}

int ASN1C_ObjectAttributeStock::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ObjectAttributeStock (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_ObjectAttributeStock (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributeStock* pvalue)
{
   ...
   stat = asn1PD_StockResourceList (ctxt_p, &pvalue->resources);
   if (stat != ASN_OK) return stat;
...
int ASN1C_ObjectAttributeStock::Decode ()
{
   return asn1PD_ObjectAttributeStock (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_ObjectAttributes (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributes* pvalue)
{
   ...
   pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.nbc_agentPresent);

   pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.stockPresent);
   ...
   if (pvalue->m.nbc_agentPresent) {
      stat = asn1PE_ObjectAttributeNBCType (ctxt_p, &pvalue->nbc_agent);
      if (stat != ASN_OK) return stat;
   }
   ...
   if (pvalue->m.stockPresent) {
      stat = asn1PE_ObjectAttributeStock (ctxt_p, &pvalue->stock);
      if (stat != ASN_OK) return stat;
   }
...
EXTERN int asn1PD_ObjectAttributes (ASN1CTXT* ctxt_p, ASN1T_ObjectAttributes* pvalue)
{
   ...
   pd_bit (ctxt_p, &optbit);
   pvalue->m.nbc_agentPresent = optbit;

   pd_bit (ctxt_p, &optbit);
   pvalue->m.stockPresent = optbit;
   ...
   if (pvalue->m.nbc_agentPresent) {
      stat = asn1PD_ObjectAttributeNBCType (ctxt_p, &pvalue->nbc_agent);
      if (stat != ASN_OK) return stat;
   }
   ...
   if (pvalue->m.stockPresent) {
      stat = asn1PD_ObjectAttributeStock (ctxt_p, &pvalue->stock);
      if (stat != ASN_OK) return stat;
   }
