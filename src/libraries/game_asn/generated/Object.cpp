...
ASN1C_EnumTypeObstacle::ASN1C_EnumTypeObstacle (
   ASN1MessageBuffer& msgBuf, ASN1T_EnumTypeObstacle& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_EnumTypeObstacle (ASN1CTXT* ctxt_p, ASN1T_EnumTypeObstacle value)
{
   int stat = ASN_OK;
   ASN1UINT ui;

   rtdiag ("asn1PE_EnumTypeObstacle: start\n");

   switch (value) {
      case EnumTypeObstacle::preliminaire: ui = 0; break;
      case EnumTypeObstacle::de_manoeuvre: ui = 1; break;
   ...
   rtdiag ("asn1PE_EnumTypeObstacle: end\n");
   return (stat);
}

int ASN1C_EnumTypeObstacle::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_EnumTypeObstacle (mpContext->GetPtr(), msgData);
   return stat;
}

EXTERN int asn1PD_EnumTypeObstacle (ASN1CTXT* ctxt_p, ASN1T_EnumTypeObstacle* pvalue)
{
   int stat = ASN_OK;
   ASN1UINT ui;

   rtdiag ("asn1PD_EnumTypeObstacle: start\n");

   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 1);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   switch (ui) {
      case 0: *pvalue = EnumTypeObstacle::preliminaire; break;
      case 1: *pvalue = EnumTypeObstacle::de_manoeuvre; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }

   rtdiag ("asn1PD_EnumTypeObstacle: end\n");

   return (stat);
}

int ASN1C_EnumTypeObstacle::Decode ()
{
   return asn1PD_EnumTypeObstacle (mpContext->GetPtr(), &msgData);
}
...
/**************************************************************/
/*                                                            */
/*  AttrObjectZoneMineeLineaire                               */
/*                                                            */
/**************************************************************/

ASN1C_AttrObjectZoneMineeLineaire::ASN1C_AttrObjectZoneMineeLineaire (
   ASN1MessageBuffer& msgBuf, ASN1T_AttrObjectZoneMineeLineaire& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_AttrObjectZoneMineeLineaire (ASN1CTXT* ctxt_p, ASN1T_AttrObjectZoneMineeLineaire* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_AttrObjectZoneMineeLineaire: start\n");
   ...
   rtdiag ("asn1PE_AttrObjectZoneMineeLineaire: end\n");
   return (stat);
}

int ASN1C_AttrObjectZoneMineeLineaire::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_AttrObjectZoneMineeLineaire (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_AttrObjectZoneMineeLineaire (ASN1CTXT* ctxt_p, ASN1T_AttrObjectZoneMineeLineaire* pvalue)
{
   int stat = ASN_OK;
   ASN1BOOL optbit;
   ...
   rtdiag ("asn1PD_AttrObjectZoneMineeLineaire: start\n");
   ...
   rtdiag ("asn1PD_AttrObjectZoneMineeLineaire: end\n");

   return (stat);
}

int ASN1C_AttrObjectZoneMineeLineaire::Decode ()
{
   return asn1PD_AttrObjectZoneMineeLineaire (mpContext->GetPtr(), &msgData);
}

/**************************************************************/
/*                                                            */
/*  AttrObjectZoneMineeParDispersion                          */
/*                                                            */
/**************************************************************/

ASN1C_AttrObjectZoneMineeParDispersion::ASN1C_AttrObjectZoneMineeParDispersion (
   ASN1MessageBuffer& msgBuf, ASN1T_AttrObjectZoneMineeParDispersion& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_AttrObjectZoneMineeParDispersion (ASN1CTXT* ctxt_p, ASN1T_AttrObjectZoneMineeParDispersion* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_AttrObjectZoneMineeParDispersion: start\n");
   ...
   rtdiag ("asn1PE_AttrObjectZoneMineeParDispersion: end\n");
   return (stat);
}

int ASN1C_AttrObjectZoneMineeParDispersion::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_AttrObjectZoneMineeParDispersion (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_AttrObjectZoneMineeParDispersion (ASN1CTXT* ctxt_p, ASN1T_AttrObjectZoneMineeParDispersion* pvalue)
{
   int stat = ASN_OK;
   ASN1BOOL optbit;
   ASN1BOOL densitePresent;
   ...
   rtdiag ("asn1PD_AttrObjectZoneMineeParDispersion: start\n");
   ...
   rtdiag ("asn1PD_AttrObjectZoneMineeParDispersion: end\n");

   return (stat);
}

int ASN1C_AttrObjectZoneMineeParDispersion::Decode ()
{
   return asn1PD_AttrObjectZoneMineeParDispersion (mpContext->GetPtr(), &msgData);
}

/**************************************************************/
/*                                                            */
/*  AttrObjectBouchonMines                                    */
/*                                                            */
/**************************************************************/

ASN1C_AttrObjectBouchonMines::ASN1C_AttrObjectBouchonMines (
   ASN1MessageBuffer& msgBuf, ASN1T_AttrObjectBouchonMines& data) :
   ASN1CType(msgBuf), msgData(data)
{}

EXTERN int asn1PE_AttrObjectBouchonMines (ASN1CTXT* ctxt_p, ASN1T_AttrObjectBouchonMines* pvalue)
{
   int stat = ASN_OK;

   rtdiag ("asn1PE_AttrObjectBouchonMines: start\n");
   ...
   rtdiag ("asn1PE_AttrObjectBouchonMines: end\n");
   return (stat);
}

int ASN1C_AttrObjectBouchonMines::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_AttrObjectBouchonMines (mpContext->GetPtr(), &msgData);
   return stat;
}

EXTERN int asn1PD_AttrObjectBouchonMines (ASN1CTXT* ctxt_p, ASN1T_AttrObjectBouchonMines* pvalue)
{
   int stat = ASN_OK;
   ASN1BOOL optbit;
   ASN1BOOL delai_activite_minesPresent;

   rtdiag ("asn1PD_AttrObjectBouchonMines: start\n");
   ...
   rtdiag ("asn1PD_AttrObjectBouchonMines: end\n");

   return (stat);
}

int ASN1C_AttrObjectBouchonMines::Decode ()
{
   return asn1PD_AttrObjectBouchonMines (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_AttrObjectSpecific (ASN1CTXT* ctxt_p, ASN1T_AttrObjectSpecific* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      case 8:
         ...
         stat = asn1PE_AttrObjectZoneMineeLineaire (ctxt_p, pvalue->u.zone_minee_lineaire);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
      ...
      case 9:
         ...
         stat = asn1PE_AttrObjectZoneMineeParDispersion (ctxt_p, pvalue->u.zone_minee_par_dispersion);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
      ...
      case 10:
         ...
         stat = asn1PE_AttrObjectBouchonMines (ctxt_p, pvalue->u.bouchon_mines);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_AttrObjectSpecific (ASN1CTXT* ctxt_p, ASN1T_AttrObjectSpecific* pvalue)
{
   ...
   switch (ui) {
      ...
      case 7:
         ...
         pvalue->u.zone_minee_lineaire = ALLOC_ASN1ELEM (ctxt_p, ASN1T_AttrObjectZoneMineeLineaire);
         if (pvalue->u.zone_minee_lineaire == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_AttrObjectZoneMineeLineaire (ctxt_p, pvalue->u.zone_minee_lineaire);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 8:
         ...
         pvalue->u.zone_minee_par_dispersion = ALLOC_ASN1ELEM (ctxt_p, ASN1T_AttrObjectZoneMineeParDispersion);
         if (pvalue->u.zone_minee_par_dispersion == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_AttrObjectZoneMineeParDispersion (ctxt_p, pvalue->u.zone_minee_par_dispersion);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 9:
         ...
         pvalue->u.bouchon_mines = ALLOC_ASN1ELEM (ctxt_p, ASN1T_AttrObjectBouchonMines);
         if (pvalue->u.bouchon_mines == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_AttrObjectBouchonMines (ctxt_p, pvalue->u.bouchon_mines);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
