...
EXTERN int asn1PE_EnumObjectType (ASN1CTXT* ctxt_p, ASN1T_EnumObjectType value)
{
   ...
   switch (value) {
      ...
      case EnumObjectType::fire: ui = 39; break;
      case EnumObjectType::emergency_shelter: ui = 40; break;
      default: return ASN_E_INVENUM;
   }

   stat = pe_ConsUnsigned (ctxt_p, ui, 0, 40);
   if (stat != ASN_OK) return stat;
   return (stat);
}
...
EXTERN int asn1PD_EnumObjectType (ASN1CTXT* ctxt_p, ASN1T_EnumObjectType* pvalue)
{
   ...
   switch (ui) {
      ...
      case 39: *pvalue = EnumObjectType::fire; break;
      case 40: *pvalue = EnumObjectType::emergency_shelter; break;
      default: return ASN_E_INVENUM;
   }
