...
ASN1C_SimMessagesIncludes::ASN1C_SimMessagesIncludes (
...
EXTERN int asn1PE_SimMessagesIncludes (ASN1CTXT* ctxt_p, ASN1T_SimMessagesIncludes* pvalue)
{
   ...
   /* encode urbanKnowledgeExports */

   stat = asn1PE_UrbanKnowledgeExports (ctxt_p);
   if (stat != ASN_OK) return stat;

   return (stat);
}

int ASN1C_SimMessagesIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_SimMessagesIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_SimMessagesIncludes (ASN1CTXT* ctxt_p, ASN1T_SimMessagesIncludes* pvalue)
{
   ...
   /* decode urbanKnowledgeExports */

   stat = asn1PD_UrbanKnowledgeExports (ctxt_p);
   if (stat != ASN_OK) return stat;
...
int ASN1C_SimMessagesIncludes::Decode ()
{
   return asn1PD_SimMessagesIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_SimMessagesExports::ASN1C_SimMessagesExports (
...
int ASN1C_SimMessagesExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_SimMessagesExports (mpContext->GetPtr());
   return stat;
}
...
int ASN1C_SimMessagesExports::Decode ()
{
   return asn1PD_SimMessagesExports (mpContext->GetPtr());
}
...
EXTERN int asn1PE_MsgsSimToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      /* msg_knowledge_group_change_superior_ack */
      case 17:
         stat = asn1PE_MsgKnowledgeGroupChangeSuperiorAck (ctxt_p, pvalue->u.msg_knowledge_group_change_superior_ack);
         if (stat != ASN_OK) return stat;
         break;

      /* msg_knowledge_group_delete_ack */
      case 18:
         stat = asn1PE_MsgKnowledgeGroupDeleteAck (ctxt_p, pvalue->u.msg_knowledge_group_delete_ack);
         if (stat != ASN_OK) return stat;
         break;

      /* msg_knowledge_group_set_type_ack */
      case 19:
         stat = asn1PE_MsgKnowledgeGroupSetTypeAck (ctxt_p, pvalue->u.msg_knowledge_group_set_type_ack);
         if (stat != ASN_OK) return stat;
         break;

      /* msg_knowledge_group_creation_ack */
      case 20:
         stat = asn1PE_MsgKnowledgeGroupCreationAck (ctxt_p, pvalue->u.msg_knowledge_group_creation_ack);
         if (stat != ASN_OK) return stat;
         break;
      ...
      /* msg_control_date_time_change_ack */
      case 29:
         stat = asn1PE_MsgControlDatetimeChangeAck (ctxt_p, pvalue->u.msg_control_date_time_change_ack);
         if (stat != ASN_OK) return stat;
         break;
      ...
      case 33:
         stat = asn1PE_MsgControlCheckPointSaveEnd (ctxt_p, pvalue->u.msg_control_checkpoint_save_end);
         if (stat != ASN_OK) return stat;
         break;
      ...
      /* msg_knowledge_group_update */
      case 119:
         stat = asn1PE_MsgKnowledgeGroupUpdate (ctxt_p, pvalue->u.msg_knowledge_group_update);
         if (stat != ASN_OK) return stat;
         break;
...
EXTERN int asn1PD_MsgsSimToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   switch (ui) {
      ...
      /* msg_knowledge_group_change_superior_ack */
      case 16:
         pvalue->u.msg_knowledge_group_change_superior_ack = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgKnowledgeGroupChangeSuperiorAck);

         stat = asn1PD_MsgKnowledgeGroupChangeSuperiorAck (ctxt_p, pvalue->u.msg_knowledge_group_change_superior_ack);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_knowledge_group_delete_ack */
      case 17:
         pvalue->u.msg_knowledge_group_delete_ack = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgKnowledgeGroupDeleteAck);

         stat = asn1PD_MsgKnowledgeGroupDeleteAck (ctxt_p, pvalue->u.msg_knowledge_group_delete_ack);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_knowledge_group_set_type_ack */
      case 18:
         pvalue->u.msg_knowledge_group_set_type_ack = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgKnowledgeGroupSetTypeAck);

         stat = asn1PD_MsgKnowledgeGroupSetTypeAck (ctxt_p, pvalue->u.msg_knowledge_group_set_type_ack);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_knowledge_group_creation_ack */
      case 19:
         pvalue->u.msg_knowledge_group_creation_ack = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgKnowledgeGroupCreationAck);

         stat = asn1PD_MsgKnowledgeGroupCreationAck (ctxt_p, pvalue->u.msg_knowledge_group_creation_ack);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_control_date_time_change_ack */
      case 28:
         stat = asn1PD_MsgControlDatetimeChangeAck (ctxt_p, &pvalue->u.msg_control_date_time_change_ack);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_control_checkpoint_save_end */
      case 32:
         pvalue->u.msg_control_checkpoint_save_end = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgControlCheckPointSaveEnd);

         stat = asn1PD_MsgControlCheckPointSaveEnd (ctxt_p, pvalue->u.msg_control_checkpoint_save_end);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_knowledge_group_update */
      case 118:
         pvalue->u.msg_knowledge_group_update = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgKnowledgeGroupUpdate);

         stat = asn1PD_MsgKnowledgeGroupUpdate (ctxt_p, pvalue->u.msg_knowledge_group_update);
         if (stat != ASN_OK) return stat;
...
EXTERN int asn1PE_MsgsClientToSim_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsClientToSim_msg* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      /* msg_control_date_time_change */
      case 5:
         stat = asn1PE_MsgControlDatetimeChange (ctxt_p, pvalue->u.msg_control_date_time_change);
         if (stat != ASN_OK) return stat;
         break;
      ...
      /* msg_knowledge_group_enable */
      case 31:
         stat = asn1PE_MsgKnowledgeGroupEnable (ctxt_p, pvalue->u.msg_knowledge_group_enable);
         if (stat != ASN_OK) return stat;
         break;
...
EXTERN int asn1PD_MsgsClientToSim_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsClientToSim_msg* pvalue)
{
   ...
   switch (ui) {
      ...
      /* msg_control_date_time_change */
      case 4:
         pvalue->u.msg_control_date_time_change = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgControlDatetimeChange);

         stat = asn1PD_MsgControlDatetimeChange (ctxt_p, pvalue->u.msg_control_date_time_change);
         if (stat != ASN_OK) return stat;
      ...
      /* msg_knowledge_group_enable */
      case 30:
         pvalue->u.msg_knowledge_group_enable = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgKnowledgeGroupEnable);

         stat = asn1PD_MsgKnowledgeGroupEnable (ctxt_p, pvalue->u.msg_knowledge_group_enable);
         if (stat != ASN_OK) return stat;
