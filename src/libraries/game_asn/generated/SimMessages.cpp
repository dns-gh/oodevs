...
EXTERN int asn1PE_SimMessagesIncludes (ASN1CTXT* ctxt_p, ASN1T_SimMessagesIncludes* pvalue)
{
   ...
   /* encode infoMessageExports */

   stat = asn1PE_InfoMessageExports (ctxt_p);
   if (stat != ASN_OK) return stat;
...
EXTERN int asn1PD_SimMessagesIncludes (ASN1CTXT* ctxt_p, ASN1T_SimMessagesIncludes* pvalue)
{
   ...
   /* decode infoMessageExports */

   stat = asn1PD_InfoMessageExports (ctxt_p);
   if (stat != ASN_OK) return stat;
...
EXTERN int asn1PE_MsgsSimToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->t - 1, 0, 109);
   if (stat != ASN_OK) return stat;
   ...
   switch (pvalue->t)
   {
      ...
      /* msg_xmlia_text_message */
      case 110:
         stat = asn1PE_MsgXmliaTextMessage (ctxt_p, pvalue->u.msg_xmlia_text_message);
         if (stat != ASN_OK) return stat;
         break;
...
EXTERN int asn1PD_MsgsSimToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 109);
   if (stat != ASN_OK) return stat;
   else pvalue->t = ui + 1;
   ...
   switch (ui) {
      ...
      /* msg_xmlia_text_message */
      case 109:
         pvalue->u.msg_xmlia_text_message = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgXmliaTextMessage);

         stat = asn1PD_MsgXmliaTextMessage (ctxt_p, pvalue->u.msg_xmlia_text_message);
         if (stat != ASN_OK) return stat;
...
EXTERN int asn1PE_MsgsClientToSim_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsClientToSim_msg* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->t - 1, 0, 25);
   if (stat != ASN_OK) return stat;
...
EXTERN int asn1PD_MsgsClientToSim_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsClientToSim_msg* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 25);
   if (stat != ASN_OK) return stat;
   else pvalue->t = ui + 1;
