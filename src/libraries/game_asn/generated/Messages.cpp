...
EXTERN int asn1PE_MsgsSimToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      /* msg_folk_graph_edge_update */
      case 116:
         stat = asn1PE_MsgFolkGraphEdgeUpdate (ctxt_p, pvalue->u.msg_folk_graph_edge_update);
         if (stat != ASN_OK) return stat;
         break;
...
EXTERN int asn1PD_MsgsSimToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   switch (ui) {
      ...
      /* msg_folk_graph_edge_update */
      case 115:
         pvalue->u.msg_folk_graph_edge_update = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgFolkGraphEdgeUpdate);

         stat = asn1PD_MsgFolkGraphEdgeUpdate (ctxt_p, pvalue->u.msg_folk_graph_edge_update);
         if (stat != ASN_OK) return stat;
