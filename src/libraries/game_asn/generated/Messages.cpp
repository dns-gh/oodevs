...
EXTERN int asn1PE_MsgsSimToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->t - 1, 0, 116);
   if (stat != ASN_OK) return stat;
...
EXTERN int asn1PD_MsgsSimToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 116);
   if (stat != ASN_OK) return stat;
   else pvalue->t = ui + 1;
   ...
   switch (ui) {
      ...
      /* msg_automat_change_superior_ack */
      case 18:
         pvalue->u.msg_automat_change_superior_ack = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgAutomatChangeSuperiorAck);
