...
EXTERN int asn1PE_MsgsSimToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->t - 1, 0, 115);
   if (stat != ASN_OK) return stat;
...
EXTERN int asn1PD_MsgsSimToClient_msg (ASN1CTXT* ctxt_p, ASN1T_MsgsSimToClient_msg* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 115);
   if (stat != ASN_OK) return stat;
   else pvalue->t = ui + 1;
...
ASN1C_MsgsAfterActionReviewToClient_msg::ASN1C_MsgsAfterActionReviewToClient_msg (
...
int ASN1C_MsgsAfterActionReviewToClient_msg::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgsAfterActionReviewToClient_msg (mpContext->GetPtr(), &msgData);
   return stat;
}
...
int ASN1C_MsgsAfterActionReviewToClient_msg::Decode ()
{
   return asn1PD_MsgsAfterActionReviewToClient_msg (mpContext->GetPtr(), &msgData);
}
...
ASN1C_MsgsAfterActionReviewToClient::ASN1C_MsgsAfterActionReviewToClient (
...
EXTERN int asn1PE_MsgsAfterActionReviewToClient (ASN1CTXT* ctxt_p, ASN1T_MsgsAfterActionReviewToClient* pvalue)
{
   ...
   stat = asn1PE_MsgsAfterActionReviewToClient_msg (ctxt_p, &pvalue->msg);
   if (stat != ASN_OK) return stat;

   return (stat);
}

int ASN1C_MsgsAfterActionReviewToClient::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgsAfterActionReviewToClient (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_MsgsAfterActionReviewToClient (ASN1CTXT* ctxt_p, ASN1T_MsgsAfterActionReviewToClient* pvalue)
{
   ...
   stat = asn1PD_MsgsAfterActionReviewToClient_msg (ctxt_p, &pvalue->msg);
   if (stat != ASN_OK) return stat;
...
int ASN1C_MsgsAfterActionReviewToClient::Decode ()
{
   return asn1PD_MsgsAfterActionReviewToClient (mpContext->GetPtr(), &msgData);
}
...
ASN1C_MsgsClientToAfterActionReview_msg::ASN1C_MsgsClientToAfterActionReview_msg (
...
int ASN1C_MsgsClientToAfterActionReview_msg::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgsClientToAfterActionReview_msg (mpContext->GetPtr(), &msgData);
   return stat;
}
...
int ASN1C_MsgsClientToAfterActionReview_msg::Decode ()
{
   return asn1PD_MsgsClientToAfterActionReview_msg (mpContext->GetPtr(), &msgData);
}
...
ASN1C_MsgsClientToAfterActionReview::ASN1C_MsgsClientToAfterActionReview (
...
EXTERN int asn1PE_MsgsClientToAfterActionReview (ASN1CTXT* ctxt_p, ASN1T_MsgsClientToAfterActionReview* pvalue)
{
   ...
   stat = asn1PE_MsgsClientToAfterActionReview_msg (ctxt_p, &pvalue->msg);
   if (stat != ASN_OK) return stat;

   return (stat);
}

int ASN1C_MsgsClientToAfterActionReview::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgsClientToAfterActionReview (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_MsgsClientToAfterActionReview (ASN1CTXT* ctxt_p, ASN1T_MsgsClientToAfterActionReview* pvalue)
{
   ...
   stat = asn1PD_MsgsClientToAfterActionReview_msg (ctxt_p, &pvalue->msg);
   if (stat != ASN_OK) return stat;
...
int ASN1C_MsgsClientToAfterActionReview::Decode ()
{
   return asn1PD_MsgsClientToAfterActionReview (mpContext->GetPtr(), &msgData);
}
