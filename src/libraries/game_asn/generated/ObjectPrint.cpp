/* This file was generated by ASN1C V5.31 on 20-Jun-2007 */
...
void asn1Print_ObjectAttributesSpecific (ASN1ConstCharPtr name, ASN1T_ObjectAttributesSpecific* pvalue)
{
   ...
   switch (pvalue->t) {
      case 1:
         ...
         asn1Print_ObjectAttributesCrossingSite (namebuf, pvalue->u.site_franchissement);
         break;

      case 2:
         sprintf (namebuf, "%s.u.nuage_nbc", name);
         asn1Print_ObjectAttributesNbcCloud (namebuf, pvalue->u.nuage_nbc);
         break;
      ...
      case 4:
         ...
         asn1Print_ObjectAttributesNbcZone (namebuf, pvalue->u.zone_nbc);
         break;

      case 5:
         sprintf (namebuf, "%s.u.itineraire_logistique", name);
         asn1Print_ObjectAttributesLogisticRoute (namebuf, pvalue->u.itineraire_logistique);
         break;

      case 6:
         sprintf (namebuf, "%s.u.camp_prisonniers", name);
         asn1Print_ObjectAttributesPrisonerCamp (namebuf, pvalue->u.camp_prisonniers);
         break;

      case 7:
         sprintf (namebuf, "%s.u.camp_refugies", name);
         asn1Print_ObjectAttributesRefugeeCamp (namebuf, pvalue->u.camp_refugies);
         break;

      case 8:
         sprintf (namebuf, "%s.u.zone_minee_lineaire", name);
         asn1Print_ObjectAttributesLinearMineArea (namebuf, pvalue->u.zone_minee_lineaire);
         break;

      case 9:
         sprintf (namebuf, "%s.u.zone_minee_par_dispersion", name);
         asn1Print_ObjectAttributesDispersedMineArea (namebuf, pvalue->u.zone_minee_par_dispersion);
         break;

      case 10:
         sprintf (namebuf, "%s.u.bouchon_mines", name);
         asn1Print_ObjectAttributesMineJam (namebuf, pvalue->u.bouchon_mines);
         break;
...
void asn1Print_MsgObjectCreation (ASN1ConstCharPtr name, ASN1T_MsgObjectCreation* pvalue)
{
   ...
   printf ("%s.m.type_obstaclePresent = %d\n", name, (int)pvalue->m.type_obstaclePresent);
   printf ("%s.m.obstacle_de_manoeuvre_activePresent = %d\n", name, (int)pvalue->m.obstacle_de_manoeuvre_activePresent);
   ...
   if (pvalue->m.obstacle_de_manoeuvre_activePresent) {
      sprintf (namebuf, "%s.obstacle_de_manoeuvre_active", name);
      rtPrintBoolean (namebuf, pvalue->obstacle_de_manoeuvre_active);
   }
