...
void asn1Print_EnumTypeObstacle (ASN1ConstCharPtr name, ASN1T_EnumTypeObstacle* pvalue)
{
   printf ("%s = ", name);
   switch (*pvalue) {
...
void ASN1C_EnumTypeObstacle::Print (ASN1ConstCharPtr name)

{
   asn1Print_EnumTypeObstacle (name, &msgData);
}
