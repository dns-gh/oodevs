...
public:                                                                 \
    ...
    NAMESPACE##::Msg##MSG& operator()()                                 \
    { return *message.mutable_message()->mutable_##VAR(); }             \
private:                                                                \
    Msgs##TARGET##::Msg##TARGET message;                                \
};
...
public:                                                                                         \
    MSG() { operator()(); }                                                                     \
    MSG( NAMESPACE##::Msg##MSG& msg ){ *message.mutable_message()->mutable_##VAR() = msg; }     \
    template< typename P >                                                                      \
    ...
    {                                                                                           \
        publisher.Send( message );                                                              \
                                                                                                ...
                                                                                                \
    NAMESPACE##::Msg##MSG& operator()() { return *message.mutable_message()->mutable_##VAR(); } \
private:                                                                                        \
    Msgs##TARGET##::Msg##TARGET message;                                                        \
};
