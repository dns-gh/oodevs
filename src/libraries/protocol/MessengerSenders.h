...
namespace messenger
{
    ...
    GENERATE_NO_CONTEXT_MESSAGE( sword::ClientToMessenger, sword, LimaCreationRequest            , lima_creation_request                 )
    GENERATE_NO_CONTEXT_MESSAGE( sword::ClientToMessenger, sword, LimaDestructionRequest         , lima_destruction_request              )
    GENERATE_NO_CONTEXT_MESSAGE( sword::ClientToMessenger, sword, LimaUpdateRequest              , lima_update_request                   )
    ...
    GENERATE_NO_CONTEXT_MESSAGE( sword::MessengerToClient, sword, LimitCreationRequestAck           , limit_creation_request_ack            )
    ...
    GENERATE_NO_CONTEXT_MESSAGE( sword::MessengerToClient, sword, LimaCreationRequestAck            , lima_creation_request_ack             )
    GENERATE_NO_CONTEXT_MESSAGE( sword::MessengerToClient, sword, LimaDestructionRequestAck         , lima_destruction_request_ack          )
    GENERATE_NO_CONTEXT_MESSAGE( sword::MessengerToClient, sword, LimaUpdateRequestAck              , lima_update_request_ack               )
    GENERATE_NO_CONTEXT_MESSAGE( sword::MessengerToClient, sword, LimaCreation                      , lima_creation                         )
    GENERATE_NO_CONTEXT_MESSAGE( sword::MessengerToClient, sword, LimaUpdate                        , lima_update                           )
    GENERATE_NO_CONTEXT_MESSAGE( sword::MessengerToClient, sword, LimaDestruction                   , lima_destruction                      )
    ...
    GENERATE_NO_CONTEXT_MESSAGE( sword::MessengerToClient, sword, ShapeCreationRequestAck           , shape_creation_request_ack            )
    ...
    GENERATE_NO_CONTEXT_MESSAGE( sword::MessengerToClient, sword, MarkerCreation                    , marker_creation                       )
