...
namespace messenger
{
    ...
    GENERATE_MESSAGE           ( sword::MessengerToClient, sword, MarkerCreationRequestAck          , marker_creation_request_ack           )
    GENERATE_NO_CONTEXT_MESSAGE( sword::MessengerToClient, sword, MarkerUpdateRequestAck            , marker_update_request_ack             )
    GENERATE_NO_CONTEXT_MESSAGE( sword::MessengerToClient, sword, MarkerDestructionRequestAck       , marker_destruction_request_ack        )
