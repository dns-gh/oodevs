...
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, FormationDestruction                          , formation_destruction                             )
...
GENERATE_ASN_MSG_SENDER( SimToClient, Common         , CrowdOrder                                    , crowd_order                                       )
...
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, PartyCreation                                 , party_creation                                    )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, AutomatCreation                               , automat_creation                                  )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, AutomatDestruction                            , automat_destruction                               )
...
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, StartCrowdFire                                , start_crowd_fire                                  )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, StopCrowdFire                                 , stop_crowd_fire                                   )
...
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdUpdate                                   , crowd_update                                 )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdConcentrationCreation                    , crowd_concentration_creation                 )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdConcentrationDestruction                 , crowd_concentration_destruction              )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdConcentrationUpdate                      , crowd_concentration_update                   )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdFlowCreation                             , crowd_flow_creation                          )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdFlowDestruction                          , crowd_flow_destruction                       )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdFlowUpdate                               , crowd_flow_update                            )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdKnowledgeCreation                        , crowd_knowledge_creation                     )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdKnowledgeUpdate                          , crowd_knowledge_update                       )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdKnowledgeDestruction                     , crowd_knowledge_destruction                  )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdConcentrationKnowledgeCreation           , crowd_concentration_knowledge_creation       )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdConcentrationKnowledgeDestruction        , crowd_concentration_knowledge_destruction    )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdConcentrationKnowledgeUpdate             , crowd_concentration_knowledge_update         )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdFlowKnowledgeCreation                    , crowd_flow_knowledge_creation                )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdFlowKnowledgeDestruction                 , crowd_flow_knowledge_destruction             )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdFlowKnowledgeUpdate                      , crowd_flow_knowledge_update                  )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, FolkCreation                                  , folk_creation                                )

GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, ControlGlobalWeatherAck                       , control_global_weather_ack                        )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, ControlLocalWeatherAck                        , control_local_weather_ack                         )
...
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdConcentrationDetection                   , crowd_concentration_detection                     )
...
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, CrowdMagicActionAck                           , crowd_magic_action_ack                            )
...
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, UrbanUpdate                                   , urban_update                                      )
...
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, ControlGlobalWeather                          , control_global_weather                            )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, ControlLocalWeatherCreation                   , control_local_weather_creation                    )
GENERATE_ASN_MSG_SENDER( SimToClient, MsgsSimToClient, ControlLocalWeatherDestruction                , control_local_weather_destruction                 )
}
