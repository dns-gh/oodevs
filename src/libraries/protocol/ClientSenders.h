...
namespace client
{
    ...
    GENERATE_MESSAGE( sword::SimToClient, sword, UnitOrderAck                           , unit_order_ack                            )
    GENERATE_MESSAGE( sword::SimToClient, sword, AutomatOrderAck                        , automat_order_ack                         )
    GENERATE_MESSAGE( sword::SimToClient, sword, CrowdOrderAck                          , crowd_order_ack                           )
