...
namespace client
{
    ...
    GENERATE_MESSAGE_WITH_CLIENTID( sword::SimToClient, sword, ControlChangeTimeFactorAck       , control_change_time_factor_ack            )
    ...
    GENERATE_MESSAGE_WITH_CLIENTID( sword::SimToClient, sword, ControlCheckPointSetFrequencyAck , control_checkpoint_set_frequency_ack      )
    GENERATE_MESSAGE_WITH_CLIENTID( sword::SimToClient, sword, ControlDateTimeChangeAck         , control_date_time_change_ack              )
    ...
    GENERATE_MESSAGE( sword::SimToClient, sword, Hierarchy                                      , hierarchy_creation                        )
    ...
    GENERATE_MESSAGE( sword::SimToClient, sword, LogSupplyRequestCreation                       , log_supply_request_creation               )
    GENERATE_MESSAGE( sword::SimToClient, sword, LogSupplyRequestDestruction                    , log_supply_request_destruction            )
    GENERATE_MESSAGE( sword::SimToClient, sword, LogSupplyRequestUpdate                         , log_supply_request_update                 )
