...
class ProtocolVersion : public ::google::protobuf::Message {
 public:
  ProtocolVersion();
  ...
  // required string value = 1 [default = "4.0.0.1"];
...
inline void ProtocolVersion::clear_value() {
  if (value_ != &_default_value_) {
    value_->assign(_default_value_);
  }
  _clear_bit(0);
}
inline const ::std::string& ProtocolVersion::value() const {
  return *value_;
}
inline void ProtocolVersion::set_value(const ::std::string& value) {
  _set_bit(0);
  if (value_ == &_default_value_) {
...
inline void ProtocolVersion::set_value(const char* value) {
  _set_bit(0);
  if (value_ == &_default_value_) {
    value_ = new ::std::string;
  }
...
inline void ProtocolVersion::set_value(const char* value, size_t size) {
  _set_bit(0);
  if (value_ == &_default_value_) {
    value_ = new ::std::string;
  }
...
inline ::std::string* ProtocolVersion::mutable_value() {
  _set_bit(0);
  if (value_ == &_default_value_) {
