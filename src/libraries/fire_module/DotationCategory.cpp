...
DECLARE_HOOK( CanFire, bool, ( const SWORD_Model* component, const char* dotation, int firingType, int ammoDotationClass ) )
...
// Created: MCO 2012-06-21
// -----------------------------------------------------------------------------
bool DotationCategory::CanFire( const wrapper::View& component, int firingType, int ammoDotationClass ) const
{
    return GET_HOOK( ::CanFire )( component, strName_.c_str(), firingType, ammoDotationClass );
}
