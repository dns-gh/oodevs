...
#include "Automate\MIL_AutomateMission_InterdireFranchissementPopulations.cpp"
#include "Automate\MIL_AutomateMission_FiltrerPopulations.cpp"
#include "Automate\MIL_AutomateMission_CanaliserPopulations.cpp"
#include "Automate\MIL_AutomateMission_ControlerPopulationsDansZone.cpp"
#include "Automate\MIL_AutomateMission_SecuriserZoneContrePopulations.cpp"
#include "Automate\MIL_AutomateMission_ASY_CommettreExactionsSurPopulationDansZone.cpp"
...
#include "Pion\MIL_PionMission_InterdireFranchissementPopulations.cpp"
#include "Pion\MIL_PionMission_FiltrerPopulations.cpp"
#include "Pion\MIL_PionMission_RenseignerSurPopulations.cpp"
#include "Pion\MIL_PionMission_CanaliserPopulations.cpp"
#include "Pion\MIL_PionMission_ControlerPopulationsDansZone.cpp"
#include "Pion\MIL_PionMission_SecuriserZoneContrePopulations.cpp"
...
void missions::RegisterAutomateMissions()
{
    ...
    MIL_AutomateMissionType::RegisterMission< MIL_AutomateMission_InterdireFranchissementPopulations>( "Automate InterdireFranchissementPopulations", eMission_Automate_InterdireFranchissementPopulations, T_Mission_Automate_mission_automate_interdire_franchissement_populations, "T_Mission_Automate_InterdireFranchissementPopulations", "MIS_Automate_MRT_InterdireFranchissementPopulations", "MIS_Automate_CDT_InterdireFranchissementPopulations");
    MIL_AutomateMissionType::RegisterMission< MIL_AutomateMission_FiltrerPopulations>( "Automate FiltrerPopulations", eMission_Automate_FiltrerPopulations, T_Mission_Automate_mission_automate_filtrer_populations, "T_Mission_Automate_FiltrerPopulations", "MIS_Automate_MRT_FiltrerPopulations", "MIS_Automate_CDT_FiltrerPopulations");
    MIL_AutomateMissionType::RegisterMission< MIL_AutomateMission_CanaliserPopulations>( "Automate CanaliserPopulations", eMission_Automate_CanaliserPopulations, T_Mission_Automate_mission_automate_canaliser_populations, "T_Mission_Automate_CanaliserPopulations", "MIS_Automate_MRT_CanaliserPopulations", "MIS_Automate_CDT_CanaliserPopulations");
    MIL_AutomateMissionType::RegisterMission< MIL_AutomateMission_ControlerPopulationsDansZone>( "Automate ControlerPopulationsDansZone", eMission_Automate_ControlerPopulationsDansZone, T_Mission_Automate_mission_automate_controler_populations_dans_zone, "T_Mission_Automate_ControlerPopulationsDansZone", "MIS_Automate_MRT_ControlerPopulationsDansZone", "MIS_Automate_CDT_ControlerPopulationsDansZone");
    MIL_AutomateMissionType::RegisterMission< MIL_AutomateMission_SecuriserZoneContrePopulations>( "Automate SecuriserZoneContrePopulations", eMission_Automate_SecuriserZoneContrePopulations, T_Mission_Automate_mission_automate_securiser_zone_contre_populations, "T_Mission_Automate_SecuriserZoneContrePopulations", "MIS_Automate_MRT_SecuriserZoneContrePopulations", "MIS_Automate_CDT_SecuriserZoneContrePopulations");
    MIL_AutomateMissionType::RegisterMission< MIL_AutomateMission_ASY_CommettreExactionsSurPopulationDansZone>( "Automate ASY CommettreExactionsSurPopulationDansZone", eMission_Automate_ASY_CommettreExactionsSurPopulationDansZone, T_Mission_Automate_mission_automate_asy_commettre_exactions_sur_population_dans_zone, "T_Mission_Automate_ASY_CommettreExactionsSurPopulationDansZone", "MIS_Automate_MRT_ASY_CommettreExactionsSurPopulationDansZone", "MIS_Automate_CDT_ASY_CommettreExactionsSurPopulationDansZone");
...
void missions::RegisterPionMissions()
{
    ...
    MIL_PionMissionType::RegisterMission< MIL_PionMission_InterdireFranchissementPopulations>( "Pion InterdireFranchissementPopulations", eMission_Pion_InterdireFranchissementPopulations, T_Mission_Pion_mission_pion_interdire_franchissement_populations, "T_Mission_Pion_InterdireFranchissementPopulations", "MIS_Pion_InterdireFranchissementPopulations");
    MIL_PionMissionType::RegisterMission< MIL_PionMission_FiltrerPopulations>( "Pion FiltrerPopulations", eMission_Pion_FiltrerPopulations, T_Mission_Pion_mission_pion_filtrer_populations, "T_Mission_Pion_FiltrerPopulations", "MIS_Pion_FiltrerPopulations");
    MIL_PionMissionType::RegisterMission< MIL_PionMission_RenseignerSurPopulations>( "Pion RenseignerSurPopulations", eMission_Pion_RenseignerSurPopulations, T_Mission_Pion_mission_pion_renseigner_sur_populations, "T_Mission_Pion_RenseignerSurPopulations", "MIS_Pion_RenseignerSurPopulations");
    MIL_PionMissionType::RegisterMission< MIL_PionMission_CanaliserPopulations>( "Pion CanaliserPopulations", eMission_Pion_CanaliserPopulations, T_Mission_Pion_mission_pion_canaliser_populations, "T_Mission_Pion_CanaliserPopulations", "MIS_Pion_CanaliserPopulations");
    MIL_PionMissionType::RegisterMission< MIL_PionMission_ControlerPopulationsDansZone>( "Pion ControlerPopulationsDansZone", eMission_Pion_ControlerPopulationsDansZone, T_Mission_Pion_mission_pion_controler_populations_dans_zone, "T_Mission_Pion_ControlerPopulationsDansZone", "MIS_Pion_ControlerPopulationsDansZone");
    MIL_PionMissionType::RegisterMission< MIL_PionMission_SecuriserZoneContrePopulations>( "Pion SecuriserZoneContrePopulations", eMission_Pion_SecuriserZoneContrePopulations, T_Mission_Pion_mission_pion_securiser_zone_contre_populations, "T_Mission_Pion_SecuriserZoneContrePopulations", "MIS_Pion_SecuriserZoneContrePopulations");
...
void missions::RegisterOrderConduites()
{
    ...
    MIL_OrderConduiteType::RegisterOrderConduite< MIL_OrderConduite_AttendreSePoster>( "AttendreSePoster", eOrdreConduite_AttendreSePoster, T_MsgOrderConduite_order_conduite_order_conduite_attendre_se_poster, "Rep_OrderConduite_AttendreSePoster", true, false );
    MIL_OrderConduiteType::RegisterOrderConduite< MIL_OrderConduite_Poursuivre>( "Poursuivre", eOrdreConduite_Poursuivre, T_MsgOrderConduite_order_conduite_order_conduite_poursuivre, "Rep_OrderConduite_Poursuivre", true, false );
    ...
    MIL_OrderConduiteType::RegisterOrderConduite< MIL_OrderConduite_Pion_Contourner>( "Pion Contourner", eOrdreConduite_Pion_Contourner, T_MsgOrderConduite_order_conduite_order_conduite_pion_contourner, "Rep_OrderConduite_Pion_Contourner", false, false );
    ...
    MIL_OrderConduiteType::RegisterOrderConduite< MIL_OrderConduite_Pion_ActiverObstacle>( "Pion ActiverObstacle", eOrdreConduite_Pion_ActiverObstacle, T_MsgOrderConduite_order_conduite_order_conduite_pion_activer_obstacle, "Rep_OrderConduite_Pion_ActiverObstacle", false, false );
    ...
    MIL_OrderConduiteType::RegisterOrderConduite< MIL_OrderConduite_Pion_ExecuterTir>( "Pion ExecuterTir", eOrdreConduite_Pion_ExecuterTir, T_MsgOrderConduite_order_conduite_order_conduite_pion_executer_tir, "Rep_OrderConduite_Pion_ExecuterTir", false, false );
