...
#ifndef __MIL_AutomateMission_ABC_Semparer_h_
#define __MIL_AutomateMission_ABC_Semparer_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_Semparer : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_Semparer )

public:
             MIL_AutomateMission_ABC_Semparer( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_Semparer();
...
#endif // __MIL_AutomateMission_ABC_Semparer_h_
