...
#ifndef __MIL_AutomateMission_NBC_DecontaminerUneZone_h_
#define __MIL_AutomateMission_NBC_DecontaminerUneZone_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_NBC_DecontaminerUneZone : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_NBC_DecontaminerUneZone )

public:
             MIL_AutomateMission_NBC_DecontaminerUneZone( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_NBC_DecontaminerUneZone();
...
#endif // __MIL_AutomateMission_NBC_DecontaminerUneZone_h_
