...
#ifndef __MIL_AutomateMission_GEN_RealiserSystemeObstacles_h_
#define __MIL_AutomateMission_GEN_RealiserSystemeObstacles_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_GEN_RealiserSystemeObstacles : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_GEN_RealiserSystemeObstacles )

public:
             MIL_AutomateMission_GEN_RealiserSystemeObstacles( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_GEN_RealiserSystemeObstacles();
...
#endif // __MIL_AutomateMission_GEN_RealiserSystemeObstacles_h_
