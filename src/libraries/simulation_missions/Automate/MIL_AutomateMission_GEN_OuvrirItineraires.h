...
#ifndef __MIL_AutomateMission_GEN_OuvrirItineraires_h_
#define __MIL_AutomateMission_GEN_OuvrirItineraires_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_GEN_OuvrirItineraires : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_GEN_OuvrirItineraires )

public:
             MIL_AutomateMission_GEN_OuvrirItineraires( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_GEN_OuvrirItineraires();
...
#endif // __MIL_AutomateMission_GEN_OuvrirItineraires_h_
