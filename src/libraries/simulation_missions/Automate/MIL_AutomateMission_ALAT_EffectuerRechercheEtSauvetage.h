...
#ifndef __MIL_AutomateMission_ALAT_EffectuerRechercheEtSauvetage_h_
#define __MIL_AutomateMission_ALAT_EffectuerRechercheEtSauvetage_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ALAT_EffectuerRechercheEtSauvetage : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_EffectuerRechercheEtSauvetage )

public:
             MIL_AutomateMission_ALAT_EffectuerRechercheEtSauvetage( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_EffectuerRechercheEtSauvetage();
...
#endif // __MIL_AutomateMission_ALAT_EffectuerRechercheEtSauvetage_h_
