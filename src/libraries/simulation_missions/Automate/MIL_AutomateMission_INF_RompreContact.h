...
#ifndef __MIL_AutomateMission_INF_RompreContact_h_
#define __MIL_AutomateMission_INF_RompreContact_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_RompreContact : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_RompreContact )

public:
             MIL_AutomateMission_INF_RompreContact( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_RompreContact();
...
#endif // __MIL_AutomateMission_INF_RompreContact_h_
