...
#ifndef __MIL_AutomateMission_FaireMouvement_h_
#define __MIL_AutomateMission_FaireMouvement_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_FaireMouvement : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_FaireMouvement )

public:
             MIL_AutomateMission_FaireMouvement( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_FaireMouvement();
...
#endif // __MIL_AutomateMission_FaireMouvement_h_
