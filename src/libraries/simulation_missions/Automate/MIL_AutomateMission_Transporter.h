...
#ifndef __MIL_AutomateMission_Transporter_h_
#define __MIL_AutomateMission_Transporter_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_Transporter : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_Transporter )

public:
             MIL_AutomateMission_Transporter( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_Transporter();
...
#endif // __MIL_AutomateMission_Transporter_h_
