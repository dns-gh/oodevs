...
#ifndef __MIL_AutomateMission_GEN_RealiserCampRefugies_h_
#define __MIL_AutomateMission_GEN_RealiserCampRefugies_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_GEN_RealiserCampRefugies : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_GEN_RealiserCampRefugies )

public:
             MIL_AutomateMission_GEN_RealiserCampRefugies( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_GEN_RealiserCampRefugies();
...
#endif // __MIL_AutomateMission_GEN_RealiserCampRefugies_h_
