...
#ifndef __MIL_AutomateMission_Decrocher_h_
#define __MIL_AutomateMission_Decrocher_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_Decrocher : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_Decrocher )

public:
             MIL_AutomateMission_Decrocher( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_Decrocher();
...
#endif // __MIL_AutomateMission_Decrocher_h_
