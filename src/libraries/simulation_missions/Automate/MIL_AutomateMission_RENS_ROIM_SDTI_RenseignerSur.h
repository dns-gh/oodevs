...
#ifndef __MIL_AutomateMission_RENS_ROIM_SDTI_RenseignerSur_h_
#define __MIL_AutomateMission_RENS_ROIM_SDTI_RenseignerSur_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_RENS_ROIM_SDTI_RenseignerSur : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_RENS_ROIM_SDTI_RenseignerSur )

public:
             MIL_AutomateMission_RENS_ROIM_SDTI_RenseignerSur( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_RENS_ROIM_SDTI_RenseignerSur();
...
#endif // __MIL_AutomateMission_RENS_ROIM_SDTI_RenseignerSur_h_
