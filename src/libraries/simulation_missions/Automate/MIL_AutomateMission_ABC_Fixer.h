...
#ifndef __MIL_AutomateMission_ABC_Fixer_h_
#define __MIL_AutomateMission_ABC_Fixer_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_Fixer : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_Fixer )

public:
             MIL_AutomateMission_ABC_Fixer( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_Fixer();
...
#endif // __MIL_AutomateMission_ABC_Fixer_h_
