...
#ifndef __MIL_AutomateMission_INF_Freiner_h_
#define __MIL_AutomateMission_INF_Freiner_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_Freiner : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_Freiner )

public:
             MIL_AutomateMission_INF_Freiner( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_Freiner();
...
#endif // __MIL_AutomateMission_INF_Freiner_h_
