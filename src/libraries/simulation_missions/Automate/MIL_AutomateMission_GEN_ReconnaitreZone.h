...
#ifndef __MIL_AutomateMission_GEN_ReconnaitreZone_h_
#define __MIL_AutomateMission_GEN_ReconnaitreZone_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_GEN_ReconnaitreZone : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_GEN_ReconnaitreZone )

public:
             MIL_AutomateMission_GEN_ReconnaitreZone( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_GEN_ReconnaitreZone();
...
#endif // __MIL_AutomateMission_GEN_ReconnaitreZone_h_
