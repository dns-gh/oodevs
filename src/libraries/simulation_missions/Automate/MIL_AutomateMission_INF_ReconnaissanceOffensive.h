...
#ifndef __MIL_AutomateMission_INF_ReconnaissanceOffensive_h_
#define __MIL_AutomateMission_INF_ReconnaissanceOffensive_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_ReconnaissanceOffensive : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_ReconnaissanceOffensive )

public:
             MIL_AutomateMission_INF_ReconnaissanceOffensive( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_ReconnaissanceOffensive();
...
#endif // __MIL_AutomateMission_INF_ReconnaissanceOffensive_h_
