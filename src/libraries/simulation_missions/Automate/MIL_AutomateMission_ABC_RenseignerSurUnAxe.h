...
#ifndef __MIL_AutomateMission_ABC_RenseignerSurUnAxe_h_
#define __MIL_AutomateMission_ABC_RenseignerSurUnAxe_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_RenseignerSurUnAxe : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_RenseignerSurUnAxe )

public:
             MIL_AutomateMission_ABC_RenseignerSurUnAxe( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_RenseignerSurUnAxe();
...
#endif // __MIL_AutomateMission_ABC_RenseignerSurUnAxe_h_
