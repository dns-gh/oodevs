...
#ifndef __MIL_AutomateMission_ALAT_Appuyer_h_
#define __MIL_AutomateMission_ALAT_Appuyer_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ALAT_Appuyer : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_Appuyer )

public:
             MIL_AutomateMission_ALAT_Appuyer( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_Appuyer();
...
#endif // __MIL_AutomateMission_ALAT_Appuyer_h_
