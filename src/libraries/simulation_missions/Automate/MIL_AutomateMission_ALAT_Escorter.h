...
#ifndef __MIL_AutomateMission_ALAT_Escorter_h_
#define __MIL_AutomateMission_ALAT_Escorter_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ALAT_Escorter : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_Escorter )

public:
             MIL_AutomateMission_ALAT_Escorter( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_Escorter();
...
private:
    static int nDIAUnitesAEscorterIdx_;
...
#endif // __MIL_AutomateMission_ALAT_Escorter_h_
