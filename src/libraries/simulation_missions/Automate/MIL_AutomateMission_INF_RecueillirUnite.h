...
#ifndef __MIL_AutomateMission_INF_RecueillirUnite_h_
#define __MIL_AutomateMission_INF_RecueillirUnite_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_RecueillirUnite : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_RecueillirUnite )

public:
             MIL_AutomateMission_INF_RecueillirUnite( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_RecueillirUnite();
...
#endif // __MIL_AutomateMission_INF_RecueillirUnite_h_
