...
#ifndef __MIL_AutomateMission_ASA_DefendreItineraire_h_
#define __MIL_AutomateMission_ASA_DefendreItineraire_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ASA_DefendreItineraire : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ASA_DefendreItineraire )

public:
             MIL_AutomateMission_ASA_DefendreItineraire( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ASA_DefendreItineraire();
...
#endif // __MIL_AutomateMission_ASA_DefendreItineraire_h_
