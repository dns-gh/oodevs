...
#ifndef __MIL_AutomateMission_ALAT_Reconnaitre_h_
#define __MIL_AutomateMission_ALAT_Reconnaitre_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ALAT_Reconnaitre : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_Reconnaitre )

public:
             MIL_AutomateMission_ALAT_Reconnaitre( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_Reconnaitre();
...
#endif // __MIL_AutomateMission_ALAT_Reconnaitre_h_
