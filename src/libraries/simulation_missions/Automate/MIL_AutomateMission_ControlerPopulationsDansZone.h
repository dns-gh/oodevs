...
#ifndef __MIL_AutomateMission_ControlerPopulationsDansZone_h_
#define __MIL_AutomateMission_ControlerPopulationsDansZone_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ControlerPopulationsDansZone : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ControlerPopulationsDansZone )

public:
             MIL_AutomateMission_ControlerPopulationsDansZone( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ControlerPopulationsDansZone();
...
#endif // __MIL_AutomateMission_ControlerPopulationsDansZone_h_
