...
#ifndef __MIL_AutomateMission_INF_FlancGarder_h_
#define __MIL_AutomateMission_INF_FlancGarder_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_FlancGarder : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_FlancGarder )

public:
             MIL_AutomateMission_INF_FlancGarder( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_FlancGarder();
...
#endif // __MIL_AutomateMission_INF_FlancGarder_h_
