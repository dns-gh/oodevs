...
#ifndef __MIL_AutomateMission_GEN_AmenagerTerrainPoserSommaire_h_
#define __MIL_AutomateMission_GEN_AmenagerTerrainPoserSommaire_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_GEN_AmenagerTerrainPoserSommaire : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_GEN_AmenagerTerrainPoserSommaire )

public:
             MIL_AutomateMission_GEN_AmenagerTerrainPoserSommaire( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_GEN_AmenagerTerrainPoserSommaire();
...
#endif // __MIL_AutomateMission_GEN_AmenagerTerrainPoserSommaire_h_
