...
#ifndef __MIL_AutomateMission_ASA_HAWK_Surveiller_h_
#define __MIL_AutomateMission_ASA_HAWK_Surveiller_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ASA_HAWK_Surveiller : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ASA_HAWK_Surveiller )

public:
             MIL_AutomateMission_ASA_HAWK_Surveiller( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ASA_HAWK_Surveiller();
...
#endif // __MIL_AutomateMission_ASA_HAWK_Surveiller_h_
