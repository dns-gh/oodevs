...
#ifndef __MIL_AutomateMission_SecuriserZoneContrePopulations_h_
#define __MIL_AutomateMission_SecuriserZoneContrePopulations_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_SecuriserZoneContrePopulations : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_SecuriserZoneContrePopulations )

public:
             MIL_AutomateMission_SecuriserZoneContrePopulations( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_SecuriserZoneContrePopulations();
...
#endif // __MIL_AutomateMission_SecuriserZoneContrePopulations_h_
