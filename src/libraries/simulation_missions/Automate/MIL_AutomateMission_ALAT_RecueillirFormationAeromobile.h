...
#ifndef __MIL_AutomateMission_ALAT_RecueillirFormationAeromobile_h_
#define __MIL_AutomateMission_ALAT_RecueillirFormationAeromobile_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ALAT_RecueillirFormationAeromobile : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_RecueillirFormationAeromobile )

public:
             MIL_AutomateMission_ALAT_RecueillirFormationAeromobile( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_RecueillirFormationAeromobile();
...
#endif // __MIL_AutomateMission_ALAT_RecueillirFormationAeromobile_h_
