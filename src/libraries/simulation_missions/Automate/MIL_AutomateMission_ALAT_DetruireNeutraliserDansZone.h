...
#ifndef __MIL_AutomateMission_ALAT_DetruireNeutraliserDansZone_h_
#define __MIL_AutomateMission_ALAT_DetruireNeutraliserDansZone_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ALAT_DetruireNeutraliserDansZone : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_DetruireNeutraliserDansZone )

public:
             MIL_AutomateMission_ALAT_DetruireNeutraliserDansZone( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_DetruireNeutraliserDansZone();
...
#endif // __MIL_AutomateMission_ALAT_DetruireNeutraliserDansZone_h_
