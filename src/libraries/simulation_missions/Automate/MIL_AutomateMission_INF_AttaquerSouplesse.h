...
#ifndef __MIL_AutomateMission_INF_AttaquerSouplesse_h_
#define __MIL_AutomateMission_INF_AttaquerSouplesse_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_AttaquerSouplesse : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_AttaquerSouplesse )

public:
             MIL_AutomateMission_INF_AttaquerSouplesse( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_AttaquerSouplesse();
...
#endif // __MIL_AutomateMission_INF_AttaquerSouplesse_h_
