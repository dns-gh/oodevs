...
#ifndef __MIL_AutomateMission_ALAT_Heliporter_h_
#define __MIL_AutomateMission_ALAT_Heliporter_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ALAT_Heliporter : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_Heliporter )

public:
             MIL_AutomateMission_ALAT_Heliporter( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_Heliporter();
...
private:
    ...
    static int nDIAAttendreUnitesIdx_;
    static int nDIAAvecMaterielIdx_;

};


#endif // __MIL_AutomateMission_ALAT_Heliporter_h_
