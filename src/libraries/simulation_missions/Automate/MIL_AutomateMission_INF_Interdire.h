...
#ifndef __MIL_AutomateMission_INF_Interdire_h_
#define __MIL_AutomateMission_INF_Interdire_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_Interdire : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_Interdire )

public:
             MIL_AutomateMission_INF_Interdire( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_Interdire();
...
#endif // __MIL_AutomateMission_INF_Interdire_h_
