...
#ifndef __MIL_AutomateMission_CanaliserPopulations_h_
#define __MIL_AutomateMission_CanaliserPopulations_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_CanaliserPopulations : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_CanaliserPopulations )

public:
             MIL_AutomateMission_CanaliserPopulations( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_CanaliserPopulations();
...
#endif // __MIL_AutomateMission_CanaliserPopulations_h_
