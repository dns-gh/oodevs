...
#ifndef __MIL_AutomateMission_ASA_DefendreSite_h_
#define __MIL_AutomateMission_ASA_DefendreSite_h_
...
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ASA_DefendreSite )

public:
             MIL_AutomateMission_ASA_DefendreSite( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ASA_DefendreSite();
...
#endif // __MIL_AutomateMission_ASA_DefendreSite_h_
