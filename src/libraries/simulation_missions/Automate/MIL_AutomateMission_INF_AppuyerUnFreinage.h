...
#ifndef __MIL_AutomateMission_INF_AppuyerUnFreinage_h_
#define __MIL_AutomateMission_INF_AppuyerUnFreinage_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_AppuyerUnFreinage : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_AppuyerUnFreinage )

public:
             MIL_AutomateMission_INF_AppuyerUnFreinage( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_AppuyerUnFreinage();
...
#endif // __MIL_AutomateMission_INF_AppuyerUnFreinage_h_
