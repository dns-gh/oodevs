...
#ifndef __MIL_AutomateMission_LOG_SeDeployer_h_
#define __MIL_AutomateMission_LOG_SeDeployer_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_LOG_SeDeployer : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_LOG_SeDeployer )

public:
             MIL_AutomateMission_LOG_SeDeployer( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_LOG_SeDeployer();
...
#endif // __MIL_AutomateMission_LOG_SeDeployer_h_
