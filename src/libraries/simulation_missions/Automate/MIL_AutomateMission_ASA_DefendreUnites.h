...
#ifndef __MIL_AutomateMission_ASA_DefendreUnites_h_
#define __MIL_AutomateMission_ASA_DefendreUnites_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ASA_DefendreUnites : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ASA_DefendreUnites )

public:
             MIL_AutomateMission_ASA_DefendreUnites( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ASA_DefendreUnites();
...
private:
    static int nDIAUnitesIdx_;

};


#endif // __MIL_AutomateMission_ASA_DefendreUnites_h_
