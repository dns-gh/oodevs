...
#ifndef __MIL_AutomateMission_ABC_Tenir_h_
#define __MIL_AutomateMission_ABC_Tenir_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_Tenir : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_Tenir )

public:
             MIL_AutomateMission_ABC_Tenir( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_Tenir();
...
#endif // __MIL_AutomateMission_ABC_Tenir_h_
