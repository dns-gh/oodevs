...
#ifndef __MIL_AutomateMission_INF_AppuyerUneAttaque_h_
#define __MIL_AutomateMission_INF_AppuyerUneAttaque_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_AppuyerUneAttaque : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_AppuyerUneAttaque )

public:
             MIL_AutomateMission_INF_AppuyerUneAttaque( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_AppuyerUneAttaque();
...
#endif // __MIL_AutomateMission_INF_AppuyerUneAttaque_h_
