...
#ifndef __MIL_AutomateMission_ABC_EffectuerRaid_h_
#define __MIL_AutomateMission_ABC_EffectuerRaid_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_EffectuerRaid : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_EffectuerRaid )

public:
             MIL_AutomateMission_ABC_EffectuerRaid( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_EffectuerRaid();
...
#endif // __MIL_AutomateMission_ABC_EffectuerRaid_h_
