...
#ifndef __MIL_AutomateMission_ALAT_Jalonner_h_
#define __MIL_AutomateMission_ALAT_Jalonner_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ALAT_Jalonner : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_Jalonner )

public:
             MIL_AutomateMission_ALAT_Jalonner( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_Jalonner();
...
#endif // __MIL_AutomateMission_ALAT_Jalonner_h_
