...
#ifndef __MIL_AutomateMission_SeRendre_h_
#define __MIL_AutomateMission_SeRendre_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_SeRendre : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_SeRendre )

public:
             MIL_AutomateMission_SeRendre( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_SeRendre();
...
#endif // __MIL_AutomateMission_SeRendre_h_
