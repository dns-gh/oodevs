...
#ifndef __MIL_AutomateMission_NBC_ArmerUnSiteDeDecontamination_h_
#define __MIL_AutomateMission_NBC_ArmerUnSiteDeDecontamination_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_NBC_ArmerUnSiteDeDecontamination : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_NBC_ArmerUnSiteDeDecontamination )

public:
             MIL_AutomateMission_NBC_ArmerUnSiteDeDecontamination( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_NBC_ArmerUnSiteDeDecontamination();
...
#endif // __MIL_AutomateMission_NBC_ArmerUnSiteDeDecontamination_h_
