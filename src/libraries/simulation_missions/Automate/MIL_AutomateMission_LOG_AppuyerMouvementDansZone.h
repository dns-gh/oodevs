...
#ifndef __MIL_AutomateMission_LOG_AppuyerMouvementDansZone_h_
#define __MIL_AutomateMission_LOG_AppuyerMouvementDansZone_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_LOG_AppuyerMouvementDansZone : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_LOG_AppuyerMouvementDansZone )

public:
             MIL_AutomateMission_LOG_AppuyerMouvementDansZone( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_LOG_AppuyerMouvementDansZone();
...
#endif // __MIL_AutomateMission_LOG_AppuyerMouvementDansZone_h_
