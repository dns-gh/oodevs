...
#ifndef __MIL_AutomateMission_GEN_RealiserTravaux_h_
#define __MIL_AutomateMission_GEN_RealiserTravaux_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_GEN_RealiserTravaux : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_GEN_RealiserTravaux )

public:
             MIL_AutomateMission_GEN_RealiserTravaux( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_GEN_RealiserTravaux();
...
#endif // __MIL_AutomateMission_GEN_RealiserTravaux_h_
