...
#ifndef __MIL_AutomateMission_RENS_ROHUM_OrienterGuider_h_
#define __MIL_AutomateMission_RENS_ROHUM_OrienterGuider_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_RENS_ROHUM_OrienterGuider : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_RENS_ROHUM_OrienterGuider )

public:
             MIL_AutomateMission_RENS_ROHUM_OrienterGuider( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_RENS_ROHUM_OrienterGuider();
...
private:
    static int nDIAAmiIdx_;

};


#endif // __MIL_AutomateMission_RENS_ROHUM_OrienterGuider_h_
