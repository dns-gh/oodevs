...
#ifndef __MIL_AutomateMission_InterdireFranchissementPopulations_h_
#define __MIL_AutomateMission_InterdireFranchissementPopulations_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_InterdireFranchissementPopulations : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_InterdireFranchissementPopulations )

public:
             MIL_AutomateMission_InterdireFranchissementPopulations( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_InterdireFranchissementPopulations();
...
#endif // __MIL_AutomateMission_InterdireFranchissementPopulations_h_
