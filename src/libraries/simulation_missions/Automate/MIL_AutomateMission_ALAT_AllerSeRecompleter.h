...
#ifndef __MIL_AutomateMission_ALAT_AllerSeRecompleter_h_
#define __MIL_AutomateMission_ALAT_AllerSeRecompleter_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ALAT_AllerSeRecompleter : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_AllerSeRecompleter )

public:
             MIL_AutomateMission_ALAT_AllerSeRecompleter( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_AllerSeRecompleter();
...
#endif // __MIL_AutomateMission_ALAT_AllerSeRecompleter_h_
