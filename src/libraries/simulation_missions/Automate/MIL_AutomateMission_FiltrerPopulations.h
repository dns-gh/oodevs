...
#ifndef __MIL_AutomateMission_FiltrerPopulations_h_
#define __MIL_AutomateMission_FiltrerPopulations_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_FiltrerPopulations : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_FiltrerPopulations )

public:
             MIL_AutomateMission_FiltrerPopulations( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_FiltrerPopulations();
...
#endif // __MIL_AutomateMission_FiltrerPopulations_h_
