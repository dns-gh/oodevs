...
#ifndef __MIL_OrderConduite_Automate_ReagirFaceAEni_h_
#define __MIL_OrderConduite_Automate_ReagirFaceAEni_h_

#include "MIL/Entities/Orders/Conduite/MIL_OrderConduite_ABC.h"
#include "TER/TER_Localisation.h"

// =============================================================================
/** @class  MIL_OrderConduite_Automate_ReagirFaceAEni
    @brief  MIL_OrderConduite_Automate_ReagirFaceAEni
*/
// Created: AGR 
// =============================================================================
class MIL_OrderConduite_Automate_ReagirFaceAEni : public MIL_OrderConduite_ABC
{
...
private:
    ...
    static int nDIAActionIdx_;

};

#endif // __MIL_OrderConduite_Automate_ReagirFaceAEni_h_
