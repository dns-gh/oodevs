...
// Created: AGR 
//-----------------------------------------------------------------------------
MIL_OrderConduite_PasserEnSilenceRadio::MIL_OrderConduite_PasserEnSilenceRadio( const MIL_OrderConduiteType& type, const MIL_KnowledgeGroup* pKnowledgeGroup )
