...
#include "MIL_OrderConduite_ModifierPrioritesBlesses.h"
...
int MIL_OrderConduite_ModifierPrioritesBlesses::nDIAOrderConduiteModifierPrioritesBlessesIdx_ = 0 ;
...
void MIL_OrderConduite_ModifierPrioritesBlesses::InitializeDIA( const MIL_OrderConduiteType& type )
{
    ...
    nDIAOrderConduiteModifierPrioritesBlessesIdx_ = DEC_Tools::InitializeDIAField( "orderConduiteModifierPrioritesBlesses_", diaType );
...
// Created: AGR 
//-----------------------------------------------------------------------------
MIL_OrderConduite_ModifierPrioritesBlesses::MIL_OrderConduite_ModifierPrioritesBlesses( const MIL_OrderConduiteType& type, const MIL_KnowledgeGroup* pKnowledgeGroup )
