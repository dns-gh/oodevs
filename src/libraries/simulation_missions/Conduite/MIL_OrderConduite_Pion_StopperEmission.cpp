...
// Created: AGR 
//-----------------------------------------------------------------------------
MIL_OrderConduite_Pion_StopperEmission::MIL_OrderConduite_Pion_StopperEmission( const MIL_OrderConduiteType& type, const MIL_KnowledgeGroup* pKnowledgeGroup )
