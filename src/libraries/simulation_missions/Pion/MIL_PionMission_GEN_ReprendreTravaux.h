...
#ifndef __MIL_PionMission_GEN_ReprendreTravaux_h_
#define __MIL_PionMission_GEN_ReprendreTravaux_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_ReprendreTravaux: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_ReprendreTravaux )

public:

             MIL_PionMission_GEN_ReprendreTravaux( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_ReprendreTravaux();
...
#endif // __MIL_PionMission_GEN_ReprendreTravaux_h_
