...
#ifndef __MIL_PionMission_RENS_ROIM_SDTI_RenseignerSur_h_
#define __MIL_PionMission_RENS_ROIM_SDTI_RenseignerSur_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_RENS_ROIM_SDTI_RenseignerSur: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_RENS_ROIM_SDTI_RenseignerSur )

public:

             MIL_PionMission_RENS_ROIM_SDTI_RenseignerSur( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_RENS_ROIM_SDTI_RenseignerSur();
...
#endif // __MIL_PionMission_RENS_ROIM_SDTI_RenseignerSur_h_
