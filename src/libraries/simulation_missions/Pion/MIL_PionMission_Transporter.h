...
#ifndef __MIL_PionMission_Transporter_h_
#define __MIL_PionMission_Transporter_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_Transporter: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_Transporter )

public:

             MIL_PionMission_Transporter( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_Transporter();
...
#endif // __MIL_PionMission_Transporter_h_
