...
#ifndef __MIL_PionMission_ASS_RATAC_AcquerirObjectifs_h_
#define __MIL_PionMission_ASS_RATAC_AcquerirObjectifs_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASS_RATAC_AcquerirObjectifs: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASS_RATAC_AcquerirObjectifs )

public:

             MIL_PionMission_ASS_RATAC_AcquerirObjectifs( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASS_RATAC_AcquerirObjectifs();
...
#endif // __MIL_PionMission_ASS_RATAC_AcquerirObjectifs_h_
