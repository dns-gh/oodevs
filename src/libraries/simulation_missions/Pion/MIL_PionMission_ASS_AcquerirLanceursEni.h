...
#ifndef __MIL_PionMission_ASS_AcquerirLanceursEni_h_
#define __MIL_PionMission_ASS_AcquerirLanceursEni_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASS_AcquerirLanceursEni: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASS_AcquerirLanceursEni )

public:

             MIL_PionMission_ASS_AcquerirLanceursEni( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASS_AcquerirLanceursEni();
...
#endif // __MIL_PionMission_ASS_AcquerirLanceursEni_h_
