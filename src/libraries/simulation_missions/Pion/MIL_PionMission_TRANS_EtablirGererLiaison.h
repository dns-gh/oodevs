...
#ifndef __MIL_PionMission_TRANS_EtablirGererLiaison_h_
#define __MIL_PionMission_TRANS_EtablirGererLiaison_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_TRANS_EtablirGererLiaison: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_TRANS_EtablirGererLiaison )

public:

             MIL_PionMission_TRANS_EtablirGererLiaison( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_TRANS_EtablirGererLiaison();
...
#endif // __MIL_PionMission_TRANS_EtablirGererLiaison_h_
