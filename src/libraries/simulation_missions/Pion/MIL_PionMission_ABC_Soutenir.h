...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_Soutenir: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_Soutenir )

public:

             MIL_PionMission_ABC_Soutenir( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_Soutenir();
...
#endif // __MIL_PionMission_ABC_Soutenir_h_
