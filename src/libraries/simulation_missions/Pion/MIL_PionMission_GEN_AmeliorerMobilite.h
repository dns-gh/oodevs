...
#ifndef __MIL_PionMission_GEN_AmeliorerMobilite_h_
#define __MIL_PionMission_GEN_AmeliorerMobilite_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_AmeliorerMobilite: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_AmeliorerMobilite )

public:

             MIL_PionMission_GEN_AmeliorerMobilite( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_AmeliorerMobilite();
...
#endif // __MIL_PionMission_GEN_AmeliorerMobilite_h_
