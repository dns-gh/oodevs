...
#ifndef __MIL_PionMission_ALAT_EvacuationSanitaire_h_
#define __MIL_PionMission_ALAT_EvacuationSanitaire_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ALAT_EvacuationSanitaire: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_EvacuationSanitaire )

public:

             MIL_PionMission_ALAT_EvacuationSanitaire( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_EvacuationSanitaire();
...
private:
    ...
    static int nDIAZoneExtractionIdx_;
...
#endif // __MIL_PionMission_ALAT_EvacuationSanitaire_h_
