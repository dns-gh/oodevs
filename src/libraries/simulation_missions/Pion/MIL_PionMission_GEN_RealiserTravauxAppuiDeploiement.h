...
#ifndef __MIL_PionMission_GEN_RealiserTravauxAppuiDeploiement_h_
#define __MIL_PionMission_GEN_RealiserTravauxAppuiDeploiement_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_RealiserTravauxAppuiDeploiement: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_RealiserTravauxAppuiDeploiement )

public:

             MIL_PionMission_GEN_RealiserTravauxAppuiDeploiement( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_RealiserTravauxAppuiDeploiement();
...
#endif // __MIL_PionMission_GEN_RealiserTravauxAppuiDeploiement_h_
