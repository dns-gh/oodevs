...
#ifndef __MIL_PionMission_ASA_MISTRAL_DefendreSiteAPartirPosition_h_
#define __MIL_PionMission_ASA_MISTRAL_DefendreSiteAPartirPosition_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASA_MISTRAL_DefendreSiteAPartirPosition: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASA_MISTRAL_DefendreSiteAPartirPosition )

public:

             MIL_PionMission_ASA_MISTRAL_DefendreSiteAPartirPosition( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASA_MISTRAL_DefendreSiteAPartirPosition();
...
#endif // __MIL_PionMission_ASA_MISTRAL_DefendreSiteAPartirPosition_h_
