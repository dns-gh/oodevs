...
#ifndef __MIL_PionMission_LOG_TrierBlesses_h_
#define __MIL_PionMission_LOG_TrierBlesses_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_LOG_TrierBlesses: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_TrierBlesses )

public:

             MIL_PionMission_LOG_TrierBlesses( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_TrierBlesses();
...
#endif // __MIL_PionMission_LOG_TrierBlesses_h_
