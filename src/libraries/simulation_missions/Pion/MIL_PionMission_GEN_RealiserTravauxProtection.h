...
#ifndef __MIL_PionMission_GEN_RealiserTravauxProtection_h_
#define __MIL_PionMission_GEN_RealiserTravauxProtection_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_RealiserTravauxProtection: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_RealiserTravauxProtection )

public:

             MIL_PionMission_GEN_RealiserTravauxProtection( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_RealiserTravauxProtection();
...
#endif // __MIL_PionMission_GEN_RealiserTravauxProtection_h_
