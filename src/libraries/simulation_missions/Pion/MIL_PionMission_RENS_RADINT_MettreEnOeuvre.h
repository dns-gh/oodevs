...
#ifndef __MIL_PionMission_RENS_RADINT_MettreEnOeuvre_h_
#define __MIL_PionMission_RENS_RADINT_MettreEnOeuvre_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_RENS_RADINT_MettreEnOeuvre: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_RENS_RADINT_MettreEnOeuvre )

public:

             MIL_PionMission_RENS_RADINT_MettreEnOeuvre( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_RENS_RADINT_MettreEnOeuvre();
...
#endif // __MIL_PionMission_RENS_RADINT_MettreEnOeuvre_h_
