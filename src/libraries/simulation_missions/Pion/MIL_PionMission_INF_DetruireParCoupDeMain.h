...
#ifndef __MIL_PionMission_INF_DetruireParCoupDeMain_h_
#define __MIL_PionMission_INF_DetruireParCoupDeMain_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_DetruireParCoupDeMain: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_DetruireParCoupDeMain )

public:

             MIL_PionMission_INF_DetruireParCoupDeMain( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_DetruireParCoupDeMain();
...
#endif // __MIL_PionMission_INF_DetruireParCoupDeMain_h_
