...
#ifndef __MIL_PionMission_Test_MoveTo_h_
#define __MIL_PionMission_Test_MoveTo_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_Test_MoveTo: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_Test_MoveTo )

public:

             MIL_PionMission_Test_MoveTo( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_Test_MoveTo();
...
private:
    ...
    static int nDIATypeItineraireIdx_;
    static int nDIADebarqueIdx_;
    static int nDIAVerrouillageVisionIdx_;
...
#endif // __MIL_PionMission_Test_MoveTo_h_
