...
#ifndef __MIL_PionMission_GEN_DepolluerZone_h_
#define __MIL_PionMission_GEN_DepolluerZone_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_DepolluerZone: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_DepolluerZone )

public:

             MIL_PionMission_GEN_DepolluerZone( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_DepolluerZone();
...
#endif // __MIL_PionMission_GEN_DepolluerZone_h_
