...
#ifndef __MIL_PionMission_ASY_CommettreAttentatContreForcesArmees_h_
#define __MIL_PionMission_ASY_CommettreAttentatContreForcesArmees_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASY_CommettreAttentatContreForcesArmees: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASY_CommettreAttentatContreForcesArmees )

public:

             MIL_PionMission_ASY_CommettreAttentatContreForcesArmees( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASY_CommettreAttentatContreForcesArmees();
...
#endif // __MIL_PionMission_ASY_CommettreAttentatContreForcesArmees_h_
