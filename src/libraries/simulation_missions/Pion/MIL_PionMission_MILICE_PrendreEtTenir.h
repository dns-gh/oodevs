...
#ifndef __MIL_PionMission_MILICE_PrendreEtTenir_h_
#define __MIL_PionMission_MILICE_PrendreEtTenir_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_MILICE_PrendreEtTenir: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_MILICE_PrendreEtTenir )

public:

             MIL_PionMission_MILICE_PrendreEtTenir( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_MILICE_PrendreEtTenir();
...
private:
    static int nDIAPointAPrendreIdx_;

};


#endif // __MIL_PionMission_MILICE_PrendreEtTenir_h_
