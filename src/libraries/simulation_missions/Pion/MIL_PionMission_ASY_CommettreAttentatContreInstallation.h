...
#ifndef __MIL_PionMission_ASY_CommettreAttentatContreInstallation_h_
#define __MIL_PionMission_ASY_CommettreAttentatContreInstallation_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASY_CommettreAttentatContreInstallation: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASY_CommettreAttentatContreInstallation )

public:

             MIL_PionMission_ASY_CommettreAttentatContreInstallation( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASY_CommettreAttentatContreInstallation();
...
#endif // __MIL_PionMission_ASY_CommettreAttentatContreInstallation_h_
