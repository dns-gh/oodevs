...
#ifndef __MIL_PionMission_Test_CreateBypass_h_
#define __MIL_PionMission_Test_CreateBypass_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_Test_CreateBypass: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_Test_CreateBypass )

public:

             MIL_PionMission_Test_CreateBypass( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_Test_CreateBypass();
...
#endif // __MIL_PionMission_Test_CreateBypass_h_
