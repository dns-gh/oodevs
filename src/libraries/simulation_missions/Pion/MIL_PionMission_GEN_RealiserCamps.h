...
#ifndef __MIL_PionMission_GEN_RealiserCamps_h_
#define __MIL_PionMission_GEN_RealiserCamps_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_RealiserCamps: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_RealiserCamps )

public:

             MIL_PionMission_GEN_RealiserCamps( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_RealiserCamps();
...
#endif // __MIL_PionMission_GEN_RealiserCamps_h_
