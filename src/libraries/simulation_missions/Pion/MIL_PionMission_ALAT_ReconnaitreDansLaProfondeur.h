...
#ifndef __MIL_PionMission_ALAT_ReconnaitreDansLaProfondeur_h_
#define __MIL_PionMission_ALAT_ReconnaitreDansLaProfondeur_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ALAT_ReconnaitreDansLaProfondeur: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_ReconnaitreDansLaProfondeur )

public:

             MIL_PionMission_ALAT_ReconnaitreDansLaProfondeur( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_ReconnaitreDansLaProfondeur();
...
#endif // __MIL_PionMission_ALAT_ReconnaitreDansLaProfondeur_h_
