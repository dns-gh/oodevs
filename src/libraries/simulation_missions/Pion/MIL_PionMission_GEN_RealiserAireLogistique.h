...
#ifndef __MIL_PionMission_GEN_RealiserAireLogistique_h_
#define __MIL_PionMission_GEN_RealiserAireLogistique_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_RealiserAireLogistique: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_RealiserAireLogistique )

public:

             MIL_PionMission_GEN_RealiserAireLogistique( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_RealiserAireLogistique();
...
#endif // __MIL_PionMission_GEN_RealiserAireLogistique_h_
