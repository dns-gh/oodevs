...
#ifndef __MIL_PionMission_ASY_Renseigner_h_
#define __MIL_PionMission_ASY_Renseigner_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASY_Renseigner: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASY_Renseigner )

public:

             MIL_PionMission_ASY_Renseigner( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASY_Renseigner();
...
private:
    static int nDIADestinataireIdx_;

};


#endif // __MIL_PionMission_ASY_Renseigner_h_
