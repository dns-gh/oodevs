...
#ifndef __MIL_PionMission_GEN_RealiserFosseAC_h_
#define __MIL_PionMission_GEN_RealiserFosseAC_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_RealiserFosseAC: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_RealiserFosseAC )

public:

             MIL_PionMission_GEN_RealiserFosseAC( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_RealiserFosseAC();
...
#endif // __MIL_PionMission_GEN_RealiserFosseAC_h_
