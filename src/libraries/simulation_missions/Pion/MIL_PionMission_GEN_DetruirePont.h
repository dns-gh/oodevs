...
#ifndef __MIL_PionMission_GEN_DetruirePont_h_
#define __MIL_PionMission_GEN_DetruirePont_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_DetruirePont: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_DetruirePont )

public:

             MIL_PionMission_GEN_DetruirePont( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_DetruirePont();
...
#endif // __MIL_PionMission_GEN_DetruirePont_h_
