...
#ifndef __MIL_PionMission_LOG_PreparerBascule_h_
#define __MIL_PionMission_LOG_PreparerBascule_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_LOG_PreparerBascule: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_PreparerBascule )

public:

             MIL_PionMission_LOG_PreparerBascule( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_PreparerBascule();
...
private:
    static int nDIAAutomatePourBasculeIdx_;
    static int nDIAResterSurPlaceIdx_;

};


#endif // __MIL_PionMission_LOG_PreparerBascule_h_
