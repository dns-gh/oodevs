...
#ifndef __MIL_PionMission_GEN_ReconnaitreItineraire_h_
#define __MIL_PionMission_GEN_ReconnaitreItineraire_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_ReconnaitreItineraire: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_ReconnaitreItineraire )

public:

             MIL_PionMission_GEN_ReconnaitreItineraire( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_ReconnaitreItineraire();
...
#endif // __MIL_PionMission_GEN_ReconnaitreItineraire_h_
