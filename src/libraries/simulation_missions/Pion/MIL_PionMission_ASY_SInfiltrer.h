...
#ifndef __MIL_PionMission_ASY_SInfiltrer_h_
#define __MIL_PionMission_ASY_SInfiltrer_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASY_SInfiltrer: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASY_SInfiltrer )

public:

             MIL_PionMission_ASY_SInfiltrer( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASY_SInfiltrer();
...
#endif // __MIL_PionMission_ASY_SInfiltrer_h_
