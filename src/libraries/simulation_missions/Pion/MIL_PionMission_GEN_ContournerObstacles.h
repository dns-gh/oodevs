...
#ifndef __MIL_PionMission_GEN_ContournerObstacles_h_
#define __MIL_PionMission_GEN_ContournerObstacles_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_ContournerObstacles: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_ContournerObstacles )

public:

             MIL_PionMission_GEN_ContournerObstacles( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_ContournerObstacles();
...
#endif // __MIL_PionMission_GEN_ContournerObstacles_h_
