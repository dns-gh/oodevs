...
#ifndef __MIL_PionMission_NBC_ReconnaitreZone_h_
#define __MIL_PionMission_NBC_ReconnaitreZone_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_NBC_ReconnaitreZone: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_NBC_ReconnaitreZone )

public:

             MIL_PionMission_NBC_ReconnaitreZone( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_NBC_ReconnaitreZone();
...
#endif // __MIL_PionMission_NBC_ReconnaitreZone_h_
