...
#ifndef __MIL_PionMission_LOG_AppuyerFranchissementSurUnPoint_h_
#define __MIL_PionMission_LOG_AppuyerFranchissementSurUnPoint_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_LOG_AppuyerFranchissementSurUnPoint: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_AppuyerFranchissementSurUnPoint )

public:

             MIL_PionMission_LOG_AppuyerFranchissementSurUnPoint( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_AppuyerFranchissementSurUnPoint();
...
#endif // __MIL_PionMission_LOG_AppuyerFranchissementSurUnPoint_h_
