...
#ifndef __MIL_PionMission_ALAT_DetruireNeutraliserDansZone_h_
#define __MIL_PionMission_ALAT_DetruireNeutraliserDansZone_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ALAT_DetruireNeutraliserDansZone: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_DetruireNeutraliserDansZone )

public:

             MIL_PionMission_ALAT_DetruireNeutraliserDansZone( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_DetruireNeutraliserDansZone();
...
#endif // __MIL_PionMission_ALAT_DetruireNeutraliserDansZone_h_
