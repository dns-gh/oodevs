...
#ifndef __MIL_PionMission_Generique_h_
#define __MIL_PionMission_Generique_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_Generique: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_Generique )

public:

             MIL_PionMission_Generique( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_Generique();
...
#endif // __MIL_PionMission_Generique_h_
