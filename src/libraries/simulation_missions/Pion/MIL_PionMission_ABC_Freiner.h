...
#ifndef __MIL_PionMission_ABC_Freiner_h_
#define __MIL_PionMission_ABC_Freiner_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_Freiner: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_Freiner )

public:

             MIL_PionMission_ABC_Freiner( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_Freiner();
...
#endif // __MIL_PionMission_ABC_Freiner_h_
