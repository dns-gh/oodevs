...
#ifndef __MIL_PionMission_FaireMouvement_h_
#define __MIL_PionMission_FaireMouvement_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_FaireMouvement: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_FaireMouvement )

public:

             MIL_PionMission_FaireMouvement( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_FaireMouvement();
...
#endif // __MIL_PionMission_FaireMouvement_h_
