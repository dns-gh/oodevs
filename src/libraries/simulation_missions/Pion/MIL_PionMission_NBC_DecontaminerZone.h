...
#ifndef __MIL_PionMission_NBC_DecontaminerZone_h_
#define __MIL_PionMission_NBC_DecontaminerZone_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_NBC_DecontaminerZone: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_NBC_DecontaminerZone )

public:

             MIL_PionMission_NBC_DecontaminerZone( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_NBC_DecontaminerZone();
...
#endif // __MIL_PionMission_NBC_DecontaminerZone_h_
