...
#ifndef __MIL_PionMission_INF_ContreAttaquer_h_
#define __MIL_PionMission_INF_ContreAttaquer_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_ContreAttaquer: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_ContreAttaquer )

public:

             MIL_PionMission_INF_ContreAttaquer( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_ContreAttaquer();
...
#endif // __MIL_PionMission_INF_ContreAttaquer_h_
