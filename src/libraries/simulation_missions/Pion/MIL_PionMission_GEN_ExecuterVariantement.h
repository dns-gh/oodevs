...
#ifndef __MIL_PionMission_GEN_ExecuterVariantement_h_
#define __MIL_PionMission_GEN_ExecuterVariantement_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_ExecuterVariantement: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_ExecuterVariantement )

public:

             MIL_PionMission_GEN_ExecuterVariantement( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_ExecuterVariantement();
...
#endif // __MIL_PionMission_GEN_ExecuterVariantement_h_
