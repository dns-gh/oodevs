...
#ifndef __MIL_PionMission_ABC_FlancGarder_h_
#define __MIL_PionMission_ABC_FlancGarder_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_FlancGarder: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_FlancGarder )

public:

             MIL_PionMission_ABC_FlancGarder( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_FlancGarder();
...
#endif // __MIL_PionMission_ABC_FlancGarder_h_
