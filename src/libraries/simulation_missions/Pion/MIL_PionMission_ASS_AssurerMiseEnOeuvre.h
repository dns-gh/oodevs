...
#ifndef __MIL_PionMission_ASS_AssurerMiseEnOeuvre_h_
#define __MIL_PionMission_ASS_AssurerMiseEnOeuvre_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASS_AssurerMiseEnOeuvre: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASS_AssurerMiseEnOeuvre )

public:

             MIL_PionMission_ASS_AssurerMiseEnOeuvre( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASS_AssurerMiseEnOeuvre();
...
#endif // __MIL_PionMission_ASS_AssurerMiseEnOeuvre_h_
