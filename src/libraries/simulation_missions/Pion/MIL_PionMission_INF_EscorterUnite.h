...
#ifndef __MIL_PionMission_INF_EscorterUnite_h_
#define __MIL_PionMission_INF_EscorterUnite_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_EscorterUnite: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_EscorterUnite )

public:

             MIL_PionMission_INF_EscorterUnite( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_EscorterUnite();
...
#endif // __MIL_PionMission_INF_EscorterUnite_h_
