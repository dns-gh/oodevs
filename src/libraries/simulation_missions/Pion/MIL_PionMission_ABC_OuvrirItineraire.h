...
#ifndef __MIL_PionMission_ABC_OuvrirItineraire_h_
#define __MIL_PionMission_ABC_OuvrirItineraire_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_OuvrirItineraire: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_OuvrirItineraire )

public:

             MIL_PionMission_ABC_OuvrirItineraire( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_OuvrirItineraire();
...
#endif // __MIL_PionMission_ABC_OuvrirItineraire_h_
