...
#ifndef __MIL_PionMission_ABC_Fixer_h_
#define __MIL_PionMission_ABC_Fixer_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_Fixer: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_Fixer )

public:

             MIL_PionMission_ABC_Fixer( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_Fixer();
...
private:
    static int nDIAUniteAFixerIdx_;

};


#endif // __MIL_PionMission_ABC_Fixer_h_
