...
#ifndef __MIL_PionMission_GEN_DeminerSiteFranchissement_h_
#define __MIL_PionMission_GEN_DeminerSiteFranchissement_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_DeminerSiteFranchissement: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_DeminerSiteFranchissement )

public:

             MIL_PionMission_GEN_DeminerSiteFranchissement( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_DeminerSiteFranchissement();
...
#endif // __MIL_PionMission_GEN_DeminerSiteFranchissement_h_
