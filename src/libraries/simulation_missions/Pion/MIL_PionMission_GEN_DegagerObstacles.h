...
#ifndef __MIL_PionMission_GEN_DegagerObstacles_h_
#define __MIL_PionMission_GEN_DegagerObstacles_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_DegagerObstacles: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_DegagerObstacles )

public:

             MIL_PionMission_GEN_DegagerObstacles( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_DegagerObstacles();
...
#endif // __MIL_PionMission_GEN_DegagerObstacles_h_
