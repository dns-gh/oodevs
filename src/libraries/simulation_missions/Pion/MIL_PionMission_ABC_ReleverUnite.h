...
#ifndef __MIL_PionMission_ABC_ReleverUnite_h_
#define __MIL_PionMission_ABC_ReleverUnite_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_ReleverUnite: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_ReleverUnite )

public:

             MIL_PionMission_ABC_ReleverUnite( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_ReleverUnite();
...
private:
    static int nDIAUniteAReleverIdx_;

};


#endif // __MIL_PionMission_ABC_ReleverUnite_h_
