...
#ifndef __MIL_PionMission_LOG_AppuyerMouvement_h_
#define __MIL_PionMission_LOG_AppuyerMouvement_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_LOG_AppuyerMouvement: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_AppuyerMouvement )

public:

             MIL_PionMission_LOG_AppuyerMouvement( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_AppuyerMouvement();
...
#endif // __MIL_PionMission_LOG_AppuyerMouvement_h_
