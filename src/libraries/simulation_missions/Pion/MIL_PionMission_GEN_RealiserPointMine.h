...
#ifndef __MIL_PionMission_GEN_RealiserPointMine_h_
#define __MIL_PionMission_GEN_RealiserPointMine_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_RealiserPointMine: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_RealiserPointMine )

public:

             MIL_PionMission_GEN_RealiserPointMine( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_RealiserPointMine();
...
#endif // __MIL_PionMission_GEN_RealiserPointMine_h_
