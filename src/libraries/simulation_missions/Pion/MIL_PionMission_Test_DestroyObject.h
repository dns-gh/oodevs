...
#ifndef __MIL_PionMission_Test_DestroyObject_h_
#define __MIL_PionMission_Test_DestroyObject_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_Test_DestroyObject: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_Test_DestroyObject )

public:

             MIL_PionMission_Test_DestroyObject( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_Test_DestroyObject();
...
private:
    static int nDIAObjetIdx_;

};


#endif // __MIL_PionMission_Test_DestroyObject_h_
