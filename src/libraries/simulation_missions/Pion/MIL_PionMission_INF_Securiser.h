...
#ifndef __MIL_PionMission_INF_Securiser_h_
#define __MIL_PionMission_INF_Securiser_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_Securiser: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_Securiser )

public:

             MIL_PionMission_INF_Securiser( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_Securiser();
...
#endif // __MIL_PionMission_INF_Securiser_h_
