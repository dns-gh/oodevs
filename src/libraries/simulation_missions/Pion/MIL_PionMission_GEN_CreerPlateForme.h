...
#ifndef __MIL_PionMission_GEN_CreerPlateForme_h_
#define __MIL_PionMission_GEN_CreerPlateForme_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_CreerPlateForme: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_CreerPlateForme )

public:

             MIL_PionMission_GEN_CreerPlateForme( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_CreerPlateForme();
...
#endif // __MIL_PionMission_GEN_CreerPlateForme_h_
