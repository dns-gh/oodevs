...
#ifndef __MIL_PionMission_ALAT_DetruireAeromobile_h_
#define __MIL_PionMission_ALAT_DetruireAeromobile_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ALAT_DetruireAeromobile: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_DetruireAeromobile )

public:

             MIL_PionMission_ALAT_DetruireAeromobile( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_DetruireAeromobile();
...
private:
    static int nDIAUniteADetruireIdx_;
...
#endif // __MIL_PionMission_ALAT_DetruireAeromobile_h_
