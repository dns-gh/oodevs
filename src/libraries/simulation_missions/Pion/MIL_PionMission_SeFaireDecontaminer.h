...
#ifndef __MIL_PionMission_SeFaireDecontaminer_h_
#define __MIL_PionMission_SeFaireDecontaminer_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_SeFaireDecontaminer: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_SeFaireDecontaminer )

public:

             MIL_PionMission_SeFaireDecontaminer( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_SeFaireDecontaminer();
...
#endif // __MIL_PionMission_SeFaireDecontaminer_h_
