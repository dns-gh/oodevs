...
#ifndef __MIL_PionMission_ASA_DefendreUnites_h_
#define __MIL_PionMission_ASA_DefendreUnites_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASA_DefendreUnites: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASA_DefendreUnites )

public:

             MIL_PionMission_ASA_DefendreUnites( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASA_DefendreUnites();
...
#endif // __MIL_PionMission_ASA_DefendreUnites_h_
