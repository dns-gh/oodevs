...
#ifndef __MIL_PionMission_SeFaireTransporter_h_
#define __MIL_PionMission_SeFaireTransporter_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_SeFaireTransporter: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_SeFaireTransporter )

public:

             MIL_PionMission_SeFaireTransporter( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_SeFaireTransporter();
...
#endif // __MIL_PionMission_SeFaireTransporter_h_
