...
#ifndef __MIL_PionMission_INF_OrganiserUnCheckPoint_h_
#define __MIL_PionMission_INF_OrganiserUnCheckPoint_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_OrganiserUnCheckPoint: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_OrganiserUnCheckPoint )

public:

             MIL_PionMission_INF_OrganiserUnCheckPoint( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_OrganiserUnCheckPoint();
...
private:
    static int nDIAPointInstallationIdx_;

};


#endif // __MIL_PionMission_INF_OrganiserUnCheckPoint_h_
