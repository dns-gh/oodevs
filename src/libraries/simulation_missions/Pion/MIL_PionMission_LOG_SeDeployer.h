...
#ifndef __MIL_PionMission_LOG_SeDeployer_h_
#define __MIL_PionMission_LOG_SeDeployer_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_LOG_SeDeployer: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_SeDeployer )

public:

             MIL_PionMission_LOG_SeDeployer( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_SeDeployer();
...
#endif // __MIL_PionMission_LOG_SeDeployer_h_
