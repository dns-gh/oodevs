...
#ifndef __MIL_PionMission_GEN_CreerContournement_h_
#define __MIL_PionMission_GEN_CreerContournement_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_CreerContournement: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_CreerContournement )

public:

             MIL_PionMission_GEN_CreerContournement( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_CreerContournement();
...
#endif // __MIL_PionMission_GEN_CreerContournement_h_
