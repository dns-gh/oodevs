...
#ifndef __MIL_PionMission_ASA_Surveiller_h_
#define __MIL_PionMission_ASA_Surveiller_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASA_Surveiller: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASA_Surveiller )

public:

             MIL_PionMission_ASA_Surveiller( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASA_Surveiller();
...
#endif // __MIL_PionMission_ASA_Surveiller_h_
