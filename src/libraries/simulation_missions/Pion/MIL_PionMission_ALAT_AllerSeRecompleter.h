...
#ifndef __MIL_PionMission_ALAT_AllerSeRecompleter_h_
#define __MIL_PionMission_ALAT_AllerSeRecompleter_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ALAT_AllerSeRecompleter: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_AllerSeRecompleter )

public:

             MIL_PionMission_ALAT_AllerSeRecompleter( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_AllerSeRecompleter();
...
#endif // __MIL_PionMission_ALAT_AllerSeRecompleter_h_
