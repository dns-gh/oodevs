...
#ifndef __MIL_PionMission_GEN_RealiserTravauxContreMobilite_h_
#define __MIL_PionMission_GEN_RealiserTravauxContreMobilite_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_RealiserTravauxContreMobilite: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_RealiserTravauxContreMobilite )

public:

             MIL_PionMission_GEN_RealiserTravauxContreMobilite( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_RealiserTravauxContreMobilite();
...
#endif // __MIL_PionMission_GEN_RealiserTravauxContreMobilite_h_
