...
#ifndef __MIL_PionMission_GEN_OuvrirItineraire_h_
#define __MIL_PionMission_GEN_OuvrirItineraire_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_OuvrirItineraire: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_OuvrirItineraire )

public:

             MIL_PionMission_GEN_OuvrirItineraire( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_OuvrirItineraire();
...
#endif // __MIL_PionMission_GEN_OuvrirItineraire_h_
