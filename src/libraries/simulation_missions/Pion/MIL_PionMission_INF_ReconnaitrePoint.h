...
#ifndef __MIL_PionMission_INF_ReconnaitrePoint_h_
#define __MIL_PionMission_INF_ReconnaitrePoint_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_ReconnaitrePoint: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_ReconnaitrePoint )

public:

             MIL_PionMission_INF_ReconnaitrePoint( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_ReconnaitrePoint();
...
#endif // __MIL_PionMission_INF_ReconnaitrePoint_h_
