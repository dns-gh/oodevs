...
#ifndef __MIL_PionMission_ALAT_HeliporterHelitransporterPlotRavitaillement_h_
#define __MIL_PionMission_ALAT_HeliporterHelitransporterPlotRavitaillement_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ALAT_HeliporterHelitransporterPlotRavitaillement: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_HeliporterHelitransporterPlotRavitaillement )

public:

             MIL_PionMission_ALAT_HeliporterHelitransporterPlotRavitaillement( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_HeliporterHelitransporterPlotRavitaillement();
...
#endif // __MIL_PionMission_ALAT_HeliporterHelitransporterPlotRavitaillement_h_
