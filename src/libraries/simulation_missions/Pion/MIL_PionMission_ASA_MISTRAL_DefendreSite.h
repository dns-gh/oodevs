...
#ifndef __MIL_PionMission_ASA_MISTRAL_DefendreSite_h_
#define __MIL_PionMission_ASA_MISTRAL_DefendreSite_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASA_MISTRAL_DefendreSite: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASA_MISTRAL_DefendreSite )

public:

             MIL_PionMission_ASA_MISTRAL_DefendreSite( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASA_MISTRAL_DefendreSite();
...
#endif // __MIL_PionMission_ASA_MISTRAL_DefendreSite_h_
