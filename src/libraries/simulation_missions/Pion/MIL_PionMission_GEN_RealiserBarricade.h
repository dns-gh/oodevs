...
#ifndef __MIL_PionMission_GEN_RealiserBarricade_h_
#define __MIL_PionMission_GEN_RealiserBarricade_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_RealiserBarricade: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_RealiserBarricade )

public:

             MIL_PionMission_GEN_RealiserBarricade( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_RealiserBarricade();
...
#endif // __MIL_PionMission_GEN_RealiserBarricade_h_
