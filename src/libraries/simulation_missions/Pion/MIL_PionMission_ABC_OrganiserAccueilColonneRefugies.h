...
#ifndef __MIL_PionMission_ABC_OrganiserAccueilColonneRefugies_h_
#define __MIL_PionMission_ABC_OrganiserAccueilColonneRefugies_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_OrganiserAccueilColonneRefugies: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_OrganiserAccueilColonneRefugies )

public:

             MIL_PionMission_ABC_OrganiserAccueilColonneRefugies( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_OrganiserAccueilColonneRefugies();
...
#endif // __MIL_PionMission_ABC_OrganiserAccueilColonneRefugies_h_
