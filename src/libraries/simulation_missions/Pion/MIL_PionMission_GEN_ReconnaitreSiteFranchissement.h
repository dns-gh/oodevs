...
#ifndef __MIL_PionMission_GEN_ReconnaitreSiteFranchissement_h_
#define __MIL_PionMission_GEN_ReconnaitreSiteFranchissement_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_ReconnaitreSiteFranchissement: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_ReconnaitreSiteFranchissement )

public:

             MIL_PionMission_GEN_ReconnaitreSiteFranchissement( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_ReconnaitreSiteFranchissement();
...
#endif // __MIL_PionMission_GEN_ReconnaitreSiteFranchissement_h_
