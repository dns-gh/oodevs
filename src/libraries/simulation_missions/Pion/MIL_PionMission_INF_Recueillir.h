...
#ifndef __MIL_PionMission_INF_Recueillir_h_
#define __MIL_PionMission_INF_Recueillir_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_Recueillir: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_Recueillir )

public:

             MIL_PionMission_INF_Recueillir( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_Recueillir();
...
#endif // __MIL_PionMission_INF_Recueillir_h_
