...
#ifndef __MIL_PionMission_GEN_DegagerRues_h_
#define __MIL_PionMission_GEN_DegagerRues_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_DegagerRues: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_DegagerRues )

public:

             MIL_PionMission_GEN_DegagerRues( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_DegagerRues();
...
#endif // __MIL_PionMission_GEN_DegagerRues_h_
