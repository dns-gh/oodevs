...
#ifndef __MIL_PionMission_ALAT_Helitransporter_h_
#define __MIL_PionMission_ALAT_Helitransporter_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ALAT_Helitransporter: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_Helitransporter )

public:

             MIL_PionMission_ALAT_Helitransporter( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_Helitransporter();
...
#endif // __MIL_PionMission_ALAT_Helitransporter_h_
