...
#ifndef __MIL_PionMission_INF_Soutenir_h_
#define __MIL_PionMission_INF_Soutenir_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_Soutenir: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_Soutenir )

public:

             MIL_PionMission_INF_Soutenir( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_Soutenir();
...
private:
    static int nDIAUniteASoutenirIdx_;

};


#endif // __MIL_PionMission_INF_Soutenir_h_
