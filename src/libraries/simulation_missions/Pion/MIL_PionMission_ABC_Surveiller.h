...
#ifndef __MIL_PionMission_ABC_Surveiller_h_
#define __MIL_PionMission_ABC_Surveiller_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_Surveiller: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_Surveiller )

public:

             MIL_PionMission_ABC_Surveiller( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_Surveiller();
...
#endif // __MIL_PionMission_ABC_Surveiller_h_
