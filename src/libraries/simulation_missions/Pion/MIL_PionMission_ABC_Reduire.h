...
#ifndef __MIL_PionMission_ABC_Reduire_h_
#define __MIL_PionMission_ABC_Reduire_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_Reduire: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_Reduire )

public:

             MIL_PionMission_ABC_Reduire( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_Reduire();
...
private:
    static int nDIAUniteAReduireIdx_;

};


#endif // __MIL_PionMission_ABC_Reduire_h_
