...
#ifndef __MIL_PionMission_Suivre_h_
#define __MIL_PionMission_Suivre_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_Suivre: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_Suivre )

public:

             MIL_PionMission_Suivre( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_Suivre();
...
private:
    static int nDIAUniteASuivreIdx_;

};


#endif // __MIL_PionMission_Suivre_h_
