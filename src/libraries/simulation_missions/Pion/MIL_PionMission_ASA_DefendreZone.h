...
#ifndef __MIL_PionMission_ASA_DefendreZone_h_
#define __MIL_PionMission_ASA_DefendreZone_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASA_DefendreZone: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASA_DefendreZone )

public:

             MIL_PionMission_ASA_DefendreZone( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASA_DefendreZone();
...
#endif // __MIL_PionMission_ASA_DefendreZone_h_
