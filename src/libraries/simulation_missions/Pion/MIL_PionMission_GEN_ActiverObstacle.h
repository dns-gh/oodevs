...
#ifndef __MIL_PionMission_GEN_ActiverObstacle_h_
#define __MIL_PionMission_GEN_ActiverObstacle_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_ActiverObstacle: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_ActiverObstacle )

public:

             MIL_PionMission_GEN_ActiverObstacle( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_ActiverObstacle();
...
#endif // __MIL_PionMission_GEN_ActiverObstacle_h_
