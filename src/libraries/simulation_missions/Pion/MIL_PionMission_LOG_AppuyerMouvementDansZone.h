...
#ifndef __MIL_PionMission_LOG_AppuyerMouvementDansZone_h_
#define __MIL_PionMission_LOG_AppuyerMouvementDansZone_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_LOG_AppuyerMouvementDansZone: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_AppuyerMouvementDansZone )

public:

             MIL_PionMission_LOG_AppuyerMouvementDansZone( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_AppuyerMouvementDansZone();
...
#endif // __MIL_PionMission_LOG_AppuyerMouvementDansZone_h_
