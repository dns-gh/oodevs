...
void asn1Print_ScipioLogRavitaillementIncludes (ASN1ConstCharPtr name, ASN1T_ScipioLogRavitaillementIncludes* pvalue)
{
   char namebuf[512];
...
void ASN1C_ScipioLogRavitaillementIncludes::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioLogRavitaillementIncludes (name, &msgData);
}

void asn1Print_ScipioLogRavitaillementExports (ASN1ConstCharPtr name)
{
}

void ASN1C_ScipioLogRavitaillementExports::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioLogRavitaillementExports (name);
}
