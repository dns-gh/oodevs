...
typedef struct EXTERN ASN1T_ScipioPopulationIncludes {
} ASN1T_ScipioPopulationIncludes;

class EXTERN ASN1C_ScipioPopulationIncludes : public ASN1CType {
public:
   ASN1T_ScipioPopulationIncludes& msgData;
   ASN1C_ScipioPopulationIncludes (
...
EXTERN void asn1Print_ScipioPopulationIncludes (ASN1ConstCharPtr name, ASN1T_ScipioPopulationIncludes* pvalue);
...
class EXTERN ASN1C_ScipioPopulationExports : public ASN1CType {
public:
   ASN1C_ScipioPopulationExports (
...
EXTERN void asn1Print_ScipioPopulationExports (ASN1ConstCharPtr name);
