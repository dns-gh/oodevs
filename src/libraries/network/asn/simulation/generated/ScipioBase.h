...
typedef struct EXTERN ASN1T_ScipioBaseIncludes {
   ASN1OCTET __dummy__;
} ASN1T_ScipioBaseIncludes;

class EXTERN ASN1C_ScipioBaseIncludes : public ASN1CType {
public:
   ASN1T_ScipioBaseIncludes& msgData;
   ASN1C_ScipioBaseIncludes (
...
EXTERN void asn1Print_ScipioBaseIncludes (ASN1ConstCharPtr name, ASN1T_ScipioBaseIncludes* pvalue);
...
class EXTERN ASN1C_ScipioBaseExports : public ASN1CType {
public:
   ASN1C_ScipioBaseExports (
...
EXTERN void asn1Print_ScipioBaseExports (ASN1ConstCharPtr name);
