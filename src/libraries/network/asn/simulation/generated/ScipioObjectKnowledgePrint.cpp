...
void asn1Print_ScipioObjectKnowledgeIncludes (ASN1ConstCharPtr name, ASN1T_ScipioObjectKnowledgeIncludes* pvalue)
{
   char namebuf[512];
...
void ASN1C_ScipioObjectKnowledgeIncludes::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioObjectKnowledgeIncludes (name, &msgData);
}

void asn1Print_ScipioObjectKnowledgeExports (ASN1ConstCharPtr name)
{
}

void ASN1C_ScipioObjectKnowledgeExports::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioObjectKnowledgeExports (name);
}
