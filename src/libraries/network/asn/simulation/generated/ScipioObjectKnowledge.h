...
typedef struct EXTERN ASN1T_ScipioObjectKnowledgeIncludes {
} ASN1T_ScipioObjectKnowledgeIncludes;

class EXTERN ASN1C_ScipioObjectKnowledgeIncludes : public ASN1CType {
public:
   ASN1T_ScipioObjectKnowledgeIncludes& msgData;
   ASN1C_ScipioObjectKnowledgeIncludes (
...
EXTERN void asn1Print_ScipioObjectKnowledgeIncludes (ASN1ConstCharPtr name, ASN1T_ScipioObjectKnowledgeIncludes* pvalue);
...
class EXTERN ASN1C_ScipioObjectKnowledgeExports : public ASN1CType {
public:
   ASN1C_ScipioObjectKnowledgeExports (
...
EXTERN void asn1Print_ScipioObjectKnowledgeExports (ASN1ConstCharPtr name);
...
typedef struct EXTERN ASN1T_MsgObjectKnowledgeUpdate {
   ...
   ASN1T_ListOID  perception_par_compagnie;
