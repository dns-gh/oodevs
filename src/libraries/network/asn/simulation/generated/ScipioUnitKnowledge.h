...
typedef struct EXTERN ASN1T_ScipioUnitKnowledgeIncludes {
} ASN1T_ScipioUnitKnowledgeIncludes;

class EXTERN ASN1C_ScipioUnitKnowledgeIncludes : public ASN1CType {
public:
   ASN1T_ScipioUnitKnowledgeIncludes& msgData;
   ASN1C_ScipioUnitKnowledgeIncludes (
...
EXTERN void asn1Print_ScipioUnitKnowledgeIncludes (ASN1ConstCharPtr name, ASN1T_ScipioUnitKnowledgeIncludes* pvalue);
...
class EXTERN ASN1C_ScipioUnitKnowledgeExports : public ASN1CType {
public:
   ASN1C_ScipioUnitKnowledgeExports (
...
EXTERN void asn1Print_ScipioUnitKnowledgeExports (ASN1ConstCharPtr name);
