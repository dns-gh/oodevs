...
void asn1Print_ScipioAutomateIncludes (ASN1ConstCharPtr name, ASN1T_ScipioAutomateIncludes* pvalue)
{
   char namebuf[512];
...
void ASN1C_ScipioAutomateIncludes::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioAutomateIncludes (name, &msgData);
}

void asn1Print_ScipioAutomateExports (ASN1ConstCharPtr name)
{
}

void ASN1C_ScipioAutomateExports::Print (ASN1ConstCharPtr name)

{
   asn1Print_ScipioAutomateExports (name);
}
