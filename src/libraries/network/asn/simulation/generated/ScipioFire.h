...
typedef struct EXTERN ASN1T_ScipioFireIncludes {
} ASN1T_ScipioFireIncludes;

class EXTERN ASN1C_ScipioFireIncludes : public ASN1CType {
public:
   ASN1T_ScipioFireIncludes& msgData;
   ASN1C_ScipioFireIncludes (
      ASN1MessageBuffer& msgBuf, ASN1T_ScipioFireIncludes& data);
   int Encode ();
   int Decode ();
   void Print (ASN1ConstCharPtr name);
} ;

EXTERN int asn1PE_ScipioFireIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioFireIncludes* pvalue);
EXTERN int asn1PD_ScipioFireIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioFireIncludes* pvalue);

EXTERN void asn1Print_ScipioFireIncludes (ASN1ConstCharPtr name, ASN1T_ScipioFireIncludes* pvalue);
...
class EXTERN ASN1C_ScipioFireExports : public ASN1CType {
public:
   ASN1C_ScipioFireExports (
...
EXTERN int asn1PE_ScipioFireExports (ASN1CTXT* ctxt_p);
EXTERN int asn1PD_ScipioFireExports (ASN1CTXT* ctxt_p);

EXTERN void asn1Print_ScipioFireExports (ASN1ConstCharPtr name);
