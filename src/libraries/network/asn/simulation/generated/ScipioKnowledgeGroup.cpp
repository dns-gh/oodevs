...
ASN1C_ScipioKnowledgeGroupIncludes::ASN1C_ScipioKnowledgeGroupIncludes (
...
EXTERN int asn1PE_ScipioKnowledgeGroupIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioKnowledgeGroupIncludes* pvalue)
{
   ...
   rtdiag ("asn1PE_ScipioKnowledgeGroupIncludes: start\n");
   ...
   rtdiag ("asn1PE_ScipioKnowledgeGroupIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioKnowledgeGroupIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioKnowledgeGroupIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_ScipioKnowledgeGroupIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioKnowledgeGroupIncludes* pvalue)
{
   ...
   rtdiag ("asn1PD_ScipioKnowledgeGroupIncludes: start\n");
   ...
   rtdiag ("asn1PD_ScipioKnowledgeGroupIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioKnowledgeGroupIncludes::Decode ()
{
   return asn1PD_ScipioKnowledgeGroupIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioKnowledgeGroupExports::ASN1C_ScipioKnowledgeGroupExports (
...
EXTERN int asn1PE_ScipioKnowledgeGroupExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_ScipioKnowledgeGroupExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioKnowledgeGroupExports: end\n");
   return (stat);
}

int ASN1C_ScipioKnowledgeGroupExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioKnowledgeGroupExports (mpContext->GetPtr());
   return stat;
}
...
EXTERN int asn1PD_ScipioKnowledgeGroupExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_ScipioKnowledgeGroupExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioKnowledgeGroupExports: end\n");

   return (stat);
}

int ASN1C_ScipioKnowledgeGroupExports::Decode ()
{
   return asn1PD_ScipioKnowledgeGroupExports (mpContext->GetPtr());
}
