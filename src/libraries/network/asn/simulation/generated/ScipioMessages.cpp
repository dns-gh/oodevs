...
ASN1C_ScipioMessagesIncludes::ASN1C_ScipioMessagesIncludes (
...
EXTERN int asn1PE_ScipioMessagesIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioMessagesIncludes* pvalue)
{
   ...
   rtdiag ("asn1PE_ScipioMessagesIncludes: start\n");
   ...
   /* encode scipioLimaLimiteExports */

   PU_PUSHNAME (ctxt_p, "scipioLimaLimiteExports");

   stat = asn1PE_ScipioLimaLimiteExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioOrderExports */

   PU_PUSHNAME (ctxt_p, "scipioOrderExports");

   stat = asn1PE_ScipioOrderExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioControlExports */

   PU_PUSHNAME (ctxt_p, "scipioControlExports");

   stat = asn1PE_ScipioControlExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioKnowledgeGroupExports */

   PU_PUSHNAME (ctxt_p, "scipioKnowledgeGroupExports");

   stat = asn1PE_ScipioKnowledgeGroupExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioFormationExports */

   PU_PUSHNAME (ctxt_p, "scipioFormationExports");

   stat = asn1PE_ScipioFormationExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioFireExports */

   PU_PUSHNAME (ctxt_p, "scipioFireExports");

   stat = asn1PE_ScipioFireExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioUnitExports */

   PU_PUSHNAME (ctxt_p, "scipioUnitExports");

   stat = asn1PE_ScipioUnitExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioUnitKnowledgeExports */

   PU_PUSHNAME (ctxt_p, "scipioUnitKnowledgeExports");

   stat = asn1PE_ScipioUnitKnowledgeExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
   ...
   /* encode scipioObjectKnowledgeExports */

   PU_PUSHNAME (ctxt_p, "scipioObjectKnowledgeExports");

   stat = asn1PE_ScipioObjectKnowledgeExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioPopulationExports */

   PU_PUSHNAME (ctxt_p, "scipioPopulationExports");

   stat = asn1PE_ScipioPopulationExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioPopulationKnowledgeExports */

   PU_PUSHNAME (ctxt_p, "scipioPopulationKnowledgeExports");

   stat = asn1PE_ScipioPopulationKnowledgeExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioLogMaintenanceExports */

   PU_PUSHNAME (ctxt_p, "scipioLogMaintenanceExports");

   stat = asn1PE_ScipioLogMaintenanceExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioLogRavitaillementExports */

   PU_PUSHNAME (ctxt_p, "scipioLogRavitaillementExports");

   stat = asn1PE_ScipioLogRavitaillementExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioLogSanteExports */

   PU_PUSHNAME (ctxt_p, "scipioLogSanteExports");

   stat = asn1PE_ScipioLogSanteExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioAutomateExports */

   PU_PUSHNAME (ctxt_p, "scipioAutomateExports");

   stat = asn1PE_ScipioAutomateExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioArmyExports */

   PU_PUSHNAME (ctxt_p, "scipioArmyExports");

   stat = asn1PE_ScipioArmyExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);

   /* encode scipioAuthExports */

   PU_PUSHNAME (ctxt_p, "scipioAuthExports");

   stat = asn1PE_ScipioAuthExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);


   rtdiag ("asn1PE_ScipioMessagesIncludes: end\n");
   return (stat);
}

int ASN1C_ScipioMessagesIncludes::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioMessagesIncludes (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_ScipioMessagesIncludes (ASN1CTXT* ctxt_p, ASN1T_ScipioMessagesIncludes* pvalue)
{
   ...
   rtdiag ("asn1PD_ScipioMessagesIncludes: start\n");
   ...
   /* decode scipioLimaLimiteExports */

   PU_PUSHNAME (ctxt_p, "scipioLimaLimiteExports");

   stat = asn1PD_ScipioLimaLimiteExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioOrderExports */

   PU_PUSHNAME (ctxt_p, "scipioOrderExports");

   stat = asn1PD_ScipioOrderExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioControlExports */

   PU_PUSHNAME (ctxt_p, "scipioControlExports");

   stat = asn1PD_ScipioControlExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioKnowledgeGroupExports */

   PU_PUSHNAME (ctxt_p, "scipioKnowledgeGroupExports");

   stat = asn1PD_ScipioKnowledgeGroupExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioFormationExports */

   PU_PUSHNAME (ctxt_p, "scipioFormationExports");

   stat = asn1PD_ScipioFormationExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioFireExports */

   PU_PUSHNAME (ctxt_p, "scipioFireExports");

   stat = asn1PD_ScipioFireExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioUnitExports */

   PU_PUSHNAME (ctxt_p, "scipioUnitExports");

   stat = asn1PD_ScipioUnitExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioUnitKnowledgeExports */

   PU_PUSHNAME (ctxt_p, "scipioUnitKnowledgeExports");

   stat = asn1PD_ScipioUnitKnowledgeExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   /* decode scipioObjectKnowledgeExports */

   PU_PUSHNAME (ctxt_p, "scipioObjectKnowledgeExports");

   stat = asn1PD_ScipioObjectKnowledgeExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioPopulationExports */

   PU_PUSHNAME (ctxt_p, "scipioPopulationExports");

   stat = asn1PD_ScipioPopulationExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioPopulationKnowledgeExports */

   PU_PUSHNAME (ctxt_p, "scipioPopulationKnowledgeExports");

   stat = asn1PD_ScipioPopulationKnowledgeExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioLogMaintenanceExports */

   PU_PUSHNAME (ctxt_p, "scipioLogMaintenanceExports");

   stat = asn1PD_ScipioLogMaintenanceExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioLogRavitaillementExports */

   PU_PUSHNAME (ctxt_p, "scipioLogRavitaillementExports");

   stat = asn1PD_ScipioLogRavitaillementExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioLogSanteExports */

   PU_PUSHNAME (ctxt_p, "scipioLogSanteExports");

   stat = asn1PD_ScipioLogSanteExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioAutomateExports */

   PU_PUSHNAME (ctxt_p, "scipioAutomateExports");

   stat = asn1PD_ScipioAutomateExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioArmyExports */

   PU_PUSHNAME (ctxt_p, "scipioArmyExports");

   stat = asn1PD_ScipioArmyExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);

   /* decode scipioAuthExports */

   PU_PUSHNAME (ctxt_p, "scipioAuthExports");

   stat = asn1PD_ScipioAuthExports (ctxt_p);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);


   rtdiag ("asn1PD_ScipioMessagesIncludes: end\n");

   return (stat);
}

int ASN1C_ScipioMessagesIncludes::Decode ()
{
   return asn1PD_ScipioMessagesIncludes (mpContext->GetPtr(), &msgData);
}
...
ASN1C_ScipioMessagesExports::ASN1C_ScipioMessagesExports (
...
EXTERN int asn1PE_ScipioMessagesExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_ScipioMessagesExports: start\n");

   /* NULL */

   rtdiag ("asn1PE_ScipioMessagesExports: end\n");
   return (stat);
}

int ASN1C_ScipioMessagesExports::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_ScipioMessagesExports (mpContext->GetPtr());
   return stat;
}
...
EXTERN int asn1PD_ScipioMessagesExports (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_ScipioMessagesExports: start\n");

   /* NULL */

   rtdiag ("asn1PD_ScipioMessagesExports: end\n");

   return (stat);
}

int ASN1C_ScipioMessagesExports::Decode ()
{
   return asn1PD_ScipioMessagesExports (mpContext->GetPtr());
}
