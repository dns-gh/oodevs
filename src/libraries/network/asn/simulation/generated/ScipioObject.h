...
typedef struct EXTERN ASN1T_ScipioObjectIncludes {
} ASN1T_ScipioObjectIncludes;

class EXTERN ASN1C_ScipioObjectIncludes : public ASN1CType {
public:
   ASN1T_ScipioObjectIncludes& msgData;
   ASN1C_ScipioObjectIncludes (
...
EXTERN void asn1Print_ScipioObjectIncludes (ASN1ConstCharPtr name, ASN1T_ScipioObjectIncludes* pvalue);
...
class EXTERN ASN1C_ScipioObjectExports : public ASN1CType {
public:
   ASN1C_ScipioObjectExports (
...
EXTERN void asn1Print_ScipioObjectExports (ASN1ConstCharPtr name);
