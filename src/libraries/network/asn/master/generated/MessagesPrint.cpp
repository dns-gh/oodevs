...
void asn1Print_MsgClientAnnouncement (ASN1ConstCharPtr name)
{
}

void ASN1C_MsgClientAnnouncement::Print (ASN1ConstCharPtr name)

{
   asn1Print_MsgClientAnnouncement (name);
}
...
void asn1Print_MsgsInMaster_msg (ASN1ConstCharPtr name, ASN1T_MsgsInMaster_msg* pvalue)
{
   ...
   switch (pvalue->t) {
      case 1:
         sprintf (namebuf, "%s.u.msg_client_announcement", name);
         break;
