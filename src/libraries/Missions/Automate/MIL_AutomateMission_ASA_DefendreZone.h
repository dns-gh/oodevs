...
#ifndef __MIL_AutomateMission_ASA_DefendreZone_h_
#define __MIL_AutomateMission_ASA_DefendreZone_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ASA_DefendreZone : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ASA_DefendreZone )

public:
             MIL_AutomateMission_ASA_DefendreZone( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ASA_DefendreZone();
...
#endif // __MIL_AutomateMission_ASA_DefendreZone_h_
