...
#ifndef __MIL_AutomateMission_ABC_ReconnaitrePoint_h_
#define __MIL_AutomateMission_ABC_ReconnaitrePoint_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_ReconnaitrePoint : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_ReconnaitrePoint )

public:
             MIL_AutomateMission_ABC_ReconnaitrePoint( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_ReconnaitrePoint();
...
#endif // __MIL_AutomateMission_ABC_ReconnaitrePoint_h_
