...
#ifndef __MIL_AutomateMission_RENS_ROHUM_SExfiltrer_h_
#define __MIL_AutomateMission_RENS_ROHUM_SExfiltrer_h_
...
// Created: 2005-08-17 - 16:30:43
//=============================================================================
class MIL_AutomateMission_RENS_ROHUM_SExfiltrer : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_RENS_ROHUM_SExfiltrer )

public:
             MIL_AutomateMission_RENS_ROHUM_SExfiltrer( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_RENS_ROHUM_SExfiltrer();
...
private:
    TER_Localisation zoneDeRegroupement_;

private:
    static int nDIAZoneDeRegroupementIdx_;

};


#endif // __MIL_AutomateMission_RENS_ROHUM_SExfiltrer_h_
