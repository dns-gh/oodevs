...
#ifndef __MIL_AutomateMission_INF_Reduire_h_
#define __MIL_AutomateMission_INF_Reduire_h_
...
// Created: 2005-08-17 - 16:30:43
//=============================================================================
class MIL_AutomateMission_INF_Reduire : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_Reduire )

public:
             MIL_AutomateMission_INF_Reduire( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_Reduire();
...
#endif // __MIL_AutomateMission_INF_Reduire_h_
