...
#include "MIL_AutomateMission_GEN_AmenagerAireStationnement.h"
...
int MIL_AutomateMission_GEN_AmenagerAireStationnement::nDIATravauxIdx_ = 0 ;
...
//-----------------------------------------------------------------------------
// Name: MIL_AutomateMission_GEN_AmenagerAireStationnement::InitializeDIA
// Created: NLD 2003-04-10
//-----------------------------------------------------------------------------
// static
void MIL_AutomateMission_GEN_AmenagerAireStationnement::InitializeDIA( const MIL_AutomateMissionType& type )
{
...
ASN1T_EnumOrderErrorCode MIL_AutomateMission_GEN_AmenagerAireStationnement::Initialize( const ASN1T_MsgAutomateOrder& asnMsg )
{
    ...
    const ASN1T_Mission_Automate_GEN_AmenagerAireStationnement& asnMission = *asnMsg.mission.u.mission_automate_gen_amenager_aire_stationnement;
...
void MIL_AutomateMission_GEN_AmenagerAireStationnement::Serialize( ASN1T_MsgAutomateOrder& asnMsg )
{
    ...
    asnMsg.mission.t                           = T_Mission_Automate_mission_automate_gen_amenager_aire_stationnement;
    asnMsg.mission.u.mission_automate_gen_amenager_aire_stationnement  = &asnMission;
