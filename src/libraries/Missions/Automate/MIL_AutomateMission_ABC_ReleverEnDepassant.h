...
#ifndef __MIL_AutomateMission_ABC_ReleverEnDepassant_h_
#define __MIL_AutomateMission_ABC_ReleverEnDepassant_h_
...
// Created: 2005-08-17 - 16:30:43
//=============================================================================
class MIL_AutomateMission_ABC_ReleverEnDepassant : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_ReleverEnDepassant )

public:
             MIL_AutomateMission_ABC_ReleverEnDepassant( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_ReleverEnDepassant();
...
#endif // __MIL_AutomateMission_ABC_ReleverEnDepassant_h_
