...
#ifndef __MIL_AutomateMission_ALAT_Attaquer_h_
#define __MIL_AutomateMission_ALAT_Attaquer_h_
...
// Created: 2005-08-01 - 11:23:53
//=============================================================================
class MIL_AutomateMission_ALAT_Attaquer : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_Attaquer )

public:
             MIL_AutomateMission_ALAT_Attaquer( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_Attaquer();
...
#endif // __MIL_AutomateMission_ALAT_Attaquer_h_
