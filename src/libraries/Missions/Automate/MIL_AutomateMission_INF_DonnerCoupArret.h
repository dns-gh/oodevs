...
#ifndef __MIL_AutomateMission_INF_DonnerCoupArret_h_
#define __MIL_AutomateMission_INF_DonnerCoupArret_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_DonnerCoupArret : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_DonnerCoupArret )

public:
             MIL_AutomateMission_INF_DonnerCoupArret( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_DonnerCoupArret();
...
#endif // __MIL_AutomateMission_INF_DonnerCoupArret_h_
