...
#ifndef __MIL_AutomateMission_ABC_Reduire_h_
#define __MIL_AutomateMission_ABC_Reduire_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_Reduire : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_Reduire )

public:
             MIL_AutomateMission_ABC_Reduire( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_Reduire();
...
#endif // __MIL_AutomateMission_ABC_Reduire_h_
