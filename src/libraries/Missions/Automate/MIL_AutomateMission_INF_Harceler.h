...
#ifndef __MIL_AutomateMission_INF_Harceler_h_
#define __MIL_AutomateMission_INF_Harceler_h_
...
// Created: 2005-08-01 - 11:23:53
//=============================================================================
class MIL_AutomateMission_INF_Harceler : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_Harceler )

public:
             MIL_AutomateMission_INF_Harceler( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_Harceler();
...
#endif // __MIL_AutomateMission_INF_Harceler_h_
