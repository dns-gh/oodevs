...
#ifndef __MIL_AutomateMission_ABC_Controler_h_
#define __MIL_AutomateMission_ABC_Controler_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_Controler : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_Controler )

public:
             MIL_AutomateMission_ABC_Controler( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_Controler();
...
private:
    TER_Localisation zoneAControler_;

private:
    static int nDIAZoneAControlerIdx_;

};


#endif // __MIL_AutomateMission_ABC_Controler_h_
