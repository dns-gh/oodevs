...
#ifndef __MIL_AutomateMission_INF_Couvrir_h_
#define __MIL_AutomateMission_INF_Couvrir_h_
...
// Created: 2005-08-19 - 11:30:55
//=============================================================================
class MIL_AutomateMission_INF_Couvrir : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_Couvrir )

public:
             MIL_AutomateMission_INF_Couvrir( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_Couvrir();
...
#endif // __MIL_AutomateMission_INF_Couvrir_h_
