...
#ifndef __MIL_AutomateMission_INF_AttaquerEnTerrainDifficile_h_
#define __MIL_AutomateMission_INF_AttaquerEnTerrainDifficile_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_AttaquerEnTerrainDifficile : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_AttaquerEnTerrainDifficile )

public:
             MIL_AutomateMission_INF_AttaquerEnTerrainDifficile( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_AttaquerEnTerrainDifficile();
...
#endif // __MIL_AutomateMission_INF_AttaquerEnTerrainDifficile_h_
