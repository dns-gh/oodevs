...
#ifndef __MIL_AutomateMission_ABC_DonnerCoupArret_h_
#define __MIL_AutomateMission_ABC_DonnerCoupArret_h_
...
// Created: 2005-08-17 - 16:30:43
//=============================================================================
class MIL_AutomateMission_ABC_DonnerCoupArret : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_DonnerCoupArret )

public:
             MIL_AutomateMission_ABC_DonnerCoupArret( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_DonnerCoupArret();
...
private:
    TER_Localisation zoneRegroupement_;
...
#endif // __MIL_AutomateMission_ABC_DonnerCoupArret_h_
