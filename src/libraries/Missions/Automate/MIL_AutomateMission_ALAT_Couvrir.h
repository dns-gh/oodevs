...
#ifndef __MIL_AutomateMission_ALAT_Couvrir_h_
#define __MIL_AutomateMission_ALAT_Couvrir_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ALAT_Couvrir : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_Couvrir )

public:
             MIL_AutomateMission_ALAT_Couvrir( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_Couvrir();
...
#endif // __MIL_AutomateMission_ALAT_Couvrir_h_
