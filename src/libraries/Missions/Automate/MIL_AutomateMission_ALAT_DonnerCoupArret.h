...
#ifndef __MIL_AutomateMission_ALAT_DonnerCoupArret_h_
#define __MIL_AutomateMission_ALAT_DonnerCoupArret_h_
...
// Created: 2005-08-19 - 11:30:55
//=============================================================================
class MIL_AutomateMission_ALAT_DonnerCoupArret : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_DonnerCoupArret )

public:
             MIL_AutomateMission_ALAT_DonnerCoupArret( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_DonnerCoupArret();
...
#endif // __MIL_AutomateMission_ALAT_DonnerCoupArret_h_
