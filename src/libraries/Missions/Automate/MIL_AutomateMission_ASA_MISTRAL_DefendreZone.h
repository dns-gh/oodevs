...
#ifndef __MIL_AutomateMission_ASA_MISTRAL_DefendreZone_h_
#define __MIL_AutomateMission_ASA_MISTRAL_DefendreZone_h_
...
// Created: 2005-6-28 - 14:3:2
//=============================================================================
class MIL_AutomateMission_ASA_MISTRAL_DefendreZone : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ASA_MISTRAL_DefendreZone )

public:
             MIL_AutomateMission_ASA_MISTRAL_DefendreZone( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ASA_MISTRAL_DefendreZone();
...
#endif // __MIL_AutomateMission_ASA_MISTRAL_DefendreZone_h_
