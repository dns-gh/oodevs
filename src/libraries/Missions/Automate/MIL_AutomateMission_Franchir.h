...
#ifndef __MIL_AutomateMission_Franchir_h_
#define __MIL_AutomateMission_Franchir_h_
...
// Created: 2005-08-19 - 11:30:56
//=============================================================================
class MIL_AutomateMission_Franchir : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_Franchir )

public:
             MIL_AutomateMission_Franchir( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_Franchir();
...
#endif // __MIL_AutomateMission_Franchir_h_
