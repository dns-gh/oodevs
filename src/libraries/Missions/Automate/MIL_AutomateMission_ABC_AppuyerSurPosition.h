...
#ifndef __MIL_AutomateMission_ABC_AppuyerSurPosition_h_
#define __MIL_AutomateMission_ABC_AppuyerSurPosition_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_AppuyerSurPosition : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_AppuyerSurPosition )

public:
             MIL_AutomateMission_ABC_AppuyerSurPosition( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_AppuyerSurPosition();
...
#endif // __MIL_AutomateMission_ABC_AppuyerSurPosition_h_
