...
#ifndef __MIL_AutomateMission_RENS_ROEM_Appuyer_h_
#define __MIL_AutomateMission_RENS_ROEM_Appuyer_h_
...
// Created: 2005-08-19 - 11:30:56
//=============================================================================
class MIL_AutomateMission_RENS_ROEM_Appuyer : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_RENS_ROEM_Appuyer )

public:
             MIL_AutomateMission_RENS_ROEM_Appuyer( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_RENS_ROEM_Appuyer();
...
#endif // __MIL_AutomateMission_RENS_ROEM_Appuyer_h_
