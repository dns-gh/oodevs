...
#ifndef __MIL_AutomateMission_LOG_ReconnaitreItineraire_h_
#define __MIL_AutomateMission_LOG_ReconnaitreItineraire_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_LOG_ReconnaitreItineraire : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_LOG_ReconnaitreItineraire )

public:
             MIL_AutomateMission_LOG_ReconnaitreItineraire( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_LOG_ReconnaitreItineraire();
...
#endif // __MIL_AutomateMission_LOG_ReconnaitreItineraire_h_
