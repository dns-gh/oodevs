...
#ifndef __MIL_AutomateMission_ABC_Reconnaitre_h_
#define __MIL_AutomateMission_ABC_Reconnaitre_h_
...
// Created: 2005-6-28 - 14:3:2
//=============================================================================
class MIL_AutomateMission_ABC_Reconnaitre : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_Reconnaitre )

public:
             MIL_AutomateMission_ABC_Reconnaitre( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_Reconnaitre();
...
#endif // __MIL_AutomateMission_ABC_Reconnaitre_h_
