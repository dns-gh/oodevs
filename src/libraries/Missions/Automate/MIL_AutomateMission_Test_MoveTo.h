...
#ifndef __MIL_AutomateMission_Test_MoveTo_h_
#define __MIL_AutomateMission_Test_MoveTo_h_
...
// Created: 2005-6-28 - 14:3:3
//=============================================================================
class MIL_AutomateMission_Test_MoveTo : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_Test_MoveTo )

public:
             MIL_AutomateMission_Test_MoveTo( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_Test_MoveTo();
...
#endif // __MIL_AutomateMission_Test_MoveTo_h_
