...
#ifndef __MIL_AutomateMission_INF_Fixer_h_
#define __MIL_AutomateMission_INF_Fixer_h_
...
// Created: 2005-08-19 - 11:30:55
//=============================================================================
class MIL_AutomateMission_INF_Fixer : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_Fixer )

public:
             MIL_AutomateMission_INF_Fixer( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_Fixer();
...
private:
    static int nDIAEnnemisIdx_;

};


#endif // __MIL_AutomateMission_INF_Fixer_h_
