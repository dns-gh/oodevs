...
#ifndef __MIL_AutomateMission_NBC_ReconnaitreUneZone_h_
#define __MIL_AutomateMission_NBC_ReconnaitreUneZone_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_NBC_ReconnaitreUneZone : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_NBC_ReconnaitreUneZone )

public:
             MIL_AutomateMission_NBC_ReconnaitreUneZone( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_NBC_ReconnaitreUneZone();
...
#endif // __MIL_AutomateMission_NBC_ReconnaitreUneZone_h_
