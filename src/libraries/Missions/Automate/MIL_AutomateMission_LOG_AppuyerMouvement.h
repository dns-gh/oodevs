...
#ifndef __MIL_AutomateMission_LOG_AppuyerMouvement_h_
#define __MIL_AutomateMission_LOG_AppuyerMouvement_h_
...
// Created: 2005-08-01 - 11:23:53
//=============================================================================
class MIL_AutomateMission_LOG_AppuyerMouvement : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_LOG_AppuyerMouvement )

public:
             MIL_AutomateMission_LOG_AppuyerMouvement( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_LOG_AppuyerMouvement();
...
#endif // __MIL_AutomateMission_LOG_AppuyerMouvement_h_
