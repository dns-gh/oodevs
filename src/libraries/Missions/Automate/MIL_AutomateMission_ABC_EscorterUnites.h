...
#ifndef __MIL_AutomateMission_ABC_EscorterUnites_h_
#define __MIL_AutomateMission_ABC_EscorterUnites_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_EscorterUnites : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_EscorterUnites )

public:
             MIL_AutomateMission_ABC_EscorterUnites( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_EscorterUnites();
...
#endif // __MIL_AutomateMission_ABC_EscorterUnites_h_
