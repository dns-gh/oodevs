...
#ifndef __MIL_AutomateMission_LOG_ReconnaitreZoneDeDeploiement_h_
#define __MIL_AutomateMission_LOG_ReconnaitreZoneDeDeploiement_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_LOG_ReconnaitreZoneDeDeploiement : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_LOG_ReconnaitreZoneDeDeploiement )

public:
             MIL_AutomateMission_LOG_ReconnaitreZoneDeDeploiement( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_LOG_ReconnaitreZoneDeDeploiement();
...
#endif // __MIL_AutomateMission_LOG_ReconnaitreZoneDeDeploiement_h_
