...
#ifndef __MIL_AutomateMission_GEN_RetablirItineraires_h_
#define __MIL_AutomateMission_GEN_RetablirItineraires_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_GEN_RetablirItineraires : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_GEN_RetablirItineraires )

public:
             MIL_AutomateMission_GEN_RetablirItineraires( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_GEN_RetablirItineraires();
...
#endif // __MIL_AutomateMission_GEN_RetablirItineraires_h_
