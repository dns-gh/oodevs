...
#ifndef __MIL_AutomateMission_FaireMouvementVersCampRefugies_h_
#define __MIL_AutomateMission_FaireMouvementVersCampRefugies_h_
...
// Created: 2005-08-17 - 16:30:43
//=============================================================================
class MIL_AutomateMission_FaireMouvementVersCampRefugies : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_FaireMouvementVersCampRefugies )

public:
             MIL_AutomateMission_FaireMouvementVersCampRefugies( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_FaireMouvementVersCampRefugies();
...
#endif // __MIL_AutomateMission_FaireMouvementVersCampRefugies_h_
