...
#ifndef __MIL_AutomateMission_LOG_AppuyerFranchissementDansZone_h_
#define __MIL_AutomateMission_LOG_AppuyerFranchissementDansZone_h_
...
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_LOG_AppuyerFranchissementDansZone )

public:
             MIL_AutomateMission_LOG_AppuyerFranchissementDansZone( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_LOG_AppuyerFranchissementDansZone();
...
#endif // __MIL_AutomateMission_LOG_AppuyerFranchissementDansZone_h_
