...
#ifndef __MIL_AutomateMission_ABC_PrendrePreciserContact_h_
#define __MIL_AutomateMission_ABC_PrendrePreciserContact_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_PrendrePreciserContact : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_PrendrePreciserContact )

public:
             MIL_AutomateMission_ABC_PrendrePreciserContact( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_PrendrePreciserContact();
...
#endif // __MIL_AutomateMission_ABC_PrendrePreciserContact_h_
