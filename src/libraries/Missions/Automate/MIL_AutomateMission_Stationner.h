...
#ifndef __MIL_AutomateMission_Stationner_h_
#define __MIL_AutomateMission_Stationner_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_Stationner : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_Stationner )

public:
             MIL_AutomateMission_Stationner( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_Stationner();
...
#endif // __MIL_AutomateMission_Stationner_h_
