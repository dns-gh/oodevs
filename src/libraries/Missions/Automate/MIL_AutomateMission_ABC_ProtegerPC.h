...
#ifndef __MIL_AutomateMission_ABC_ProtegerPC_h_
#define __MIL_AutomateMission_ABC_ProtegerPC_h_
...
// Created: 2005-08-01 - 11:23:53
//=============================================================================
class MIL_AutomateMission_ABC_ProtegerPC : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_ProtegerPC )

public:
             MIL_AutomateMission_ABC_ProtegerPC( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_ProtegerPC();
...
private:
    static int nDIAPcIdx_;

};


#endif // __MIL_AutomateMission_ABC_ProtegerPC_h_
