...
#ifndef __MIL_AutomateMission_GEN_ReconnaitreZoneDeploiement_h_
#define __MIL_AutomateMission_GEN_ReconnaitreZoneDeploiement_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_GEN_ReconnaitreZoneDeploiement : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_GEN_ReconnaitreZoneDeploiement )

public:
             MIL_AutomateMission_GEN_ReconnaitreZoneDeploiement( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_GEN_ReconnaitreZoneDeploiement();
...
#endif // __MIL_AutomateMission_GEN_ReconnaitreZoneDeploiement_h_
