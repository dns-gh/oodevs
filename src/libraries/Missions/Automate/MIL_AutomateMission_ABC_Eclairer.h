...
#ifndef __MIL_AutomateMission_ABC_Eclairer_h_
#define __MIL_AutomateMission_ABC_Eclairer_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_Eclairer : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_Eclairer )

public:
             MIL_AutomateMission_ABC_Eclairer( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_Eclairer();
...
#endif // __MIL_AutomateMission_ABC_Eclairer_h_
