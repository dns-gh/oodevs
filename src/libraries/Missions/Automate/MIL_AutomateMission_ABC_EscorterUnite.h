...
#ifndef __MIL_AutomateMission_ABC_EscorterUnite_h_
#define __MIL_AutomateMission_ABC_EscorterUnite_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ABC_EscorterUnite : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_EscorterUnite )

public:
             MIL_AutomateMission_ABC_EscorterUnite( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_EscorterUnite();
...
#endif // __MIL_AutomateMission_ABC_EscorterUnite_h_
