...
#ifndef __MIL_AutomateMission_ABC_Appuyer_h_
#define __MIL_AutomateMission_ABC_Appuyer_h_
...
// Created: 2005-08-17 - 16:30:43
//=============================================================================
class MIL_AutomateMission_ABC_Appuyer : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ABC_Appuyer )

public:
             MIL_AutomateMission_ABC_Appuyer( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ABC_Appuyer();
...
#endif // __MIL_AutomateMission_ABC_Appuyer_h_
