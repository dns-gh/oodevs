...
#ifndef __MIL_AutomateMission_NBC_ReconnaitreUnAxe_h_
#define __MIL_AutomateMission_NBC_ReconnaitreUnAxe_h_
...
// Created: 2005-08-01 - 11:23:53
//=============================================================================
class MIL_AutomateMission_NBC_ReconnaitreUnAxe : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_NBC_ReconnaitreUnAxe )

public:
             MIL_AutomateMission_NBC_ReconnaitreUnAxe( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_NBC_ReconnaitreUnAxe();
...
#endif // __MIL_AutomateMission_NBC_ReconnaitreUnAxe_h_
