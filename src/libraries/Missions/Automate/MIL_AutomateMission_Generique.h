...
#ifndef __MIL_AutomateMission_Generique_h_
#define __MIL_AutomateMission_Generique_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_Generique : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_Generique )

public:
             MIL_AutomateMission_Generique( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_Generique();
...
#endif // __MIL_AutomateMission_Generique_h_
