...
#ifndef __MIL_AutomateMission_SeRecompleter_h_
#define __MIL_AutomateMission_SeRecompleter_h_
...
// Created: 2005-08-19 - 11:30:56
//=============================================================================
class MIL_AutomateMission_SeRecompleter : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_SeRecompleter )

public:
             MIL_AutomateMission_SeRecompleter( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_SeRecompleter();
...
#endif // __MIL_AutomateMission_SeRecompleter_h_
