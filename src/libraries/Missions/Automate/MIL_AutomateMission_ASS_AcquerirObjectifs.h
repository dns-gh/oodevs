...
#ifndef __MIL_AutomateMission_ASS_AcquerirObjectifs_h_
#define __MIL_AutomateMission_ASS_AcquerirObjectifs_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_ASS_AcquerirObjectifs : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ASS_AcquerirObjectifs )

public:
             MIL_AutomateMission_ASS_AcquerirObjectifs( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ASS_AcquerirObjectifs();
...
#endif // __MIL_AutomateMission_ASS_AcquerirObjectifs_h_
