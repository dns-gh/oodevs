...
#ifndef __MIL_AutomateMission_ASA_MISTRAL_Surveiller_h_
#define __MIL_AutomateMission_ASA_MISTRAL_Surveiller_h_
...
// Created: 2005-08-17 - 16:30:43
//=============================================================================
class MIL_AutomateMission_ASA_MISTRAL_Surveiller : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ASA_MISTRAL_Surveiller )

public:
             MIL_AutomateMission_ASA_MISTRAL_Surveiller( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ASA_MISTRAL_Surveiller();
...
#endif // __MIL_AutomateMission_ASA_MISTRAL_Surveiller_h_
