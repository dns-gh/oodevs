...
#ifndef __MIL_AutomateMission_ALAT_AttaquerFormationAeromobile_h_
#define __MIL_AutomateMission_ALAT_AttaquerFormationAeromobile_h_
...
// Created: 2005-08-19 - 11:30:55
//=============================================================================
class MIL_AutomateMission_ALAT_AttaquerFormationAeromobile : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_ALAT_AttaquerFormationAeromobile )

public:
             MIL_AutomateMission_ALAT_AttaquerFormationAeromobile( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_ALAT_AttaquerFormationAeromobile();
...
private:
    static int nDIAUnitesAAttaquerIdx_;
...
#endif // __MIL_AutomateMission_ALAT_AttaquerFormationAeromobile_h_
