...
#ifndef __MIL_AutomateMission_LOG_BloquerZone_h_
#define __MIL_AutomateMission_LOG_BloquerZone_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_LOG_BloquerZone : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_LOG_BloquerZone )

public:
             MIL_AutomateMission_LOG_BloquerZone( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_LOG_BloquerZone();
...
#endif // __MIL_AutomateMission_LOG_BloquerZone_h_
