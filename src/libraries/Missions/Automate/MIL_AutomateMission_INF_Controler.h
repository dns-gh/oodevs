...
#ifndef __MIL_AutomateMission_INF_Controler_h_
#define __MIL_AutomateMission_INF_Controler_h_
...
// Created: 2005-08-19 - 11:30:55
//=============================================================================
class MIL_AutomateMission_INF_Controler : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_Controler )

public:
             MIL_AutomateMission_INF_Controler( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_Controler();
...
#endif // __MIL_AutomateMission_INF_Controler_h_
