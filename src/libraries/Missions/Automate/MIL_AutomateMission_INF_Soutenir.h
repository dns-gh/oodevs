...
#ifndef __MIL_AutomateMission_INF_Soutenir_h_
#define __MIL_AutomateMission_INF_Soutenir_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_INF_Soutenir : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_INF_Soutenir )

public:
             MIL_AutomateMission_INF_Soutenir( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_INF_Soutenir();
...
#endif // __MIL_AutomateMission_INF_Soutenir_h_
