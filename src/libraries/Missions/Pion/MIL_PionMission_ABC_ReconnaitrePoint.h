...
#ifndef __MIL_PionMission_ABC_ReconnaitrePoint_h_
#define __MIL_PionMission_ABC_ReconnaitrePoint_h_
...
// Created: 2005-08-01 - 11:23:53
//*****************************************************************************
class MIL_PionMission_ABC_ReconnaitrePoint: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_ReconnaitrePoint )

public:

             MIL_PionMission_ABC_ReconnaitrePoint( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_ReconnaitrePoint();
...
#endif // __MIL_PionMission_ABC_ReconnaitrePoint_h_
