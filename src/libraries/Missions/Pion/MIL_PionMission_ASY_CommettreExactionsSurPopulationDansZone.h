...
#ifndef __MIL_PionMission_ASY_CommettreExactionsSurPopulationDansZone_h_
#define __MIL_PionMission_ASY_CommettreExactionsSurPopulationDansZone_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASY_CommettreExactionsSurPopulationDansZone: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASY_CommettreExactionsSurPopulationDansZone )

public:

             MIL_PionMission_ASY_CommettreExactionsSurPopulationDansZone( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASY_CommettreExactionsSurPopulationDansZone();
...
#endif // __MIL_PionMission_ASY_CommettreExactionsSurPopulationDansZone_h_
