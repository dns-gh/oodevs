...
#ifndef __MIL_PionMission_INF_PrendrePreciserContact_h_
#define __MIL_PionMission_INF_PrendrePreciserContact_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_PrendrePreciserContact: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_PrendrePreciserContact )

public:

             MIL_PionMission_INF_PrendrePreciserContact( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_PrendrePreciserContact();
...
#endif // __MIL_PionMission_INF_PrendrePreciserContact_h_
