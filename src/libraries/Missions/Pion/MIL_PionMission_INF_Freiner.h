...
#ifndef __MIL_PionMission_INF_Freiner_h_
#define __MIL_PionMission_INF_Freiner_h_
...
// Created: 2005-08-01 - 11:23:53
//*****************************************************************************
class MIL_PionMission_INF_Freiner: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_Freiner )

public:

             MIL_PionMission_INF_Freiner( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_Freiner();
...
#endif // __MIL_PionMission_INF_Freiner_h_
