...
#ifndef __MIL_PionMission_ABC_SemparerZone_h_
#define __MIL_PionMission_ABC_SemparerZone_h_
...
// Created: 2005-08-01 - 11:23:53
//*****************************************************************************
class MIL_PionMission_ABC_SemparerZone: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_SemparerZone )

public:

             MIL_PionMission_ABC_SemparerZone( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_SemparerZone();
...
private:
    static int nDIAZoneAPrendreIdx_;


private:
    TER_Localisation zoneAPrendre_;

};


#endif // __MIL_PionMission_ABC_SemparerZone_h_
