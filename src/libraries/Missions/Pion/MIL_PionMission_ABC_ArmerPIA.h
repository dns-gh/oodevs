...
#ifndef __MIL_PionMission_ABC_ArmerPIA_h_
#define __MIL_PionMission_ABC_ArmerPIA_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_ArmerPIA: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_ArmerPIA )

public:

             MIL_PionMission_ABC_ArmerPIA( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_ArmerPIA();
...
#endif // __MIL_PionMission_ABC_ArmerPIA_h_
