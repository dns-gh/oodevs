...
#ifndef __MIL_PionMission_RENS_ROHUM_SExfiltrer_h_
#define __MIL_PionMission_RENS_ROHUM_SExfiltrer_h_
...
// Created: 2005-6-28 - 14:3:4
//*****************************************************************************
class MIL_PionMission_RENS_ROHUM_SExfiltrer: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_RENS_ROHUM_SExfiltrer )

public:

             MIL_PionMission_RENS_ROHUM_SExfiltrer( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_RENS_ROHUM_SExfiltrer();
...
#endif // __MIL_PionMission_RENS_ROHUM_SExfiltrer_h_
