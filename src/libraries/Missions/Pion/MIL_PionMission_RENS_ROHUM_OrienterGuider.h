...
#ifndef __MIL_PionMission_RENS_ROHUM_OrienterGuider_h_
#define __MIL_PionMission_RENS_ROHUM_OrienterGuider_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_RENS_ROHUM_OrienterGuider: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_RENS_ROHUM_OrienterGuider )

public:

             MIL_PionMission_RENS_ROHUM_OrienterGuider( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_RENS_ROHUM_OrienterGuider();
...
#endif // __MIL_PionMission_RENS_ROHUM_OrienterGuider_h_
