...
#ifndef __MIL_PionMission_MILICE_DetruireEmbuscade_h_
#define __MIL_PionMission_MILICE_DetruireEmbuscade_h_
...
// Created: 2005-08-01 - 11:23:53
//*****************************************************************************
class MIL_PionMission_MILICE_DetruireEmbuscade: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_MILICE_DetruireEmbuscade )

public:

             MIL_PionMission_MILICE_DetruireEmbuscade( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_MILICE_DetruireEmbuscade();
...
private:
    static int nDIAPositionEmbuscadeIdx_;
    static int nDIAPositionRegroupementIdx_;
...
#endif // __MIL_PionMission_MILICE_DetruireEmbuscade_h_
