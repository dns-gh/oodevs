...
#ifndef __MIL_PionMission_LOG_MettreEnOeuvreZoneStationnement_h_
#define __MIL_PionMission_LOG_MettreEnOeuvreZoneStationnement_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_LOG_MettreEnOeuvreZoneStationnement: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_MettreEnOeuvreZoneStationnement )

public:

             MIL_PionMission_LOG_MettreEnOeuvreZoneStationnement( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_MettreEnOeuvreZoneStationnement();
...
#endif // __MIL_PionMission_LOG_MettreEnOeuvreZoneStationnement_h_
