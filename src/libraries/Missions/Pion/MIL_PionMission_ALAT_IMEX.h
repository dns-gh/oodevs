...
#ifndef __MIL_PionMission_ALAT_IMEX_h_
#define __MIL_PionMission_ALAT_IMEX_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ALAT_IMEX: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_IMEX )

public:

             MIL_PionMission_ALAT_IMEX( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_IMEX();
...
#endif // __MIL_PionMission_ALAT_IMEX_h_
