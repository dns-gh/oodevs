...
#ifndef __MIL_PionMission_GEN_AppuyerDebarquementTroupesGU_h_
#define __MIL_PionMission_GEN_AppuyerDebarquementTroupesGU_h_
...
// Created: 2005-6-28 - 14:3:3
//*****************************************************************************
class MIL_PionMission_GEN_AppuyerDebarquementTroupesGU: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_AppuyerDebarquementTroupesGU )

public:

             MIL_PionMission_GEN_AppuyerDebarquementTroupesGU( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_AppuyerDebarquementTroupesGU();
...
private:
    static int nDIAZoneAppuiIdx_;


private:
    TER_Localisation zoneAppui_;

};


#endif // __MIL_PionMission_GEN_AppuyerDebarquementTroupesGU_h_
