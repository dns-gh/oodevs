...
#ifndef __MIL_PionMission_ABC_Jalonner_h_
#define __MIL_PionMission_ABC_Jalonner_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_Jalonner: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_Jalonner )

public:

             MIL_PionMission_ABC_Jalonner( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_Jalonner();
...
#endif // __MIL_PionMission_ABC_Jalonner_h_
