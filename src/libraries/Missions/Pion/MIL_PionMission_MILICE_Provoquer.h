...
#ifndef __MIL_PionMission_MILICE_Provoquer_h_
#define __MIL_PionMission_MILICE_Provoquer_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_MILICE_Provoquer: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_MILICE_Provoquer )

public:

             MIL_PionMission_MILICE_Provoquer( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_MILICE_Provoquer();
...
private:
    static int nDIAUniteAProvoquerIdx_;

};


#endif // __MIL_PionMission_MILICE_Provoquer_h_
