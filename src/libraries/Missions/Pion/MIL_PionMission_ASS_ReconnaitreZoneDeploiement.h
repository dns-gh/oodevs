...
#ifndef __MIL_PionMission_ASS_ReconnaitreZoneDeploiement_h_
#define __MIL_PionMission_ASS_ReconnaitreZoneDeploiement_h_
...
// Created: 2005-6-28 - 14:3:3
//*****************************************************************************
class MIL_PionMission_ASS_ReconnaitreZoneDeploiement: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASS_ReconnaitreZoneDeploiement )

public:

             MIL_PionMission_ASS_ReconnaitreZoneDeploiement( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASS_ReconnaitreZoneDeploiement();
...
#endif // __MIL_PionMission_ASS_ReconnaitreZoneDeploiement_h_
