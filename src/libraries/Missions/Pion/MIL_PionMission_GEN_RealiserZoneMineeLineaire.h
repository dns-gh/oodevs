...
#ifndef __MIL_PionMission_GEN_RealiserZoneMineeLineaire_h_
#define __MIL_PionMission_GEN_RealiserZoneMineeLineaire_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_RealiserZoneMineeLineaire: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_RealiserZoneMineeLineaire )

public:

             MIL_PionMission_GEN_RealiserZoneMineeLineaire( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_RealiserZoneMineeLineaire();
...
#endif // __MIL_PionMission_GEN_RealiserZoneMineeLineaire_h_
