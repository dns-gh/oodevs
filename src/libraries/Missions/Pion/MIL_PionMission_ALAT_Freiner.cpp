...
#include "MIL_PionMission_ALAT_Freiner.h"
...
int MIL_PionMission_ALAT_Freiner::nDIACiblesPrioritairesIdx_ = 0 ;
int MIL_PionMission_ALAT_Freiner::nDIAPointRegroupementIdx_ = 0 ;
int MIL_PionMission_ALAT_Freiner::nDIAPlotsRavitaillementIdx_ = 0 ;
int MIL_PionMission_ALAT_Freiner::nDIARavitaillementDebutMissionIdx_ = 0 ;
int MIL_PionMission_ALAT_Freiner::nDIAPorteeActionIdx_ = 0 ;
int MIL_PionMission_ALAT_Freiner::nDIAAmbianceMissionIdx_ = 0 ;


//-----------------------------------------------------------------------------
// Name: MIL_PionMission_ALAT_Freiner::InitializeDIA
// Created: 2005-08-01 - 11:23:53
//-----------------------------------------------------------------------------
// static
void MIL_PionMission_ALAT_Freiner::InitializeDIA( const MIL_PionMissionType& type )
{
...
//-----------------------------------------------------------------------------
// Name: MIL_PionMission_ALAT_Freiner constructor
// Created: 2005-08-01 - 11:23:53
//-----------------------------------------------------------------------------
MIL_PionMission_ALAT_Freiner::MIL_PionMission_ALAT_Freiner( MIL_AgentPion& pion, const MIL_PionMissionType& type )
...
//-----------------------------------------------------------------------------
// Name: MIL_PionMission_ALAT_Freiner destructor
// Created: 2005-08-01 - 11:23:53
//-----------------------------------------------------------------------------
MIL_PionMission_ALAT_Freiner::~MIL_PionMission_ALAT_Freiner()
{
    // NOTHING
}
...
//-----------------------------------------------------------------------------
// Name: MIL_PionMission_ALAT_Freiner::Initialize
// Created: 2005-08-01 - 11:23:53
//-----------------------------------------------------------------------------
ASN1T_EnumOrderErrorCode MIL_PionMission_ALAT_Freiner::Initialize( const ASN1T_MsgPionOrder& asnMsg )
{
    ASN1T_EnumOrderErrorCode nCode = MIL_PionMission_ABC::Initialize( asnMsg );
    if( nCode != EnumOrderErrorCode::no_error )
        return nCode;        

    const ASN1T_Mission_Pion_ALAT_Freiner& asnMission = *asnMsg.mission.u.mission_pion_alat_freiner;
...
// Created: 2005-08-01 - 11:23:53
//-----------------------------------------------------------------------------
bool MIL_PionMission_ALAT_Freiner::Initialize( const MIL_AutomateMission_ABC& parentMission )
{
...
// Created: 2005-08-01 - 11:23:53
// -----------------------------------------------------------------------------
bool MIL_PionMission_ALAT_Freiner::Initialize( MIL_PionMission_ABC& missionTmp )
{
    if( !MIL_PionMission_ABC::Initialize( missionTmp ) )
        return false;
    MIL_PionMission_ALAT_Freiner& mission = static_cast< MIL_PionMission_ALAT_Freiner& >( missionTmp );
...
//-----------------------------------------------------------------------------
// Name: MIL_PionMission_ALAT_Freiner::Terminate
// Created: 2005-08-01 - 11:23:53
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Name: MIL_PionMission_ALAT_Freiner::Serialize
// Created: 2005-08-01 - 11:23:53
//-----------------------------------------------------------------------------
void MIL_PionMission_ALAT_Freiner::Serialize( ASN1T_MsgPionOrder& asnMsg )
{
    MIL_PionMission_ABC::Serialize( asnMsg );
    
    ASN1T_Mission_Pion_ALAT_Freiner& asnMission = *new ASN1T_Mission_Pion_ALAT_Freiner();
    asnMsg.mission.t                           = T_Mission_Pion_mission_pion_alat_freiner;
    asnMsg.mission.u.mission_pion_alat_freiner  = &asnMission;
...
//-----------------------------------------------------------------------------
// Name: MIL_PionMission_ALAT_Freiner::CleanAfterSerialization
// Created: 2005-08-01 - 11:23:53
//-----------------------------------------------------------------------------
void MIL_PionMission_ALAT_Freiner::CleanAfterSerialization( ASN1T_MsgPionOrder& asnMsg )
{
    assert( asnMsg.mission.t == T_Mission_Pion_mission_pion_alat_freiner );
    ASN1T_Mission_Pion_ALAT_Freiner& asnMission = *asnMsg.mission.u.mission_pion_alat_freiner;
