...
#ifndef __MIL_PionMission_LOG_TrierEtTraiterBlesses_h_
#define __MIL_PionMission_LOG_TrierEtTraiterBlesses_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_LOG_TrierEtTraiterBlesses: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_TrierEtTraiterBlesses )

public:

             MIL_PionMission_LOG_TrierEtTraiterBlesses( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_TrierEtTraiterBlesses();
...
#endif // __MIL_PionMission_LOG_TrierEtTraiterBlesses_h_
