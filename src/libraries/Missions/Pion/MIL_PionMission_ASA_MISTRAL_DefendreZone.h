...
#ifndef __MIL_PionMission_ASA_MISTRAL_DefendreZone_h_
#define __MIL_PionMission_ASA_MISTRAL_DefendreZone_h_
...
// Created: 2005-08-17 - 16:30:43
//*****************************************************************************
class MIL_PionMission_ASA_MISTRAL_DefendreZone: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASA_MISTRAL_DefendreZone )

public:

             MIL_PionMission_ASA_MISTRAL_DefendreZone( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASA_MISTRAL_DefendreZone();
...
#endif // __MIL_PionMission_ASA_MISTRAL_DefendreZone_h_
