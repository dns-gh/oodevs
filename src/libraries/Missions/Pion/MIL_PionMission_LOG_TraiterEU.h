...
#ifndef __MIL_PionMission_LOG_TraiterEU_h_
#define __MIL_PionMission_LOG_TraiterEU_h_
...
// Created: 2005-5-9 - 11:49:5
//*****************************************************************************
class MIL_PionMission_LOG_TraiterEU: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_TraiterEU )

public:

             MIL_PionMission_LOG_TraiterEU( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_TraiterEU();
...
#endif // __MIL_PionMission_LOG_TraiterEU_h_
