...
#ifndef __MIL_PionMission_ABC_Eclairer_h_
#define __MIL_PionMission_ABC_Eclairer_h_
...
// Created: 2005-08-17 - 16:30:44
//*****************************************************************************
class MIL_PionMission_ABC_Eclairer: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_Eclairer )

public:

             MIL_PionMission_ABC_Eclairer( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_Eclairer();
...
#endif // __MIL_PionMission_ABC_Eclairer_h_
