...
#ifndef __MIL_PionMission_Test_Reinforce_h_
#define __MIL_PionMission_Test_Reinforce_h_
...
// Created: 2005-08-17 - 16:30:44
//*****************************************************************************
class MIL_PionMission_Test_Reinforce: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_Test_Reinforce )

public:

             MIL_PionMission_Test_Reinforce( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_Test_Reinforce();
...
#endif // __MIL_PionMission_Test_Reinforce_h_
