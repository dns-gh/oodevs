...
#ifndef __MIL_PionMission_ASA_MISTRAL_DefendreZoneAPartirPosition_h_
#define __MIL_PionMission_ASA_MISTRAL_DefendreZoneAPartirPosition_h_
...
// Created: 2005-08-01 - 11:23:53
//*****************************************************************************
class MIL_PionMission_ASA_MISTRAL_DefendreZoneAPartirPosition: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASA_MISTRAL_DefendreZoneAPartirPosition )

public:

             MIL_PionMission_ASA_MISTRAL_DefendreZoneAPartirPosition( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASA_MISTRAL_DefendreZoneAPartirPosition();
...
#endif // __MIL_PionMission_ASA_MISTRAL_DefendreZoneAPartirPosition_h_
