...
#include "MIL_PionMission_GEN_RealiserBarricade.h"
...
int MIL_PionMission_GEN_RealiserBarricade::nDIAPosObstacleIdx_ = 0 ;
int MIL_PionMission_GEN_RealiserBarricade::nDIAOidObstaclePlanifieIdx_ = 0 ;
int MIL_PionMission_GEN_RealiserBarricade::nDIAUrgenceIdx_ = 0 ;
...
ASN1T_EnumOrderErrorCode MIL_PionMission_GEN_RealiserBarricade::Initialize( const ASN1T_MsgPionOrder& asnMsg )
{
    ...
    const ASN1T_Mission_Pion_GEN_RealiserBarricade& asnMission = *asnMsg.mission.u.mission_pion_gen_realiser_barricade;
...
bool MIL_PionMission_GEN_RealiserBarricade::Initialize( MIL_PionMission_ABC& missionTmp )
{
    if( !MIL_PionMission_ABC::Initialize( missionTmp ) )
        return false;
    MIL_PionMission_GEN_RealiserBarricade& mission = static_cast< MIL_PionMission_GEN_RealiserBarricade& >( missionTmp );
...
void MIL_PionMission_GEN_RealiserBarricade::Serialize( ASN1T_MsgPionOrder& asnMsg )
{
    ...
    asnMsg.mission.t                           = T_Mission_Pion_mission_pion_gen_realiser_barricade;
    asnMsg.mission.u.mission_pion_gen_realiser_barricade  = &asnMission;
...
{
    assert( asnMsg.mission.t == T_Mission_Pion_mission_pion_gen_realiser_barricade );
    ASN1T_Mission_Pion_GEN_RealiserBarricade& asnMission = *asnMsg.mission.u.mission_pion_gen_realiser_barricade;
