...
#include "MIL_PionMission_MILICE_Provoquer.h"
...
int MIL_PionMission_MILICE_Provoquer::nDIAUniteAProvoquerIdx_ = 0 ;
...
void MIL_PionMission_MILICE_Provoquer::InitializeDIA( const MIL_PionMissionType& type )
{
    ...
    nDIAUniteAProvoquerIdx_ = DEC_Tools::InitializeDIAField( "uniteAProvoquer_", diaType );
...
bool MIL_PionMission_MILICE_Provoquer::Initialize( MIL_PionMission_ABC& missionTmp )
{
    if( !MIL_PionMission_ABC::Initialize( missionTmp ) )
        return false;
    MIL_PionMission_MILICE_Provoquer& mission = static_cast< MIL_PionMission_MILICE_Provoquer& >( missionTmp );

    NET_ASN_Tools::CopyAgentKnowledge( mission.GetVariable( nDIAUniteAProvoquerIdx_ ), GetVariable( nDIAUniteAProvoquerIdx_ ) );
...
{
    assert( asnMsg.mission.t == T_Mission_Pion_mission_pion_milice_provoquer );
    ASN1T_Mission_Pion_MILICE_Provoquer& asnMission = *asnMsg.mission.u.mission_pion_milice_provoquer;
