...
// $Archive: /MVW_v10/Build/SDK/Missions/src/Pion/MIL_PionMission_ASA_SurveillerAPartirPosition.h $
// $Author: Nld $
// $Modtime: 27/04/05 17:37 $
// $Revision: 20 $
// $Workfile: MIL_PionMission_ASA_SurveillerAPartirPosition.h $
//
// *****************************************************************************

#ifndef __MIL_PionMission_ASA_SurveillerAPartirPosition_h_
#define __MIL_PionMission_ASA_SurveillerAPartirPosition_h_
...
// Created: 2005-4-27 - 17:37:45
//*****************************************************************************
class MIL_PionMission_ASA_SurveillerAPartirPosition: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASA_SurveillerAPartirPosition )

public:

             MIL_PionMission_ASA_SurveillerAPartirPosition( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASA_SurveillerAPartirPosition();
...
#endif // __MIL_PionMission_ASA_SurveillerAPartirPosition_h_
