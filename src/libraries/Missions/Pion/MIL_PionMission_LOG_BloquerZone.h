...
#ifndef __MIL_PionMission_LOG_BloquerZone_h_
#define __MIL_PionMission_LOG_BloquerZone_h_
...
// Created: 2005-6-28 - 14:3:4
//*****************************************************************************
class MIL_PionMission_LOG_BloquerZone: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_BloquerZone )

public:

             MIL_PionMission_LOG_BloquerZone( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_BloquerZone();
...
#endif // __MIL_PionMission_LOG_BloquerZone_h_
