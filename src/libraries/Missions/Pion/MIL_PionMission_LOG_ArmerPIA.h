...
#ifndef __MIL_PionMission_LOG_ArmerPIA_h_
#define __MIL_PionMission_LOG_ArmerPIA_h_
...
// Created: 2005-08-19 - 11:30:56
//*****************************************************************************
class MIL_PionMission_LOG_ArmerPIA: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_ArmerPIA )

public:

             MIL_PionMission_LOG_ArmerPIA( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_ArmerPIA();
...
#endif // __MIL_PionMission_LOG_ArmerPIA_h_
