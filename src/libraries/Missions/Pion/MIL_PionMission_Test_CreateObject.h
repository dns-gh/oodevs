...
#ifndef __MIL_PionMission_Test_CreateObject_h_
#define __MIL_PionMission_Test_CreateObject_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_Test_CreateObject: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_Test_CreateObject )

public:

             MIL_PionMission_Test_CreateObject( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_Test_CreateObject();
...
#endif // __MIL_PionMission_Test_CreateObject_h_
