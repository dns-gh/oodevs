...
int MIL_PionMission_ALAT_Surveiller::nDIARavitaillementDebutMissionIdx_ = 0 ;
int MIL_PionMission_ALAT_Surveiller::nDIAPorteeActionIdx_ = 0 ;
int MIL_PionMission_ALAT_Surveiller::nDIAAmbianceMissionIdx_ = 0 ;
