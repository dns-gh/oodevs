...
#ifndef __MIL_PionMission_ASS_AssurerMiseEnOeuvreSurPosition_h_
#define __MIL_PionMission_ASS_AssurerMiseEnOeuvreSurPosition_h_
...
// Created: 2005-08-01 - 11:23:53
//*****************************************************************************
class MIL_PionMission_ASS_AssurerMiseEnOeuvreSurPosition: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASS_AssurerMiseEnOeuvreSurPosition )

public:

             MIL_PionMission_ASS_AssurerMiseEnOeuvreSurPosition( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASS_AssurerMiseEnOeuvreSurPosition();
...
#endif // __MIL_PionMission_ASS_AssurerMiseEnOeuvreSurPosition_h_
