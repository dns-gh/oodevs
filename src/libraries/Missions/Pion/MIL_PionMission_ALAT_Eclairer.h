...
#ifndef __MIL_PionMission_ALAT_Eclairer_h_
#define __MIL_PionMission_ALAT_Eclairer_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ALAT_Eclairer: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_Eclairer )

public:

             MIL_PionMission_ALAT_Eclairer( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_Eclairer();
...
#endif // __MIL_PionMission_ALAT_Eclairer_h_
