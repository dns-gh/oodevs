...
#ifndef __MIL_PionMission_INF_AppuyerSurPosition_h_
#define __MIL_PionMission_INF_AppuyerSurPosition_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_AppuyerSurPosition: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_AppuyerSurPosition )

public:

             MIL_PionMission_INF_AppuyerSurPosition( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_AppuyerSurPosition();
...
#endif // __MIL_PionMission_INF_AppuyerSurPosition_h_
