...
#ifndef __MIL_PionMission_ASY_CommettreAttentatContrePopulation_h_
#define __MIL_PionMission_ASY_CommettreAttentatContrePopulation_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ASY_CommettreAttentatContrePopulation: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASY_CommettreAttentatContrePopulation )

public:

             MIL_PionMission_ASY_CommettreAttentatContrePopulation( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASY_CommettreAttentatContrePopulation();
...
private:
    ...
    static int nDIAPopulationCibleIdx_;

};


#endif // __MIL_PionMission_ASY_CommettreAttentatContrePopulation_h_
