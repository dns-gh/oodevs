...
#ifndef __MIL_PionMission_ABC_ContreAttaquer_h_
#define __MIL_PionMission_ABC_ContreAttaquer_h_
...
// Created: 2005-08-01 - 11:23:53
//*****************************************************************************
class MIL_PionMission_ABC_ContreAttaquer: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_ContreAttaquer )

public:

             MIL_PionMission_ABC_ContreAttaquer( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_ContreAttaquer();
...
#endif // __MIL_PionMission_ABC_ContreAttaquer_h_
