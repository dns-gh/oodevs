...
int MIL_PionMission_LOG_TrierBlesses::nDIAPositionDeploiementIdx_ = 0 ;
...
ASN1T_EnumOrderErrorCode MIL_PionMission_LOG_TrierBlesses::Initialize( const ASN1T_MsgPionOrder& asnMsg )
{
    ...
    const ASN1T_Mission_Pion_LOG_TrierBlesses& asnMission = *asnMsg.mission.u.mission_pion_log_trier_blesses;
