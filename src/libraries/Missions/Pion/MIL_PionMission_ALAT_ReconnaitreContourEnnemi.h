...
#ifndef __MIL_PionMission_ALAT_ReconnaitreContourEnnemi_h_
#define __MIL_PionMission_ALAT_ReconnaitreContourEnnemi_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ALAT_ReconnaitreContourEnnemi: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_ReconnaitreContourEnnemi )

public:

             MIL_PionMission_ALAT_ReconnaitreContourEnnemi( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_ReconnaitreContourEnnemi();
...
#endif // __MIL_PionMission_ALAT_ReconnaitreContourEnnemi_h_
