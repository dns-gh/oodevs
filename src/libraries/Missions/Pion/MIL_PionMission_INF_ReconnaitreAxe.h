...
#ifndef __MIL_PionMission_INF_ReconnaitreAxe_h_
#define __MIL_PionMission_INF_ReconnaitreAxe_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_ReconnaitreAxe: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_ReconnaitreAxe )

public:

             MIL_PionMission_INF_ReconnaitreAxe( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_ReconnaitreAxe();
...
#endif // __MIL_PionMission_INF_ReconnaitreAxe_h_
