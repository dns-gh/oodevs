...
#ifndef __MIL_PionMission_ALAT_Escorter_h_
#define __MIL_PionMission_ALAT_Escorter_h_
...
// Created: 2005-6-28 - 14:3:2
//*****************************************************************************
class MIL_PionMission_ALAT_Escorter: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_Escorter )

public:

             MIL_PionMission_ALAT_Escorter( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_Escorter();
...
#endif // __MIL_PionMission_ALAT_Escorter_h_
