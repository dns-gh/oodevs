...
#ifndef __MIL_PionMission_ASS_EO_AcquerirObjectifs_h_
#define __MIL_PionMission_ASS_EO_AcquerirObjectifs_h_
...
// Created: 2005-6-28 - 14:3:3
//*****************************************************************************
class MIL_PionMission_ASS_EO_AcquerirObjectifs: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ASS_EO_AcquerirObjectifs )

public:

             MIL_PionMission_ASS_EO_AcquerirObjectifs( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ASS_EO_AcquerirObjectifs();
...
#endif // __MIL_PionMission_ASS_EO_AcquerirObjectifs_h_
