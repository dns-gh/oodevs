...
#ifndef __MIL_PionMission_ABC_Couvrir_h_
#define __MIL_PionMission_ABC_Couvrir_h_
...
// Created: 2005-08-01 - 11:23:53
//*****************************************************************************
class MIL_PionMission_ABC_Couvrir: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_Couvrir )

public:

             MIL_PionMission_ABC_Couvrir( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_Couvrir();
...
#endif // __MIL_PionMission_ABC_Couvrir_h_
