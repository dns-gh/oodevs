...
#ifndef __MIL_PionMission_INF_ControlerSecteur_h_
#define __MIL_PionMission_INF_ControlerSecteur_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_ControlerSecteur: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_ControlerSecteur )

public:

             MIL_PionMission_INF_ControlerSecteur( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_ControlerSecteur();
...
#endif // __MIL_PionMission_INF_ControlerSecteur_h_
