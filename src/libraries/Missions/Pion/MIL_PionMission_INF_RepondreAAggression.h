...
#ifndef __MIL_PionMission_INF_RepondreAAggression_h_
#define __MIL_PionMission_INF_RepondreAAggression_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_RepondreAAggression: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_RepondreAAggression )

public:

             MIL_PionMission_INF_RepondreAAggression( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_RepondreAAggression();
...
#endif // __MIL_PionMission_INF_RepondreAAggression_h_
