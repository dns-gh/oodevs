...
#ifndef __MIL_PionMission_ABC_Appuyer_h_
#define __MIL_PionMission_ABC_Appuyer_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_Appuyer: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_Appuyer )

public:

             MIL_PionMission_ABC_Appuyer( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_Appuyer();
...
#endif // __MIL_PionMission_ABC_Appuyer_h_
