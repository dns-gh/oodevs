...
#ifndef __MIL_PionMission_Test_Fire_h_
#define __MIL_PionMission_Test_Fire_h_
...
// Created: 2005-6-28 - 14:3:4
//*****************************************************************************
class MIL_PionMission_Test_Fire: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_Test_Fire )

public:

             MIL_PionMission_Test_Fire( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_Test_Fire();
...
#endif // __MIL_PionMission_Test_Fire_h_
