...
#ifndef __MIL_PionMission_ALAT_Jalonner_h_
#define __MIL_PionMission_ALAT_Jalonner_h_
...
// Created: 2005-08-19 - 11:30:55
//*****************************************************************************
class MIL_PionMission_ALAT_Jalonner: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_Jalonner )

public:

             MIL_PionMission_ALAT_Jalonner( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_Jalonner();
...
#endif // __MIL_PionMission_ALAT_Jalonner_h_
