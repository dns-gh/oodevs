...
#ifndef __MIL_PionMission_GEN_DegagerEboulement_h_
#define __MIL_PionMission_GEN_DegagerEboulement_h_
...
// Created: 2005-6-28 - 14:3:3
//*****************************************************************************
class MIL_PionMission_GEN_DegagerEboulement: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_DegagerEboulement )

public:

             MIL_PionMission_GEN_DegagerEboulement( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_DegagerEboulement();
...
#endif // __MIL_PionMission_GEN_DegagerEboulement_h_
