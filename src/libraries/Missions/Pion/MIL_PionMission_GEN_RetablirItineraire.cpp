...
#include "MIL_PionMission_GEN_RetablirItineraire.h"
...
int MIL_PionMission_GEN_RetablirItineraire::nDIAItineraireIdx_ = 0 ;
...
ASN1T_EnumOrderErrorCode MIL_PionMission_GEN_RetablirItineraire::Initialize( const ASN1T_MsgPionOrder& asnMsg )
{
    ...
    const ASN1T_Mission_Pion_GEN_RetablirItineraire& asnMission = *asnMsg.mission.u.mission_pion_gen_retablir_itineraire;
...
bool MIL_PionMission_GEN_RetablirItineraire::Initialize( MIL_PionMission_ABC& missionTmp )
{
    if( !MIL_PionMission_ABC::Initialize( missionTmp ) )
        return false;
    MIL_PionMission_GEN_RetablirItineraire& mission = static_cast< MIL_PionMission_GEN_RetablirItineraire& >( missionTmp );
...
void MIL_PionMission_GEN_RetablirItineraire::Serialize( ASN1T_MsgPionOrder& asnMsg )
{
    ...
    asnMsg.mission.t                           = T_Mission_Pion_mission_pion_gen_retablir_itineraire;
    asnMsg.mission.u.mission_pion_gen_retablir_itineraire  = &asnMission;
...
{
    assert( asnMsg.mission.t == T_Mission_Pion_mission_pion_gen_retablir_itineraire );
    ASN1T_Mission_Pion_GEN_RetablirItineraire& asnMission = *asnMsg.mission.u.mission_pion_gen_retablir_itineraire;
