...
#ifndef __MIL_PionMission_LOG_TrierEtTraiterEU_h_
#define __MIL_PionMission_LOG_TrierEtTraiterEU_h_
...
// Created: 2005-5-9 - 11:49:5
//*****************************************************************************
class MIL_PionMission_LOG_TrierEtTraiterEU: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_LOG_TrierEtTraiterEU )

public:

             MIL_PionMission_LOG_TrierEtTraiterEU( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_LOG_TrierEtTraiterEU();
...
#endif // __MIL_PionMission_LOG_TrierEtTraiterEU_h_
