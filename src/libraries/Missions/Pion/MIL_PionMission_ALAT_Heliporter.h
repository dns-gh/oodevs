...
#ifndef __MIL_PionMission_ALAT_Heliporter_h_
#define __MIL_PionMission_ALAT_Heliporter_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ALAT_Heliporter: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_Heliporter )

public:

             MIL_PionMission_ALAT_Heliporter( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_Heliporter();
...
private:
    static int nDIAUnitesAHeliporterIdx_;
    ...
    static int nDIAAttendreUniteIdx_;
    static int nDIAAvecMaterielIdx_;

};


#endif // __MIL_PionMission_ALAT_Heliporter_h_
