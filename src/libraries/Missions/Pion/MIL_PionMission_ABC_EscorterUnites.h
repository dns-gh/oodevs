...
#ifndef __MIL_PionMission_ABC_EscorterUnites_h_
#define __MIL_PionMission_ABC_EscorterUnites_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_ABC_EscorterUnites: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_EscorterUnites )

public:

             MIL_PionMission_ABC_EscorterUnites( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_EscorterUnites();
...
#endif // __MIL_PionMission_ABC_EscorterUnites_h_
