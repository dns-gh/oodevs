...
#ifndef __MIL_PionMission_NBC_ReconnaitreUnSiteROTA_h_
#define __MIL_PionMission_NBC_ReconnaitreUnSiteROTA_h_
...
// Created: 2005-08-19 - 11:30:56
//*****************************************************************************
class MIL_PionMission_NBC_ReconnaitreUnSiteROTA: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_NBC_ReconnaitreUnSiteROTA )

public:

             MIL_PionMission_NBC_ReconnaitreUnSiteROTA( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_NBC_ReconnaitreUnSiteROTA();
...
#endif // __MIL_PionMission_NBC_ReconnaitreUnSiteROTA_h_
