...
#ifndef __MIL_PionMission_RENS_ROEM_MettreEnOeuvre_h_
#define __MIL_PionMission_RENS_ROEM_MettreEnOeuvre_h_
...
// Created: 2005-08-19 - 11:30:56
//*****************************************************************************
class MIL_PionMission_RENS_ROEM_MettreEnOeuvre: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_RENS_ROEM_MettreEnOeuvre )

public:

             MIL_PionMission_RENS_ROEM_MettreEnOeuvre( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_RENS_ROEM_MettreEnOeuvre();
...
#endif // __MIL_PionMission_RENS_ROEM_MettreEnOeuvre_h_
