...
#ifndef __MIL_PionMission_GEN_FranchirEntonnoir_h_
#define __MIL_PionMission_GEN_FranchirEntonnoir_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_FranchirEntonnoir: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_FranchirEntonnoir )

public:

             MIL_PionMission_GEN_FranchirEntonnoir( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_FranchirEntonnoir();
...
#endif // __MIL_PionMission_GEN_FranchirEntonnoir_h_
