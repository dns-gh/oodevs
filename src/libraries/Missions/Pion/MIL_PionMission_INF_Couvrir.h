...
#ifndef __MIL_PionMission_INF_Couvrir_h_
#define __MIL_PionMission_INF_Couvrir_h_
...
// Created: 2005-6-28 - 14:3:3
//*****************************************************************************
class MIL_PionMission_INF_Couvrir: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_Couvrir )

public:

             MIL_PionMission_INF_Couvrir( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_Couvrir();
...
#endif // __MIL_PionMission_INF_Couvrir_h_
