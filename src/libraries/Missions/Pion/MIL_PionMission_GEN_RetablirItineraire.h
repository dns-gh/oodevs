...
#ifndef __MIL_PionMission_GEN_RetablirItineraire_h_
#define __MIL_PionMission_GEN_RetablirItineraire_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_RetablirItineraire: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_RetablirItineraire )

public:

             MIL_PionMission_GEN_RetablirItineraire( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_RetablirItineraire();
...
#endif // __MIL_PionMission_GEN_RetablirItineraire_h_
