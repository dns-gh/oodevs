...
#ifndef __MIL_PionMission_Test_ChangePosture_h_
#define __MIL_PionMission_Test_ChangePosture_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_Test_ChangePosture: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_Test_ChangePosture )

public:

             MIL_PionMission_Test_ChangePosture( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_Test_ChangePosture();
...
#endif // __MIL_PionMission_Test_ChangePosture_h_
