...
#ifndef __MIL_PionMission_GEN_CreerPiste_h_
#define __MIL_PionMission_GEN_CreerPiste_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_CreerPiste: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_CreerPiste )

public:

             MIL_PionMission_GEN_CreerPiste( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_CreerPiste();
...
#endif // __MIL_PionMission_GEN_CreerPiste_h_
