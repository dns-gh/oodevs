...
#ifndef __MIL_PionMission_GEN_ComblerEntonnoir_h_
#define __MIL_PionMission_GEN_ComblerEntonnoir_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_ComblerEntonnoir: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_ComblerEntonnoir )

public:

             MIL_PionMission_GEN_ComblerEntonnoir( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_ComblerEntonnoir();
...
#endif // __MIL_PionMission_GEN_ComblerEntonnoir_h_
