...
#ifndef __MIL_PionMission_ALAT_AppuyerDirectAuContact_h_
#define __MIL_PionMission_ALAT_AppuyerDirectAuContact_h_
...
{
    MT_COPYNOTALLOWED( MIL_PionMission_ALAT_AppuyerDirectAuContact )

public:

             MIL_PionMission_ALAT_AppuyerDirectAuContact( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ALAT_AppuyerDirectAuContact();
...
#endif // __MIL_PionMission_ALAT_AppuyerDirectAuContact_h_
