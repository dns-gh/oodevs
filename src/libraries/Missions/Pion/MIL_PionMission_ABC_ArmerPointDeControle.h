...
#ifndef __MIL_PionMission_ABC_ArmerPointDeControle_h_
#define __MIL_PionMission_ABC_ArmerPointDeControle_h_
...
// Created: 2005-08-17 - 16:30:44
//*****************************************************************************
class MIL_PionMission_ABC_ArmerPointDeControle: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_ABC_ArmerPointDeControle )

public:

             MIL_PionMission_ABC_ArmerPointDeControle( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_ABC_ArmerPointDeControle();
...
private:
    static int nDIAPointDeControleIdx_;


private:
    MT_Vector2D pointDeControle_;

};


#endif // __MIL_PionMission_ABC_ArmerPointDeControle_h_
