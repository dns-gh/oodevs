...
#ifndef __MIL_PionMission_Franchir_h_
#define __MIL_PionMission_Franchir_h_
...
// Created: 2005-08-01 - 11:23:53
//*****************************************************************************
class MIL_PionMission_Franchir: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_Franchir )

public:

             MIL_PionMission_Franchir( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_Franchir();
...
#endif // __MIL_PionMission_Franchir_h_
