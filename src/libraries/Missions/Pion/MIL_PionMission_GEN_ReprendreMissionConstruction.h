...
#ifndef __MIL_PionMission_GEN_ReprendreMissionConstruction_h_
#define __MIL_PionMission_GEN_ReprendreMissionConstruction_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_GEN_ReprendreMissionConstruction: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_GEN_ReprendreMissionConstruction )

public:

             MIL_PionMission_GEN_ReprendreMissionConstruction( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_GEN_ReprendreMissionConstruction();
...
#endif // __MIL_PionMission_GEN_ReprendreMissionConstruction_h_
