...
#ifndef __MIL_PionMission_INF_FlancGarder_h_
#define __MIL_PionMission_INF_FlancGarder_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_INF_FlancGarder: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_INF_FlancGarder )

public:

             MIL_PionMission_INF_FlancGarder( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_INF_FlancGarder();
...
#endif // __MIL_PionMission_INF_FlancGarder_h_
