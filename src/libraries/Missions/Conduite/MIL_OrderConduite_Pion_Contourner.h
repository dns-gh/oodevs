...
#ifndef __MIL_OrderConduite_Pion_Contourner_h_
#define __MIL_OrderConduite_Pion_Contourner_h_

#include "MIL/Entities/Orders/Conduite/MIL_OrderConduite_ABC.h"
#include "TER/TER_Localisation.h"

// =============================================================================
/** @class  MIL_OrderConduite_Pion_Contourner
    @brief  MIL_OrderConduite_Pion_Contourner
*/
// Created: AGR 2005-08-01 - 11:23:53
// =============================================================================
class MIL_OrderConduite_Pion_Contourner : public MIL_OrderConduite_ABC
{
    MT_COPYNOTALLOWED( MIL_OrderConduite_Pion_Contourner );
public:
...
#endif // __MIL_OrderConduite_Pion_Contourner_h_
