...
#ifndef __MIL_OrderConduite_ChangerReglesEngagementPopulation_h_
#define __MIL_OrderConduite_ChangerReglesEngagementPopulation_h_

#include "MIL/Entities/Orders/Conduite/MIL_OrderConduite_ABC.h"
#include "TER/TER_Localisation.h"

// =============================================================================
/** @class  MIL_OrderConduite_ChangerReglesEngagementPopulation
    @brief  MIL_OrderConduite_ChangerReglesEngagementPopulation
*/
// Created: AGR 
// =============================================================================
class MIL_OrderConduite_ChangerReglesEngagementPopulation : public MIL_OrderConduite_ABC
{
    MT_COPYNOTALLOWED( MIL_OrderConduite_ChangerReglesEngagementPopulation );
public:
...
private:
    static int nDIAOrderConduiteChangerReglesEngagementPopulationIdx_;

};

#endif // __MIL_OrderConduite_ChangerReglesEngagementPopulation_h_
