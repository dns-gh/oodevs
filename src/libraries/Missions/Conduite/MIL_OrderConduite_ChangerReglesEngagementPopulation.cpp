...
// Created: AGR 
//-----------------------------------------------------------------------------
MIL_OrderConduite_ChangerReglesEngagementPopulation::MIL_OrderConduite_ChangerReglesEngagementPopulation( const MIL_KnowledgeGroup& knowledgeGroup, const MIL_OrderConduiteType& type )
