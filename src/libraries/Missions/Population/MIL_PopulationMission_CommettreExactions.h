...
#ifndef __MIL_PopulationMission_CommettreExactions_h_
#define __MIL_PopulationMission_CommettreExactions_h_
...
// Created: 
//*****************************************************************************
class MIL_PopulationMission_CommettreExactions: public MIL_PopulationMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PopulationMission_CommettreExactions )

public:

             MIL_PopulationMission_CommettreExactions( MIL_Population& population, const MIL_PopulationMissionType& type );
    virtual ~MIL_PopulationMission_CommettreExactions();
...
#endif // __MIL_PopulationMission_CommettreExactions_h_
