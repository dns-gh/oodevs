...
public:
    ...
    //@{
             LodgingAttribute( gui::PropertiesDictionary& dictionary, const kernel::Entity_ABC& entity );
             LodgingAttribute( xml::xistream& xis, gui::PropertiesDictionary& dictionary, const kernel::Entity_ABC& entity );
