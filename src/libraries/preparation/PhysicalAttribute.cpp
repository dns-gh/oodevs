...
{
    architecture_.reset( new Architecture( parent, controllers, dictionary, objectTypes ) );
                                      ...
                                      UrbanObject& urbanObject, kernel::Controllers& controllers, const kernel::ObjectTypes& objectTypes )
{
    if( xis.has_child( "physical" ) )
    {
        ...
        if( xis.has_child( "architecture" ) )
            ...
            architecture_.reset( new Architecture( 0, controllers, dictionary, objectTypes ) );
