...
// -----------------------------------------------------------------------------
OrderReport::OrderReport( const dispatcher::Agent& agent, const tools::Resolver_ABC< kernel::MissionType >& missions, const MsgUnitOrder& asn )
    : who_( new Who( agent ) )
...
// Created: SBO 2008-05-22
// -----------------------------------------------------------------------------
OrderReport::OrderReport( const dispatcher::Automat& automat, const tools::Resolver_ABC< kernel::MissionType >& missions, const MsgAutomatOrder& asn )
