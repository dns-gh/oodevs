...
{
    return new ParamAgentKnowledge( this, kernel::OrderParameter( tools::translate( "ParamAgentKnowledgeList", "Agent knowledge %1" ).arg( ++count_ ).ascii(), "agentknowledge", false ), converter_, agent_, potential, controller_ );
}
