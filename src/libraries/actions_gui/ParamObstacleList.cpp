...
{
    return new ParamObstacle(this, kernel::OrderParameter( tools::translate( "ParamObstacleList", "Obstacle %1" ).arg( ++count_ ).ascii(), "obstacle", false ), objectTypes_, layer_, converter_, controller_ );
}
