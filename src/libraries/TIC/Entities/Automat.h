...
public:
    ...
    static const Automat* GetAutomatAt       ( uint nIdx );
    static       uint     GetAutomatCount    ();
	...
	const Pawn&	          GetPc              () const;
          uint            GetPawnCount       () const;
    const Pawn*           GetPawnAt          ( uint nIdx ) const;
...
private:
    ...
    static T_EntityIdSet disaggregAutomats_;
    //@}
};
