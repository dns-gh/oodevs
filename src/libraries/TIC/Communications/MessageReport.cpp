...
void MessageReport::Initialize()
{
	...
	messages_[ "DemandeRavitaillement" ] = new MessageReport( "DemandeRavitaillement", eRC_DemandeRavitaillement, T_MsgCR_cr_cr_demande_ravitaillement, CommunicationType::eReportLogisticSituation );
	...
	messages_[ "VSRAM_PretEnCours" ] = new MessageReport( "VSRAM_PretEnCours", eRC_VSRAM_PretEnCours, T_MsgCR_cr_cr_vsram_pret_en_cours, CommunicationType:: );
	messages_[ "VSRAM_PretAnnule" ] = new MessageReport( "VSRAM_PretAnnule", eRC_VSRAM_PretAnnule, T_MsgCR_cr_cr_vsram_pret_annule, CommunicationType:: );
	messages_[ "VSRAM_PretEffectue" ] = new MessageReport( "VSRAM_PretEffectue", eRC_VSRAM_PretEffectue, T_MsgCR_cr_cr_vsram_pret_effectue, CommunicationType:: );
	messages_[ "VSRAM_RecuperationEffectuee" ] = new MessageReport( "VSRAM_RecuperationEffectuee", eRC_VSRAM_RecuperationEffectuee, T_MsgCR_cr_cr_vsram_recuperation_effectuee, CommunicationType:: );
	messages_[ "Convoi_DeplacementVersPointChargement" ] = new MessageReport( "Convoi_DeplacementVersPointChargement", eRC_Convoi_DeplacementVersPointChargement, T_MsgCR_cr_cr_convoi_deplacement_vers_point_chargement, CommunicationType:: );
	messages_[ "Convoi_ChargementEnCours" ] = new MessageReport( "Convoi_ChargementEnCours", eRC_Convoi_ChargementEnCours, T_MsgCR_cr_cr_convoi_chargement_en_cours, CommunicationType:: );
	messages_[ "Convoi_ChargementEffectue" ] = new MessageReport( "Convoi_ChargementEffectue", eRC_Convoi_ChargementEffectue, T_MsgCR_cr_cr_convoi_chargement_effectue, CommunicationType:: );
	messages_[ "Convoi_DeplacementVersPointDechargement" ] = new MessageReport( "Convoi_DeplacementVersPointDechargement", eRC_Convoi_DeplacementVersPointDechargement, T_MsgCR_cr_cr_convoi_deplacement_vers_point_dechargement, CommunicationType:: );
	messages_[ "Convoi_DechargementEnCours" ] = new MessageReport( "Convoi_DechargementEnCours", eRC_Convoi_DechargementEnCours, T_MsgCR_cr_cr_convoi_dechargement_en_cours, CommunicationType:: );
	messages_[ "Convoi_DechargementEffectue" ] = new MessageReport( "Convoi_DechargementEffectue", eRC_Convoi_DechargementEffectue, T_MsgCR_cr_cr_convoi_dechargement_effectue, CommunicationType:: );
	messages_[ "Convoi_Retour" ] = new MessageReport( "Convoi_Retour", eRC_Convoi_Retour, T_MsgCR_cr_cr_convoi_retour, CommunicationType:: );
	...
	messages_[ "TirImpossiblePlusDeMunitions" ] = new MessageReport( "TirImpossiblePlusDeMunitions", eRC_TirImpossiblePlusDeMunitions, T_MsgCR_cr_cr_tir_impossible_plus_de_munitions, CommunicationType:: );
	...
	messages_[ "Rendu" ] = new MessageReport( "Rendu", eRC_Rendu, T_MsgCR_cr_cr_rendu, CommunicationType:: );
	...
	messages_[ "UniteAmieIdentifiee" ] = new MessageReport( "UniteAmieIdentifiee", eRC_UniteAmieIdentifiee, T_MsgCR_cr_cr_unite_amie_identifiee, CommunicationType:: );
	messages_[ "UniteEnnemieIdentifiee" ] = new MessageReport( "UniteEnnemieIdentifiee", eRC_UniteEnnemieIdentifiee, T_MsgCR_cr_cr_unite_ennemie_identifiee, CommunicationType:: );
	messages_[ "UniteNeutreIdentifiee" ] = new MessageReport( "UniteNeutreIdentifiee", eRC_UniteNeutreIdentifiee, T_MsgCR_cr_cr_unite_neutre_identifiee, CommunicationType:: );
	...
	messages_[ "TirInterditSurPopulation" ] = new MessageReport( "TirInterditSurPopulation", eRC_TirInterditSurPopulation, T_MsgCR_cr_cr_tir_interdit_sur_population, CommunicationType:: );
	messages_[ "TirSommationSurPopulation" ] = new MessageReport( "TirSommationSurPopulation", eRC_TirSommationSurPopulation, T_MsgCR_cr_cr_tir_sommation_sur_population, CommunicationType:: );
	messages_[ "TirDissuasionSurPopulation" ] = new MessageReport( "TirDissuasionSurPopulation", eRC_TirDissuasionSurPopulation, T_MsgCR_cr_cr_tir_dissuasion_sur_population, CommunicationType:: );
	messages_[ "TirNeutralisationSurPopulation" ] = new MessageReport( "TirNeutralisationSurPopulation", eRC_TirNeutralisationSurPopulation, T_MsgCR_cr_cr_tir_neutralisation_sur_population, CommunicationType:: );
	messages_[ "PopulationDetectee" ] = new MessageReport( "PopulationDetectee", eRC_PopulationDetectee, T_MsgCR_cr_cr_population_detectee, CommunicationType:: );
	messages_[ "PriseAPartieParPopulation" ] = new MessageReport( "PriseAPartieParPopulation", eRC_PriseAPartieParPopulation, T_MsgCR_cr_cr_prise_a_partie_par_population, CommunicationType:: );
	messages_[ "RiposteSurPopulation" ] = new MessageReport( "RiposteSurPopulation", eRC_RiposteSurPopulation, T_MsgCR_cr_cr_riposte_sur_population, CommunicationType:: );
	messages_[ "PopulationDangereuseAProximite" ] = new MessageReport( "PopulationDangereuseAProximite", eRC_PopulationDangereuseAProximite, T_MsgCR_cr_cr_population_dangereuse_a_proximite, CommunicationType:: );
	messages_[ "EsquiveDeLaPopulation" ] = new MessageReport( "EsquiveDeLaPopulation", eRC_EsquiveDeLaPopulation, T_MsgCR_cr_cr_esquive_de_la_population, CommunicationType:: );
	messages_[ "DecrochageFaceAPopulation" ] = new MessageReport( "DecrochageFaceAPopulation", eRC_DecrochageFaceAPopulation, T_MsgCR_cr_cr_decrochage_face_a_population, CommunicationType:: );
	messages_[ "MiseEnPlaceControleDeFoule" ] = new MessageReport( "MiseEnPlaceControleDeFoule", eRC_MiseEnPlaceControleDeFoule, T_MsgCR_cr_cr_mise_en_place_controle_de_foule, CommunicationType:: );
	messages_[ "MiseEnPlaceFiltrage" ] = new MessageReport( "MiseEnPlaceFiltrage", eRC_MiseEnPlaceFiltrage, T_MsgCR_cr_cr_mise_en_place_filtrage, CommunicationType:: );
	messages_[ "AnimationBarrage" ] = new MessageReport( "AnimationBarrage", eRC_AnimationBarrage, T_MsgCR_cr_cr_animation_barrage, CommunicationType:: );
	messages_[ "AnimationCanalisation" ] = new MessageReport( "AnimationCanalisation", eRC_AnimationCanalisation, T_MsgCR_cr_cr_animation_canalisation, CommunicationType:: );
	messages_[ "CollecteRenseignementsSurPopulations" ] = new MessageReport( "CollecteRenseignementsSurPopulations", eRC_CollecteRenseignementsSurPopulations, T_MsgCR_cr_cr_collecte_renseignements_sur_populations, CommunicationType:: );
	messages_[ "PopulationTotalementReconnue" ] = new MessageReport( "PopulationTotalementReconnue", eRC_PopulationTotalementReconnue, T_MsgCR_cr_cr_population_totalement_reconnue, CommunicationType:: );
	messages_[ "AttitudeCalme" ] = new MessageReport( "AttitudeCalme", eRC_AttitudeCalme, T_MsgCR_cr_cr_attitude_calme, CommunicationType:: );
	messages_[ "AttitudeAgitee" ] = new MessageReport( "AttitudeAgitee", eRC_AttitudeAgitee, T_MsgCR_cr_cr_attitude_agitee, CommunicationType:: );
	messages_[ "AttitudeExcitee" ] = new MessageReport( "AttitudeExcitee", eRC_AttitudeExcitee, T_MsgCR_cr_cr_attitude_excitee, CommunicationType:: );
	messages_[ "AttitudeAgressive" ] = new MessageReport( "AttitudeAgressive", eRC_AttitudeAgressive, T_MsgCR_cr_cr_attitude_agressive, CommunicationType:: );
	messages_[ "AggravationAttitude" ] = new MessageReport( "AggravationAttitude", eRC_AggravationAttitude, T_MsgCR_cr_cr_aggravation_attitude, CommunicationType:: );
	messages_[ "AffrontementAvecForcesEnnemies" ] = new MessageReport( "AffrontementAvecForcesEnnemies", eRC_AffrontementAvecForcesEnnemies, T_MsgCR_cr_cr_affrontement_avec_forces_ennemies, CommunicationType:: );
	messages_[ "PopulationTemporairementControlee" ] = new MessageReport( "PopulationTemporairementControlee", eRC_PopulationTemporairementControlee, T_MsgCR_cr_cr_population_temporairement_controlee, CommunicationType:: );
	messages_[ "PopulationTemporairementRepoussee" ] = new MessageReport( "PopulationTemporairementRepoussee", eRC_PopulationTemporairementRepoussee, T_MsgCR_cr_cr_population_temporairement_repoussee, CommunicationType:: );
	messages_[ "RepriseDesAffrontements" ] = new MessageReport( "RepriseDesAffrontements", eRC_RepriseDesAffrontements, T_MsgCR_cr_cr_reprise_des_affrontements, CommunicationType:: );
	messages_[ "RecuperationProgressive" ] = new MessageReport( "RecuperationProgressive", eRC_RecuperationProgressive, T_MsgCR_cr_cr_recuperation_progressive, CommunicationType:: );
	messages_[ "AgressionDePopulation" ] = new MessageReport( "AgressionDePopulation", eRC_AgressionDePopulation, T_MsgCR_cr_cr_agression_de_population, CommunicationType:: );
	messages_[ "AgressionParPopulation" ] = new MessageReport( "AgressionParPopulation", eRC_AgressionParPopulation, T_MsgCR_cr_cr_agression_par_population, CommunicationType:: );
	messages_[ "RiposteContreAgressionParPopulation" ] = new MessageReport( "RiposteContreAgressionParPopulation", eRC_RiposteContreAgressionParPopulation, T_MsgCR_cr_cr_riposte_contre_agression_par_population, CommunicationType:: );
	messages_[ "AttaqueInstallation" ] = new MessageReport( "AttaqueInstallation", eRC_AttaqueInstallation, T_MsgCR_cr_cr_attaque_installation, CommunicationType:: );
	messages_[ "EnStationnement" ] = new MessageReport( "EnStationnement", eRC_EnStationnement, T_MsgCR_cr_cr_en_stationnement, CommunicationType:: );
	messages_[ "ExecutionAttentat" ] = new MessageReport( "ExecutionAttentat", eRC_ExecutionAttentat, T_MsgCR_cr_cr_execution_attentat, CommunicationType:: );
