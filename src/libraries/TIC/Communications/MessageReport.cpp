...
void MessageReport::Initialize()
{
	...
	messages_[ "DepassementCapaciteStockage" ] = new MessageReport( "DepassementCapaciteStockage", eRC_DepassementCapaciteStockage, T_MsgCR_cr_cr_depassement_capacite_stockage, CommunicationType:: );
