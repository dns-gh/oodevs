...
void MessageReport::Initialize()
{
	...
	messages_[ "AlerteDisponibiliteMoyensReleve" ] = new MessageReport( "AlerteDisponibiliteMoyensReleve", eRC_AlerteDisponibiliteMoyensReleve, T_MsgCR_cr_cr_alerte_disponibilite_moyens_releve, CommunicationType::eReportLogisticSituation );
	messages_[ "AlerteDisponibiliteMoyensRamassage" ] = new MessageReport( "AlerteDisponibiliteMoyensRamassage", eRC_AlerteDisponibiliteMoyensRamassage, T_MsgCR_cr_cr_alerte_disponibilite_moyens_ramassage, CommunicationType::eReportLogisticSituation );
	messages_[ "AlerteDisponibiliteMedecins" ] = new MessageReport( "AlerteDisponibiliteMedecins", eRC_AlerteDisponibiliteMedecins, T_MsgCR_cr_cr_alerte_disponibilite_medecins, CommunicationType::eReportLogisticSituation );
	messages_[ "AlerteDisponibiliteRemorqueurs" ] = new MessageReport( "AlerteDisponibiliteRemorqueurs", eRC_AlerteDisponibiliteRemorqueurs, T_MsgCR_cr_cr_alerte_disponibilite_remorqueurs, CommunicationType::eReportLogisticSituation );
	messages_[ "AlerteDisponibiliteReparateurs" ] = new MessageReport( "AlerteDisponibiliteReparateurs", eRC_AlerteDisponibiliteReparateurs, T_MsgCR_cr_cr_alerte_disponibilite_reparateurs, CommunicationType::eReportLogisticSituation );
	messages_[ "AlerteDisponibiliteVecteurs" ] = new MessageReport( "AlerteDisponibiliteVecteurs", eRC_AlerteDisponibiliteVecteurs, T_MsgCR_cr_cr_alerte_disponibilite_vecteurs, CommunicationType::eReportLogisticSituation );
	...
	messages_[ "UtilisationArmesNonLetalesFaceAPopulation" ] = new MessageReport( "UtilisationArmesNonLetalesFaceAPopulation", eRC_UtilisationArmesNonLetalesFaceAPopulation, T_MsgCR_cr_cr_utilisation_armes_non_letales_face_a_population, CommunicationType::eReportMission );
