...
void MessageReport::Initialize()
{
	...
	messages_[ "AlerteDisponibiliteMoyensRamassage" ] = new MessageReport( "AlerteDisponibiliteMoyensRamassage", eRC_AlerteDisponibiliteMoyensRamassage, T_MsgCR_cr_cr_alerte_disponibilite_moyens_ramassage, CommunicationType:: );
