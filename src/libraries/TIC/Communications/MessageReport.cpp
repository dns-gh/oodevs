...
void MessageReport::Initialize()
{
	...
	messages_[ "TirIndirectFratricide" ] = new MessageReport( "TirIndirectFratricide", eRC_TirIndirectFratricide, T_MsgCR_cr_cr_tir_indirect_fratricide, CommunicationType:: );
	messages_[ "TirIndirectSurPopulation" ] = new MessageReport( "TirIndirectSurPopulation", eRC_TirIndirectSurPopulation, T_MsgCR_cr_cr_tir_indirect_sur_population, CommunicationType:: );
	...
	messages_[ "ExecutiTirIndirectFratricideonAttentat" ] = new MessageReport( "TirIndirectFratricide", eRC_TirIndirectFratricide, T_MsgCR_cr_cr_tir_indirect_fratricide, CommunicationType::eReportArtillery );	
    messages_[ "ExecutiTirIndirectSurPopulation" ] = new MessageReport( "TirIndirectSurPopulation", eRC_TirIndirectSurPopulation, T_MsgCR_cr_cr_tir_indirect_sur_population, CommunicationType::eReportArtillery );	
}
