...
void MessageReport::Initialize()
{
	...
	messages_[ "VSRAM_PretEnCours" ] = new MessageReport( "VSRAM_PretEnCours", eRC_VSRAM_PretEnCours, T_MsgCR_cr_cr_vsram_pret_en_cours, CommunicationType::eReportLogisticSituation );
	messages_[ "VSRAM_PretAnnule" ] = new MessageReport( "VSRAM_PretAnnule", eRC_VSRAM_PretAnnule, T_MsgCR_cr_cr_vsram_pret_annule, CommunicationType::eReportLogisticSituation );
	messages_[ "VSRAM_PretEffectue" ] = new MessageReport( "VSRAM_PretEffectue", eRC_VSRAM_PretEffectue, T_MsgCR_cr_cr_vsram_pret_effectue, CommunicationType::eReportLogisticSituation );
	messages_[ "VSRAM_RecuperationEffectuee" ] = new MessageReport( "VSRAM_RecuperationEffectuee", eRC_VSRAM_RecuperationEffectuee, T_MsgCR_cr_cr_vsram_recuperation_effectuee, CommunicationType::eReportLogisticSituation );
	...
	messages_[ "TirInterditSurPopulation" ] = new MessageReport( "TirInterditSurPopulation", eRC_TirInterditSurPopulation, T_MsgCR_cr_cr_tir_interdit_sur_population, CommunicationType::eReportMission );
	messages_[ "TirSommationSurPopulation" ] = new MessageReport( "TirSommationSurPopulation", eRC_TirSommationSurPopulation, T_MsgCR_cr_cr_tir_sommation_sur_population, CommunicationType::eReportMission );
	messages_[ "TirDissuasionSurPopulation" ] = new MessageReport( "TirDissuasionSurPopulation", eRC_TirDissuasionSurPopulation, T_MsgCR_cr_cr_tir_dissuasion_sur_population, CommunicationType::eReportMission );
	messages_[ "TirNeutralisationSurPopulation" ] = new MessageReport( "TirNeutralisationSurPopulation", eRC_TirNeutralisationSurPopulation, T_MsgCR_cr_cr_tir_neutralisation_sur_population, CommunicationType::eReportMission );
	...
	messages_[ "RiposteSurPopulation" ] = new MessageReport( "RiposteSurPopulation", eRC_RiposteSurPopulation, T_MsgCR_cr_cr_riposte_sur_population, CommunicationType::eReportMission );
	...
	messages_[ "EsquiveDeLaPopulation" ] = new MessageReport( "EsquiveDeLaPopulation", eRC_EsquiveDeLaPopulation, T_MsgCR_cr_cr_esquive_de_la_population, CommunicationType::eReportMission );
	...
	messages_[ "PopulationTotalementReconnue" ] = new MessageReport( "PopulationTotalementReconnue", eRC_PopulationTotalementReconnue, T_MsgCR_cr_cr_population_totalement_reconnue, CommunicationType::eReportMission );
