...
void MessageReport::Initialize()
{
	...
	messages_[ "PretMaterielEnCours" ] = new MessageReport( "PretMaterielEnCours", eRC_PretMaterielEnCours, T_MsgCR_cr_cr_pret_materiel_en_cours, CommunicationType:: );
	messages_[ "PretMaterielAnnule" ] = new MessageReport( "PretMaterielAnnule", eRC_PretMaterielAnnule, T_MsgCR_cr_cr_pret_materiel_annule, CommunicationType:: );
	messages_[ "PretMaterielEffectue" ] = new MessageReport( "PretMaterielEffectue", eRC_PretMaterielEffectue, T_MsgCR_cr_cr_pret_materiel_effectue, CommunicationType:: );
	messages_[ "PretMaterielImpossible" ] = new MessageReport( "PretMaterielImpossible", eRC_PretMaterielImpossible, T_MsgCR_cr_cr_pret_materiel_impossible, CommunicationType:: );
	messages_[ "PretMaterielPartiellementEffectue" ] = new MessageReport( "PretMaterielPartiellementEffectue", eRC_PretMaterielPartiellementEffectue, T_MsgCR_cr_cr_pret_materiel_partiellement_effectue, CommunicationType:: );
	messages_[ "RecuperationMaterielPreteImpossible" ] = new MessageReport( "RecuperationMaterielPreteImpossible", eRC_RecuperationMaterielPreteImpossible, T_MsgCR_cr_cr_recuperation_materiel_prete_impossible, CommunicationType:: );
	messages_[ "RecuperationMaterielPreteEffectuee" ] = new MessageReport( "RecuperationMaterielPreteEffectuee", eRC_RecuperationMaterielPreteEffectuee, T_MsgCR_cr_cr_recuperation_materiel_prete_effectuee, CommunicationType:: );
	messages_[ "RecuperationMaterielPretePartiellementEffectuee" ] = new MessageReport( "RecuperationMaterielPretePartiellementEffectuee", eRC_RecuperationMaterielPretePartiellementEffectuee, T_MsgCR_cr_cr_recuperation_materiel_prete_partiellement_effectuee, CommunicationType:: );
	messages_[ "MaterielPrete" ] = new MessageReport( "MaterielPrete", eRC_MaterielPrete, T_MsgCR_cr_cr_materiel_prete, CommunicationType:: );
	messages_[ "MaterielRendu" ] = new MessageReport( "MaterielRendu", eRC_MaterielRendu, T_MsgCR_cr_cr_materiel_rendu, CommunicationType:: );
