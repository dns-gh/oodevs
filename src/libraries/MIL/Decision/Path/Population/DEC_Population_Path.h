...
public:
     DEC_Population_Path( const MIL_AgentPion& queryMaker, const MT_Vector2D&   vPosEnd, const DEC_PathType& pathType );
     DEC_Population_Path( const MIL_AgentPion& queryMaker, const T_PointVector& points , const DEC_PathType& pathType );
    ...
    //! @name Operations
    //@{
    bool operator==( const DEC_Population_Path& rhs ) const;
    bool operator!=( const DEC_Population_Path& rhs ) const;
    //@}
