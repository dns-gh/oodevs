...
#include "Entities/Agents/Actions/Loading/PHY_ActionRecoverHumanTransporters.h"
...
{
    // Actions
    DEC_RegisterDIACallFunctor( GetFunctionTable(), &DEC_ActionFunctions::StopAction                                       , "DEC_StopAction"                           );
    DEC_RegisterDIACallFunctor( GetFunctionTable(), &DEC_ActionFunctions::SuspendAction                                    , "DEC_PauseAction"                          );
    DEC_RegisterDIACallFunctor( GetFunctionTable(), &DEC_ActionFunctions::ResumeAction                                     , "DEC_ReprendAction"                        );
    ...
    DEC_RegisterDIACallFunctor( GetFunctionTable(), &DEC_AgentFunctions::GetHumanTransportersRecoveringTime, "DEC_Agent_DureeRecuperationTranporteurs"            );
    DEC_RegisterDIACallFunctor( GetFunctionTable(), &DEC_AgentFunctions::GetHumanTransportersRecoveringTime, "DEC_Agent_DureeRecuperationTranporteursSurPosition" );
    ...
    DEC_RegisterDIACallFunctor( GetFunctionTable(), &DEC_KnowledgeFunctions::GetAttackers                                            , "DEC_Connaissances_AgentsPrenantAPartie"             );
