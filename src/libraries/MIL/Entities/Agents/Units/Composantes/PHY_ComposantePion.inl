...
// -----------------------------------------------------------------------------
// Name: PHY_ComposantePion::GetConvoyTransportUCapacity
// Created: NLD 2005-01-27
// -----------------------------------------------------------------------------
inline
MT_Float PHY_ComposantePion::GetConvoyTransporterUCapacity() const
{
    assert( pType_ );
    return pType_->GetConvoyTransporterUCapacity();
}
