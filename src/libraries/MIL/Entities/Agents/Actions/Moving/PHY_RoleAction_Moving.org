...
bool PHY_RoleAction_Moving::SetCurrentPath( DEC_Path& path )
{
    ...
    const_cast< DEC_Path& >( path ).InsertDecPoints(); // $$$ HIDEUX
    bHasChanged_     = true;
...
void PHY_RoleAction_Moving::SendFullState()
{
    ...
    std::cout << "PHY_RoleAction_Moving::SendFullState " << pCurrentPath_->GetResult().size() << std::endl;
//    return;
