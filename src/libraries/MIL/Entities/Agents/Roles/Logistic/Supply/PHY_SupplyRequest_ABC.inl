...
// $Archive: /MVW_v10/Build/SDK/MIL/Src/Entities/Agents/Roles/Logistic/Supply/PHY_SupplyRequest_ABC.inl $
// $Author: Nld $
...
// -----------------------------------------------------------------------------
template< typename T > 
void PHY_SupplyRequest_ABC< T >::Serialize( ASN1T_DemandeDotation& asn ) const
{
