...
// $Archive: /MVW_v10/Build/SDK/MIL/src/Entities/Agents/Perceptions/PHY_PerceptionRadarAntiRadar.h $
// $Author: Age $
// $Modtime: 4/03/05 14:54 $
// $Revision: 2 $
// $Workfile: PHY_PerceptionRadarAntiRadar.h $
//
// *****************************************************************************

#ifndef __PHY_PerceptionRadarAntiRadar_h_
#define __PHY_PerceptionRadarAntiRadar_h_

#include "PHY_Perception_ABC.h"
#include "TER_Localisation.h"

// =============================================================================
// @class  PHY_PerceptionRadarAntiRadar
// Created: JVT 2004-10-21
// Modified: JVT 2004-10-28
// =============================================================================
class PHY_PerceptionRadarAntiRadar : public PHY_Perception_ABC
{
    MT_COPYNOTALLOWED( PHY_PerceptionRadarAntiRadar )

public:
             PHY_PerceptionRadarAntiRadar( PHY_RolePion_Perceiver& perceiver );
    virtual ~PHY_PerceptionRadarAntiRadar();
...
#include "PHY_PerceptionRadarAntiRadar.inl"

#endif // __PHY_PerceptionRadarAntiRadar_h_
