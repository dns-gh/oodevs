...
const MIL_RC*                                   MIL_RC::pRcTirIndirectFratricide_                           = 0;
const MIL_RC*                                   MIL_RC::pRcTirIndirectSurPopulation_                        = 0;
...
const MIL_RC*                                   MIL_RC::pRcPretMaterielEnCours_                             = 0;
const MIL_RC*                                   MIL_RC::pRcPretMaterielAnnule_                              = 0;
const MIL_RC*                                   MIL_RC::pRcPretMaterielEffectue_                            = 0;
const MIL_RC*                                   MIL_RC::pRcPretMaterielPartiellementEffectue_               = 0;
const MIL_RC*                                   MIL_RC::pRcPretMaterielImpossible_                          = 0;
const MIL_RC*                                   MIL_RC::pRcRecuperationMaterielPreteEffectuee_              = 0;
const MIL_RC*                                   MIL_RC::pRcRecuperationMaterielPretePartiellementEffectuee_ = 0;
...
void MIL_RC::Initialize()
{
	...
	rcs_[ eRC_PretMaterielImpossible ] = new MIL_RC( eRC_PretMaterielImpossible, T_MsgCR_cr_cr_pret_materiel_impossible );
	rcs_[ eRC_PretMaterielPartiellementEffectue ] = new MIL_RC( eRC_PretMaterielPartiellementEffectue, T_MsgCR_cr_cr_pret_materiel_partiellement_effectue );
	rcs_[ eRC_RecuperationMaterielPreteImpossible ] = new MIL_RC( eRC_RecuperationMaterielPreteImpossible, T_MsgCR_cr_cr_recuperation_materiel_prete_impossible );
	rcs_[ eRC_RecuperationMaterielPreteEffectuee ] = new MIL_RC( eRC_RecuperationMaterielPreteEffectuee, T_MsgCR_cr_cr_recuperation_materiel_prete_effectuee );
	rcs_[ eRC_RecuperationMaterielPretePartiellementEffectuee ] = new MIL_RC( eRC_RecuperationMaterielPretePartiellementEffectuee, T_MsgCR_cr_cr_recuperation_materiel_prete_partiellement_effectuee );
	rcs_[ eRC_MaterielPrete ] = new MIL_RC( eRC_MaterielPrete, T_MsgCR_cr_cr_materiel_prete );
	rcs_[ eRC_MaterielRendu ] = new MIL_RC( eRC_MaterielRendu, T_MsgCR_cr_cr_materiel_rendu );
	...
	rcs_[ eRC_TirIndirectFratricide ] = new MIL_RC( eRC_TirIndirectFratricide, T_MsgCR_cr_cr_tir_indirect_fratricide );
	rcs_[ eRC_TirIndirectSurPopulation ] = new MIL_RC( eRC_TirIndirectSurPopulation, T_MsgCR_cr_cr_tir_indirect_sur_population );
    ...
    pRcTirIndirectFratricide_                           =                                            rcs_[ eRC_TirIndirectFratricide                            ];
    pRcTirIndirectSurPopulation_                        =                                            rcs_[ eRC_TirIndirectSurPopulation                         ];
    ...
    pRcPretMaterielEnCours_                             =                                            rcs_[ eRC_PretMaterielEnCours                              ];
    pRcPretMaterielAnnule_                              =                                            rcs_[ eRC_PretMaterielAnnule                               ];
    pRcPretMaterielEffectue_                            =                                            rcs_[ eRC_PretMaterielEffectue                             ];
    pRcPretMaterielPartiellementEffectue_               =                                            rcs_[ eRC_PretMaterielPartiellementEffectue                ];
    pRcPretMaterielImpossible_                          =                                            rcs_[ eRC_PretMaterielImpossible                           ];
    pRcRecuperationMaterielPreteEffectuee_              =                                            rcs_[ eRC_RecuperationMaterielPreteEffectuee               ];
    pRcRecuperationMaterielPretePartiellementEffectuee_ =                                            rcs_[ eRC_RecuperationMaterielPretePartiellementEffectuee  ];
