...
#ifndef __MIL_RC_AgressionDePopulation_h_
#define __MIL_RC_AgressionDePopulation_h_
...
// Created: JVT 2004-08-03
// =============================================================================
class MIL_RC_AgressionDePopulation : public MIL_RC
{
    MT_COPYNOTALLOWED( MIL_RC_AgressionDePopulation )

public:   
    MIL_RC_AgressionDePopulation( E_RC nRC, int nAsnID );
    virtual ~MIL_RC_AgressionDePopulation();
...
#endif // __MIL_RC_AgressionDePopulation_h_
