...
#ifndef __MIL_RC_RecuperationProgressive_h_
#define __MIL_RC_RecuperationProgressive_h_
...
// Created: JVT 2004-08-03
// =============================================================================
class MIL_RC_RecuperationProgressive : public MIL_RC
{
    MT_COPYNOTALLOWED( MIL_RC_RecuperationProgressive )

public:   
    MIL_RC_RecuperationProgressive( E_RC nRC, int nAsnID );
    virtual ~MIL_RC_RecuperationProgressive();
...
#endif // __MIL_RC_RecuperationProgressive_h_
