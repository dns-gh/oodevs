...
// $Archive: /MVW_v10/Build/SDK/MIL/Src/Entities/Rc/MIL_RC_EchecRenforcement.cpp $
// $Author: Nld $
// $Modtime: 9/03/05 15:21 $
// $Revision: 5 $
// $Workfile: MIL_RC_EchecRenforcement.cpp $
//
// *****************************************************************************
...
// -----------------------------------------------------------------------------
// Name: MIL_RC_EchecRenforcement constructor
// Created: NLD 2004-08-05
// -----------------------------------------------------------------------------
MIL_RC_EchecRenforcement::MIL_RC_EchecRenforcement( E_RC nRC, int nAsnID )
    : MIL_RC( nRC, nAsnID )
{
}
...
// Created: NLD 2004-08-05
// -----------------------------------------------------------------------------
MIL_RC_EchecRenforcement::~MIL_RC_EchecRenforcement()
{
}
...
// -----------------------------------------------------------------------------
// Name: MIL_RC_EchecRenforcement destructor
// Created: NLD 2004-08-05
// -----------------------------------------------------------------------------
void MIL_RC_EchecRenforcement::Send( const MIL_AgentPion& sender, E_RcType nType, DIA_Parameters& diaParams ) const
{
