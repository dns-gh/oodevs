...
const MIL_RealObjectType& MIL_RealObjectType::pontFlottant_             = *new MIL_RealObjectType( "pont flottant"             , eObjectTypePontFlottant           , EnumObjectType::pont_flottant            , &MIL_FloatingBridge         ::Create );  
