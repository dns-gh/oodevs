...
void MIL_AutomateType::InitializeDiaFunctions()
{
    ...
    DEC_RegisterDIACallFunctor( GetFunctionTable(), &DEC_KnowledgeFunctions      ::GetDangerousEnemiesForPion            < MIL_Automate >, "DEC_Connaissances_UnitesEnnemiesDangereusesPourPion"     );
