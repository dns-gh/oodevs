...
// -----------------------------------------------------------------------------
Limit::Limit( unsigned int id, xml::xistream& xis, const sword::Diffusion& diffusion, const kernel::CoordinateConverter_ABC& converter, const DisplayInfo& info )
    : TacticalLine_ABC( id, xis, diffusion, converter, info )
{
    // NOTHING
}
