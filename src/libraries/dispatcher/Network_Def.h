...
GENERATE_ASN_MSG_SENDER         ( Client, AutomateChangeGroupeConnaissanceAck           , automate_change_groupe_connaissance_ack           );
GENERATE_ASN_MSG_SENDER         ( Client, AutomateChangeLiensLogistiquesAck             , automate_change_liens_logistiques_ack             );
GENERATE_ASN_MSG_SENDER         ( Client, AutomateChangeLiensLogistiques                , automate_change_liens_logistiques                 );
GENERATE_ASN_MSG_SENDER         ( Client, PionChangeSuperiorAck                         , pion_change_superior_ack                          );
...
GENERATE_ASN_MSG_SENDER         ( Client, PionChangeSuperior                            , pion_change_superior                              );
...
GENERATE_ASN_MSG_SENDER         ( Sim, AutomateChangeGroupeConnaissance, automate_change_groupe_connaissance );
GENERATE_ASN_MSG_SENDER         ( Sim, AutomateChangeLiensLogistiques  , automate_change_liens_logistiques   );
GENERATE_ASN_MSG_SENDER         ( Sim, PionChangeSuperior              , pion_change_superior                );
