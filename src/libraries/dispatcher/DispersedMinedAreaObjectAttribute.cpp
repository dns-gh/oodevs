...
// -----------------------------------------------------------------------------
DispersedMinedAreaObjectAttribute::DispersedMinedAreaObjectAttribute( const Model& model, const ASN1T_AttrObjectSpecific& asnMsg )
    : ObjectAttribute_ABC( model, asnMsg )
    , nMinesActivityTime_( 0 )
    , rMinesDensity_     ( 0. )
{
    if( asnMsg.t == T_AttrObjectSpecific_zone_minee_par_dispersion )
    {
...
// Created: NLD 2006-09-26
// -----------------------------------------------------------------------------
void DispersedMinedAreaObjectAttribute::Update( const ASN1T_AttrObjectSpecific& asnMsg )
{
    if( asnMsg.t == T_AttrObjectSpecific_zone_minee_par_dispersion )
    {
        nMinesActivityTime_ = asnMsg.u.zone_minee_par_dispersion->delai_activite_mines;
...
// -----------------------------------------------------------------------------
void DispersedMinedAreaObjectAttribute::Send( ASN1T_AttrObjectSpecific& asnMsg ) const
{
    asnMsg.t = nType_;
    asnMsg.u.zone_minee_par_dispersion = new ASN1T_AttrObjectZoneMineeParDispersion();
...
// -----------------------------------------------------------------------------
void DispersedMinedAreaObjectAttribute::AsnDelete( ASN1T_AttrObjectSpecific& asnMsg ) const
{
