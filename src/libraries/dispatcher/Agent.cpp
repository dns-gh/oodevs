...
Agent::Agent( Model_ABC& model, const sword::UnitCreation& msg, const tools::Resolver_ABC< kernel::AgentType >& types )
    ...
    , nLastPosture_                 ( sword::UnitAttributes::arret )
    , nCurrentPosture_              ( sword::UnitAttributes::arret )
    ...
    , pTransporter_                 ( 0 )
    , nForceRatioState_             ( sword::ForceRatio::neutre )
    ...
    , nRoe_                         ( sword::RulesOfEngagement::tir_libre )
