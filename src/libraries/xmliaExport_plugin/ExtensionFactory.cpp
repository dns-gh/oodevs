...
{
    //entity.Attach< XmliaExportExtension_ABC >( *new AgentExtension( entity, publisher_, reportFactory_, simulation_, model_ ) );
}
...
{
    entity.Attach< XmliaExportExtension_ABC >( *new AutomatExtension( entity, publisher_, reportFactory_ ) );
}
