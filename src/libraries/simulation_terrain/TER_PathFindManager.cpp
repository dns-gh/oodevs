...
// Created: AGE 2005-02-01
// -----------------------------------------------------------------------------
TER_PathFinderThread& TER_PathFindManager::CreatePathFinderThread( tools::thread::MessageQueue_ABC< boost::shared_ptr< TER_PathFindRequest_ABC > >& queue, unsigned int nMaxEndConnections, bool bUseSameThread /*= false*/ )
{
    threads_.push_back( new TER_PathFinderThread( staticData_, queue, nMaxEndConnections, bUseSameThread ) );
