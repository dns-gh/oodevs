...
// Created: SBO 2008-02-28
// -----------------------------------------------------------------------------
std::auto_ptr< dispatcher::Plugin_ABC > GearthPluginFactory::Create( const std::string& name, xml::xistream& xis, const dispatcher::Config& config,
    dispatcher::Model& model, dispatcher::SimulationPublisher_ABC& /*simulation*/, dispatcher::ClientPublisher_ABC& /*clients*/,
    tools::MessageDispatcher_ABC& clientCommands, dispatcher::LinkResolver_ABC& /*links*/, dispatcher::CompositeRegistrable& ) const
{
