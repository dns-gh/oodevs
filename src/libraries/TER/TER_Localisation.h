...
public:
    ...
    bool ComputeNearestPointInPolygon   ( const MT_Vector2D& vSrc, const TER_Polygon& polygon, MT_Vector2D& vResult ) const; // Calcule la position de la localisation la plus proche de vSrc, mais étant dans polygon_
