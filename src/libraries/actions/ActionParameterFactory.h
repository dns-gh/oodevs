...
public:
    ...
    //! @name Operations
    //@{
    virtual actions::Parameter_ABC* CreateParameter( const kernel::OrderParameter& parameter, const sword::MsgMissionParameter& message, const kernel::Entity_ABC& entity ) const;
    virtual actions::Parameter_ABC* CreateParameter( const kernel::OrderParameter& parameter, const sword::MsgMissionParameter_Value& message, const kernel::Entity_ABC& entity ) const;
