...
public:
    ...
    virtual actions::Parameter_ABC* CreateParameter( const kernel::OrderParameter& parameter, const Common::MsgMissionParameter_Value& message, const kernel::Entity_ABC& entity ) const;
