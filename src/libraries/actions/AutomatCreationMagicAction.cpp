...
// -----------------------------------------------------------------------------
AutomatCreationMagicAction::AutomatCreationMagicAction( const kernel::MagicActionType& magic, kernel::Controller& controller,
    ...
    : UnitMagicAction( magic, controller, registered )
    , automatType_ ( type )
