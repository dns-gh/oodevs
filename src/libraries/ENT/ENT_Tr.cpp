...
T_ConverterUnitMagicActionType UnitMagicActionTypeConverter_[] =
{
    ...
    T_ConverterUnitMagicActionType( "log_maintenance_switch_mode",      QT_TRANSLATE_NOOP( "sword::UnitMagicAction::Type", "Log Switch Maintenance Mode" ), sword::UnitMagicAction::log_maintenance_switch_mode ),
