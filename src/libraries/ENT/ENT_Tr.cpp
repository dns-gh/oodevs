...
T_ConverterUnitMagicActionType UnitMagicActionTypeConverter_[] =
{
    ...
    T_ConverterUnitMagicActionType( "log_maintenance_switch_mode",      QT_TRANSLATE_NOOP( "sword::UnitMagicAction::Type", "Switch Log Maintenance Mode" ), sword::UnitMagicAction::log_maintenance_switch_mode ),
