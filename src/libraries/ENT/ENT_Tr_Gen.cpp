...
ENT_Tr::T_ConverterAutomataMission ENT_Tr::automataMissionConverter_[] =
{
    ...
    T_ConverterAutomataMission( "Automate LOG TransporterFormationBlindee", QT_TRANSLATE_NOOP( "ENT", "Automate LOG TransporterFormationBlindee" ), eMission_Automate_LOG_TransporterFormationBlindee ),
...
ENT_Tr::T_ConverterUnitMission ENT_Tr::unitMissionConverter_[] =
{
    ...
    T_ConverterUnitMission( "Pion LOG TransporterUniteChars", QT_TRANSLATE_NOOP( "ENT", "Pion LOG TransporterUniteChars" ), eMission_Pion_LOG_TransporterUniteChars ),
...
void ENT_Tr::InitTranslations()
{
    ...
    InitTr( UnitNatureCategoryConverter_ );
    InitTr( UnitNatureMobilityConverter_ );
    InitTr( UnitCapaciteMissionConverter_ );
    InitTr( NatureLevelConverter_ );
    InitTr( HumanWoundConverter_ );
    InitTr( HumanRankConverter_ );
    InitTr( TempsBordeeConverter_ );
    InitTr( MissionALAT_PorteeActionConverter_ );
    InitTr( MissionALAT_AmbianceMissionConverter_ );
    InitTr( ModeDeploiementConverter_ );
    InitTr( OrderErrorCodeConverter_ );
    InitTr( OrderStateConverter_ );
    InitTr( ObjectTypeConverter_ );
    InitTr( MissionGenUrgenceConverter_ );
    InitTr( MissionGenSousTypeObstacleConverter_ );
    InitTr( ObjectErrorCodeConverter_ );
    InitTr( MissionGenPrioriteConverter_ );
    InitTr( ModeDeploiementSectionMistralConverter_ );
    InitTr( TypeFosseACConverter_ );
    InitTr( GenTypePontageConverter_ );
    InitTr( MissionInfNatureObjectifConverter_ );
    InitTr( AutomateOrderFormationConverter_ );
    InitTr( CtrlErrorCodeConverter_ );
    InitTr( MsgCtrlClientAnnouncementConverter_ );
    InitTr( EtatSimConverter_ );
    InitTr( PrecipitationTypeConverter_ );
    ...
    InitTr( ChangeDiplomatieErrorCodeConverter_ );
    InitTr( ChangeGroupeConnaissanceErrorCodeConverter_ );
    InitTr( ChangeLiensLogistiquesErrorCodeConverter_ );
    InitTr( ChangeAutomateErrorCodeConverter_ );
    InitTr( CtrlErrorCodeLauncherConverter_ );
    InitTr( LogMaintenanceTraitementEtatConverter_ );
    InitTr( LogRavitaillementTraitementEtatConverter_ );
    InitTr( MsgLogRavitaillementChangeQuotasAckConverter_ );
    ...
    InitTr( SetAutomateModeErrorCodeConverter_ );
    InitTr( UnitAttrErrorCodeConverter_ );
    InitTr( TypeMunitionTirIndirectConverter_ );
    InitTr( ActionReagirFaceAEniConverter_ );
    InitTr( TC2GererMaterielAvantDeplacementConverter_ );
