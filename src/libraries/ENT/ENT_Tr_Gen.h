...
public:
    ...
    static const std::string& ConvertFromObstacleActivation( E_ObstacleActivation, E_Conversion = eToSim );
    ...
    static const std::string& ConvertFromAviationRange( E_AviationRange, E_Conversion = eToSim );
    ...
    static E_ObstacleActivation ConvertToObstacleActivation( const std::string&, E_Conversion = eToSim );
    ...
    static E_AviationRange ConvertToAviationRange( const std::string& );
...
private:
    ...
    static T_ConverterAmmunitionType AmmunitionTypeConverter_ [];
    ...
    static T_ConverterObstacleActivation ObstacleActivationConverter_ [];
    ...
    static T_ConverterAviationRange AviationRangeConverter_ [];
