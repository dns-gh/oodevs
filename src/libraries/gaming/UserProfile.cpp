...
void UserProfile::RequestCreation()
{
    ...
    message().mutable_profile()->set_login( login_.toUtf8().constData() );
...
void UserProfile::RequestDeletion()
{
    ...
    message().set_login( login_.toUtf8().constData() );
    message.Send( publisher_ );
}
...
void UserProfile::RequestUpdate( const QString& newLogin )
{
    ...
    profile.set_login( newLogin.toUtf8().constData() );
    profile.set_password( password_.toUtf8().constData() );
