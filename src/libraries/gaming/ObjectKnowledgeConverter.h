...
private:
    ...
    const kernel::ObjectKnowledge_ABC* FindInKnowledgeGroups( const kernel::Entity_ABC* key, unsigned int id ) const;
    const kernel::ObjectKnowledge_ABC* FindInKnowledgeGroups( const kernel::Entity_ABC* key, const kernel::Object_ABC* object ) const;
    //@}
