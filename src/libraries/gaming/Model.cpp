...
Model::Model( kernel::Controllers& controllers, const StaticModel& staticModel, const Simulation& simulation, kernel::Workers& workers, Publisher_ABC& publisher, const RcEntityResolver_ABC& rcResolver )
    ...
    , actionParameterFactory_( *new actions::ActionParameterFactory( staticModel.coordinateConverter_, *this, staticModel, agentKnowledgeConverter_, objectKnowledgeConverter_, urbanKnowledgeConverter_, controllers_.controller_ ) )
    ...
    , resourceNetwork_( *new ResourceNetworkModel( controllers, *this, static_, urbanObjects_ ) )
...
Model::~Model()
{
    ...
    delete &urbanKnowledgeConverter_;
