...
void AgentServerMsgMgr::OnReceiveSimToClient( const std::string& /*from*/, const sword::SimToClient& msg )
{
    ...
    static const struct
    {
        ...
        { &sword::SimToClient_Content::has_control_send_current_state_end,              nullptr },
        ...
        { &sword::SimToClient_Content::has_magic_order,                                 nullptr },
        { &sword::SimToClient_Content::has_magic_order_destruction,                     nullptr },
