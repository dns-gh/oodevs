...
typedef struct EXTERN ASN1T_Mission_Automate_Transporter {
   ASN1T_ListAgent  unites_a_transporter;
   ASN1T_Point  point_debarquement;
   ASN1T_Point  point_embarquement;
   ASN1BOOL  avec_materiel;

   ASN1T_Mission_Automate_Transporter () {
      avec_materiel = FALSE;
   }
} ASN1T_Mission_Automate_Transporter;

class EXTERN ASN1C_Mission_Automate_Transporter : public ASN1CType {
public:
   ASN1T_Mission_Automate_Transporter& msgData;
   ASN1C_Mission_Automate_Transporter (
      ASN1MessageBuffer& msgBuf, ASN1T_Mission_Automate_Transporter& data);
   int Encode ();
   int Decode ();
   void Print (ASN1ConstCharPtr name);
} ;

EXTERN int asn1PE_Mission_Automate_Transporter (ASN1CTXT* ctxt_p, ASN1T_Mission_Automate_Transporter* pvalue);
EXTERN int asn1PD_Mission_Automate_Transporter (ASN1CTXT* ctxt_p, ASN1T_Mission_Automate_Transporter* pvalue);

EXTERN void asn1Print_Mission_Automate_Transporter (ASN1ConstCharPtr name, ASN1T_Mission_Automate_Transporter* pvalue);
