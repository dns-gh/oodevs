...
EXTERN int asn1PE_MsgPopulationConcentrationUpdate (ASN1CTXT* ctxt_p, ASN1T_MsgPopulationConcentrationUpdate* pvalue)
{
   ...
   PU_NEWFIELD (ctxt_p, "formePresent");

   stat = pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.formePresent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PD_MsgPopulationConcentrationUpdate (ASN1CTXT* ctxt_p, ASN1T_MsgPopulationConcentrationUpdate* pvalue)
{
   ...
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->m.formePresent = optbit;
...
EXTERN int asn1PE_MsgPopulationFluxUpdate (ASN1CTXT* ctxt_p, ASN1T_MsgPopulationFluxUpdate* pvalue)
{
   ...
   PU_NEWFIELD (ctxt_p, "queuePresent");

   stat = pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.queuePresent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_SETBITCOUNT (ctxt_p);

   PU_NEWFIELD (ctxt_p, "tetePresent");

   stat = pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.tetePresent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   if (pvalue->m.queuePresent) {
      PU_PUSHNAME (ctxt_p, "queue");

      stat = asn1PE_CoordUTM (ctxt_p, pvalue->queue);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }
   ...
   if (pvalue->m.tetePresent) {
      PU_PUSHNAME (ctxt_p, "tete");

      stat = asn1PE_CoordUTM (ctxt_p, pvalue->tete);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }
...
EXTERN int asn1PD_MsgPopulationFluxUpdate (ASN1CTXT* ctxt_p, ASN1T_MsgPopulationFluxUpdate* pvalue)
{
   ...
   stat = pd_bit (ctxt_p, &optbit);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->m.queuePresent = optbit;
   ...
   stat = pd_bit (ctxt_p, &optbit);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->m.tetePresent = optbit;
   ...
   if (pvalue->m.queuePresent) {
      ...
      stat = asn1PD_CoordUTM (ctxt_p, &pvalue->queue);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   if (pvalue->m.tetePresent) {
      ...
      stat = asn1PD_CoordUTM (ctxt_p, &pvalue->tete);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
