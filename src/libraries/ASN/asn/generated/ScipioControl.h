...
typedef ASN1UINT ASN1T_MsgCtrlBeginTick;
...
struct EXTERN MsgCtrlClientAnnouncement {
   enum Root {
      mos = 0,
      mos_light = 1
   } ;
...
typedef MsgCtrlClientAnnouncement::Root ASN1T_MsgCtrlClientAnnouncement;

class EXTERN ASN1C_MsgCtrlClientAnnouncement : public ASN1CType {
public:
   ASN1T_MsgCtrlClientAnnouncement& msgData;
...
EXTERN void asn1Print_MsgCtrlClientAnnouncement (ASN1ConstCharPtr name, ASN1T_MsgCtrlClientAnnouncement* pvalue);
