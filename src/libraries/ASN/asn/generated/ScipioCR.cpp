...
ASN1C_CR_SilenceRadar::ASN1C_CR_SilenceRadar (
   ASN1MessageBuffer& msgBuf) :
   ASN1CType(msgBuf)
{}
...
EXTERN int asn1PE_CR_SilenceRadar (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PE_CR_SilenceRadar: start\n");

   /* NULL */

   rtdiag ("asn1PE_CR_SilenceRadar: end\n");
   return (stat);
}

int ASN1C_CR_SilenceRadar::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_CR_SilenceRadar (mpContext->GetPtr());
   return stat;
}
...
EXTERN int asn1PD_CR_SilenceRadar (ASN1CTXT* ctxt_p)
{
   ...
   rtdiag ("asn1PD_CR_SilenceRadar: start\n");

   /* NULL */

   rtdiag ("asn1PD_CR_SilenceRadar: end\n");

   return (stat);
}

int ASN1C_CR_SilenceRadar::Decode ()
{
   return asn1PD_CR_SilenceRadar (mpContext->GetPtr());
}
...
EXTERN int asn1PE_MsgCR_cr (ASN1CTXT* ctxt_p, ASN1T_MsgCR_cr* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->t - 1, 0, 163);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   switch (pvalue->t)
   {
      ...
      /* cr_silence_radar */
      case 159:
         PU_PUSHNAME (ctxt_p, "u.cr_silence_radar");

         stat = asn1PE_CR_SilenceRadar (ctxt_p);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MsgCR_cr (ASN1CTXT* ctxt_p, ASN1T_MsgCR_cr* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 163);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->t = ui + 1;
   ...
   switch (ui) {
      ...
      case 158:
         ...
         stat = asn1PD_CR_SilenceRadar (ctxt_p);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
