...
ASN1C_EnumTypeDotation::ASN1C_EnumTypeDotation (
...
EXTERN int asn1PE_EnumTypeDotation (ASN1CTXT* ctxt_p, ASN1T_EnumTypeDotation value)
{
   ...
   rtdiag ("asn1PE_EnumTypeDotation: start\n");

   switch (value) {
      case EnumTypeDotation::munition: ui = 0; break;
      case EnumTypeDotation::carburant: ui = 1; break;
      case EnumTypeDotation::explosif: ui = 2; break;
      case EnumTypeDotation::mine: ui = 3; break;
      case EnumTypeDotation::barbele: ui = 4; break;
      case EnumTypeDotation::piece: ui = 5; break;
      case EnumTypeDotation::ration: ui = 6; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }
   ...
   rtdiag ("asn1PE_EnumTypeDotation: end\n");
   return (stat);
}

int ASN1C_EnumTypeDotation::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_EnumTypeDotation (mpContext->GetPtr(), msgData);
   return stat;
}
...
EXTERN int asn1PD_EnumTypeDotation (ASN1CTXT* ctxt_p, ASN1T_EnumTypeDotation* pvalue)
{
   ...
   rtdiag ("asn1PD_EnumTypeDotation: start\n");

   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 6);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   switch (ui) {
      case 0: *pvalue = EnumTypeDotation::munition; break;
      case 1: *pvalue = EnumTypeDotation::carburant; break;
      case 2: *pvalue = EnumTypeDotation::explosif; break;
      case 3: *pvalue = EnumTypeDotation::mine; break;
      case 4: *pvalue = EnumTypeDotation::barbele; break;
      case 5: *pvalue = EnumTypeDotation::piece; break;
      case 6: *pvalue = EnumTypeDotation::ration; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }

   rtdiag ("asn1PD_EnumTypeDotation: end\n");

   return (stat);
}

int ASN1C_EnumTypeDotation::Decode ()
{
   return asn1PD_EnumTypeDotation (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_CR_SituationLogDefavorable (ASN1CTXT* ctxt_p, ASN1T_CR_SituationLogDefavorable value)
{
   ...
   stat = asn1PE_EnumTypeDotation (ctxt_p, value);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PD_CR_SituationLogDefavorable (ASN1CTXT* ctxt_p, ASN1T_CR_SituationLogDefavorable* pvalue)
{
   ...
   stat = asn1PD_EnumTypeDotation (ctxt_p, pvalue);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
