 ...
 * (http://www.obj-sys.com).  Version: 5.31, Date: 13-Jan-2006.
 */
...
EXTERN int asn1PE_Mission_Pion (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->t - 1, 0, 215);
   ...
   switch (pvalue->t)
   {
      ...
      /* mission_pion_interdire_franchissement_population */
      case 182:
         PU_PUSHNAME (ctxt_p, "u.mission_pion_interdire_franchissement_population");

         stat = asn1PE_Mission_Pion_InterdireFranchissementPopulation (ctxt_p, pvalue->u.mission_pion_interdire_franchissement_population);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);

         break;

      /* mission_pion_filter_population */
      case 183:
         PU_PUSHNAME (ctxt_p, "u.mission_pion_filter_population");

         stat = asn1PE_Mission_Pion_FilterPopulation (ctxt_p, pvalue->u.mission_pion_filter_population);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);

         break;

      /* mission_pion_renseigner_sur_population */
      case 184:
         PU_PUSHNAME (ctxt_p, "u.mission_pion_renseigner_sur_population");

         stat = asn1PE_Mission_Pion_RenseignerSurPopulation (ctxt_p, pvalue->u.mission_pion_renseigner_sur_population);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);

         break;

      /* mission_pion_canaliser_population */
      case 185:
         PU_PUSHNAME (ctxt_p, "u.mission_pion_canaliser_population");

         stat = asn1PE_Mission_Pion_CanaliserPopulation (ctxt_p, pvalue->u.mission_pion_canaliser_population);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);

         break;

      /* mission_pion_securiser_population_dans_zone */
      case 186:
         PU_PUSHNAME (ctxt_p, "u.mission_pion_securiser_population_dans_zone");

         stat = asn1PE_Mission_Pion_SecuriserPopulationDansZone (ctxt_p, pvalue->u.mission_pion_securiser_population_dans_zone);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);

         break;

      /* mission_pion_securiser_zone_contre_menaces_asymetriques */
      case 187:
         PU_PUSHNAME (ctxt_p, "u.mission_pion_securiser_zone_contre_menaces_asymetriques");

         stat = asn1PE_Mission_Pion_SecuriserZoneContreMenacesAsymetriques (ctxt_p, pvalue->u.mission_pion_securiser_zone_contre_menaces_asymetriques);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_Mission_Pion (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 215);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->t = ui + 1;
   ...
   switch (ui) {
      ...
      case 154:
         ...
         if (pvalue->u.mission_pion_log_transporter_unite == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_Mission_Pion_LOG_TransporterUnite (ctxt_p, pvalue->u.mission_pion_log_transporter_unite);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 181:
         ...
         pvalue->u.mission_pion_interdire_franchissement_population = ALLOC_ASN1ELEM (ctxt_p, ASN1T_Mission_Pion_InterdireFranchissementPopulation);
         if (pvalue->u.mission_pion_interdire_franchissement_population == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_Mission_Pion_InterdireFranchissementPopulation (ctxt_p, pvalue->u.mission_pion_interdire_franchissement_population);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 182:
         ...
         pvalue->u.mission_pion_filter_population = ALLOC_ASN1ELEM (ctxt_p, ASN1T_Mission_Pion_FilterPopulation);
         if (pvalue->u.mission_pion_filter_population == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_Mission_Pion_FilterPopulation (ctxt_p, pvalue->u.mission_pion_filter_population);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 183:
         ...
         pvalue->u.mission_pion_renseigner_sur_population = ALLOC_ASN1ELEM (ctxt_p, ASN1T_Mission_Pion_RenseignerSurPopulation);
         if (pvalue->u.mission_pion_renseigner_sur_population == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_Mission_Pion_RenseignerSurPopulation (ctxt_p, pvalue->u.mission_pion_renseigner_sur_population);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 184:
         ...
         pvalue->u.mission_pion_canaliser_population = ALLOC_ASN1ELEM (ctxt_p, ASN1T_Mission_Pion_CanaliserPopulation);
         if (pvalue->u.mission_pion_canaliser_population == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_Mission_Pion_CanaliserPopulation (ctxt_p, pvalue->u.mission_pion_canaliser_population);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 185:
         ...
         pvalue->u.mission_pion_securiser_population_dans_zone = ALLOC_ASN1ELEM (ctxt_p, ASN1T_Mission_Pion_SecuriserPopulationDansZone);
         if (pvalue->u.mission_pion_securiser_population_dans_zone == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_Mission_Pion_SecuriserPopulationDansZone (ctxt_p, pvalue->u.mission_pion_securiser_population_dans_zone);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 186:
         ...
         pvalue->u.mission_pion_securiser_zone_contre_menaces_asymetriques = ALLOC_ASN1ELEM (ctxt_p, ASN1T_Mission_Pion_SecuriserZoneContreMenacesAsymetriques);
         if (pvalue->u.mission_pion_securiser_zone_contre_menaces_asymetriques == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_Mission_Pion_SecuriserZoneContreMenacesAsymetriques (ctxt_p, pvalue->u.mission_pion_securiser_zone_contre_menaces_asymetriques);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
