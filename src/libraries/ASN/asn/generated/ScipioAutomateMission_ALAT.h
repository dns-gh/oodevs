...
public:
   ASN1T_Mission_Automate_ALAT_AllerSeRecompleter& msgData;
   ASN1C_Mission_Automate_ALAT_AllerSeRecompleter (
...
EXTERN void asn1Print_Mission_Automate_ALAT_AllerSeRecompleter (ASN1ConstCharPtr name, ASN1T_Mission_Automate_ALAT_AllerSeRecompleter* pvalue);
