...
EXTERN int asn1PE_OrderConduite_ChangerReglesEngagement (ASN1CTXT* ctxt_p, ASN1T_OrderConduite_ChangerReglesEngagement value)
{
   ...
   stat = asn1PE_EnumReglesEngagement (ctxt_p, value);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PD_OrderConduite_ChangerReglesEngagement (ASN1CTXT* ctxt_p, ASN1T_OrderConduite_ChangerReglesEngagement* pvalue)
{
   ...
   stat = asn1PD_EnumReglesEngagement (ctxt_p, pvalue);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
ASN1C_OrderConduite_AssignerPositionEmbarquement::ASN1C_OrderConduite_AssignerPositionEmbarquement (
...
EXTERN int asn1PE_OrderConduite_AssignerPositionEmbarquement (ASN1CTXT* ctxt_p, ASN1T_OrderConduite_AssignerPositionEmbarquement* pvalue)
{
   ...
   rtdiag ("asn1PE_OrderConduite_AssignerPositionEmbarquement: start\n");

   stat = asn1PE_Point (ctxt_p, pvalue);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   rtdiag ("asn1PE_OrderConduite_AssignerPositionEmbarquement: end\n");
   return (stat);
}

int ASN1C_OrderConduite_AssignerPositionEmbarquement::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_OrderConduite_AssignerPositionEmbarquement (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_OrderConduite_AssignerPositionEmbarquement (ASN1CTXT* ctxt_p, ASN1T_OrderConduite_AssignerPositionEmbarquement* pvalue)
{
   ...
   rtdiag ("asn1PD_OrderConduite_AssignerPositionEmbarquement: start\n");

   stat = asn1PD_Point (ctxt_p, pvalue);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   rtdiag ("asn1PD_OrderConduite_AssignerPositionEmbarquement: end\n");

   return (stat);
}

int ASN1C_OrderConduite_AssignerPositionEmbarquement::Decode ()
{
   return asn1PD_OrderConduite_AssignerPositionEmbarquement (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_MsgOrderConduite_order_conduite (ASN1CTXT* ctxt_p, ASN1T_MsgOrderConduite_order_conduite* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->t - 1, 0, 39);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   switch (pvalue->t)
   {
      ...
      /* order_conduite_assigner_position_embarquement */
      case 13:
         PU_PUSHNAME (ctxt_p, "u.order_conduite_assigner_position_embarquement");

         stat = asn1PE_OrderConduite_AssignerPositionEmbarquement (ctxt_p, pvalue->u.order_conduite_assigner_position_embarquement);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MsgOrderConduite_order_conduite (ASN1CTXT* ctxt_p, ASN1T_MsgOrderConduite_order_conduite* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 39);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->t = ui + 1;
   ...
   switch (ui) {
      ...
      case 12:
         ...
         pvalue->u.order_conduite_assigner_position_embarquement = ALLOC_ASN1ELEM (ctxt_p, ASN1T_OrderConduite_AssignerPositionEmbarquement);
         if (pvalue->u.order_conduite_assigner_position_embarquement == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_OrderConduite_AssignerPositionEmbarquement (ctxt_p, pvalue->u.order_conduite_assigner_position_embarquement);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
