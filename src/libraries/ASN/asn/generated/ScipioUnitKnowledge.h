 ...
 * (http://www.obj-sys.com).  Version: 5.31, Date: 24-Oct-2006.
 */
...
typedef struct EXTERN ASN1T_MsgUnitKnowledgeCreation {
   ASN1T_KnowledgeAgent  oid_connaissance;
   ASN1T_KnowledgeGroup  oid_groupe_possesseur;
   ASN1T_Agent  oid_unite_reelle;
   ASN1T_TypePion  type_unite;
