/* This file was generated by ASN1C V5.31 on 28-Sep-2005 */
...
void asn1Print_MsgPopulationConcentrationUpdate (ASN1ConstCharPtr name, ASN1T_MsgPopulationConcentrationUpdate* pvalue)
{
   ...
   printf ("%s.m.formePresent = %d\n", name, (int)pvalue->m.formePresent);
...
void asn1Print_MsgPopulationFluxUpdate (ASN1ConstCharPtr name, ASN1T_MsgPopulationFluxUpdate* pvalue)
{
   ...
   printf ("%s.m.queuePresent = %d\n", name, (int)pvalue->m.queuePresent);
   printf ("%s.m.tetePresent = %d\n", name, (int)pvalue->m.tetePresent);
   ...
   if (pvalue->m.queuePresent) {
      sprintf (namebuf, "%s.queue", name);
      asn1Print_CoordUTM (namebuf, &pvalue->queue);
   }

   if (pvalue->m.tetePresent) {
      sprintf (namebuf, "%s.tete", name);
      asn1Print_CoordUTM (namebuf, &pvalue->tete);
   }
