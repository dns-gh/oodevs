/* This file was generated by ASN1C V5.31 on 05-Apr-2006 */
...
void asn1Print_EnumLogMaintenanceRegimeTravail (ASN1ConstCharPtr name, ASN1T_EnumLogMaintenanceRegimeTravail* pvalue)
{
   printf ("%s = ", name);
   switch (*pvalue) {
      case 0: printf ("regime_0\n"); break;
      case 1: printf ("regime_1\n"); break;
      case 2: printf ("regime_2\n"); break;
      case 3: printf ("regime_3\n"); break;
      case 4: printf ("regime_4\n"); break;
      default: printf ("???\n");
   }
}
