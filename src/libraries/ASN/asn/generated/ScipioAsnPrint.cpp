/* This file was generated by ASN1C V5.31 on 19-Aug-2005 */
...
{
   asn1Print_EnumFamilleDotation (name, pvalue);
}
...
void asn1Print_CR_SilenceRadar (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_SilenceRadar::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_SilenceRadar (name);
}
...
void asn1Print_MsgCR_cr (ASN1ConstCharPtr name, ASN1T_MsgCR_cr* pvalue)
{
   ...
   switch (pvalue->t) {
      ...
      case 159:
         sprintf (namebuf, "%s.u.cr_silence_radar", name);
         break;
