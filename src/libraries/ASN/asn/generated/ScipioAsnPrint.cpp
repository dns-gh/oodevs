/* This file was generated by ASN1C V5.31 on 29-Mar-2006 */
...
void asn1Print_CR_TempsBordeeMaintenanceDelaiDepasse (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_TempsBordeeMaintenanceDelaiDepasse::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_TempsBordeeMaintenanceDelaiDepasse (name);
}

void asn1Print_CR_TempsBordeeSanteDelaiDepasse (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_TempsBordeeSanteDelaiDepasse::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_TempsBordeeSanteDelaiDepasse (name);
}
...
void asn1Print_MsgCR_cr (ASN1ConstCharPtr name, ASN1T_MsgCR_cr* pvalue)
{
   ...
   switch (pvalue->t) {
      ...
      case 94:
         sprintf (namebuf, "%s.u.cr_temps_bordee_maintenance_delai_depasse", name);
         break;

      case 95:
         sprintf (namebuf, "%s.u.cr_temps_bordee_sante_delai_depasse", name);
         break;
