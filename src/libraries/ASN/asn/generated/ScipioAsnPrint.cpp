/* This file was generated by ASN1C V5.31 on 17-Jul-2006 */
...
void asn1Print_EquipementRecuEnPret (ASN1ConstCharPtr name, ASN1T_EquipementRecuEnPret* pvalue)
{
   char namebuf[512];
...
void ASN1C_EquipementRecuEnPret::Print (ASN1ConstCharPtr name)

{
   asn1Print_EquipementRecuEnPret (name, &msgData);
}

void asn1Print__SeqOfEquipementRecuEnPret (ASN1ConstCharPtr name, ASN1T__SeqOfEquipementRecuEnPret* pvalue)
{
   char namebuf[512];
   ...
   for (xx1 = 0; xx1 < pvalue->n; xx1++) {
      sprintf (namebuf, "%s.elem[%d]", name, xx1);
      asn1Print_EquipementRecuEnPret (namebuf, &pvalue->elem[xx1]);
   }
   }

}

void ASN1C__SeqOfEquipementRecuEnPret::Print (ASN1ConstCharPtr name)

{
   asn1Print__SeqOfEquipementRecuEnPret (name, &msgData);
}
...
void asn1Print_MsgUnitDotations (ASN1ConstCharPtr name, ASN1T_MsgUnitDotations* pvalue)
{
   ...
   printf ("%s.m.equipements_recus_en_pretPresent = %d\n", name, (int)pvalue->m.equipements_recus_en_pretPresent);
   sprintf (namebuf, "%s.oid_pion", name);
   asn1Print_Agent (namebuf, &pvalue->oid_pion);
   ...
   if (pvalue->m.equipements_recus_en_pretPresent) {
      sprintf (namebuf, "%s.equipements_recus_en_pret", name);
      asn1Print__SeqOfEquipementRecuEnPret (namebuf, &pvalue->equipements_recus_en_pret);
   }
