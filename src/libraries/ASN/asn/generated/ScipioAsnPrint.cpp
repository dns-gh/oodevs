/* This file was generated by ASN1C V5.31 on 03-Apr-2006 */
...
void asn1Print_CR_VSRAM_PretEnCours (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_VSRAM_PretEnCours::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_VSRAM_PretEnCours (name);
}

void asn1Print_CR_VSRAM_PretAnnule (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_VSRAM_PretAnnule::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_VSRAM_PretAnnule (name);
}

void asn1Print_CR_VSRAM_PretEffectue (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_VSRAM_PretEffectue::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_VSRAM_PretEffectue (name);
}

void asn1Print_CR_VSRAM_RecuperationEffectuee (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_VSRAM_RecuperationEffectuee::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_VSRAM_RecuperationEffectuee (name);
}
...
void asn1Print_MsgCR_cr (ASN1ConstCharPtr name, ASN1T_MsgCR_cr* pvalue)
{
   ...
   switch (pvalue->t) {
      ...
      case 112:
         sprintf (namebuf, "%s.u.cr_vsram_pret_en_cours", name);
         break;

      case 113:
         sprintf (namebuf, "%s.u.cr_vsram_pret_annule", name);
         break;

      case 114:
         sprintf (namebuf, "%s.u.cr_vsram_pret_effectue", name);
         break;

      case 115:
         sprintf (namebuf, "%s.u.cr_vsram_recuperation_effectuee", name);
         break;
