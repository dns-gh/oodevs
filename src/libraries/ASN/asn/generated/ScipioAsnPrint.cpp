/* This file was generated by ASN1C V5.31 on 04-Jul-2005 */
...
void asn1Print_EnumTypeTerrain (ASN1ConstCharPtr name, ASN1T_EnumTypeTerrain* pvalue)
{
   printf ("%s = ", name);
   switch (*pvalue) {
      case 0: printf ("vide\n"); break;
      case 1: printf ("route\n"); break;
      case 2: printf ("foret\n"); break;
      case 3: printf ("urbain\n"); break;
      case 4: printf ("pont\n"); break;
      default: printf ("???\n");
   }
}

void ASN1C_EnumTypeTerrain::Print (ASN1ConstCharPtr name)

{
   asn1Print_EnumTypeTerrain (name, &msgData);
}

void asn1Print_EnumTypeDotation (ASN1ConstCharPtr name, ASN1T_EnumTypeDotation* pvalue)
{
   printf ("%s = ", name);
   switch (*pvalue) {
...
void ASN1C_EnumTypeDotation::Print (ASN1ConstCharPtr name)

{
   asn1Print_EnumTypeDotation (name, &msgData);
}
...
void asn1Print_CR_PretPourNouvelleMission (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_PretPourNouvelleMission::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_PretPourNouvelleMission (name);
}

void asn1Print_CR_RejointFuseau (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_RejointFuseau::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_RejointFuseau (name);
}

void asn1Print_CR_FuseauRejoint (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_FuseauRejoint::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_FuseauRejoint (name);
}
...
void asn1Print_CR_ProgressionVersLocalisation (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_ProgressionVersLocalisation::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_ProgressionVersLocalisation (name);
}

void asn1Print_CR_ArriveSurLocalisation (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_ArriveSurLocalisation::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_ArriveSurLocalisation (name);
}

void asn1Print_CR_ReconnaissanceLocalisation (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_ReconnaissanceLocalisation::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_ReconnaissanceLocalisation (name);
}
...
void asn1Print_CR_EnPosteSurBond (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_EnPosteSurBond::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_EnPosteSurBond (name);
}
...
void asn1Print_CR_EnControleZone (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_EnControleZone::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_EnControleZone (name);
}

void asn1Print_CR_EnSurveillance (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_EnSurveillance::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_EnSurveillance (name);
}
...
void asn1Print_CR_Brouille (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_Brouille::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_Brouille (name);
}

void asn1Print_CR_EnEcoute (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_EnEcoute::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_EnEcoute (name);
}

void asn1Print_CR_EnEcouteRadar (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_EnEcouteRadar::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_EnEcouteRadar (name);
}

void asn1Print_CR_Automate_PriseContact (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_Automate_PriseContact::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_Automate_PriseContact (name);
}

void asn1Print_CR_Automate_RuptureContact (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_Automate_RuptureContact::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_Automate_RuptureContact (name);
}

void asn1Print_CR_Pion_PriseContact (ASN1ConstCharPtr name, ASN1T_CR_Pion_PriseContact* pvalue)
{
   asn1Print_KnowledgeAgent (name, pvalue);
}

void ASN1C_CR_Pion_PriseContact::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_Pion_PriseContact (name, &msgData);
}

void asn1Print_CR_Pion_RuptureContact (ASN1ConstCharPtr name, ASN1T_CR_Pion_RuptureContact* pvalue)
{
   asn1Print_KnowledgeAgent (name, pvalue);
}

void ASN1C_CR_Pion_RuptureContact::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_Pion_RuptureContact (name, &msgData);
}
...
void asn1Print_CR_PerteDeContactVisuel (ASN1ConstCharPtr name, ASN1T_CR_PerteDeContactVisuel* pvalue)
{
   asn1Print_KnowledgeAgent (name, pvalue);
}

void ASN1C_CR_PerteDeContactVisuel::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_PerteDeContactVisuel (name, &msgData);
}

void asn1Print_CR_PosteFaceEni (ASN1ConstCharPtr name, ASN1T_CR_PosteFaceEni* pvalue)
{
   asn1Print_KnowledgeAgent (name, pvalue);
}

void ASN1C_CR_PosteFaceEni::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_PosteFaceEni (name, &msgData);
}

void asn1Print_CR_PriseAPartie (ASN1ConstCharPtr name, ASN1T_CR_PriseAPartie* pvalue)
{
   asn1Print_KnowledgeAgent (name, pvalue);
}

void ASN1C_CR_PriseAPartie::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_PriseAPartie (name, &msgData);
}
...
void asn1Print_CR_PresenceEniProbable (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_PresenceEniProbable::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_PresenceEniProbable (name);
}
...
void asn1Print_CR_DetruitTactiquement (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_DetruitTactiquement::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_DetruitTactiquement (name);
}
...
void asn1Print_CR_SurTypeTerrainParticulier (ASN1ConstCharPtr name, ASN1T_CR_SurTypeTerrainParticulier* pvalue)
{
   asn1Print_EnumTypeTerrain (name, pvalue);
}

void ASN1C_CR_SurTypeTerrainParticulier::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_SurTypeTerrainParticulier (name, &msgData);
}
...
void asn1Print_CR_TravauxRealises (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_TravauxRealises::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_TravauxRealises (name);
}
...
void asn1Print_CR_DebutFranchissement (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_DebutFranchissement::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_DebutFranchissement (name);
}

void asn1Print_CR_FinFranchissement (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_FinFranchissement::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_FinFranchissement (name);
}
...
void asn1Print_CR_ItineraireRetabli (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_ItineraireRetabli::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_ItineraireRetabli (name);
}

void asn1Print_CR_RenforcementBientotFini (ASN1ConstCharPtr name, ASN1T_CR_RenforcementBientotFini* pvalue)
{
   asn1Print_Agent (name, pvalue);
}

void ASN1C_CR_RenforcementBientotFini::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_RenforcementBientotFini (name, &msgData);
}

void asn1Print_CR_SituationLogFavorable (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_SituationLogFavorable::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_SituationLogFavorable (name);
}

void asn1Print_CR_SituationLogDefavorable (ASN1ConstCharPtr name, ASN1T_CR_SituationLogDefavorable* pvalue)
{
   asn1Print_EnumTypeDotation (name, pvalue);
}

void ASN1C_CR_SituationLogDefavorable::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_SituationLogDefavorable (name, &msgData);
}
...
void asn1Print_CR_AlerteNBC (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_AlerteNBC::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_AlerteNBC (name);
}
...
void asn1Print_CR_PionDecontamine (ASN1ConstCharPtr name, ASN1T_CR_PionDecontamine* pvalue)
{
   asn1Print_Agent (name, pvalue);
}

void ASN1C_CR_PionDecontamine::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_PionDecontamine (name, &msgData);
}
...
void asn1Print_CR_MissionImpossiblePionsSubordonnesNonOperationnels (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_MissionImpossiblePionsSubordonnesNonOperationnels::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_MissionImpossiblePionsSubordonnesNonOperationnels (name);
}
...
void asn1Print_CR_PionNeutralise (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_PionNeutralise::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_PionNeutralise (name);
}

void asn1Print_CR_SilenceRadio (ASN1ConstCharPtr name)
{
}

void ASN1C_CR_SilenceRadio::Print (ASN1ConstCharPtr name)

{
   asn1Print_CR_SilenceRadio (name);
}
...
void asn1Print_MsgCR_cr (ASN1ConstCharPtr name, ASN1T_MsgCR_cr* pvalue)
{
   ...
   switch (pvalue->t) {
      ...
      case 5:
         sprintf (namebuf, "%s.u.cr_pret_pour_nouvelle_mission", name);
         break;

      case 6:
         sprintf (namebuf, "%s.u.cr_rejoint_fuseau", name);
         break;

      case 7:
         sprintf (namebuf, "%s.u.cr_fuseau_rejoint", name);
         break;
      ...
      case 9:
         sprintf (namebuf, "%s.u.cr_progression_vers_localisation", name);
         break;

      case 10:
         sprintf (namebuf, "%s.u.cr_arrive_sur_localisation", name);
         break;

      case 11:
         sprintf (namebuf, "%s.u.cr_reconnaissance_localisation", name);
         break;
      ...
      case 13:
         sprintf (namebuf, "%s.u.cr_en_poste_sur_bond", name);
         break;
      ...
      case 28:
         sprintf (namebuf, "%s.u.cr_en_controle_zone", name);
         break;

      case 29:
         sprintf (namebuf, "%s.u.cr_en_surveillance", name);
         break;
      ...
      case 38:
         sprintf (namebuf, "%s.u.cr_brouille", name);
         break;

      case 39:
         sprintf (namebuf, "%s.u.cr_en_ecoute", name);
         break;

      case 40:
         sprintf (namebuf, "%s.u.cr_en_ecoute_radar", name);
         break;

      case 41:
         sprintf (namebuf, "%s.u.cr_automate_prise_contact", name);
         break;

      case 42:
         sprintf (namebuf, "%s.u.cr_automate_rupture_contact", name);
         break;

      case 43:
         sprintf (namebuf, "%s.u.cr_pion_prise_contact", name);
         asn1Print_CR_Pion_PriseContact (namebuf, &pvalue->u.cr_pion_prise_contact);
         break;

      case 44:
         sprintf (namebuf, "%s.u.cr_pion_rupture_contact", name);
         asn1Print_CR_Pion_RuptureContact (namebuf, &pvalue->u.cr_pion_rupture_contact);
         break;
      ...
      case 47:
         sprintf (namebuf, "%s.u.cr_perte_de_contact_visuel", name);
         asn1Print_CR_PerteDeContactVisuel (namebuf, &pvalue->u.cr_perte_de_contact_visuel);
         break;

      case 48:
         sprintf (namebuf, "%s.u.cr_poste_face_eni", name);
         asn1Print_CR_PosteFaceEni (namebuf, &pvalue->u.cr_poste_face_eni);
         break;

      case 49:
         sprintf (namebuf, "%s.u.cr_prise_a_partie", name);
         asn1Print_CR_PriseAPartie (namebuf, &pvalue->u.cr_prise_a_partie);
         break;
      ...
      case 52:
         sprintf (namebuf, "%s.u.cr_presence_eni_probable", name);
         break;
      ...
      case 60:
         sprintf (namebuf, "%s.u.cr_detruit_tactiquement", name);
         break;
      ...
      case 64:
         sprintf (namebuf, "%s.u.cr_sur_type_terrain_particulier", name);
         asn1Print_CR_SurTypeTerrainParticulier (namebuf, &pvalue->u.cr_sur_type_terrain_particulier);
         break;
      ...
      case 66:
         sprintf (namebuf, "%s.u.cr_travaux_realises", name);
         break;
      ...
      case 74:
         sprintf (namebuf, "%s.u.cr_debut_franchissement", name);
         break;

      case 75:
         sprintf (namebuf, "%s.u.cr_fin_franchissement", name);
         break;
      ...
      case 78:
         sprintf (namebuf, "%s.u.cr_itineraire_retabli", name);
         break;

      case 79:
         sprintf (namebuf, "%s.u.cr_renforcement_bientot_fini", name);
         asn1Print_CR_RenforcementBientotFini (namebuf, &pvalue->u.cr_renforcement_bientot_fini);
         break;

      case 80:
         sprintf (namebuf, "%s.u.cr_situation_log_favorable", name);
         break;

      case 81:
         sprintf (namebuf, "%s.u.cr_situation_log_defavorable", name);
         asn1Print_CR_SituationLogDefavorable (namebuf, &pvalue->u.cr_situation_log_defavorable);
         break;
...
void asn1Print_MsgStartDirectFire (ASN1ConstCharPtr name, ASN1T_MsgStartDirectFire* pvalue)
{
   ...
   asn1Print_OID (namebuf, &pvalue->oid_tir);
...
void asn1Print_OrderConduite_AssignerPositionEmbarquement (ASN1ConstCharPtr name, ASN1T_OrderConduite_AssignerPositionEmbarquement* pvalue)
{
   asn1Print_Point (name, pvalue);
}

void ASN1C_OrderConduite_AssignerPositionEmbarquement::Print (ASN1ConstCharPtr name)

{
   asn1Print_OrderConduite_AssignerPositionEmbarquement (name, &msgData);
}
...
void asn1Print_MsgOrderConduite_order_conduite (ASN1ConstCharPtr name, ASN1T_MsgOrderConduite_order_conduite* pvalue)
{
   ...
   switch (pvalue->t) {
      ...
      case 13:
         sprintf (namebuf, "%s.u.order_conduite_assigner_position_embarquement", name);
         asn1Print_OrderConduite_AssignerPositionEmbarquement (namebuf, pvalue->u.order_conduite_assigner_position_embarquement);
         break;
...
void asn1Print_EnumUnitState (ASN1ConstCharPtr name, ASN1T_EnumUnitState* pvalue)
{
   printf ("%s = ", name);
   switch (*pvalue) {
      case 0: printf ("normal\n"); break;
      case 1: printf ("neutralise\n"); break;
      case 2: printf ("mort\n"); break;
      default: printf ("???\n");
   }
}

void ASN1C_EnumUnitState::Print (ASN1ConstCharPtr name)

{
   asn1Print_EnumUnitState (name, &msgData);
}
...
void asn1Print_MsgUnitAttributes (ASN1ConstCharPtr name, ASN1T_MsgUnitAttributes* pvalue)
{
   ...
   printf ("%s.m.capa_op_personnelPresent = %d\n", name, (int)pvalue->m.capa_op_personnelPresent);
   printf ("%s.m.capa_op_materielPresent = %d\n", name, (int)pvalue->m.capa_op_materielPresent);
   ...
   if (pvalue->m.capa_op_personnelPresent) {
      sprintf (namebuf, "%s.capa_op_personnel", name);
      asn1Print_Pourcentage (namebuf, &pvalue->capa_op_personnel);
   }

   if (pvalue->m.capa_op_materielPresent) {
      sprintf (namebuf, "%s.capa_op_materiel", name);
      asn1Print_Pourcentage (namebuf, &pvalue->capa_op_materiel);
   }
   ...
   if (pvalue->m.etatPresent) {
      sprintf (namebuf, "%s.etat", name);
      asn1Print_EnumUnitState (namebuf, &pvalue->etat);
   }
