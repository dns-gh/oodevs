...
EXTERN int asn1PE_Mission_Population (ASN1CTXT* ctxt_p, ASN1T_Mission_Population* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      case 2:
         PU_PUSHNAME (ctxt_p, "u.mission_population_manifester");

         stat = asn1PE_Mission_Population_Manifester (ctxt_p, pvalue->u.mission_population_manifester);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);

         break;

      /* mission_population_commettre_exactions */
      case 3:
         PU_PUSHNAME (ctxt_p, "u.mission_population_commettre_exactions");

         stat = asn1PE_Mission_Population_CommettreExactions (ctxt_p, pvalue->u.mission_population_commettre_exactions);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_Mission_Population (ASN1CTXT* ctxt_p, ASN1T_Mission_Population* pvalue)
{
   ...
   switch (ui) {
      ...
      case 1:
         ...
         pvalue->u.mission_population_manifester = ALLOC_ASN1ELEM (ctxt_p, ASN1T_Mission_Population_Manifester);
         if (pvalue->u.mission_population_manifester == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_Mission_Population_Manifester (ctxt_p, pvalue->u.mission_population_manifester);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 2:
         ...
         pvalue->u.mission_population_commettre_exactions = ALLOC_ASN1ELEM (ctxt_p, ASN1T_Mission_Population_CommettreExactions);
         if (pvalue->u.mission_population_commettre_exactions == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_Mission_Population_CommettreExactions (ctxt_p, pvalue->u.mission_population_commettre_exactions);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
