 ...
 * (http://www.obj-sys.com).  Version: 5.31, Date: 08-Aug-2006.
 */
...
/**************************************************************/
/*                                                            */
/*  Mission_Pion_INF_EscorterUnite                            */
/*                                                            */
/**************************************************************/

typedef struct EXTERN ASN1T_Mission_Pion_INF_EscorterUnite {
   ASN1T_Agent  unite_a_escorter;
} ASN1T_Mission_Pion_INF_EscorterUnite;

class EXTERN ASN1C_Mission_Pion_INF_EscorterUnite : public ASN1CType {
public:
   ASN1T_Mission_Pion_INF_EscorterUnite& msgData;
   ASN1C_Mission_Pion_INF_EscorterUnite (
      ASN1MessageBuffer& msgBuf, ASN1T_Mission_Pion_INF_EscorterUnite& data);
   int Encode ();
   int Decode ();
   void Print (ASN1ConstCharPtr name);
} ;

EXTERN int asn1PE_Mission_Pion_INF_EscorterUnite (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_INF_EscorterUnite* pvalue);
EXTERN int asn1PD_Mission_Pion_INF_EscorterUnite (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_INF_EscorterUnite* pvalue);

EXTERN void asn1Print_Mission_Pion_INF_EscorterUnite (ASN1ConstCharPtr name, ASN1T_Mission_Pion_INF_EscorterUnite* pvalue);

/**************************************************************/
/*                                                            */
/*  Mission_Pion_INF_EscorterUnites                           */
/*                                                            */
/**************************************************************/

typedef struct EXTERN ASN1T_Mission_Pion_INF_EscorterUnites {
   ASN1T_Automate  automate_a_escorter;
} ASN1T_Mission_Pion_INF_EscorterUnites;

class EXTERN ASN1C_Mission_Pion_INF_EscorterUnites : public ASN1CType {
public:
   ASN1T_Mission_Pion_INF_EscorterUnites& msgData;
   ASN1C_Mission_Pion_INF_EscorterUnites (
      ASN1MessageBuffer& msgBuf, ASN1T_Mission_Pion_INF_EscorterUnites& data);
   int Encode ();
   int Decode ();
   void Print (ASN1ConstCharPtr name);
} ;

EXTERN int asn1PE_Mission_Pion_INF_EscorterUnites (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_INF_EscorterUnites* pvalue);
EXTERN int asn1PD_Mission_Pion_INF_EscorterUnites (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_INF_EscorterUnites* pvalue);

EXTERN void asn1Print_Mission_Pion_INF_EscorterUnites (ASN1ConstCharPtr name, ASN1T_Mission_Pion_INF_EscorterUnites* pvalue);
...
/**************************************************************/
/*                                                            */
/*  Mission_Pion_INF_AppuyerSurPosition                       */
/*                                                            */
/**************************************************************/

typedef struct EXTERN ASN1T_Mission_Pion_INF_AppuyerSurPosition {
   ASN1T_Point  position;
   ASN1T_ListAgent  unites_a_appuyer;
} ASN1T_Mission_Pion_INF_AppuyerSurPosition;

class EXTERN ASN1C_Mission_Pion_INF_AppuyerSurPosition : public ASN1CType {
public:
   ASN1T_Mission_Pion_INF_AppuyerSurPosition& msgData;
   ASN1C_Mission_Pion_INF_AppuyerSurPosition (
      ASN1MessageBuffer& msgBuf, ASN1T_Mission_Pion_INF_AppuyerSurPosition& data);
   int Encode ();
   int Decode ();
   void Print (ASN1ConstCharPtr name);
} ;

EXTERN int asn1PE_Mission_Pion_INF_AppuyerSurPosition (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_INF_AppuyerSurPosition* pvalue);
EXTERN int asn1PD_Mission_Pion_INF_AppuyerSurPosition (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_INF_AppuyerSurPosition* pvalue);

EXTERN void asn1Print_Mission_Pion_INF_AppuyerSurPosition (ASN1ConstCharPtr name, ASN1T_Mission_Pion_INF_AppuyerSurPosition* pvalue);
