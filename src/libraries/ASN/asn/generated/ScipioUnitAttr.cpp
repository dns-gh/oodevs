...
ASN1C_EquipementRecuEnPret::ASN1C_EquipementRecuEnPret (
...
EXTERN int asn1PE_EquipementRecuEnPret (ASN1CTXT* ctxt_p, ASN1T_EquipementRecuEnPret* pvalue)
{
   ...
   rtdiag ("asn1PE_EquipementRecuEnPret: start\n");
   ...
   rtdiag ("asn1PE_EquipementRecuEnPret: end\n");
   return (stat);
}

int ASN1C_EquipementRecuEnPret::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_EquipementRecuEnPret (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_EquipementRecuEnPret (ASN1CTXT* ctxt_p, ASN1T_EquipementRecuEnPret* pvalue)
{
   ...
   rtdiag ("asn1PD_EquipementRecuEnPret: start\n");
   ...
   rtdiag ("asn1PD_EquipementRecuEnPret: end\n");

   return (stat);
}

int ASN1C_EquipementRecuEnPret::Decode ()
{
   return asn1PD_EquipementRecuEnPret (mpContext->GetPtr(), &msgData);
}
...
ASN1C__SeqOfEquipementRecuEnPret::ASN1C__SeqOfEquipementRecuEnPret (
...
EXTERN int asn1PE__SeqOfEquipementRecuEnPret (ASN1CTXT* ctxt_p, ASN1T__SeqOfEquipementRecuEnPret* pvalue)
{
   ...
   rtdiag ("asn1PE__SeqOfEquipementRecuEnPret: start\n");
   ...
   for (xx1 = 0; xx1 < pvalue->n; xx1++) {
      ...
      stat = asn1PE_EquipementRecuEnPret (ctxt_p, &pvalue->elem[xx1]);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }

   rtdiag ("asn1PE__SeqOfEquipementRecuEnPret: end\n");
   return (stat);
}

int ASN1C__SeqOfEquipementRecuEnPret::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE__SeqOfEquipementRecuEnPret (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD__SeqOfEquipementRecuEnPret (ASN1CTXT* ctxt_p, ASN1T__SeqOfEquipementRecuEnPret* pvalue)
{
   ...
   rtdiag ("asn1PD__SeqOfEquipementRecuEnPret: start\n");
   ...
   ALLOC_ASN1ARRAY (ctxt_p, pvalue, ASN1T_EquipementRecuEnPret);

   for (xx1 = 0; xx1 < pvalue->n; xx1++) {
      PU_PUSHELEMNAME (ctxt_p, xx1);

      stat = asn1PD_EquipementRecuEnPret (ctxt_p, &pvalue->elem[xx1]);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   rtdiag ("asn1PD__SeqOfEquipementRecuEnPret: end\n");

   return (stat);
}

int ASN1C__SeqOfEquipementRecuEnPret::Decode ()
{
   return asn1PD__SeqOfEquipementRecuEnPret (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_MsgUnitDotations (ASN1CTXT* ctxt_p, ASN1T_MsgUnitDotations* pvalue)
{
   ...
   PU_NEWFIELD (ctxt_p, "equipements_recus_en_pretPresent");

   stat = pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.equipements_recus_en_pretPresent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   /* encode equipements_recus_en_pret */

   if (pvalue->m.equipements_recus_en_pretPresent) {
      PU_PUSHNAME (ctxt_p, "equipements_recus_en_pret");

      stat = asn1PE__SeqOfEquipementRecuEnPret (ctxt_p, &pvalue->equipements_recus_en_pret);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }
...
EXTERN int asn1PD_MsgUnitDotations (ASN1CTXT* ctxt_p, ASN1T_MsgUnitDotations* pvalue)
{
   ...
   stat = pd_bit (ctxt_p, &optbit);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->m.equipements_recus_en_pretPresent = optbit;
   ...
   /* decode equipements_recus_en_pret */

   if (pvalue->m.equipements_recus_en_pretPresent) {
      PU_PUSHNAME (ctxt_p, "equipements_recus_en_pret");

      stat = asn1PD__SeqOfEquipementRecuEnPret (ctxt_p, &pvalue->equipements_recus_en_pret);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
