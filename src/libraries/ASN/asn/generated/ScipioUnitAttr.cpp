...
ASN1C_EnumUnitState::ASN1C_EnumUnitState (
...
EXTERN int asn1PE_EnumUnitState (ASN1CTXT* ctxt_p, ASN1T_EnumUnitState value)
{
   ...
   rtdiag ("asn1PE_EnumUnitState: start\n");

   switch (value) {
      case EnumUnitState::normal: ui = 0; break;
      case EnumUnitState::neutralise: ui = 1; break;
      case EnumUnitState::mort: ui = 2; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }
   ...
   rtdiag ("asn1PE_EnumUnitState: end\n");
   return (stat);
}

int ASN1C_EnumUnitState::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_EnumUnitState (mpContext->GetPtr(), msgData);
   return stat;
}
...
EXTERN int asn1PD_EnumUnitState (ASN1CTXT* ctxt_p, ASN1T_EnumUnitState* pvalue)
{
   ...
   rtdiag ("asn1PD_EnumUnitState: start\n");

   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 2);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   switch (ui) {
      case 0: *pvalue = EnumUnitState::normal; break;
      case 1: *pvalue = EnumUnitState::neutralise; break;
      case 2: *pvalue = EnumUnitState::mort; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }

   rtdiag ("asn1PD_EnumUnitState: end\n");

   return (stat);
}

int ASN1C_EnumUnitState::Decode ()
{
   return asn1PD_EnumUnitState (mpContext->GetPtr(), &msgData);
}
...
ASN1C_EnumReglesEngagement::ASN1C_EnumReglesEngagement (
...
EXTERN int asn1PE_EnumReglesEngagement (ASN1CTXT* ctxt_p, ASN1T_EnumReglesEngagement value)
{
   ...
   rtdiag ("asn1PE_EnumReglesEngagement: start\n");

   switch (value) {
      case EnumReglesEngagement::none: ui = 0; break;
      case EnumReglesEngagement::tir_libre: ui = 1; break;
      case EnumReglesEngagement::tir_sur_riposte: ui = 2; break;
      case EnumReglesEngagement::tir_interdit: ui = 3; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }
   ...
   rtdiag ("asn1PE_EnumReglesEngagement: end\n");
   return (stat);
}

int ASN1C_EnumReglesEngagement::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_EnumReglesEngagement (mpContext->GetPtr(), msgData);
   return stat;
}
...
EXTERN int asn1PD_EnumReglesEngagement (ASN1CTXT* ctxt_p, ASN1T_EnumReglesEngagement* pvalue)
{
   ...
   rtdiag ("asn1PD_EnumReglesEngagement: start\n");

   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 3);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   switch (ui) {
      case 0: *pvalue = EnumReglesEngagement::none; break;
      case 1: *pvalue = EnumReglesEngagement::tir_libre; break;
      case 2: *pvalue = EnumReglesEngagement::tir_sur_riposte; break;
      case 3: *pvalue = EnumReglesEngagement::tir_interdit; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }

   rtdiag ("asn1PD_EnumReglesEngagement: end\n");

   return (stat);
}

int ASN1C_EnumReglesEngagement::Decode ()
{
   return asn1PD_EnumReglesEngagement (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_MsgUnitAttributes (ASN1CTXT* ctxt_p, ASN1T_MsgUnitAttributes* pvalue)
{
   ...
   PU_NEWFIELD (ctxt_p, "capa_op_personnelPresent");

   stat = pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.capa_op_personnelPresent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_SETBITCOUNT (ctxt_p);

   PU_NEWFIELD (ctxt_p, "capa_op_materielPresent");

   stat = pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.capa_op_materielPresent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   PU_NEWFIELD (ctxt_p, "regles_d_engagementPresent");

   stat = pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.regles_d_engagementPresent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   /* encode capa_op_personnel */

   if (pvalue->m.capa_op_personnelPresent) {
      PU_PUSHNAME (ctxt_p, "capa_op_personnel");

      stat = asn1PE_Pourcentage (ctxt_p, pvalue->capa_op_personnel);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }

   /* encode capa_op_materiel */

   if (pvalue->m.capa_op_materielPresent) {
      PU_PUSHNAME (ctxt_p, "capa_op_materiel");

      stat = asn1PE_Pourcentage (ctxt_p, pvalue->capa_op_materiel);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }
   ...
   if (pvalue->m.etatPresent) {
      ...
      stat = asn1PE_EnumUnitState (ctxt_p, pvalue->etat);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }
   ...
   /* encode regles_d_engagement */

   if (pvalue->m.regles_d_engagementPresent) {
      PU_PUSHNAME (ctxt_p, "regles_d_engagement");

      stat = asn1PE_EnumReglesEngagement (ctxt_p, pvalue->regles_d_engagement);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }
...
EXTERN int asn1PD_MsgUnitAttributes (ASN1CTXT* ctxt_p, ASN1T_MsgUnitAttributes* pvalue)
{
   ...
   stat = pd_bit (ctxt_p, &optbit);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->m.capa_op_personnelPresent = optbit;
   ...
   stat = pd_bit (ctxt_p, &optbit);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->m.capa_op_materielPresent = optbit;
   ...
   stat = pd_bit (ctxt_p, &optbit);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->m.regles_d_engagementPresent = optbit;
   ...
   /* decode capa_op_personnel */

   if (pvalue->m.capa_op_personnelPresent) {
      PU_PUSHNAME (ctxt_p, "capa_op_personnel");

      stat = asn1PD_Pourcentage (ctxt_p, &pvalue->capa_op_personnel);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

      PU_POPNAME (ctxt_p);
   }

   /* decode capa_op_materiel */

   if (pvalue->m.capa_op_materielPresent) {
      PU_PUSHNAME (ctxt_p, "capa_op_materiel");

      stat = asn1PD_Pourcentage (ctxt_p, &pvalue->capa_op_materiel);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   if (pvalue->m.etatPresent) {
      ...
      stat = asn1PD_EnumUnitState (ctxt_p, &pvalue->etat);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   /* decode regles_d_engagement */

   if (pvalue->m.regles_d_engagementPresent) {
      PU_PUSHNAME (ctxt_p, "regles_d_engagement");

      stat = asn1PD_EnumReglesEngagement (ctxt_p, &pvalue->regles_d_engagement);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PE_DotationPersonnel (ASN1CTXT* ctxt_p, ASN1T_DotationPersonnel* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_total, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_operationnels, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_morts, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_blesses, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_blesses_mentaux, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_contamines_nbc, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_dans_chaine_sante, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_utilises_pour_maintenance, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PD_DotationPersonnel (ASN1CTXT* ctxt_p, ASN1T_DotationPersonnel* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_total, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_operationnels, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_morts, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_blesses, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_blesses_mentaux, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_contamines_nbc, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_dans_chaine_sante, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_utilises_pour_maintenance, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PE_DotationEquipement (ASN1CTXT* ctxt_p, ASN1T_DotationEquipement* pvalue)
{
   ...
   PU_NEWFIELD (ctxt_p, "majeurPresent");

   stat = pe_bit (ctxt_p, (ASN1BOOL)(pvalue->majeur != FALSE));
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_disponibles, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_indisponibles, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_reparables, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_dans_chaine_maintenance, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->nb_prisonniers, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   if (pvalue->majeur != FALSE) {
      PU_PUSHNAME (ctxt_p, "majeur");

      PU_NEWFIELD (ctxt_p, "boolean");

      stat = pe_bit (ctxt_p, (ASN1BOOL)pvalue->majeur);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PD_DotationEquipement (ASN1CTXT* ctxt_p, ASN1T_DotationEquipement* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_disponibles, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_indisponibles, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_reparables, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_dans_chaine_maintenance, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   stat = pd_ConsUnsigned (ctxt_p, &pvalue->nb_prisonniers, 0U, ASN1UINT_MAX);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   if (majeurPresent) {
      ...
      stat = pd_bit (ctxt_p, &pvalue->majeur);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
ASN1C_PretEquipement::ASN1C_PretEquipement (
...
EXTERN int asn1PE_PretEquipement (ASN1CTXT* ctxt_p, ASN1T_PretEquipement* pvalue)
{
   ...
   rtdiag ("asn1PE_PretEquipement: start\n");
   ...
   rtdiag ("asn1PE_PretEquipement: end\n");
   return (stat);
}

int ASN1C_PretEquipement::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_PretEquipement (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_PretEquipement (ASN1CTXT* ctxt_p, ASN1T_PretEquipement* pvalue)
{
   ...
   rtdiag ("asn1PD_PretEquipement: start\n");
   ...
   rtdiag ("asn1PD_PretEquipement: end\n");

   return (stat);
}

int ASN1C_PretEquipement::Decode ()
{
   return asn1PD_PretEquipement (mpContext->GetPtr(), &msgData);
}
...
ASN1C__SeqOfPretEquipement::ASN1C__SeqOfPretEquipement (
...
EXTERN int asn1PE__SeqOfPretEquipement (ASN1CTXT* ctxt_p, ASN1T__SeqOfPretEquipement* pvalue)
{
   ...
   rtdiag ("asn1PE__SeqOfPretEquipement: start\n");
   ...
   for (xx1 = 0; xx1 < pvalue->n; xx1++) {
      ...
      stat = asn1PE_PretEquipement (ctxt_p, &pvalue->elem[xx1]);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }

   rtdiag ("asn1PE__SeqOfPretEquipement: end\n");
   return (stat);
}

int ASN1C__SeqOfPretEquipement::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE__SeqOfPretEquipement (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD__SeqOfPretEquipement (ASN1CTXT* ctxt_p, ASN1T__SeqOfPretEquipement* pvalue)
{
   ...
   rtdiag ("asn1PD__SeqOfPretEquipement: start\n");
   ...
   ALLOC_ASN1ARRAY (ctxt_p, pvalue, ASN1T_PretEquipement);

   for (xx1 = 0; xx1 < pvalue->n; xx1++) {
      PU_PUSHELEMNAME (ctxt_p, xx1);

      stat = asn1PD_PretEquipement (ctxt_p, &pvalue->elem[xx1]);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   rtdiag ("asn1PD__SeqOfPretEquipement: end\n");

   return (stat);
}

int ASN1C__SeqOfPretEquipement::Decode ()
{
   return asn1PD__SeqOfPretEquipement (mpContext->GetPtr(), &msgData);
}
...
ASN1C_MsgUnitDotations::ASN1C_MsgUnitDotations (
...
EXTERN int asn1PE_MsgUnitDotations (ASN1CTXT* ctxt_p, ASN1T_MsgUnitDotations* pvalue)
{
   ...
   rtdiag ("asn1PE_MsgUnitDotations: start\n");
   ...
   PU_NEWFIELD (ctxt_p, "prets_equipementPresent");

   stat = pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.prets_equipementPresent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   /* encode prets_equipement */

   if (pvalue->m.prets_equipementPresent) {
      PU_PUSHNAME (ctxt_p, "prets_equipement");

      stat = asn1PE__SeqOfPretEquipement (ctxt_p, &pvalue->prets_equipement);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      PU_POPNAME (ctxt_p);
   }


   rtdiag ("asn1PE_MsgUnitDotations: end\n");
   return (stat);
}

int ASN1C_MsgUnitDotations::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_MsgUnitDotations (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_MsgUnitDotations (ASN1CTXT* ctxt_p, ASN1T_MsgUnitDotations* pvalue)
{
   ...
   rtdiag ("asn1PD_MsgUnitDotations: start\n");
   ...
   stat = pd_bit (ctxt_p, &optbit);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->m.prets_equipementPresent = optbit;
   ...
   /* decode prets_equipement */

   if (pvalue->m.prets_equipementPresent) {
      PU_PUSHNAME (ctxt_p, "prets_equipement");

      stat = asn1PD__SeqOfPretEquipement (ctxt_p, &pvalue->prets_equipement);
      if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   rtdiag ("asn1PD_MsgUnitDotations: end\n");

   return (stat);
}

int ASN1C_MsgUnitDotations::Decode ()
{
   return asn1PD_MsgUnitDotations (mpContext->GetPtr(), &msgData);
}
...
{
   mMsgBuf.Init ();
   int stat = asn1PE_MagicActionSeRendre (mpContext->GetPtr(), msgData);
   return stat;
}
...
{
   return asn1PD_MagicActionSeRendre (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_MsgUnitMagicAction_action (ASN1CTXT* ctxt_p, ASN1T_MsgUnitMagicAction_action* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->t - 1, 0, 7);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   ...
   switch (pvalue->t)
   {
      ...
      case 8:
         ...
         stat = asn1PE_MagicActionSeRendre (ctxt_p, pvalue->u.se_rendre);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MsgUnitMagicAction_action (ASN1CTXT* ctxt_p, ASN1T_MsgUnitMagicAction_action* pvalue)
{
   ...
   switch (ui) {
      ...
      case 7:
         ...
         stat = asn1PD_MagicActionSeRendre (ctxt_p, &pvalue->u.se_rendre);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
