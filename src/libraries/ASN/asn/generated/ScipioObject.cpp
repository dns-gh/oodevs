...
ASN1C_EnumMissionGenUrgence::ASN1C_EnumMissionGenUrgence (
...
EXTERN int asn1PE_EnumMissionGenUrgence (ASN1CTXT* ctxt_p, ASN1T_EnumMissionGenUrgence value)
{
   ...
   rtdiag ("asn1PE_EnumMissionGenUrgence: start\n");

   switch (value) {
      case EnumMissionGenUrgence::serie_minimum: ui = 0; break;
      case EnumMissionGenUrgence::serie_complementaire: ui = 1; break;
   ...
   rtdiag ("asn1PE_EnumMissionGenUrgence: end\n");
   return (stat);
}

int ASN1C_EnumMissionGenUrgence::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_EnumMissionGenUrgence (mpContext->GetPtr(), msgData);
   return stat;
}
...
EXTERN int asn1PD_EnumMissionGenUrgence (ASN1CTXT* ctxt_p, ASN1T_EnumMissionGenUrgence* pvalue)
{
   ...
   rtdiag ("asn1PD_EnumMissionGenUrgence: start\n");

   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 1);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   switch (ui) {
      case 0: *pvalue = EnumMissionGenUrgence::serie_minimum; break;
      case 1: *pvalue = EnumMissionGenUrgence::serie_complementaire; break;
      default: return LOG_ASN1ERR (ctxt_p, ASN_E_INVENUM);
   }

   rtdiag ("asn1PD_EnumMissionGenUrgence: end\n");

   return (stat);
}

int ASN1C_EnumMissionGenUrgence::Decode ()
{
   return asn1PD_EnumMissionGenUrgence (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_EnumObjectType (ASN1CTXT* ctxt_p, ASN1T_EnumObjectType value)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, ui, 0, 37);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PD_EnumObjectType (ASN1CTXT* ctxt_p, ASN1T_EnumObjectType* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 37);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PE_MsgObjectCreation (ASN1CTXT* ctxt_p, ASN1T_MsgObjectCreation* pvalue)
{
   ...
   PU_NEWFIELD (ctxt_p, "oid_objet_planifiePresent");

   stat = pe_bit (ctxt_p, (ASN1BOOL)pvalue->m.oid_objet_planifiePresent);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PD_MsgObjectCreation (ASN1CTXT* ctxt_p, ASN1T_MsgObjectCreation* pvalue)
{
   ...
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->m.oid_objet_planifiePresent = optbit;
