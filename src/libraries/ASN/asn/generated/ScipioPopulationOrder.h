...
#define T_Mission_Population_mission_population_manifester 2
#define T_Mission_Population_mission_population_commettre_exactions 3
...
typedef struct EXTERN ASN1T_Mission_Population {
   ...
   union {
      ...
      /* t = 2 */
      ASN1T_Mission_Population_Manifester *mission_population_manifester;
      /* t = 3 */
      ASN1T_Mission_Population_CommettreExactions *mission_population_commettre_exactions;
   } u;
