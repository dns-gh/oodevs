...
EXTERN int asn1PE_MsgsSimMos (ASN1CTXT* ctxt_p, ASN1T_MsgsSimMos* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->t - 1, 0, 64);
   ...
   switch (pvalue->t)
   {
      ...
      /* msg_start_direct_fire */
      case 31:
         PU_PUSHNAME (ctxt_p, "u.msg_start_direct_fire");

         stat = asn1PE_MsgStartDirectFire (ctxt_p, pvalue->u.msg_start_direct_fire);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);

         break;

      /* msg_stop_direct_fire */
      case 32:
         PU_PUSHNAME (ctxt_p, "u.msg_stop_direct_fire");

         stat = asn1PE_MsgStopDirectFire (ctxt_p, pvalue->u.msg_stop_direct_fire);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);

         break;

      /* msg_start_indirect_fire */
      case 33:
         PU_PUSHNAME (ctxt_p, "u.msg_start_indirect_fire");

         stat = asn1PE_MsgStartIndirectFire (ctxt_p, pvalue->u.msg_start_indirect_fire);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);

         break;

      /* msg_stop_indirect_fire */
      case 34:
         PU_PUSHNAME (ctxt_p, "u.msg_stop_indirect_fire");

         stat = asn1PE_MsgStopIndirectFire (ctxt_p, pvalue->u.msg_stop_indirect_fire);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
         PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_MsgsSimMos (ASN1CTXT* ctxt_p, ASN1T_MsgsSimMos* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 64);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->t = ui + 1;
   ...
   switch (ui) {
      ...
      case 30:
         ...
         pvalue->u.msg_start_direct_fire = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgStartDirectFire);
         if (pvalue->u.msg_start_direct_fire == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_MsgStartDirectFire (ctxt_p, pvalue->u.msg_start_direct_fire);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 31:
         ...
         pvalue->u.msg_stop_direct_fire = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgStopDirectFire);
         if (pvalue->u.msg_stop_direct_fire == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_MsgStopDirectFire (ctxt_p, pvalue->u.msg_stop_direct_fire);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 32:
         ...
         pvalue->u.msg_start_indirect_fire = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgStartIndirectFire);
         if (pvalue->u.msg_start_indirect_fire == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_MsgStartIndirectFire (ctxt_p, pvalue->u.msg_start_indirect_fire);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
      ...
      case 33:
         ...
         pvalue->u.msg_stop_indirect_fire = ALLOC_ASN1ELEM (ctxt_p, ASN1T_MsgStopIndirectFire);
         if (pvalue->u.msg_stop_indirect_fire == NULL)
            return LOG_ASN1ERR (ctxt_p, ASN_E_NOMEM);

         stat = asn1PD_MsgStopIndirectFire (ctxt_p, pvalue->u.msg_stop_indirect_fire);
         if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PE_MsgsSimMosWithContext (ASN1CTXT* ctxt_p, ASN1T_MsgsSimMosWithContext* pvalue)
{
   ...
   stat = pe_ConsUnsigned (ctxt_p, pvalue->t - 1, 0, 18);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PD_MsgsSimMosWithContext (ASN1CTXT* ctxt_p, ASN1T_MsgsSimMosWithContext* pvalue)
{
   ...
   stat = pd_ConsUnsigned (ctxt_p, &ui, 0, 18);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   else pvalue->t = ui + 1;
