...
typedef struct EXTERN ASN1T_Mission_Pion_LOG_Renforcer {
   ASN1T_Point  lieu_renforcement;
   ASN1T_Automate  automate;
} ASN1T_Mission_Pion_LOG_Renforcer;

class EXTERN ASN1C_Mission_Pion_LOG_Renforcer : public ASN1CType {
public:
   ASN1T_Mission_Pion_LOG_Renforcer& msgData;
   ASN1C_Mission_Pion_LOG_Renforcer (
      ASN1MessageBuffer& msgBuf, ASN1T_Mission_Pion_LOG_Renforcer& data);
   int Encode ();
   int Decode ();
   void Print (ASN1ConstCharPtr name);
} ;

EXTERN int asn1PE_Mission_Pion_LOG_Renforcer (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_LOG_Renforcer* pvalue);
EXTERN int asn1PD_Mission_Pion_LOG_Renforcer (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_LOG_Renforcer* pvalue);

EXTERN void asn1Print_Mission_Pion_LOG_Renforcer (ASN1ConstCharPtr name, ASN1T_Mission_Pion_LOG_Renforcer* pvalue);
...
typedef struct EXTERN ASN1T_Mission_Pion_LOG_TrierEtTraiterBlesses {
   ...
   ASN1T_SantePriorites  blessures_traitees;
   ASN1T_Point  position_deploiement;
