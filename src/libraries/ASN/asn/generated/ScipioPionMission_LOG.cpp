...
ASN1C_Mission_Pion_LOG_Renforcer::ASN1C_Mission_Pion_LOG_Renforcer (
...
EXTERN int asn1PE_Mission_Pion_LOG_Renforcer (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_LOG_Renforcer* pvalue)
{
   ...
   rtdiag ("asn1PE_Mission_Pion_LOG_Renforcer: start\n");
   ...
   PU_PUSHNAME (ctxt_p, "automate");

   stat = asn1PE_Automate (ctxt_p, pvalue->automate);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);


   rtdiag ("asn1PE_Mission_Pion_LOG_Renforcer: end\n");
   return (stat);
}

int ASN1C_Mission_Pion_LOG_Renforcer::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_Mission_Pion_LOG_Renforcer (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_Mission_Pion_LOG_Renforcer (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_LOG_Renforcer* pvalue)
{
   ...
   rtdiag ("asn1PD_Mission_Pion_LOG_Renforcer: start\n");
   ...
   stat = asn1PD_Automate (ctxt_p, &pvalue->automate);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);

   PU_POPNAME (ctxt_p);


   rtdiag ("asn1PD_Mission_Pion_LOG_Renforcer: end\n");

   return (stat);
}

int ASN1C_Mission_Pion_LOG_Renforcer::Decode ()
{
   return asn1PD_Mission_Pion_LOG_Renforcer (mpContext->GetPtr(), &msgData);
}
...
EXTERN int asn1PE_Mission_Pion_LOG_PreparerBascule (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_LOG_PreparerBascule* pvalue)
{
   ...
   /* encode rester_sur_place */

   PU_PUSHNAME (ctxt_p, "rester_sur_place");

   PU_NEWFIELD (ctxt_p, "boolean");

   stat = pe_bit (ctxt_p, (ASN1BOOL)pvalue->rester_sur_place);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PD_Mission_Pion_LOG_PreparerBascule (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_LOG_PreparerBascule* pvalue)
{
   ...
   /* decode rester_sur_place */

   PU_PUSHNAME (ctxt_p, "rester_sur_place");

   PU_NEWFIELD (ctxt_p, "boolean");

   stat = pd_bit (ctxt_p, &pvalue->rester_sur_place);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
EXTERN int asn1PE_Mission_Pion_LOG_TrierEtTraiterBlesses (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_LOG_TrierEtTraiterBlesses* pvalue)
{
   ...
   /* encode blessures_traitees */

   PU_PUSHNAME (ctxt_p, "blessures_traitees");

   stat = asn1PE_SantePriorites (ctxt_p, &pvalue->blessures_traitees);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
   PU_POPNAME (ctxt_p);
...
EXTERN int asn1PD_Mission_Pion_LOG_TrierEtTraiterBlesses (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_LOG_TrierEtTraiterBlesses* pvalue)
{
   ...
   /* decode blessures_traitees */

   PU_PUSHNAME (ctxt_p, "blessures_traitees");

   stat = asn1PD_SantePriorites (ctxt_p, &pvalue->blessures_traitees);
   if (stat != ASN_OK) return LOG_ASN1ERR (ctxt_p, stat);
...
ASN1C_Mission_Pion_LOG_TransporterUnite::ASN1C_Mission_Pion_LOG_TransporterUnite (
...
EXTERN int asn1PE_Mission_Pion_LOG_TransporterUnite (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_LOG_TransporterUnite* pvalue)
{
   ...
   rtdiag ("asn1PE_Mission_Pion_LOG_TransporterUnite: start\n");
   ...
   rtdiag ("asn1PE_Mission_Pion_LOG_TransporterUnite: end\n");
   return (stat);
}

int ASN1C_Mission_Pion_LOG_TransporterUnite::Encode ()
{
   mMsgBuf.Init ();
   int stat = asn1PE_Mission_Pion_LOG_TransporterUnite (mpContext->GetPtr(), &msgData);
   return stat;
}
...
EXTERN int asn1PD_Mission_Pion_LOG_TransporterUnite (ASN1CTXT* ctxt_p, ASN1T_Mission_Pion_LOG_TransporterUnite* pvalue)
{
   ...
   rtdiag ("asn1PD_Mission_Pion_LOG_TransporterUnite: start\n");
   ...
   rtdiag ("asn1PD_Mission_Pion_LOG_TransporterUnite: end\n");

   return (stat);
}

int ASN1C_Mission_Pion_LOG_TransporterUnite::Decode ()
{
   return asn1PD_Mission_Pion_LOG_TransporterUnite (mpContext->GetPtr(), &msgData);
}
