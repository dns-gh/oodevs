...
BOOST_FIXTURE_TEST_CASE( unit_attributes_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    FillHumanDotation( content.mutable_unit_attributes()->mutable_dotation_eff_personnel()->add_elem() );
    FillHumanDotation( content.mutable_unit_attributes()->mutable_dotation_eff_personnel()->add_elem() );
    FillEquipmentDotation( content.mutable_unit_attributes()->mutable_dotation_eff_materiel()->add_elem() );
    FillEquipmentDotation( content.mutable_unit_attributes()->mutable_dotation_eff_materiel()->add_elem() );
    FillResourceDotation( content.mutable_unit_attributes()->mutable_dotation_eff_ressource()->add_elem() );
    FillResourceDotation( content.mutable_unit_attributes()->mutable_dotation_eff_ressource()->add_elem() );
    FillLentEquipment( content.mutable_unit_attributes()->mutable_equipements_pretes()->add_elem() );
    FillLentEquipment( content.mutable_unit_attributes()->mutable_equipements_pretes()->add_elem() );
    FillBorrowedEquipment( content.mutable_unit_attributes()->mutable_equipements_empruntes()->add_elem() );
    FillBorrowedEquipment( content.mutable_unit_attributes()->mutable_equipements_empruntes()->add_elem() );
    ...
    content.mutable_unit_attributes()->set_hauteur( 78 );
    content.mutable_unit_attributes()->set_altitude( 79 );
    content.mutable_unit_attributes()->set_vitesse( 80 );
    content.mutable_unit_attributes()->set_etat_operationnel_brut( 81 );
    ...
    content.mutable_unit_attributes()->set_mort( true );
    content.mutable_unit_attributes()->set_neutralise( true );
    content.mutable_unit_attributes()->set_mode_furtif_actif( true );
    content.mutable_unit_attributes()->set_embarque( true );
    content.mutable_unit_attributes()->set_transporteurs_disponibles( true );
    content.mutable_unit_attributes()->set_posture_old( sword::UnitAttributes::arret );
    content.mutable_unit_attributes()->set_posture_new( sword::UnitAttributes::arret );
    content.mutable_unit_attributes()->set_posture_pourcentage( 90 );
    content.mutable_unit_attributes()->set_etat_installation( 91 );
    content.mutable_unit_attributes()->set_en_tenue_de_protection_nbc( true );
    content.mutable_unit_attributes()->mutable_contamine_par_agents_nbc()->add_elem()->set_id( 100 );
    content.mutable_unit_attributes()->mutable_contamine_par_agents_nbc()->add_elem()->set_id( 101 );
    content.mutable_unit_attributes()->mutable_etat_contamination()->set_percentage( 102 );
    content.mutable_unit_attributes()->mutable_etat_contamination()->set_quantity( 103.4f );
    ...
    content.mutable_unit_attributes()->set_radar_actif( true );
...
BOOST_FIXTURE_TEST_CASE( unit_knowledge_update_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    content.mutable_unit_knowledge_update()->set_mort( true );
    ...
    content.mutable_unit_knowledge_update()->set_prisonnier( true );
    content.mutable_unit_knowledge_update()->set_refugie_pris_en_compte( true );
...
BOOST_FIXTURE_TEST_CASE( start_fire_effect_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    content.mutable_start_fire_effect()->set_type( sword::light );
...
namespace
{
    ...
    void FillParameterValue( V* v )
    {
        ...
        FillIntelligence( v->mutable_intelligencelist()->add_elem() );
        v->mutable_urbanblock()->set_id( 73 );
...
namespace
{
    ...
    template< typename C >
    void FillMedicalTreatmentBedCapacity( C* c )
    {
        c->set_type_id( 35 );
        c->set_baseline_count( 36 );
        c->set_available_count( 37 );
        c->set_emergency_count( 38 );
    }
    template< typename R >
    ...
    {
        l->set_kind( sword::ResourceNetwork::Link::urban );
        l->set_target_id( 50 );
        l->set_capacity( 51 );
        l->set_flow( 52u );
    }
    ...
    void FillObjectAttributes( A* a )
    {
        ...
        a->mutable_medical_treatment()->set_external_reference_id( "ext" );
        FillMedicalTreatmentBedCapacity( a->mutable_medical_treatment()->add_bed_capacities() );
        FillMedicalTreatmentBedCapacity( a->mutable_medical_treatment()->add_bed_capacities() );
        a->mutable_medical_treatment()->set_facility_status( sword::ObjectAttributeMedicalTreatment::on_divert );
        a->mutable_medical_treatment()->set_doctors( 39 );
        a->mutable_medical_treatment()->set_available_doctors( 40 );
        ...
        a->mutable_seal_off()->set_level( 49 );
...
BOOST_FIXTURE_TEST_CASE( object_creation_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    MOCK_EXPECT( client, SendSimToClient ).once().with( constraint( msg, "context: 42 message { object_creation { object { id: 7 } type { id: \"id\" } name: \"name\" party { id: 9 } location { type: rectangle coordinates { elem { latitude: 17.23 longitude: 23.17 } elem { latitude: 17.23 longitude: 23.17 } } } attributes { construction { resource { id: 10 } dotation_nbr: 11 density: 12 percentage: 13 } obstacle { type: reserved activated: true activation_time: 14 } mine { resource { id: 15 } dotation_nbr: 16 density: 17 percentage: 18 } activity_time { value: 19 } bypass { percentage: 20 } logistic { tc2 { id: 21 } } nbc { danger_level: 22 nbc_agents { id: 23 } nbc_agents { id: 24 } } crossing_site { width: 25 depth: 26 flow_rate: 27 banks_require_fitting: true } supply_route { equipped: true max_weight: 28 width: 29 length: 30 flow_rate: 31 } toxic_cloud { quantities { elem { coordinate { latitude: 17.23 longitude: 23.17 } quantity: 32 } elem { coordinate { latitude: 17.23 longitude: 23.17 } quantity: 32 } } } fire { class_name: \"Class A\" max_combustion_energy: 2000 } medical_treatment { external_reference_id: \"ext\" bed_capacities { type_id: 35 baseline_count: 36 available_count: 37 emergency_count: 38 } bed_capacities { type_id: 35 baseline_count: 36 available_count: 37 emergency_count: 38 } facility_status: on_divert doctors: 39 available_doctors: 40 } interaction_height { height: 41 } stock { resources { resource { id: 42 } current: 43 maximum: 44 } resources { resource { id: 42 } current: 43 maximum: 44 } } nbc_agent { agent { id: 45 } concentration: 46 source_life_duration: 47 } effect_delay { value: 48 } seal_off { level: 49 } resource_networks { network { resource { name: \"name\" } link { kind: urban target_id: 50 capacity: 51 flow: 52 } link { kind: urban target_id: 50 capacity: 51 flow: 52 } enabled: true max_stock: 53 stock: 54 production: 55 consumption: 56 critical: true initial_stock: 57 max_production: 58 max_consumption: 59 } network { resource { name: \"name\" } link { kind: urban target_id: 50 capacity: 51 flow: 52 } link { kind: urban target_id: 50 capacity: 51 flow: 52 } enabled: true max_stock: 53 stock: 54 production: 55 consumption: 56 critical: true initial_stock: 57 max_production: 58 max_consumption: 59 } } burn { current_heat: 34 combustion_energy: 34 } } } }" ) );
    converter.ReceiveSimToClient( "unused endpoint", msg );
}
...
BOOST_FIXTURE_TEST_CASE( object_knowledge_creation_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    MOCK_EXPECT( client, SendSimToClient ).once().with( constraint( msg, "context: 42 message { object_knowledge_creation { knowledge { id: 7 } party { id: 8 } object { id: 9 } type { id: \"type\" } attributes { construction { resource { id: 10 } dotation_nbr: 11 density: 12 percentage: 13 } obstacle { type: reserved activated: true activation_time: 14 } mine { resource { id: 15 } dotation_nbr: 16 density: 17 percentage: 18 } activity_time { value: 19 } bypass { percentage: 20 } logistic { tc2 { id: 21 } } nbc { danger_level: 22 nbc_agents { id: 23 } nbc_agents { id: 24 } } crossing_site { width: 25 depth: 26 flow_rate: 27 banks_require_fitting: true } supply_route { equipped: true max_weight: 28 width: 29 length: 30 flow_rate: 31 } toxic_cloud { quantities { elem { coordinate { latitude: 17.23 longitude: 23.17 } quantity: 32 } elem { coordinate { latitude: 17.23 longitude: 23.17 } quantity: 32 } } } fire { class_name: \"Class A\" max_combustion_energy: 2000 } medical_treatment { external_reference_id: \"ext\" bed_capacities { type_id: 35 baseline_count: 36 available_count: 37 emergency_count: 38 } bed_capacities { type_id: 35 baseline_count: 36 available_count: 37 emergency_count: 38 } facility_status: on_divert doctors: 39 available_doctors: 40 } interaction_height { height: 41 } stock { resources { resource { id: 42 } current: 43 maximum: 44 } resources { resource { id: 42 } current: 43 maximum: 44 } } nbc_agent { agent { id: 45 } concentration: 46 source_life_duration: 47 } effect_delay { value: 48 } seal_off { level: 49 } resource_networks { network { resource { name: \"name\" } link { kind: urban target_id: 50 capacity: 51 flow: 52 } link { kind: urban target_id: 50 capacity: 51 flow: 52 } enabled: true max_stock: 53 stock: 54 production: 55 consumption: 56 critical: true initial_stock: 57 max_production: 58 max_consumption: 59 } network { resource { name: \"name\" } link { kind: urban target_id: 50 capacity: 51 flow: 52 } link { kind: urban target_id: 50 capacity: 51 flow: 52 } enabled: true max_stock: 53 stock: 54 production: 55 consumption: 56 critical: true initial_stock: 57 max_production: 58 max_consumption: 59 } } burn { current_heat: 34 combustion_energy: 34 } } knowledge_group { id: 10 } } }" ) );
    converter.ReceiveSimToClient( "unused endpoint", msg );
}
...
BOOST_FIXTURE_TEST_CASE( object_knowledge_update_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    MOCK_EXPECT( client, SendSimToClient ).once().with( constraint( msg, "context: 42 message { object_knowledge_update { knowledge { id: 7 } party { id: 8 } object { id: 9 } relevance: 10 location { type: rectangle coordinates { elem { latitude: 17.23 longitude: 23.17 } elem { latitude: 17.23 longitude: 23.17 } } } attributes { construction { resource { id: 10 } dotation_nbr: 11 density: 12 percentage: 13 } obstacle { type: reserved activated: true activation_time: 14 } mine { resource { id: 15 } dotation_nbr: 16 density: 17 percentage: 18 } activity_time { value: 19 } bypass { percentage: 20 } logistic { tc2 { id: 21 } } nbc { danger_level: 22 nbc_agents { id: 23 } nbc_agents { id: 24 } } crossing_site { width: 25 depth: 26 flow_rate: 27 banks_require_fitting: true } supply_route { equipped: true max_weight: 28 width: 29 length: 30 flow_rate: 31 } toxic_cloud { quantities { elem { coordinate { latitude: 17.23 longitude: 23.17 } quantity: 32 } elem { coordinate { latitude: 17.23 longitude: 23.17 } quantity: 32 } } } fire { class_name: \"Class A\" max_combustion_energy: 2000 } medical_treatment { external_reference_id: \"ext\" bed_capacities { type_id: 35 baseline_count: 36 available_count: 37 emergency_count: 38 } bed_capacities { type_id: 35 baseline_count: 36 available_count: 37 emergency_count: 38 } facility_status: on_divert doctors: 39 available_doctors: 40 } interaction_height { height: 41 } stock { resources { resource { id: 42 } current: 43 maximum: 44 } resources { resource { id: 42 } current: 43 maximum: 44 } } nbc_agent { agent { id: 45 } concentration: 46 source_life_duration: 47 } effect_delay { value: 48 } seal_off { level: 49 } resource_networks { network { resource { name: \"name\" } link { kind: urban target_id: 50 capacity: 51 flow: 52 } link { kind: urban target_id: 50 capacity: 51 flow: 52 } enabled: true max_stock: 53 stock: 54 production: 55 consumption: 56 critical: true initial_stock: 57 max_production: 58 max_consumption: 59 } network { resource { name: \"name\" } link { kind: urban target_id: 50 capacity: 51 flow: 52 } link { kind: urban target_id: 50 capacity: 51 flow: 52 } enabled: true max_stock: 53 stock: 54 production: 55 consumption: 56 critical: true initial_stock: 57 max_production: 58 max_consumption: 59 } } burn { current_heat: 34 combustion_energy: 34 } } perceived: true perceiving_automats { elem { id: 11 } elem { id: 12 } } knowledge_group { id: 13 } } }" ) );
    converter.ReceiveSimToClient( "unused endpoint", msg );
}
...
BOOST_FIXTURE_TEST_CASE( crowd_flow_update_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    content.mutable_crowd_flow_update()->set_vitesse( 21 );
...
BOOST_FIXTURE_TEST_CASE( crowd_flow_knowledge_update_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    content.mutable_crowd_flow_knowledge_update()->set_vitesse( 21 );
...
BOOST_FIXTURE_TEST_CASE( urban_knowledge_creation_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    content.mutable_urban_knowledge_creation()->mutable_urban_block()->set_id( 9 );
    MOCK_EXPECT( client, SendSimToClient ).once().with( constraint( msg, "context: 42 message { urban_knowledge_creation { knowledge { id: 7 } party { id: 8 } urban_block { id: 9 } } }" ) );
    converter.ReceiveSimToClient( "unused endpoint", msg );
}
...
BOOST_FIXTURE_TEST_CASE( urban_knowledge_update_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    MOCK_EXPECT( client, SendSimToClient ).once().with( constraint( msg, "context: 42 message { urban_knowledge_update { knowledge { id: 7 } party { id: 8 } urban_block { id: 9 } progress: 10 maxProgress: 11 perceived: true automat_perceptions { elem { id: 13 } elem { id: 14 } } } }" ) );
    converter.ReceiveSimToClient( "unused endpoint", msg );
}
...
BOOST_FIXTURE_TEST_CASE( urban_detection_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    content.mutable_urban_detection()->mutable_urban_object()->set_id( 8 );
    content.mutable_urban_detection()->set_visibility( sword::detected );
    MOCK_EXPECT( client, SendSimToClient ).once().with( constraint( msg, "context: 42 message { urban_detection { observer { id: 7 } urban_object { id: 8 } visibility: detected } }" ) );
    converter.ReceiveSimToClient( "unused endpoint", msg );
}
...
BOOST_FIXTURE_TEST_CASE( knowledge_group_creation_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    MOCK_EXPECT( client, SendSimToClient ).once().with( constraint( msg, "context: 42 message { knowledge_group_creation { knowledge_group { id: 7 } party { id: 8 } parent { id: 9 } type: \"type\" jam: true } }" ) );
    converter.ReceiveSimToClient( "unused endpoint", msg );
}
...
BOOST_FIXTURE_TEST_CASE( population_creation_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    ...
    FillExtension( content.mutable_population_creation()->mutable_extension()->add_entries() );
    content.mutable_population_creation()->add_blocks()->set_id( 27 );
    content.mutable_population_creation()->add_blocks()->set_id( 28 );
    MOCK_EXPECT( client, SendSimToClient ).once().with( constraint( msg, "context: 42 message { population_creation { id { id: 7 } party { id: 8 } type { id: 9 } name: \"name\" text: \"text\" extension { entries { name: \"name2\" value: \"value\" } entries { name: \"name2\" value: \"value\" } } blocks { id: 27 } blocks { id: 28 } } }" ) );
    converter.ReceiveSimToClient( "unused endpoint", msg );
}
...
BOOST_FIXTURE_TEST_CASE( change_population_magic_action_ack_to_client_is_converted, ContextFixture< sword::SimToClient > )
{
    content.mutable_change_population_magic_action_ack()->set_error_code( sword::ChangePopulationMagicActionAck::error_invalid_number );
