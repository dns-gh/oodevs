...
namespace
{
    ...
    void FillObjectAttributes( A* a )
    {
        ...
        a->mutable_burn()->set_combustion_energy_sum( 340 );
        a->mutable_burn()->set_combustion_energy_count( 10 );
