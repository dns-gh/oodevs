...
MOCK_BASE_CLASS( MockFederate, Federate_ABC )
{
    ...
    MOCK_METHOD_EXT( Create, 2, bool ( const std::string& federation, const std::string& fomFile ), Create1 )
    MOCK_METHOD_EXT( Create, 2, bool ( const std::string& federation, const T_FomFiles& fomFiles ), CreateV )
