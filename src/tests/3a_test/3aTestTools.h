...
public:
    ...
    static sword::SimToClient UpdatePopulation ( int healthy, int wounded, int dead, unsigned long id );
    static sword::SimToClient UpdatePopulationbis ( int healthy, int wounded, unsigned long id );
    ...
    static sword::SimToClient CreateConsign( unsigned long id, unsigned long unit_id = 0 );
