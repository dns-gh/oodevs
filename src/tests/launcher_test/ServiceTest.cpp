...
// -----------------------------------------------------------------------------
// Name: ClientCanSendSessionNotification
// Created: LDC 2011-11-07
// -----------------------------------------------------------------------------
BOOST_FIXTURE_TEST_CASE( ClientCanSendSessionNotification, ExerciseFixture )
{
    sword::SessionNotificationRequest request;
}