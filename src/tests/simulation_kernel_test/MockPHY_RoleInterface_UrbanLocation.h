...
MOCK_BASE_CLASS( MockPHY_RoleInterface_UrbanLocation, PHY_RoleInterface_UrbanLocation )
{
    ...
    MOCK_METHOD( ComputeRatioPionInside, 1, double( const MT_Ellipse& ) , ComputeRatioPionInsideEllipse );
    MOCK_METHOD( ComputeRatioPionInside, 2, double( const TER_Polygon&, double ), ComputeRatioPionInsidePolygon );
    MOCK_METHOD( GetCurrentUrbanBlock, 0 );
    MOCK_METHOD( IsInCity, 0 );
    MOCK_METHOD( CanMount, 0 );
    MOCK_METHOD( MagicMove, 1 );
    MOCK_METHOD( AddInhabitantCollision, 1 );
    MOCK_METHOD( RemoveInhabitantCollision, 1 );
