...
MOCK_BASE_CLASS( MockSink, sword::Sink_ABC )
{
    ...
    MOCK_METHOD_EXT( Create, 4, MIL_AgentPion*( const MIL_AgentTypePion&, MIL_Automate&, xml::xistream&, sword::RoleExtender_ABC* ), CreateFromXml );
    MOCK_METHOD_EXT( Create, 4, MIL_AgentPion*( const MIL_AgentTypePion&, MIL_Automate&, const MT_Vector2D&, sword::RoleExtender_ABC* ), CreateFromPoint );
    MOCK_METHOD_EXT( Create, 5, MIL_AgentPion*( const MIL_AgentTypePion&, MIL_Automate&, const MT_Vector2D&, const std::string&, sword::RoleExtender_ABC* ), CreateFromPointAndName );
