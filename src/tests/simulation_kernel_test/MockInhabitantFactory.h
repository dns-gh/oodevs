...
{
    MOCK_METHOD( Create, 2, MIL_Inhabitant&( xml::xistream&, MIL_Army_ABC& ), Create1 )
    MOCK_METHOD( Create, 5, MIL_Inhabitant&( const std::string&, const MT_Vector2D&, int, const std::string&, MIL_Army_ABC& ), Create2 )
