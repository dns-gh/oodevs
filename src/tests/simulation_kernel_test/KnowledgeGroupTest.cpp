...
BOOST_AUTO_TEST_CASE( ReceiveChangeSuperiorKnowledgeGroupUnderKnowledgeGroup )
{
    ...
    boost::shared_ptr< MIL_KnowledgeGroup > groupArmy( new MIL_KnowledgeGroup( kgType, 1, army ) );
...
//    MOCK_EXPECT( groupArmy, RegisterKnowledgeGroup ).once(); // $$$$ _RC_ SBO 2010-04-27: TODO: check registration into parent KG
    boost::shared_ptr< MIL_KnowledgeGroup > group1( new MIL_KnowledgeGroup( xis2, army, groupArmy, mockKnowledgeGroupFactory ) );
//    army.verify();
    ...
    xis3 >> xml::start( "root" );
//    MOCK_EXPECT( groupArmy, RegisterKnowledgeGroup ).once(); // $$$$ _RC_ SBO 2010-04-27: TODO: check registration into parent KG
    boost::shared_ptr< MIL_KnowledgeGroup > group2( new MIL_KnowledgeGroup( xis3, army, groupArmy, mockKnowledgeGroupFactory ) );
//    army.verify();
...
// Name: BOOST_AUTO_TEST_CASE
// Created: FHD 2010-01-19:
// $$$ LDC Impossible to test with shared_ptr and mock. 
// -----------------------------------------------------------------------------
...
//    boost::shared_ptr< MIL_KnowledgeGroup > groupArmy( new MIL_KnowledgeGroup( kgType, 10, army ) );
//
//    // register 1st sub knowledge group
...
//    boost::shared_ptr< MIL_KnowledgeGroup > group2( new MIL_KnowledgeGroup( xis3, army, group1, mockKnowledgeGroupFactory ) );
////    group1.verify();
//
//    sword::KnowledgeMagicAction msg;
//    msg.mutable_knowledge_group()->set_id( group2->GetId() );
...
//
//    // register army sub knowledge group
//    boost::shared_ptr< MIL_KnowledgeGroup > groupArmy( new MIL_KnowledgeGroup( kgType, 20, army ) );
//
//    // register 1st sub knowledge group
...
//    boost::shared_ptr< MIL_KnowledgeGroup > group2( new MIL_KnowledgeGroup( xis3, army, none, mockKnowledgeGroupFactory ) );
//    army.verify();
//
//    sword::KnowledgeMagicAction msg;
//    msg.mutable_knowledge_group()->set_id( group2->GetId() );
...
//
//    // moves group2 under group1
//    MOCK_EXPECT( army, UnregisterKnowledgeGroup ).with( group2 ).once();
...
//    MOCK_EXPECT( army, RegisterKnowledgeGroup ).once();
//    boost::shared_ptr< MIL_KnowledgeGroup > groupArmy( new MIL_KnowledgeGroup( kgType, 30, army ) );
//
//    // prepare message
//    sword::KnowledgeMagicAction msg;
...
//    mockPublisher.verify();
//    MOCK_EXPECT( army, UnregisterKnowledgeGroup ).with( groupArmy ).once();
//}
