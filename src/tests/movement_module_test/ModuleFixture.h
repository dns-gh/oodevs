...
#define REGISTERED_HOOKS( APPLY ) \
    APPLY( CleanPathAfterComputation, 1, void, ( boost::shared_ptr< sword::movement::Path_ABC > path ) ) \
    ...
    APPLY( ComputePath, 1, void, ( boost::shared_ptr< sword::movement::Path_ABC > path ) ) \
    ...
    APPLY( ExecutePathfind, 2, void, ( boost::shared_ptr< sword::movement::Path_ABC > path, TerrainPathfinder& pathfind ) ) \
    APPLY( GetAgentFuturePosition, 3, MT_Vector2D, ( const SWORD_Model* entity, double rTime, bool bBoundOnPath ) ) \
    APPLY( GetPathDestPoint, 1, boost::shared_ptr< sword::movement::PathPoint >, ( boost::shared_ptr< sword::movement::PathPoint > pPoint ) ) \
    APPLY( GetPathDIAType, 1, const char*, ( boost::shared_ptr< sword::movement::PathPoint > point ) ) \
    APPLY( GetPathLimaPoint, 1, unsigned int, ( boost::shared_ptr< sword::movement::PathPoint > pPoint ) ) \
    APPLY( AvoidEnemies, 1, bool, ( boost::shared_ptr< sword::movement::Path_ABC > path ) ) \
    APPLY( GetEnemyCostAtSecurityRange, 1, double, ( boost::shared_ptr< sword::movement::Path_ABC > path ) ) \
    APPLY( GetEnemyCostOnContact, 1, double, ( boost::shared_ptr< sword::movement::Path_ABC > path ) ) \
    APPLY( AvoidObjects, 1, bool, ( boost::shared_ptr< sword::movement::Path_ABC > path ) ) \
    APPLY( GetFirstPoint, 3, void, ( boost::shared_ptr< sword::movement::Path_ABC > path, void(*callback)( const MT_Vector2D& point, void* userData ), void* userData ) ) \
    ...
    APPLY( GetPathTypeLimaPoint, 1, int, ( boost::shared_ptr< sword::movement::PathPoint > pPoint ) ) \
    APPLY( GetPathTypePoint, 1, int, ( boost::shared_ptr< sword::movement::PathPoint > pPoint ) ) \
    APPLY( InitializePathClass, 3, void, ( const char* xml, const unsigned int* first, size_t size ) ) \
    APPLY( IsAgentMovingOnPath, 2, bool, ( unsigned int entity, boost::shared_ptr< sword::movement::Path_ABC > path ) ) \
    APPLY( PathGetLastPointOfPath, 1, boost::shared_ptr< MT_Vector2D >, ( boost::shared_ptr< sword::movement::Path_ABC > pPath ) ) \
    APPLY( PathGetLength, 1, double, ( boost::shared_ptr< sword::movement::Path_ABC > path ) ) \
    APPLY( PathGetState, 1, DEC_Path_ABC::E_State, ( boost::shared_ptr< sword::movement::Path_ABC > path ) ) \
...
#define USED_HOOKS( APPLY ) \
    ...
    APPLY( GetAltitudeCost, 5, double, ( const SWORD_Model* entity, boost::shared_ptr< sword::movement::Path_ABC > path, const MT_Vector2D& from, const MT_Vector2D& to, double rAltitudeCostPerMeter ) ) \
    APPLY( GetEnemiesCost, 7, double, ( const SWORD_Model* entity, boost::shared_ptr< sword::movement::Path_ABC > path, const MT_Vector2D& from, const MT_Vector2D& to, const TerrainData& nToTerrainType, const TerrainData& nLinkTerrainType, double rEnemyMaximumCost ) ) \
    APPLY( GetFuseauxCost, 11, double, ( const SWORD_Model* entity, boost::shared_ptr< sword::movement::Path_ABC > path, const MT_Vector2D& from, const MT_Vector2D& to, double rMaximumFuseauDistance, double rMaximumFuseauDistanceWithAutomata, double rFuseauCostPerMeterOut, double rComfortFuseauDistance, double rFuseauCostPerMeterIn, double rMaximumAutomataFuseauDistance, double rAutomataFuseauCostPerMeterOut ) ) \
    APPLY( GetObjectsCost, 6, double, ( const SWORD_Model* entity, boost::shared_ptr< sword::movement::Path_ABC > path, const MT_Vector2D& from, const MT_Vector2D& to, const TerrainData& nToTerrainType, const TerrainData& nLinkTerrainType ) ) \
    APPLY( GetPopulationsCost, 7, double, ( const SWORD_Model* entity, boost::shared_ptr< sword::movement::Path_ABC > path, const MT_Vector2D& from, const MT_Vector2D& to, const TerrainData& nToTerrainType, const TerrainData& nLinkTerrainType, double rPopulationMaximumCost ) ) \
    APPLY( GetUrbanBlockCost, 4, double, ( const SWORD_Model* entity, boost::shared_ptr< sword::movement::Path_ABC > path, const MT_Vector2D& from, const MT_Vector2D& to ) ) \
    APPLY( IsValidPosition, 1, bool, ( const MT_Vector2D& point ) ) \
    APPLY( GetMaxPathFindComputationDuration, 0, unsigned int, () ) \
    APPLY( CancelPathFindJob, 1, void, ( boost::shared_ptr< sword::movement::Path_ABC > path ) ) \
...
#define REGISTERED_AND_USED_HOOKS( APPLY ) \
    ...
    APPLY( RemovePathPoint, 2, void, ( unsigned int entity, boost::shared_ptr< sword::movement::PathPoint > point ) ) \
