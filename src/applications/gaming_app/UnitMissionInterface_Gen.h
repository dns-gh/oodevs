...
// *****************************************************************************
    ...
    void CreateMission_GEN_OuvrirItineraire();
    ...
    void CreateMission_GEN_EquiperExploiterSiteFranchissement();
    void CreateMission_GEN_ExecuterVariantement();
    void CreateMission_GEN_DegagerObstacles();
    void CreateMission_GEN_ContournerObstacles();
    void CreateMission_GEN_DepolluerZone();
    void CreateMission_GEN_Renforcer();
    void CreateMission_GEN_RealiserTravauxProtection();
    void CreateMission_GEN_RealiserTravauxContreMobilite();
    void CreateMission_GEN_RealiserTravauxAppuiDeploiement();
    void CreateMission_GEN_RealiserCamps();
    void CreateMission_GEN_ReprendreTravaux();
