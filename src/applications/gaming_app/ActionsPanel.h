...
public:
    ...
    //@{
             ActionsPanel( QMainWindow* parent, kernel::Controllers& controllers, gui::ItemFactory_ABC& factory, actions::ActionsModel& actions, ActionsScheduler& scheduler, const tools::ExerciseConfig& config );
