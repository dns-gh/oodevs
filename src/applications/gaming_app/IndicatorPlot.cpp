    ...
    , max_         ( -std::numeric_limits< double >::infinity() )
{
    ...
    YAxis().ShowAxis( true );
    YAxis().ShowGrid( true );
    YAxis().SetAxisCaption( tools::translate( "IndicatorPlot", "Value" ).toUtf8().constData() );
    YAxis().ShowTicks( 25 );
    ...
    XAxis().SetAxisCaption( tools::translate( "IndicatorPlot","Time (Tick)" ).toUtf8().constData() );
