...
// -----------------------------------------------------------------------------
// Name: MOS_Agent::DeleteReport
/** @param  report
*/
// Created: APE 2004-08-04
// -----------------------------------------------------------------------------
void MOS_Agent::DeleteReport( MOS_Report_ABC& report )
{
...
// -----------------------------------------------------------------------------
// Name: MOS_Agent::DeleteAllRCs
// Created: APE 2004-05-10
// -----------------------------------------------------------------------------
void MOS_Agent::DeleteAllRCs()
{
...
// -----------------------------------------------------------------------------
// Name: MOS_Agent::DeleteAllTraces
// Created: APE 2004-05-10
// -----------------------------------------------------------------------------
void MOS_Agent::DeleteAllTraces()
{
    for( IT_ReportVector it = reportVector_.begin(); it != reportVector_.end(); )
    {
