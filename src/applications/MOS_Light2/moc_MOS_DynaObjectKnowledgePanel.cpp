/****************************************************************************
** MOS_DynaObjectKnowledgePanel meta object code from reading C++ file 'MOS_DynaObjectKnowledgePanel.h'
**
...
const char *MOS_DynaObjectKnowledgePanel::className() const
{
    return "MOS_DynaObjectKnowledgePanel";
}

QMetaObject *MOS_DynaObjectKnowledgePanel::metaObj = 0;
static QMetaObjectCleanUp cleanUp_MOS_DynaObjectKnowledgePanel( "MOS_DynaObjectKnowledgePanel", &MOS_DynaObjectKnowledgePanel::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString MOS_DynaObjectKnowledgePanel::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "MOS_DynaObjectKnowledgePanel", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString MOS_DynaObjectKnowledgePanel::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "MOS_DynaObjectKnowledgePanel", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* MOS_DynaObjectKnowledgePanel::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	{ "OnKnowledgeCreated(MOS_Team&,MOS_DynaObjectKnowledge&)", &slot_2, QMetaData::Private },
	{ "OnKnowledgeUpdated(MOS_Team&,MOS_DynaObjectKnowledge&)", &slot_3, QMetaData::Private },
	{ "OnKnowledgeDeleted(MOS_Team&,MOS_DynaObjectKnowledge&)", &slot_4, QMetaData::Private },
	...
	"MOS_DynaObjectKnowledgePanel", parentObject,
	slot_tbl, 7,
	signal_tbl, 3,
	...
	0, 0 );
    cleanUp_MOS_DynaObjectKnowledgePanel.setMetaObject( metaObj );
    return metaObj;
}

void* MOS_DynaObjectKnowledgePanel::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "MOS_DynaObjectKnowledgePanel" ) )
	return this;
...
// SIGNAL NewPopupMenu
void MOS_DynaObjectKnowledgePanel::NewPopupMenu( QPopupMenu& t0, const MOS_ActionContext& t1 )
{
    if ( signalsBlocked() )
	return;
...
void MOS_DynaObjectKnowledgePanel::ElementSelected( MOS_SelectedElement& t0 )
{
    if ( signalsBlocked() )
	return;
...
void MOS_DynaObjectKnowledgePanel::CenterOnPoint( const MT_Vector2D& t0 )
{
    if ( signalsBlocked() )
	return;
...
bool MOS_DynaObjectKnowledgePanel::qt_invoke( int _id, QUObject* _o )
{
    switch ( _id - staticMetaObject()->slotOffset() ) {
    case 0: OnSelectionChanged((QListViewItem*)static_QUType_ptr.get(_o+1)); break;
    case 1: OnRequestCenter(); break;
    case 2: OnKnowledgeCreated((MOS_Team&)*((MOS_Team*)static_QUType_ptr.get(_o+1)),(MOS_DynaObjectKnowledge&)*((MOS_DynaObjectKnowledge*)static_QUType_ptr.get(_o+2))); break;
    case 3: OnKnowledgeUpdated((MOS_Team&)*((MOS_Team*)static_QUType_ptr.get(_o+1)),(MOS_DynaObjectKnowledge&)*((MOS_DynaObjectKnowledge*)static_QUType_ptr.get(_o+2))); break;
    case 4: OnKnowledgeDeleted((MOS_Team&)*((MOS_Team*)static_QUType_ptr.get(_o+1)),(MOS_DynaObjectKnowledge&)*((MOS_DynaObjectKnowledge*)static_QUType_ptr.get(_o+2))); break;
...
bool MOS_DynaObjectKnowledgePanel::qt_emit( int _id, QUObject* _o )
{
...
bool MOS_DynaObjectKnowledgePanel::qt_property( int id, int f, QVariant* v)
{
    return MOS_InfoPanel_ABC::qt_property( id, f, v);
}

bool MOS_DynaObjectKnowledgePanel::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
