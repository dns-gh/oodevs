...
{
    launcher_.Connect( host.toUtf8().constData(), port, *this );
}
...
{
    OnError( tools::translate( "LauncherClientPage", "Failed to connect to host: %1." ).arg( reason.c_str() ).toUtf8().constData() );
}
