...
{
    strName_ = "Automat_ASS_SeDeployer";
}
...
void Mission_Automat_ASS_SeDeployer::Serialize()
{
    ...
    asnMsg_.GetAsnMsg().mission.t = T_Mission_Automate_mission_automate_ass_se_deployer;
    asnMsg_.GetAsnMsg().mission.u.mission_automate_ass_se_deployer = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.t == T_Mission_Automate_mission_automate_ass_se_deployer );
    ASN1T_Mission_Automate_ASS_SeDeployer& asnMission = *asnMsg_.GetAsnMsg().mission.u.mission_automate_ass_se_deployer;
