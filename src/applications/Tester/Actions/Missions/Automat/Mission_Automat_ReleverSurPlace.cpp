...
{
    strName_ = "Automat_ReleverSurPlace";
}
...
{
    assert( asnMsg_.GetAsnMsg().mission.t == T_Mission_Automate_mission_automate_relever_sur_place );
    ASN1T_Mission_Automate_ReleverSurPlace& asnMission = *asnMsg_.GetAsnMsg().mission.u.mission_automate_relever_sur_place;
