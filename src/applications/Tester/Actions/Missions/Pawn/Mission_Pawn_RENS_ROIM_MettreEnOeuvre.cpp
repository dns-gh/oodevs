...
// -----------------------------------------------------------------------------
Mission_Pawn_RENS_ROIM_MettreEnOeuvre::Mission_Pawn_RENS_ROIM_MettreEnOeuvre( Pawn& pawn, uint nExecutionTick /* = 0 */ )
    : Mission_Pawn_ABC ( pawn, nExecutionTick )
{
    strName_ = "Pawn_RENS_ROIM_MettreEnOeuvre";
}
...
void Mission_Pawn_RENS_ROIM_MettreEnOeuvre::Serialize()
{
    ...
    asnMsg_.GetAsnMsg().mission.t = T_Mission_Pion_mission_pion_rens_roim_mettre_en_oeuvre;
    asnMsg_.GetAsnMsg().mission.u.mission_pion_rens_roim_mettre_en_oeuvre = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.t == T_Mission_Pion_mission_pion_rens_roim_mettre_en_oeuvre );
    ASN1T_Mission_Pion_RENS_ROIM_MettreEnOeuvre& asnMission = *asnMsg_.GetAsnMsg().mission.u.mission_pion_rens_roim_mettre_en_oeuvre;
