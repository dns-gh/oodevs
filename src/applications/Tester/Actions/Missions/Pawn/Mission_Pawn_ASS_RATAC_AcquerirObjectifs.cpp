...
// -----------------------------------------------------------------------------
Mission_Pawn_ASS_RATAC_AcquerirObjectifs::Mission_Pawn_ASS_RATAC_AcquerirObjectifs( Pawn& pawn, uint nExecutionTick /* = 0 */ )
    : Mission_Pawn_ABC ( pawn, nExecutionTick )
{
    strName_ = "Pawn_ASS_RATAC_AcquerirObjectifs";
}
