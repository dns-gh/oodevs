...
// -----------------------------------------------------------------------------
Mission_Pawn_LOG_AppuyerMouvementDansZone::Mission_Pawn_LOG_AppuyerMouvementDansZone( Pawn& pawn, uint nExecutionTick /* = 0 */ )
    : Mission_Pawn_ABC ( pawn, nExecutionTick )
{
    strName_ = "Pawn_LOG_AppuyerMouvementDansZone";
}
