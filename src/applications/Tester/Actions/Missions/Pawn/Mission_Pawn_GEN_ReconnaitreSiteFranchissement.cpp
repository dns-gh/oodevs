...
// -----------------------------------------------------------------------------
Mission_Pawn_GEN_ReconnaitreSiteFranchissement::Mission_Pawn_GEN_ReconnaitreSiteFranchissement( Pawn& pawn, uint nExecutionTick /* = 0 */ )
    : Mission_Pawn_ABC ( pawn, nExecutionTick )
{
    strName_ = "Pawn_GEN_ReconnaitreSiteFranchissement";
}
