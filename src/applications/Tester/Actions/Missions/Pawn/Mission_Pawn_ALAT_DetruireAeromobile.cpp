...
// -----------------------------------------------------------------------------
Mission_Pawn_ALAT_DetruireAeromobile::Mission_Pawn_ALAT_DetruireAeromobile( Pawn& pawn, uint nExecutionTick /* = 0 */ )
    : Mission_Pawn_ABC ( pawn, nExecutionTick )
{
    strName_ = "Pawn_ALAT_DetruireAeromobile";
}
...
void Mission_Pawn_ALAT_DetruireAeromobile::Serialize()
{
    ...
    ASN_Tools::CopyAgentKnowledgeList( pTarget_->GetTestParam_AgentKnowledgeList(), asnMission.unite_a_detruire );
