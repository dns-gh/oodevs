...
// -----------------------------------------------------------------------------
Mission_Pawn_INF_Barrer::Mission_Pawn_INF_Barrer( Pawn& pawn, uint nExecutionTick /* = 0 */ )
...
void Mission_Pawn_INF_Barrer::Serialize()
{
    ...
    ASN_Tools::CopyPoint( pTarget_->GetTestParam_Point(), asnMission.position_a_barrer );
