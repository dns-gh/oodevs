...
private:
    ...
    // Communications
    void OnReceiveMsgOrderConduiteAck         ( const ASN1T_MsgOrderConduiteAck& asnMsg, T_NetContextId nCtx );
    void OnReceiveMsgPawnOrder                ( const ASN1T_MsgPionOrder& asnMsg );
