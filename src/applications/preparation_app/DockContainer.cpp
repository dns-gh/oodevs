    ...
    , pLivingAreaPanel_  ( 0 )
{
    // Agent list panel
    {
        ...
        QTabWidget* pListsTabWidget = new QTabWidget( box );
        {
            ...
            // Tactical
            {
                searchListView = new gui::SearchListView< TacticalListView >( pListsTabWidget, controllers, factory, icons, modelBuilder, model.formations_.levels_, staticModel.types_, glProxy );
