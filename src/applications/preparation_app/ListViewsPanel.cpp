...
{
    {
        ...
        CreateUnitTabWidget( pFirstAgentsTabWidget, this, controllers, factory, icons, modelBuilder, model, staticModel, listViews, aggregateToolbar, true );

        pSecondAgentsTabWidget_ = new QTabWidget();
        pSecondAgentsTabWidget_->hide();
        CreateUnitTabWidget( pSecondAgentsTabWidget_, this, controllers, factory, icons, modelBuilder, model, staticModel, listViews, aggregateToolbar, false );
...
// -----------------------------------------------------------------------------
void ListViewsPanel::CreateUnitTabWidget( QTabWidget* parent, QTabWidget* tabWidget, kernel::Controllers& controllers,
                                          gui::ItemFactory_ABC& factory, gui::EntitySymbols& icons, ModelBuilder& modelBuilder,
                                          Model& model, StaticModel& staticModel, std::vector< gui::SearchListView_ABC* >& listViews,
                                          const gui::AggregateToolbar& aggregateToolbar, bool first )
{
    ...
    // Tactical
    {
        gui::SearchListView_ABC* searchListView = new gui::SearchListView< TacticalListView >( tabWidget, controllers, factory, icons, modelBuilder, model.formations_.levels_, staticModel.types_ );
