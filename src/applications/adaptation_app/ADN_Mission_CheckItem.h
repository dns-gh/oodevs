...
public:
    ...
    //@{
             ADN_Mission_CheckItem( Q3ListView* pParent, ADN_Missions_Data::ADN_Missions_ABC& mission, ADN_Models_Data::MissionInfos* pMission = 0 );
             ADN_Mission_CheckItem( Q3CheckListItem* pParent, ADN_Missions_Data::ADN_Missions_ABC& mission, ADN_Models_Data::MissionInfos* pMission = 0 );
    virtual ~ADN_Mission_CheckItem();
    //@}

    //! @name Accessors
    //@{
    ADN_Missions_Data::ADN_Missions_ABC& GetMission() const;
...
private:
    //! @name Member data
    //@{
    ADN_Missions_Data::ADN_Missions_ABC&    missionType_;
...
// -----------------------------------------------------------------------------
inline
ADN_Missions_Data::ADN_Missions_ABC& ADN_Mission_CheckItem::GetMission() const
{
    return missionType_;
}
