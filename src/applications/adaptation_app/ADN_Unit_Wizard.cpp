...
#include "moc_ADN_Unit_Wizard.cpp"
...
{
    setCaption( qApp->translate( "ADN_Unit_Wizard", "New unit creation" ) );
    ...
    pFirstPage->SetCaptions( qApp->translate( "ADN_Unit_Wizard", "New unit creation" ),qApp->translate( "ADN_Unit_Wizard",  "Units" ) );
