    ...
    : T_Parent( "ADNConsistencyDialog", parent, *new ADN_ConsistencyChecker(), *new gui::FilterProxyModel< E_ConsistencyCheck >( IsError, Convert ) )
{
    ...
    errorDescriptions_[ eMissingObjectParameter ] = tr( "Parameter '%2' of the mission %1 should have at least one object: All objects will be selectable instead of none." );
