...
// -----------------------------------------------------------------------------
ADN_Resources_GenericListView::ADN_Resources_GenericListView( QWidget* pParent, sword::DotationType nType )
    : ADN_ListView( pParent, "ADN_Resources_GenericListView", ENT_Tr::ConvertFromDotationType( nType, ENT_Tr::eToTr ).c_str() )
    , nType_      ( nType )
{
...
void ADN_Resources_GenericListView::OnContextMenu( const QPoint& pt )
{
    ...
    ADN_Resources_Wizard wizard( dotation, ADN_Workspace::GetWorkspace().GetResources().GetData().GetResources(), ENT_Tr::ConvertFromDotationType( nType_, ENT_Tr::eToTr ).c_str(), this );
