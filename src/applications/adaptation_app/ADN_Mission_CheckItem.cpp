...
// -----------------------------------------------------------------------------
ADN_Mission_CheckItem::ADN_Mission_CheckItem( Q3ListView* pParent, ADN_Missions_Mission& mission, ADN_Models_Data::MissionInfos* pMission )
...
// Created: AGN 2004-04-28
// -----------------------------------------------------------------------------
ADN_Mission_CheckItem::ADN_Mission_CheckItem( Q3CheckListItem* pParent, ADN_Missions_Mission& mission, ADN_Models_Data::MissionInfos* pMission )
    : Q3CheckListItem( pParent, mission.strName_.GetData().c_str(), CheckBox )
    , missionType_ ( mission )
    , missionModel_( pMission )
{
