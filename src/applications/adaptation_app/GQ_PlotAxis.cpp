...
// $Archive: /MVW_v10/Build/SDK/Adn2/src/GQ_PlotAxis.cpp $
// $Author: Ape $
// $Modtime: 17/12/04 11:50 $
// $Revision: 1 $
...
const uint _defaultTickMultiples   [ 4 ] = {  1, 2, 5, 25  };
const uint _defaultMinutesMultiples[ 6 ] = {  1, 5, 10, 20, 15, 30 };
...
// Created: CBX 2003-08-07
// -----------------------------------------------------------------------------
void GQ_PlotAxis::SetCaptionMargin( uint nMargin )
{
...
// Created: CBX 2003-08-07
// -----------------------------------------------------------------------------
void GQ_PlotAxis::ShowTicks( uint nTicksSpacing )
{
...
// Created: CBX 2003-08-07
// -----------------------------------------------------------------------------
void GQ_PlotAxis::SetMinTicksSpacing( uint nMinTicksSpacing )
{
...
// Created: CBX 2003-08-07
// -----------------------------------------------------------------------------
void GQ_PlotAxis::SetTicksLength( uint nLength )
{
...
// Created: CBX 2003-08-07
// -----------------------------------------------------------------------------
void GQ_PlotAxis::SetSubTicksLength( uint nLength )
{
...
// Created: CBX 2003-08-07
// -----------------------------------------------------------------------------
void GQ_PlotAxis::ShowSubTicks( uint nNbrSubTicks )
{
...
// Created: CBX 2003-08-07
// -----------------------------------------------------------------------------
void GQ_PlotAxis::SetAxisLength( uint nLength )
{
    if( nLength == nAxisLength_ )
        return;
...
//    GQ_LOG( "GQ_PlotAxis::Update()" );
    ...
    if( bShowTickValues_ )
    {
        ...
        {
            uint nMinValueWidth = metrics.width( GetStrValue( rMinAxisValue_ ) );
            uint nMaxValueWidth = metrics.width( GetStrValue( rMaxAxisValue_ ) );
