...
// =============================================================================
class ADN_Sensors_Illumination_GUI : public ADN_Sensors_ModificatorTable_ABC
{
public:
    //! @name Constructor / Destructor
    //@{
             ADN_Sensors_Illumination_GUI( const QString& objectName, ADN_Connector_ABC*& connector, QWidget* pParent = 0 );
