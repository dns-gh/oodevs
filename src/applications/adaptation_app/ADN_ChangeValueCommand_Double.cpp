...
// $Archive: /MVW_v10/Build/SDK/Adn2/src/ADN_ChangeValueCommand_Double.cpp $
// $Author: Ape $
// $Modtime: 28/01/05 14:27 $
// $Revision: 2 $
// $Workfile: ADN_ChangeValueCommand_Double.cpp $
//
// *****************************************************************************
...
// Created: AGN 2004-05-13
// -----------------------------------------------------------------------------
ADN_ChangeValueCommand_Double::ADN_ChangeValueCommand_Double( ADN_Type_Double& modifiedData, double nOldValue, double nNewValue )
: QtCommand()
...
// -----------------------------------------------------------------------------
// Name: ADN_ChangeValueCommand_Double destructor
// Created: AGN 2004-05-13
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Name: ADN_ChangeValueCommand_Double::undo
// Created: AGN 2004-05-13
// -----------------------------------------------------------------------------
void ADN_ChangeValueCommand_Double::undo()
{
...
// Created: AGN 2004-05-13
// -----------------------------------------------------------------------------
bool ADN_ChangeValueCommand_Double::mergeMeWith( QtCommand* other )
{
    ADN_ChangeValueCommand_Double* pCastCommand = static_cast< ADN_ChangeValueCommand_Double* >( other );
...
// -----------------------------------------------------------------------------
// Name: ADN_ChangeValueCommand_Double::UpdateDescription
// Created: AGN 2004-05-13
// -----------------------------------------------------------------------------
void ADN_ChangeValueCommand_Double::UpdateDescription()
{
