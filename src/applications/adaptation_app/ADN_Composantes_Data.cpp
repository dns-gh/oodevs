...
void ADN_Composantes_Data::LogSupplyInfos::ReadArchive( xml::xistream& input )
{
    ...
    if( !strNature.empty() )
    {
        ...
        if( !pNature )
            throw ADN_DataException( tools::translate( "Composante_Data", "Invalid data" ).toUtf8().constData(), tools::translate( "Composante_Data", "Equipment - Invalid resource nature '%1'" ).arg( strNature.c_str() ).toUtf8().constData() );
...
void ADN_Composantes_Data::BreakdownInfos::ReadArchive( xml::xistream& input )
{
    ...
    if( pBreakdown == 0 )
        throw ADN_DataException( tools::translate( "Composante_Data", "Invalid data" ).toUtf8().constData(), tools::translate( "Composante_Data", "Equipment - Invalid breakdown type '%1'" ).arg( strName.c_str() ).toUtf8().constData() );
...
void ADN_Composantes_Data::BreakdownGroupInfos::WriteArchive( xml::xostream& output, const std::string& composante ) const
{
    ...
    if( rSum != 100.0 )
        throw ADN_DataException( tools::translate( "Composante_Data",  "Invalid data" ).toUtf8().constData(), tools::translate( "Composante_Data", "Equipment '%1' - Invalid breakdown data : sum != 100" ).arg( composante.c_str() ).toUtf8().constData() );
...
void ADN_Composantes_Data::SensorInfos::ReadArchive( xml::xistream& input )
{
    ...
    if( pSensor == NULL )
        throw ADN_DataException( tools::translate( "Composante_Data",  "Invalid data" ).toUtf8().constData(),  tools::translate( "Composante_Data", "Equipment - Invalid sensor type '%1'" ).arg( type.c_str() ).toUtf8().constData() );
    ptrSensor_ = pSensor;
}
...
void ADN_Composantes_Data::RadarInfos::ReadArchive( xml::xistream& input )
{
    ...
    if( pRadar == 0 )
        throw ADN_DataException( tools::translate( "Composante_Data",  "Invalid data" ).toUtf8().constData(),  tools::translate( "Composante_Data", "Equipment - Invalid radar type '%1'" ).arg( strRadarName.c_str() ).toUtf8().constData() );
    ptrRadar_ = pRadar;
...
void ADN_Composantes_Data::WeaponInfos::ReadArchive( xml::xistream& input )
{
    ...
    if( !pWeapon )
        throw ADN_DataException( tools::translate( "Composante_Data",  "Invalid data" ).toUtf8().constData(), tools::translate( "Composante_Data",  "Equipment - Invalid weapon system '%1/%2'" ).arg( strLauncher.c_str(), strAmmunition.c_str() ).toUtf8().constData() );
    ptrWeapon_ = pWeapon;
...
void ADN_Composantes_Data::ActiveProtectionsInfos::ReadArchive( xml::xistream& input )
{
    ...
    if( pActiveProtection == 0 )
        throw ADN_DataException( tools::translate( "Composante_Data",  "Invalid data" ).toUtf8().constData(), tools::translate( "Composante_Data",  "Equipment - Invalid active protection type '%1'" ).arg( strActiveProtectionName.c_str() ).toUtf8().constData() );
...
void ADN_Composantes_Data::CategoryInfos::ReadArchive( xml::xistream& input )
{
    ...
    if( !pCat )
        throw ADN_DataException( tools::translate( "Composante_Data",  "Invalid data" ).toUtf8().constData(), tools::translate( "Composante_Data",  "Equipment - Invalid resource type '%1'" ).arg( strCategory.c_str() ).toUtf8().constData() );
    ptrCategory_ = pCat;
}
...
void ADN_Composantes_Data::ObjectInfos::ReadArchive( xml::xistream& input )
{
    ...
    if( !pObject )
        throw ADN_DataException( tools::translate( "Composante_Data",  "Invalid data" ).toUtf8().constData(), tools::translate( "Composante_Data",  "Equipment - Invalid object type '%1'" ).arg( strType.c_str() ).toUtf8().constData() );
    ptrObject_ = pObject;
...
void ADN_Composantes_Data::ConsumptionsInfos::ReadConsumption( xml::xistream& input )
{
    ...
    if( type == E_ConsumptionType( -1 ) )
        throw ADN_DataException( tools::translate( "Composante_Data",  "Invalid data" ).toUtf8().constData(), tools::translate( "Composante_Data",  "Equipment - Invalid activty '%1'" ).arg( status.c_str() ).toUtf8().constData() );
...
void ADN_Composantes_Data::ConsumptionsInfos::ReadDotation( xml::xistream& input, const E_ConsumptionType& type )
{
    ...
    if( !pCategory )
        throw ADN_DataException( tools::translate( "Composante_Data",  "Invalid data" ).toUtf8().constData(), tools::translate( "Composante_Data",  "Equipment - Invalid resource type '%1'" ).arg( name.c_str() ).toUtf8().constData() );
...
void ADN_Composantes_Data::ComposanteInfos::ReadSpeed( xml::xistream& input )
{
    ...
    {
        throw ADN_DataException( tools::translate( "Composantes_Data", "Invalid data" ).toUtf8().constData(), tools::translate( "Composantes_Data", "Equipment - Invalid terrain type '%1'" ).arg( strLocation.c_str() ).toUtf8().constData() );
    }
}
...
void ADN_Composantes_Data::ComposanteInfos::ReadArchive( xml::xistream& input )
{
    ...
    if( ! ptrArmor_.GetData() || ! ptrSize_.GetData() )
        throw ADN_DataException( tools::translate( "Composante_Data",  "Invalid data" ).toUtf8().constData(), tools::translate( "Composante_Data",  "Equipment - Invalid armor and/or volume" ).toUtf8().constData() );
...
void ADN_Composantes_Data::ComposanteInfos::WriteArchive( xml::xostream& output ) const
{
    ...
    if( ! attritionBreakdowns_.vBreakdowns_.empty() && !randomBreakdowns_.vBreakdowns_.empty() )
    {
        ...
        throw ADN_DataException( tools::translate( "Composante_Data", "Missing breakdown" ).toUtf8().constData(), tools::translate( "Composante_Data", "Equipment - Shall contain at least one breakdown for " ).toUtf8().constData() + strName_.GetData() );
