...
#ifndef __ADN_Sensors_UrbanBlockMaterial_GUI_h_
...
/** @class  ADN_Sensors_UrbanBlockMaterial_GUI
    @brief  ADN_Sensors_UrbanBlockMaterial_GUI
*/
// Created: ABR 2012-01-16
// =============================================================================
class ADN_Sensors_UrbanBlockMaterial_GUI : public ADN_Sensors_ModificatorTable_ABC
{
public:
    //! @name Constructor / Destructor
    //@{
             ADN_Sensors_UrbanBlockMaterial_GUI( const QString& objectName, ADN_Connector_ABC*& connector, QWidget* pParent = 0 );
...
#endif // __ADN_Sensors_UrbanBlockMaterial_GUI_h_