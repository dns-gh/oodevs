...
typedef ADN_TableItem_Edit< ADN_Connector_Int< ADN_TableItem_ABC >    , QIntValidator    > ADN_TableItem_Int;
typedef ADN_TableItem_Edit< ADN_Connector_Double< ADN_TableItem_ABC > , QDoubleValidator > ADN_TableItem_Double;
