...
void ADN_Equipement_Data::CategoryInfo::ReadArchive( xml::xistream& input )
{
    ...
    if( !pNature )
        throw ADN_DataException( tools::translate( "Equipment_Data", "Invalid data" ).toUtf8().constData(), tools::translate( "Equipment_Data", "Equipment - Invalid resource nature '%1'" ).arg( dotationNature.c_str() ).toUtf8().constData() );
    ...
    if( !pClass )
        throw ADN_DataException( tools::translate( "Equipment_Data", "Invalid data" ).toUtf8().constData(), tools::translate( "Equipment_Data", "Equipment - Invalid resource logistic supply class '%1'" ).arg( logisticSupplyClass.c_str() ).toUtf8().constData() );
...
void ADN_Equipement_Data::IndirectAmmoInfos::ReadPh( xml::xistream& input )
{
    ...
    throw ADN_DataException( tr( "Invalid data" ).toUtf8().constData(), tr( "Equipment - Invalid stance '%1'" ).arg( posture.c_str() ).toUtf8().constData() );
}
...
void ADN_Equipement_Data::IndirectAmmoInfos::ReadIndirectFire( xml::xistream& input )
{
    ...
    if( indirect == (E_TypeMunitionTirIndirect)-1 )
        throw ADN_DataException( tr( "Invalid data" ).toUtf8().constData(), tr( "Equipment - Invalid indirect fire ammo type '%1'" ).arg( type.c_str() ).toUtf8().constData() );
...
void ADN_Equipement_Data::AmmoCategoryInfo::ReadUrbanModifer( xml::xistream& input )
{
    ...
    if( it == modifUrbanBlocks_.end() )
        throw ADN_DataException( tr( "Invalid data" ).toUtf8().constData(), tr( "Equipment - Invalid urban Material type '%1'" ).arg( material.c_str() ).toUtf8().constData() );
...
void ADN_Equipement_Data::AmmoCategoryInfo::ReadArchive( xml::xistream& input )
{
    ...
    if( !type.empty() )
    {
        ...
        if( nType_ == E_MunitionType( -1 ) )
            throw ADN_DataException( tr( "Invalid data" ).toUtf8().constData(), tr( "Equipment - Invalid resource type '%1'" ).arg( type.c_str() ).toUtf8().constData() );
    }
...
void ADN_Equipement_Data::ReadResource( xml::xistream& input )
{
    ...
    if( nResourceType == -1 )
        throw ADN_DataException( tr( "Invalid data" ).toUtf8().constData(), tr( "Equipment - Invalid resource type '%1'" ).arg( category.c_str() ).toUtf8().constData() );
