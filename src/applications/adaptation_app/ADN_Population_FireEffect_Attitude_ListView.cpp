...
// -----------------------------------------------------------------------------
ADN_Population_FireEffect_Attitude_ListView::ADN_Population_FireEffect_Attitude_ListView( QWidget* pParent )
    : ADN_ListView( pParent, "ADN_Population_FireEffect_Attitude_ListView", tools::translate( "ADN_Population_FireEffect_Attitude_ListView", "Attitudes" ) )
{
    // Connector creation
