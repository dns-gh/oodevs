...
// $Archive: /MVW_v10/Build/SDK/MOS_Light/src/MOS_EnemyInfo_Localisation.h $
// $Author: Nld $
// $Modtime: 10/09/04 11:40 $
// $Revision: 6 $
// $Workfile: MOS_EnemyInfo_Localisation.h $
//
//*****************************************************************************

#ifndef __MOS_EnemyInfo_Localisation_h_
#define __MOS_EnemyInfo_Localisation_h_
...
{
    MT_COPYNOTALLOWED( MOS_EnemyInfo_Localisation )
public:
    MOS_EnemyInfo_Localisation( QWidget* pParent, const std::string& strName );
    virtual ~MOS_EnemyInfo_Localisation();
...
#endif // __MOS_EnemyInfo_Localisation_h_