...
// $Archive: /MVW_v10/Build/SDK/MOS_Light/src/MOS_Net_Def.h $
// $Author: Nld $
// $Modtime: 16/04/03 16:44 $
// $Revision: 4 $
// $Workfile: MOS_Net_Def.h $
//
//*****************************************************************************

#ifndef __MOS_Net_Def_h_
#define __MOS_Net_Def_h_
