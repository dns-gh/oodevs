...
// $Archive: /MVW_v10/Build/SDK/MOS_Light/src/MOS_MTH_ItinerairePos.h $
// $Author: Nld $
// $Modtime: 10/09/04 11:40 $
// $Revision: 7 $
// $Workfile: MOS_MTH_ItinerairePos.h $
//
//*****************************************************************************

#ifndef __MOS_MTH_ItinerairePos_h_
#define __MOS_MTH_ItinerairePos_h_
...
// Created: FBD 03-01-13
//*****************************************************************************
class MOS_MTH_ItinerairePos : public MOS_PointListView
{
    MT_COPYNOTALLOWED( MOS_MTH_ItinerairePos );
...
public:
    ...
    //-------------------------------------------------------------------------
    //@{
    explicit MOS_MTH_ItinerairePos( ASN1T_Itineraire& asnListPoint, QWidget* pParent, const std::string& sName );
    virtual ~MOS_MTH_ItinerairePos();
    //@}
...
#endif // __MOS_MTH_ItinerairePos_h_