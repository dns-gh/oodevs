...
// $Archive: /MVW_v10/Build/SDK/MOS_Light/src/MOS_MTH_ListPoint.h $
// $Author: Nld $
// $Modtime: 10/09/04 11:40 $
// $Revision: 2 $
// $Workfile: MOS_MTH_ListPoint.h $
//
//*****************************************************************************

#ifndef __MOS_MTH_ListPoint_h_
#define __MOS_MTH_ListPoint_h_
...
// Created: FBD 03-01-13
//*****************************************************************************
class MOS_MTH_ListPoint : public MOS_PointListView
{
    MT_COPYNOTALLOWED( MOS_MTH_ListPoint );
...
public:
    ...
    //-------------------------------------------------------------------------
    //@{
    explicit MOS_MTH_ListPoint( ASN1T_ListPoint& asnListPoint, QWidget* pParent, const std::string& sName );
    virtual ~MOS_MTH_ListPoint();
    //@}
