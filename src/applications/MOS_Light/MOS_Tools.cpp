...
MOS_Tools::T_OrderConverter MOS_Tools::orderConverter_[] =
{
    ...
    T_OrderConverter( "RecupererTransporteurs"                          , eOrdreConduite_RecupererTransporteurs ),    
    ...
    T_OrderConverter( "ChangerPositionDebarquement"                     , eOrdreConduite_ChangerPositionDebarquement ),    
