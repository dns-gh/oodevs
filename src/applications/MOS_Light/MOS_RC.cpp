...
void MOS_RC::Initialize( const ASN1T_MsgCR& asnMsg )
{
    ...
    switch( asnMsg.cr.t )
    {
        ...
        case T_MsgCR_cr_cr_en_poste_face_a_obstacle : strMsg << "en poste face a obstacle" << " - ConnaissanceObjet : " << " " << asnMsg.cr.u.cr_en_poste_face_a_obstacle; break;
        ...
        case T_MsgCR_cr_cr_sur_pia : strMsg << "sur pia" << " - Pion : " << " " << asnMsg.cr.u.cr_sur_pia; break;
        case T_MsgCR_cr_cr_passage_sur_pia : strMsg << "passage sur pia"; break;
        case T_MsgCR_cr_cr_unite_recueillie : strMsg << "unite recueillie" << " - Pion : " << " " << asnMsg.cr.u.cr_unite_recueillie; break;
        ...
        case T_MsgCR_cr_cr_precision_contact : strMsg << "precision contact" << " - ConnaissanceAgent : " << " " << asnMsg.cr.u.cr_precision_contact; break;
        case T_MsgCR_cr_cr_ennemi_detruit : strMsg << "ennemi detruit" << " - ConnaissanceAgent : " << " " << asnMsg.cr.u.cr_ennemi_detruit; break;
        ...
        case T_MsgCR_cr_cr_point_tenu_par_eni : strMsg << "point tenu par eni" << " - ConnaissanceAgent : " << " " << asnMsg.cr.u.cr_point_tenu_par_eni; break;
        case T_MsgCR_cr_cr_progression_vers_eni : strMsg << "progression vers eni" << " - ConnaissanceAgent : " << " " << asnMsg.cr.u.cr_progression_vers_eni; break;
        case T_MsgCR_cr_cr_decroche : strMsg << "decroche"; break;
        case T_MsgCR_cr_cr_eni_sur_objectif : strMsg << "eni sur objectif" << " - ConnaissanceAgent : " << " " << asnMsg.cr.u.cr_eni_sur_objectif; break;
        ...
        case T_MsgCR_cr_cr_releve : strMsg << "releve" << " - Pion : " << " " << asnMsg.cr.u.cr_releve; break;
        ...
        case T_MsgCR_cr_cr_reussite_renforcement : strMsg << "reussite renforcement" << " - pion_renforcant : " << asnMsg.cr.u.cr_reussite_renforcement->pion_renforcant << " - automate_renforce : " << asnMsg.cr.u.cr_reussite_renforcement->automate_renforce; break;
        case T_MsgCR_cr_cr_echec_renforcement : strMsg << "echec renforcement" << " - pion_renforcant : " << asnMsg.cr.u.cr_echec_renforcement->pion_renforcant << " - automate_renforce : " << asnMsg.cr.u.cr_echec_renforcement->automate_renforce; break;
        case T_MsgCR_cr_cr_obstacle_en_attente_activation : strMsg << "obstacle en attente activation" << " - ConnaissanceObjet : " << " " << asnMsg.cr.u.cr_obstacle_en_attente_activation; break;
        ...
        case T_MsgCR_cr_cr_transport_unite_pas_prete : strMsg << "transport unite pas prete" << " - Pion : " << " " << asnMsg.cr.u.cr_transport_unite_pas_prete; break;
        case T_MsgCR_cr_cr_transport_unite_prete : strMsg << "transport unite prete" << " - Pion : " << " " << asnMsg.cr.u.cr_transport_unite_prete; break;
        ...
        case T_MsgCR_cr_cr_unite_decontaminee : strMsg << "unite decontaminee" << " - Pion : " << " " << asnMsg.cr.u.cr_unite_decontaminee; break;
        ...
        case T_MsgCR_cr_cr_tir_sur_camp_ami : strMsg << "tir sur camp ami" << " - Pion : " << " " << asnMsg.cr.u.cr_tir_sur_camp_ami; break;
        case T_MsgCR_cr_cr_tire_par_camp_ami : strMsg << "tire par camp ami" << " - Pion : " << " " << asnMsg.cr.u.cr_tire_par_camp_ami; break;
        case T_MsgCR_cr_cr_tir_sur_camp_neutre : strMsg << "tir sur camp neutre" << " - Pion : " << " " << asnMsg.cr.u.cr_tir_sur_camp_neutre; break;
        case T_MsgCR_cr_cr_tire_par_camp_neutre : strMsg << "tire par camp neutre" << " - Pion : " << " " << asnMsg.cr.u.cr_tire_par_camp_neutre; break;
        case T_MsgCR_cr_cr_tir_sur_civil : strMsg << "tir sur civil" << " - Pion : " << " " << asnMsg.cr.u.cr_tir_sur_civil; break;
        case T_MsgCR_cr_cr_tire_par_civil : strMsg << "tire par civil" << " - Pion : " << " " << asnMsg.cr.u.cr_tire_par_civil; break;
        ...
        case T_MsgCR_cr_cr_unite_detectee : strMsg << "unite detectee" << " - ConnaissanceAgent : " << " " << asnMsg.cr.u.cr_unite_detectee; break;
        case T_MsgCR_cr_cr_unite_amie_reconnue : strMsg << "unite amie reconnue" << " - ConnaissanceAgent : " << " " << asnMsg.cr.u.cr_unite_amie_reconnue; break;
        case T_MsgCR_cr_cr_unite_ennemie_reconnue : strMsg << "unite ennemie reconnue" << " - ConnaissanceAgent : " << " " << asnMsg.cr.u.cr_unite_ennemie_reconnue; break;
        case T_MsgCR_cr_cr_unite_neutre_reconnue : strMsg << "unite neutre reconnue" << " - ConnaissanceAgent : " << " " << asnMsg.cr.u.cr_unite_neutre_reconnue; break;
        case T_MsgCR_cr_cr_objet_detecte : strMsg << "objet detecte" << " - ConnaissanceObjet : " << " " << asnMsg.cr.u.cr_objet_detecte; break;
