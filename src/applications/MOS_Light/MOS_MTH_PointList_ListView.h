...
// $Archive: /MVW_v10/Build/SDK/MOS_Light/src/MOS_MTH_PointList_ListView.h $
// $Author: Nld $
// $Modtime: 10/09/04 11:40 $
// $Revision: 5 $
// $Workfile: MOS_MTH_PointList_ListView.h $
//
//*****************************************************************************

#ifndef __MOS_MTH_PointList_ListView_h_
#define __MOS_MTH_PointList_ListView_h_
...
{
    Q_OBJECT
    MT_COPYNOTALLOWED( MOS_MTH_PointList_ListView );

public:
    MOS_MTH_PointList_ListView( ASN1T_ListItineraire& asnListLocalisation, QWidget* pParent, const std::string& strName );
    virtual ~MOS_MTH_PointList_ListView();
...
private:
    ...
    {
        eContextMenu_AddList,
        eContextMenu_EditList,
        eContextMenu_RemoveList
    };

private:
    MOS_Agent* pAgent_;
    MOS_MTH_PointList_Editor* pEditor_;

    ASN1T_ListItineraire& asnListLocalisation_;
};
...
#endif // __MOS_MTH_PointList_ListView_h_