...
// -----------------------------------------------------------------------------
void AutomatModel::ScheduleAllMissions( Automat& automat, Scheduler& scheduler, unsigned int nIteration /* = 1 */ ) const
{
...
// Created: SBO 2005-08-12
// -----------------------------------------------------------------------------
void AutomatModel::ScheduleMission( Automat& automat, Scheduler& scheduler, const std::string& strMissionName, unsigned int nIteration /* = 1 */ ) const
{
