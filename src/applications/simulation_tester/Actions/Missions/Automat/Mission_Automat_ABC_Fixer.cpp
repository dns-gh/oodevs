...
void Mission_Automat_ABC_Fixer::Serialize()
{
    ...
    Mission_Automate_ABC_Fixer& asnMission = *new Mission_Automate_ABC_Fixer();

    asnMsg_.GetAsnMsg().mission().mission_automate_abc_fixer = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_automate_abc_fixer ());
    Mission_Automate_ABC_Fixer& asnMission = *asnMsg_.GetAsnMsg().mission().mission_automate_abc_fixer;
