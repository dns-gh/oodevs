...
void Mission_Automat_LOG_AppuyerFranchissementDansZone::Serialize()
{
    ...
    Mission_Automate_LOG_AppuyerFranchissementDansZone& asnMission = *new Mission_Automate_LOG_AppuyerFranchissementDansZone();

    asnMsg_.GetAsnMsg().mission().mission_automate_log_appuyer_franchissement_dans_zone = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_automate_log_appuyer_franchissement_dans_zone ());
    Mission_Automate_LOG_AppuyerFranchissementDansZone& asnMission = *asnMsg_.GetAsnMsg().mission().mission_automate_log_appuyer_franchissement_dans_zone;
