...
void Mission_Automat_Franchir::Serialize()
{
    ...
    asnMsg_.GetAsnMsg().mission.t = T_Mission_Automate_mission_automate_franchir;
    asnMsg_.GetAsnMsg().mission.u.mission_automate_franchir = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.t == T_Mission_Automate_mission_automate_franchir );
    ASN1T_Mission_Automate_Franchir& asnMission = *asnMsg_.GetAsnMsg().mission.u.mission_automate_franchir;
