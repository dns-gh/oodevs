...
void Mission_Automat_Transporter::Serialize()
{
    ...
    Mission_Automate_Transporter& asnMission = *new Mission_Automate_Transporter();

    asnMsg_.GetAsnMsg().mission().mission_automate_transporter = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_automate_transporter ());
    Mission_Automate_Transporter& asnMission = *asnMsg_.GetAsnMsg().mission().mission_automate_transporter;
