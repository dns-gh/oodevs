...
void Mission_Automat_ABC_RenseignerSurUnAxe::Serialize()
{
    ...
    Mission_Automate_ABC_RenseignerSurUnAxe& asnMission = *new Mission_Automate_ABC_RenseignerSurUnAxe();

    asnMsg_.GetAsnMsg().mission().mission_automate_abc_renseigner_sur_un_axe = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_automate_abc_renseigner_sur_un_axe ());
    Mission_Automate_ABC_RenseignerSurUnAxe& asnMission = *asnMsg_.GetAsnMsg().mission().mission_automate_abc_renseigner_sur_un_axe;
