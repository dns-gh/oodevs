...
void Mission_Automat_INF_RecueillirUnite::Serialize()
{
    ...
    Mission_Automate_INF_RecueillirUnite& asnMission = *new Mission_Automate_INF_RecueillirUnite();

    asnMsg_.GetAsnMsg().mission().mission_automate_inf_recueillir_unite = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_automate_inf_recueillir_unite ());
    Mission_Automate_INF_RecueillirUnite& asnMission = *asnMsg_.GetAsnMsg().mission().mission_automate_inf_recueillir_unite;
