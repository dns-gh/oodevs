...
Mission_Automat_ABC_EscorterUnite::Mission_Automat_ABC_EscorterUnite( Automat& Automat )
    : Mission_Automat_ABC ( "Automat_ABC_EscorterUnite", Automat )
{
    // NOTHING
}
...
void Mission_Automat_ABC_EscorterUnite::Serialize()
{
    ...
    Mission_Automate_ABC_EscorterUnite& asnMission = *new Mission_Automate_ABC_EscorterUnite();

    asnMsg_.GetAsnMsg().mission().mission_automate_abc_escorter_unite = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_automate_abc_escorter_unite ());
    Mission_Automate_ABC_EscorterUnite& asnMission = *asnMsg_.GetAsnMsg().mission().mission_automate_abc_escorter_unite;
