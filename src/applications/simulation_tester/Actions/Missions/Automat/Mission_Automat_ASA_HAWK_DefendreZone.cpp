...
void Mission_Automat_ASA_HAWK_DefendreZone::Serialize()
{
    ...
    Mission_Automate_ASA_HAWK_DefendreZone& asnMission = *new Mission_Automate_ASA_HAWK_DefendreZone();

    asnMsg_.GetAsnMsg().mission().mission_automate_asa_hawk_defendre_zone = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_automate_asa_hawk_defendre_zone ());
    Mission_Automate_ASA_HAWK_DefendreZone& asnMission = *asnMsg_.GetAsnMsg().mission().mission_automate_asa_hawk_defendre_zone;
