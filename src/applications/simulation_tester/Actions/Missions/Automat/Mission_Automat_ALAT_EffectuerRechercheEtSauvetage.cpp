...
void Mission_Automat_ALAT_EffectuerRechercheEtSauvetage::Serialize()
{
    ...
    Mission_Automate_ALAT_EffectuerRechercheEtSauvetage& asnMission = *new Mission_Automate_ALAT_EffectuerRechercheEtSauvetage();

    asnMsg_.GetAsnMsg().mission().mission_automate_alat_effectuer_recherche_et_sauvetage = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_automate_alat_effectuer_recherche_et_sauvetage ());
    Mission_Automate_ALAT_EffectuerRechercheEtSauvetage& asnMission = *asnMsg_.GetAsnMsg().mission().mission_automate_alat_effectuer_recherche_et_sauvetage;
