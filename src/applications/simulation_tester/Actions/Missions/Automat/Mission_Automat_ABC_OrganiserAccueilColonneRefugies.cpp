...
void Mission_Automat_ABC_OrganiserAccueilColonneRefugies::Serialize()
{
    ...
    Mission_Automate_ABC_OrganiserAccueilColonneRefugies& asnMission = *new Mission_Automate_ABC_OrganiserAccueilColonneRefugies();

    asnMsg_.GetAsnMsg().mission().mission_automate_abc_organiser_accueil_colonne_refugies = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_automate_abc_organiser_accueil_colonne_refugies ());
    Mission_Automate_ABC_OrganiserAccueilColonneRefugies& asnMission = *asnMsg_.GetAsnMsg().mission().mission_automate_abc_organiser_accueil_colonne_refugies;
