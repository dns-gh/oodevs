...
void Mission_Automat_ABC_DonnerCoupArret::Serialize()
{
    ...
    Mission_Automate_ABC_DonnerCoupArret& asnMission = *new Mission_Automate_ABC_DonnerCoupArret();

    asnMsg_.GetAsnMsg().mission().mission_automate_abc_donner_coup_arret = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_automate_abc_donner_coup_arret ());
    Mission_Automate_ABC_DonnerCoupArret& asnMission = *asnMsg_.GetAsnMsg().mission().mission_automate_abc_donner_coup_arret;
