...
void Mission_Automat_ABC_RenseignerSur::Serialize()
{
    ...
    Mission_Automate_ABC_RenseignerSur& asnMission = *new Mission_Automate_ABC_RenseignerSur();

    asnMsg_.GetAsnMsg().mission().mission_automate_abc_renseigner_sur = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_automate_abc_renseigner_sur ());
    Mission_Automate_ABC_RenseignerSur& asnMission = *asnMsg_.GetAsnMsg().mission().mission_automate_abc_renseigner_sur;
