...
void Mission_Pawn_LOG_ReconnaitreZoneContaminee::Serialize()
{
    ...
    Mission_Pion_LOG_ReconnaitreZoneContaminee& asnMission = *new Mission_Pion_LOG_ReconnaitreZoneContaminee();

    asnMsg_.GetAsnMsg().mission().mission_pion_log_reconnaitre_zone_contaminee = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_log_reconnaitre_zone_contaminee ());
    Mission_Pion_LOG_ReconnaitreZoneContaminee& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_log_reconnaitre_zone_contaminee;
