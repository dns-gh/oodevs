...
void Mission_Pawn_ASA_MISTRAL_DefendreSiteAPartirPosition::Serialize()
{
    ...
    Mission_Pion_ASA_MISTRAL_DefendreSiteAPartirPosition& asnMission = *new Mission_Pion_ASA_MISTRAL_DefendreSiteAPartirPosition();

    asnMsg_.GetAsnMsg().mission().mission_pion_asa_mistral_defendre_site_a_partir_position = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_asa_mistral_defendre_site_a_partir_position ());
    Mission_Pion_ASA_MISTRAL_DefendreSiteAPartirPosition& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_asa_mistral_defendre_site_a_partir_position;
