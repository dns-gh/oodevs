...
void Mission_Pawn_INF_EscorterUnites::Serialize()
{
    ...
    Mission_Pion_INF_EscorterUnites& asnMission = *new Mission_Pion_INF_EscorterUnites();

    asnMsg_.GetAsnMsg().mission().mission_pion_inf_escorter_unites = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_inf_escorter_unites ());
    Mission_Pion_INF_EscorterUnites& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_inf_escorter_unites;
