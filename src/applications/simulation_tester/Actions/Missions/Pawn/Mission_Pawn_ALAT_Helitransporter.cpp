...
void Mission_Pawn_ALAT_Helitransporter::Serialize()
{
    ...
    Mission_Pion_ALAT_Helitransporter& asnMission = *new Mission_Pion_ALAT_Helitransporter();

    asnMsg_.GetAsnMsg().mission().mission_pion_alat_helitransporter = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_alat_helitransporter ());
    Mission_Pion_ALAT_Helitransporter& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_alat_helitransporter;
