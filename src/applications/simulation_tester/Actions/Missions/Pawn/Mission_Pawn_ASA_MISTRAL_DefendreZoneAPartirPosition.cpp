...
Mission_Pawn_ASA_MISTRAL_DefendreZoneAPartirPosition::Mission_Pawn_ASA_MISTRAL_DefendreZoneAPartirPosition( Pawn& pawn )
    : Mission_Pawn_ABC ( "Pawn_ASA_MISTRAL_DefendreZoneAPartirPosition", pawn )
{
    // NOTHING
}
...
void Mission_Pawn_ASA_MISTRAL_DefendreZoneAPartirPosition::Serialize()
{
    ...
    Mission_Pion_ASA_MISTRAL_DefendreZoneAPartirPosition& asnMission = *new Mission_Pion_ASA_MISTRAL_DefendreZoneAPartirPosition();

    asnMsg_.GetAsnMsg().mission().mission_pion_asa_mistral_defendre_zone_a_partir_position = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_asa_mistral_defendre_zone_a_partir_position ());
    Mission_Pion_ASA_MISTRAL_DefendreZoneAPartirPosition& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_asa_mistral_defendre_zone_a_partir_position;
