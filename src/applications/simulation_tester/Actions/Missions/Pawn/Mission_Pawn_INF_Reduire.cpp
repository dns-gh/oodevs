...
void Mission_Pawn_INF_Reduire::Serialize()
{
    ...
    Mission_Pion_INF_Reduire& asnMission = *new Mission_Pion_INF_Reduire();

    asnMsg_.GetAsnMsg().mission().mission_pion_inf_reduire = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_inf_reduire ());
    Mission_Pion_INF_Reduire& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_inf_reduire;
