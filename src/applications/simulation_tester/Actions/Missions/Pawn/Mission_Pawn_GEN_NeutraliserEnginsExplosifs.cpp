...
// -----------------------------------------------------------------------------
Mission_Pawn_GEN_NeutraliserEnginsExplosifs::Mission_Pawn_GEN_NeutraliserEnginsExplosifs( Pawn& pawn )
    : Mission_Pawn_ABC ( "Pawn_GEN_NeutraliserEnginsExplosifs", pawn )
{
    // NOTHING
}
