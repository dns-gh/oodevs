...
void Mission_Pawn_ASS_RATAC_AcquerirObjectifs::Serialize()
{
    ...
    Mission_Pion_ASS_RATAC_AcquerirObjectifs& asnMission = *new Mission_Pion_ASS_RATAC_AcquerirObjectifs();

    asnMsg_.GetAsnMsg().mission().mission_pion_ass_ratac_acquerir_objectifs = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_ass_ratac_acquerir_objectifs ());
    Mission_Pion_ASS_RATAC_AcquerirObjectifs& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_ass_ratac_acquerir_objectifs;
