...
void Mission_Pawn_INF_EscorterUnite::Serialize()
{
    ...
    Mission_Pion_INF_EscorterUnite& asnMission = *new Mission_Pion_INF_EscorterUnite();

    asnMsg_.GetAsnMsg().mission().mission_pion_inf_escorter_unite = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_inf_escorter_unite ());
    Mission_Pion_INF_EscorterUnite& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_inf_escorter_unite;
