...
void Mission_Pawn_ABC_OuvrirItineraire::Serialize()
{
    ...
    Mission_Pion_ABC_OuvrirItineraire& asnMission = *new Mission_Pion_ABC_OuvrirItineraire();

    asnMsg_.GetAsnMsg().mission().mission_pion_abc_ouvrir_itineraire = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_abc_ouvrir_itineraire ());
    Mission_Pion_ABC_OuvrirItineraire& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_abc_ouvrir_itineraire;
