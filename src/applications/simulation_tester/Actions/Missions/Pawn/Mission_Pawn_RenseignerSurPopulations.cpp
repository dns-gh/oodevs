...
void Mission_Pawn_RenseignerSurPopulations::Serialize()
{
    ...
    Mission_Pion_RenseignerSurPopulations& asnMission = *new Mission_Pion_RenseignerSurPopulations();

    asnMsg_.GetAsnMsg().mission().mission_pion_renseigner_sur_populations = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_renseigner_sur_populations ());
    Mission_Pion_RenseignerSurPopulations& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_renseigner_sur_populations;
