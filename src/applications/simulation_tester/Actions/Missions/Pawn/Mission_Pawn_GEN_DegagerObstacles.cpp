...
void Mission_Pawn_GEN_DegagerObstacles::Serialize()
{
    ...
    Mission_Pion_GEN_DegagerObstacles& asnMission = *new Mission_Pion_GEN_DegagerObstacles();

    asnMsg_.GetAsnMsg().mission().mission_pion_gen_degager_obstacles = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_gen_degager_obstacles ());
    Mission_Pion_GEN_DegagerObstacles& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_gen_degager_obstacles;
