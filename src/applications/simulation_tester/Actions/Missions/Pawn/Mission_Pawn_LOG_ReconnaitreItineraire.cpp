...
void Mission_Pawn_LOG_ReconnaitreItineraire::Serialize()
{
    ...
    Mission_Pion_LOG_ReconnaitreItineraire& asnMission = *new Mission_Pion_LOG_ReconnaitreItineraire();

    asnMsg_.GetAsnMsg().mission().mission_pion_log_reconnaitre_itineraire = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_log_reconnaitre_itineraire ());
    Mission_Pion_LOG_ReconnaitreItineraire& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_log_reconnaitre_itineraire;
