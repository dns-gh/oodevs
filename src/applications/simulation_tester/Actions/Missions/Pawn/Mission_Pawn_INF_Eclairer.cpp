...
void Mission_Pawn_INF_Eclairer::Serialize()
{
    ...
    Mission_Pion_INF_Eclairer& asnMission = *new Mission_Pion_INF_Eclairer();

    asnMsg_.GetAsnMsg().mission().mission_pion_inf_eclairer = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_inf_eclairer ());
    Mission_Pion_INF_Eclairer& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_inf_eclairer;
