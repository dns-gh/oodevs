...
void Mission_Pawn_ABC_Soutenir::Serialize()
{
    ...
    Mission_Pion_ABC_Soutenir& asnMission = *new Mission_Pion_ABC_Soutenir();

    asnMsg_.GetAsnMsg().mission().mission_pion_abc_soutenir = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_abc_soutenir ());
    Mission_Pion_ABC_Soutenir& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_abc_soutenir;
