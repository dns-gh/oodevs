...
void Mission_Pawn_ABC_RASIT_RenseignerSur::Serialize()
{
    ...
    Mission_Pion_ABC_RASIT_RenseignerSur& asnMission = *new Mission_Pion_ABC_RASIT_RenseignerSur();

    asnMsg_.GetAsnMsg().mission().mission_pion_abc_rasit_renseigner_sur = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_abc_rasit_renseigner_sur ());
    Mission_Pion_ABC_RASIT_RenseignerSur& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_abc_rasit_renseigner_sur;
