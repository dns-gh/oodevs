...
void Mission_Pawn_INF_Soutenir::Serialize()
{
    ...
    Mission_Pion_INF_Soutenir& asnMission = *new Mission_Pion_INF_Soutenir();

    asnMsg_.GetAsnMsg().mission().mission_pion_inf_soutenir = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_inf_soutenir ());
    Mission_Pion_INF_Soutenir& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_inf_soutenir;
