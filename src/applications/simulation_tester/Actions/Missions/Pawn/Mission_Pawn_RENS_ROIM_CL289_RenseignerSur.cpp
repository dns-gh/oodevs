...
Mission_Pawn_RENS_ROIM_CL289_RenseignerSur::Mission_Pawn_RENS_ROIM_CL289_RenseignerSur( Pawn& pawn )
    : Mission_Pawn_ABC ( "Pawn_RENS_ROIM_CL289_RenseignerSur", pawn )
{
    // NOTHING
}
...
void Mission_Pawn_RENS_ROIM_CL289_RenseignerSur::Serialize()
{
    ...
    Mission_Pion_RENS_ROIM_CL289_RenseignerSur& asnMission = *new Mission_Pion_RENS_ROIM_CL289_RenseignerSur();

    asnMsg_.GetAsnMsg().mission().mission_pion_rens_roim_cl289_renseigner_sur = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_rens_roim_cl289_renseigner_sur ());
    Mission_Pion_RENS_ROIM_CL289_RenseignerSur& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_rens_roim_cl289_renseigner_sur;
