...
void Mission_Pawn_GEN_ReconnaitreZone::Serialize()
{
    ...
    Mission_Pion_GEN_ReconnaitreZone& asnMission = *new Mission_Pion_GEN_ReconnaitreZone();

    asnMsg_.GetAsnMsg().mission().mission_pion_gen_reconnaitre_zone = &asnMission;
...
{
    assert( asnMsg_.GetAsnMsg().mission.has_mission_pion_gen_reconnaitre_zone ());
    Mission_Pion_GEN_ReconnaitreZone& asnMission = *asnMsg_.GetAsnMsg().mission().mission_pion_gen_reconnaitre_zone;
