...
namespace Sword
{
    namespace Crossbow
    {
        ...
        [ProgId("Sword.Crossbow.OrderSelectionMenu")]
        public class OrderSelectionMenu : MultiItemContextMenu
        {
            ...
            public OrderSelectionMenu()
                : base(Tools.GetExtension().OrderHandler)
            {
                // NOTHING
            }
        }
        ...
        [ClassInterface(ClassInterfaceType.None)]
        [ProgId("Sword.Crossbow.EmergencyCreationMenu")]
        public class EmergencyCreationMenu : MultiItemContextMenu
        {
            ...
            public EmergencyCreationMenu()
                : base(Tools.GetExtension().EmergencyHandler)
            {
                // NOTHING
            }
        }
