...
namespace Sword
{
    namespace Crossbow
    {
        ...
        [ProgId("Sword.Crossbow.CreateEventTool")]
        public sealed class CreateEventTool : BaseTool
        {
            ...
            public CreateEventTool()
            {
                ...
                base.m_name = "Sword_Crossbow_CreateEvent";   //unique id, non-localizable (e.g. "MyCategory_ArcMapTool")
                try
                {
                    //
            ...
            public override bool OnContextMenu(int X, int Y)
            {
                try
                {
                    Tools.GetExtension().EmergencyHandler.OnContextMenu(X, Y);
            ...
            private void BuildContextMenu(ICommandBar menu)
            {
                ...
                uid.Value = "Sword.Crossbow.EmergencyCreationMenu";
