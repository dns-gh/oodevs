    ...
    namespace Crossbow
    {
        ...
        public sealed class ParameterLimits : IOrderParameter
        {
            ...
            public ParameterLimits()
            {
                ...
                IFeatureWorkspace workspace = (IFeatureWorkspace)Tools.GetWorkspace(config.PopulationFile);
                IGeoDataset dataset = (IGeoDataset)workspace.OpenFeatureClass("Population");
