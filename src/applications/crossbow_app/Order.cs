...
namespace Sword
{
    namespace Crossbow
    {
        ...
        public class Order : IOrder
        {
            ...
            {
                ITable table = featureWorkspace.OpenTable(Tools.GetExtension().Config.LayersConfiguration.Orders); // $$$$ SBO 2007-07-20: keep it maybe...
            ...
            {
                ITable table = featureWorkspace.OpenTable(Tools.GetExtension().Config.LayersConfiguration.OrderParameters); // $$$$ SBO 2007-07-20: keep it maybe...
