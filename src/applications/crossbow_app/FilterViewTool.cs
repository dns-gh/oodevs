...
namespace Sword
{
    namespace Crossbow
    {
        ...
        [ProgId("Sword.Crossbow.FilterViewTool")]
        public class FilterViewTool : BaseCommand, IToolControl, IDisposable
        {
            ...
            public FilterViewTool()
            {
                ...
                base.m_name = "Sword_Crossbow_FilterViewTool";   //unique id, non-localizable (e.g. "MyCategory_ArcMapTool")
                try
                {
            ...
            private void OnSelectionChanged(object sender, System.EventArgs e)
            {
                ...
                IFeatureLayer layer = Tools.GetFeatureLayerByName(Tools.GetExtension().Config.LayersConfiguration.Units);
                if (layer != null)
                {
