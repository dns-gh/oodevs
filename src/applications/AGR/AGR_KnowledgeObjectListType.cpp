...
AGR_KnowledgeObjectListType::AGR_KnowledgeObjectListType()
    : AGR_Type_ABC( "ScipioBase:ListKnowledgeObject", "ObjectKnowledgeList", "", "T_ListeConnaissancesObjet", true )
{
    //NOTHING
}
...
{
    return "    NET_ASN_Tools::CopyObjectKnowledgeList( GetVariable( " + member.DIAIndexName() + " )"
