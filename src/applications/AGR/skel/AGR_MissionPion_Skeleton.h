...
#ifndef __MIL_PionMission_$MissionName$_h_
#define __MIL_PionMission_$MissionName$_h_
...
// Created: 
//*****************************************************************************
class MIL_PionMission_$MissionName$: public MIL_PionMission_ABC
{
    MT_COPYNOTALLOWED( MIL_PionMission_$MissionName$ )

public:

             MIL_PionMission_$MissionName$( MIL_AgentPion& pion, const MIL_PionMissionType& type );
    virtual ~MIL_PionMission_$MissionName$();
...
#endif // __MIL_PionMission_$MissionName$_h_
