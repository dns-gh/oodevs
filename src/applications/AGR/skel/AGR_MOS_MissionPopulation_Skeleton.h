...
//
// $Created: $
// $Archive: /MVW_v10/Build/SDK/AGR/src/AGR_MOS_MissionPopulation_Skeleton.h $
// $Author: Nld $
// $Modtime: 18/10/04 13:04 $
// $Revision: 3 $
// $Workfile: AGR_MOS_MissionPopulation_Skeleton.h $
//
// *****************************************************************************

#ifndef __MOS_MissionPopulation_h_
#define __MOS_MissionPopulation_h_
...
// Created:  
//=============================================================================
class MOS_MissionPopulation : public MOS_Mission_ABC
{
    MT_COPYNOTALLOWED( MOS_MissionPopulation )

public:
     MOS_MissionPopulation( E_MissionID nTypeMission, QWidget* pParent = 0 );
    ~MOS_MissionPopulation();
...
#endif // __MOS_MissionPopulation_h_
