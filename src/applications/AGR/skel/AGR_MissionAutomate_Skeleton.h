...
#ifndef __MIL_AutomateMission_$MissionName$_h_
#define __MIL_AutomateMission_$MissionName$_h_
...
// Created: 
//=============================================================================
class MIL_AutomateMission_$MissionName$ : public MIL_AutomateMission_ABC
{
    MT_COPYNOTALLOWED( MIL_AutomateMission_$MissionName$ )

public:
             MIL_AutomateMission_$MissionName$( MIL_Automate& automate, const MIL_AutomateMissionType& type );
    virtual ~MIL_AutomateMission_$MissionName$();
...
#endif // __MIL_AutomateMission_$MissionName$_h_
