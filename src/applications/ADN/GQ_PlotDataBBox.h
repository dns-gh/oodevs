...
// $Archive: /MVW_v10/Build/SDK/Adn2/src/GQ_PlotDataBBox.h $
// $Author: Ape $
// $Modtime: 8/03/04 20:22 $
// $Revision: 1 $
...
public:
    ...
    //@{
    GQ_PlotDataBBox(); 
    GQ_PlotDataBBox( const T_Data&, uint nFirstPoint, int nNbrPoints ); 
    ...
    //! @name Modifiers
    //@{
    bool SetData ( const T_Data&, uint nFirstPoint, int nNbrPoints );
