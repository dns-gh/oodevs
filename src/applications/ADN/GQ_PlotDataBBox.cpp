...
// $Archive: /MVW_v10/Build/SDK/Adn2/src/GQ_PlotDataBBox.cpp $
// $Author: Ape $
...
// Created: CBX 2003-08-08
// -----------------------------------------------------------------------------
GQ_PlotDataBBox::GQ_PlotDataBBox( const T_Data& data, uint nFirstPoint, int nNbrPoints )
: bEmpty_( true )
, rXMin_ ( 0.0 )
, rXMax_ ( 0.0 )
, rYMin_ ( 0.0 )
...
// Created: CBX 2003-08-08
// -----------------------------------------------------------------------------
bool GQ_PlotDataBBox::SetData( const T_Data& data, uint nFirstPoint, int nNbrPoints )
{
