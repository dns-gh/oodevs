...
{
    setCaption( tr( "New composante creation" ) );
    ...
    pFirstPage->SetCaptions( tr( "New composante creation" ), tr( "Composantes" ) );
    pFirstPage_ = pFirstPage;

    new ADN_Wizard_LastPage( this, tr( "Creation completed" ), tr( "Click \"Done\" to create the new composante." ) );
}
