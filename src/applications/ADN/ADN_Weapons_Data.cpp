...
, ptrAmmunition_    ( (ADN_Equipement_Data::T_AmmoCategoryInfo_Vector&)ADN_Workspace::GetWorkspace().GetEquipements().GetData().GetDotation( eTypeDotation_Munition ).categories_, 0, "" )
, nRoundsPerBurst_  ( 0 )
, rBurstDuration_   ( 0 )
, nRoundsPerReload_ ( 0 )
, rReloadDuration_  ( 0 )
