...
void UnitMissionInterface::CreateMission_ASA_MISTRAL_DefendreSite()
{
    ...
    CreateLocation( asnMission.site, "Site", false );
    ParamComboBox< ASN1T_EnumModeDeploiementSectionMistral >* pSelector_mode_deploiement = &CreateVarList( asnMission.mode_deploiement, "Mode deploiement", false );
...
void UnitMissionInterface::CreateMission_GEN_RealiserFosseAC()
{
    ...
    //NOTHING
    ParamComboBox< ASN1T_EnumTypeFosseAC >* pSelector_type = &CreateVarList( asnMission.type, "Type", false );
...
void UnitMissionInterface::CreateMission_GEN_RealiserAbattisMine()
{
    ...
    //NOTHING
    ParamComboBox< ASN1T_EnumMissionGenUrgence >* pSelector_urgence = &CreateVarList( asnMission.urgence, "Urgence", false );
    ...
    ParamComboBox< ASN1T_EnumMissionGenSousTypeObstacle >* pSelector_preliminaire = &CreateVarList( asnMission.preliminaire, "Preliminaire", false );
...
void UnitMissionInterface::CreateMission_GEN_EquiperExploiter()
{
    ...
    //NOTHING
    CreatePoint( asnMission.point_regroupement, "Point regroupement", false );
    ParamComboBox< ASN1T_EnumGenTypePontage >* pSelector_type_pontage = &CreateVarList( asnMission.type_pontage, "Type pontage", false );
...
void UnitMissionInterface::CreateMission_GEN_AmenagerTerrainPoser()
{
    ...
    CreatePoint( asnMission.pos_obstacle, "Pos obstacle", false );
    //NOTHING
    ParamComboBox< ASN1T_Mission_Pion_GEN_AmenagerTerrainPoser_type_objet >* pSelector_type_objet = &CreateVarList( asnMission.type_objet, "Type objet", false );
...
void UnitMissionInterface::CreateMission_INF_DetruireEmbuscade()
{
    ...
    CreatePoint( asnMission.position_regroupement, "Position regroupement", false );
    CreateAgentKnowledge( asnMission.ennemi, "Ennemi", false );
    ParamComboBox< ASN1T_EnumObjectType >* pSelector_nature_obstacle = &CreateVarList( asnMission.nature_obstacle, "Nature obstacle", false );
...
void UnitMissionInterface::CreateMission_INF_Harceler()
{
    ...
    CreateLocation( asnMission.secteur, "Secteur", false );
    CreatePoint( asnMission.point_regroupement, "Point regroupement", false );
    ParamComboBox< ASN1T_EnumMissionInfNatureObjectif >* pSelector_nature_objectif = &CreateVarList( asnMission.nature_objectif, "Nature objectif", false );
...
void UnitMissionInterface::CreateMission_INF_DetruireParCoupDeMain()
{
    ...
    ParamComboBox< ASN1T_EnumMissionInfNatureObjectif >* pSelector_nature_destruction = &CreateVarList( asnMission.nature_destruction, "Nature destruction", false );
...
// -----------------------------------------------------------------------------
// Name: UnitMissionInterface::CreateMission_LOG_DistribuerMoyens
// Created: AGR
// -----------------------------------------------------------------------------
void UnitMissionInterface::CreateMission_LOG_DistribuerMoyens()
{
...
// -----------------------------------------------------------------------------
// Name: UnitMissionInterface::CreateMission_LOG_Evacuer
// Created: AGR
// -----------------------------------------------------------------------------
void UnitMissionInterface::CreateMission_LOG_Evacuer()
{
...
// -----------------------------------------------------------------------------
// Name: UnitMissionInterface::CreateMission_LOG_DistribuerRessources
// Created: AGR
// -----------------------------------------------------------------------------
void UnitMissionInterface::CreateMission_LOG_DistribuerRessources()
{
...
// -----------------------------------------------------------------------------
// Name: UnitMissionInterface::CreateMission_LOG_ConstituerConvoi
// Created: AGR
// -----------------------------------------------------------------------------
void UnitMissionInterface::CreateMission_LOG_ConstituerConvoi()
{
...
// -----------------------------------------------------------------------------
// Name: UnitMissionInterface::CreateMission_LOG_Livrer
// Created: AGR
// -----------------------------------------------------------------------------
void UnitMissionInterface::CreateMission_LOG_Livrer()
{
...
// -----------------------------------------------------------------------------
// Name: UnitMissionInterface::CreateMission_LOG_TransporterUnite
// Created: AGR
// -----------------------------------------------------------------------------
void UnitMissionInterface::CreateMission_LOG_TransporterUnite()
{
...
void UnitMissionInterface::CreateMission_Test_MoveTo()
{
    ...
    CreatePath( asnMission.itineraire, "Itineraire", false );
    ParamComboBox< ASN1T_Mission_Pion_Test_MoveTo_type_itineraire >* pSelector_type_itineraire = &CreateVarList( asnMission.type_itineraire, "Type itineraire", false );
...
void UnitMissionInterface::CreateMission_Test_CreateObject()
{
    ...
    ParamComboBox< ASN1T_EnumObjectType >* pSelector_type = &CreateVarList( asnMission.type, "Type", false );
...
void UnitMissionInterface::CreateMission_Test_Fire()
{
    ...
    ParamComboBox< ASN1T_Mission_Pion_Test_Fire_munitions >* pSelector_munitions = &CreateVarList( asnMission.munitions, "Munitions", false );
...
void UnitMissionInterface::CreateMission_Test_ChangePosture()
{
    ...
    ParamComboBox< ASN1T_Mission_Pion_Test_ChangePosture_posture >* pSelector_posture = &CreateVarList( asnMission.posture, "Posture", false );
...
void UnitMissionInterface::CreateMission_Test_FindPosition()
{
    ...
    ParamComboBox< ASN1T_Mission_Pion_Test_FindPosition_type_objectif >* pSelector_type_objectif = &CreateVarList( asnMission.type_objectif, "Type objectif", false );
    ...
    ParamComboBox< ASN1T_Mission_Pion_Test_FindPosition_type_operation >* pSelector_type_operation = &CreateVarList( asnMission.type_operation, "Type operation", false );
    ...
    ParamComboBox< ASN1T_EnumUnitIdentificationLevel >* pSelector_niveau_identification = &CreateVarList( asnMission.niveau_identification, "Niveau identification", false );
...
void UnitMissionInterface::CreateMission_PlastronEnnemi()
{
    ...
    ParamComboBox< ASN1T_Mission_Pion_PlastronEnnemi_type >* pSelector_type = &CreateVarList( asnMission.type, "Type", false );
...
// -----------------------------------------------------------------------------
// Name: UnitMissionInterface::CreateMission_JOINT_MARINE_Transporter
// Created: AGR
// -----------------------------------------------------------------------------
void UnitMissionInterface::CreateMission_JOINT_MARINE_Transporter()
{
...
void UnitMissionInterface::CreateMission_ASY_CommettreAttentatContrePopulation()
{
    ...
    CreatePath( asnMission.itineraire, "Itineraire", false );
    CreatePoint( asnMission.point_repli, "Point repli", false );
    CreatePopulationKnowledge( asnMission.population_cible, "Population cible", false );
}
...
void UnitMissionInterface::CreateMission_ASY_CommettreAttentatContreForcesArmees()
{
    ...
    CreatePath( asnMission.itineraire, "Itineraire", false );
    CreatePoint( asnMission.point_repli, "Point repli", false );
    ParamComboBox< ASN1T_Mission_Pion_ASY_CommettreAttentatContreForcesArmees_type_attentat_forces_armees >* pSelector_type_attentat_forces_armees = &CreateVarList( asnMission.type_attentat_forces_armees, "Type attentat forces armees", false );
    ...
    CreateAgentKnowledge( asnMission.unite_cible, "Unite cible", false );
}
...
void UnitMissionInterface::CreateMission_ASY_CommettreAttentatContreInstallation()
{
    ...
    CreatePath( asnMission.itineraire, "Itineraire", false );
    CreatePoint( asnMission.point_repli, "Point repli", false );
    CreateObjectKnowledge( asnMission.installation_cible, "Installation cible", false );
}
...
void UnitMissionInterface::CreateMission_ASY_Renseigner()
{
    ...
    CreateAutomate( asnMission.destinataire, "Destinataire", false );
}
