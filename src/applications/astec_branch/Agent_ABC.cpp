...
// -----------------------------------------------------------------------------
// Name: Agent_ABC::Update
// Created: AGE 2006-02-13
// -----------------------------------------------------------------------------
void Agent_ABC::Update( const ASN1T_MsgCR& msg )
{
    RC& rc = *new RC( *this );
    rc.Initialize( msg );
...
// Created: AGE 2006-02-13
// -----------------------------------------------------------------------------
void Agent_ABC::Update( const TraceMessage& msg )
{
...
// Created: AGE 2006-02-13
// -----------------------------------------------------------------------------
void Agent_ABC::Update( const DebugPointsMessage& msg )
{
    uint32 nTmp;
    msg >> nTmp;
...
// Created: AGE 2006-02-13
// -----------------------------------------------------------------------------
void Agent_ABC::Update( const ASN1T_MsgAttenteOrdreConduite& asnMsg )
{
    RC& rc = *new RC( *this );
...
// Created: AGE 2006-02-13
// -----------------------------------------------------------------------------
void Agent_ABC::OnSendMissionOrder( ASN1T_MsgPionOrder asnMsg )
{
    sentOrders_[ asnMsg.order_id ] = asnMsg;
}
...
// Created: AGE 2006-02-13
// -----------------------------------------------------------------------------
void Agent_ABC::Update( const ASN1T_MsgPionOrderAck& asnMsg )
{
...
// Created: HME 2005-11-30
// -----------------------------------------------------------------------------
void Agent_ABC::Update( const ASN1T_MsgPionOrder& asnMsg )
{
