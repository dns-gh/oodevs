...
// $Archive: /MVW_v10/Build/SDK/Light2/src/RawVisionData.h $
// $Author: Age $
// $Modtime: 2/03/05 16:30 $
// $Revision: 8 $
// $Workfile: RawVisionData.h $
//
//*****************************************************************************

#ifndef __RawVisionData_h_
#define __RawVisionData_h_
...
class RawVisionData
{
    MT_COPYNOTALLOWED( RawVisionData )
...
public:
    ...
    protected:
        ...
        bool             bIsInGround_;
        const Meteo* pCurrentMeteo_;
    };

public:
    explicit RawVisionData();
    ~RawVisionData();
    ...
    void                          RegisterMeteoPatch( const MT_Vector2D&, const MT_Vector2D&, Meteo* );
    const Meteo::sEphemeride& GetEphemeride() const;
    ...
    //-------------------------------------------------------------------------
    //@{
    void UpdateVisionMatrice( T_VisionResultMap&, const SensorType&, const MT_Sector&, MT_Float,  const Agent& ) const;
    //@}

private:
    void               InitializeMeteo( InputArchive& );
    E_PerceptionResult FindPerception( const Agent& agent, const SensorType&, const MT_Vector2D& target, MT_Float rHeight ) const;
...
#include "RawVisionData.inl"
#include "RawVisionDataIterator.inl"


#endif // __RawVisionData_h_