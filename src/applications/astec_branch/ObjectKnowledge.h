...
// $Archive: /MVW_v10/Build/SDK/Light2/src/ObjectKnowledge.h $
// $Author: Ape $
// $Modtime: 4/11/04 11:15 $
// $Revision: 4 $
// $Workfile: ObjectKnowledge.h $
//
//*****************************************************************************
...
class ObjectKnowledge
{
    MT_COPYNOTALLOWED( ObjectKnowledge );
    friend class GLTool;
    friend class ObjectKnowledgePanel;  //$$$$ Beurk.

public:
     ObjectKnowledge( const ASN1T_MsgObjectKnowledgeCreation& asnMsg, Team& owner );
    ~ObjectKnowledge();
...
private:
    //! @name Types
    //@{
    typedef std::set< Agent* >                     T_AutomatePerceptionSet;
...
private:
    ...
    OptionalValue< Object_ABC* >     pRealObject_;
