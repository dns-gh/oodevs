...
public:
    ...
    void Update( const ASN1T_MsgUnitPathFind&              asnMsg );
    ...
    void Update( const ASN1T_MsgLogRavitaillementQuotas&   asnMsg );
    ...
    void Update( const ObjectDetectionMessage& input );
    void Update( const DetectionMessage& input );
    void Update( const ConcentrationDetectionMessage& input );
    void Update( const FlowDetectionMessage& input );
    void Update( const PopulationCollisionMessage& input );
    void Update( const VisionConesMessage& input );
