...
void UnitMissionInterface::CreateDefaultParameters()
{
    ...
    paramVector_.push_back( new ParamLimits( order.oid_limite_gauche,
...
//-----------------------------------------------------------------------------
// Name: void UnitMissionInterface::CreateMission_Test_MoveTo
...
//
//    ParamComboBox< Mission_Pion_Test_MoveTo_type_itineraire::Root >& param = CreateVarList( asnMission.type_itineraire, "Type d'itinéraire" );
...
//
//    ParamComboBox< Mission_Pion_Test_MoveTo_verrouillage_vision::Root >& param2 = CreateVarList( asnMission.verrouillage_vision, "Verrouillage vision" );
...
//-----------------------------------------------------------------------------
// Name: void UnitMissionInterface::CreateMission_Test_CreateObject
// Created: APE 2004-05-27
//-----------------------------------------------------------------------------
...
//
//    ParamComboBox< EnumObjectType::Root >& param = CreateVarList( asnMission.type, "Type" );
//    param.AddItem( Tools::ToString( EnumObjectType::bouchon_mines ).ascii()             , EnumObjectType::bouchon_mines );
//    param.AddItem( Tools::ToString( EnumObjectType::zone_minee_lineaire ).ascii()       , EnumObjectType::zone_minee_lineaire );
//    param.AddItem( Tools::ToString( EnumObjectType::zone_minee_par_dispersion ).ascii() , EnumObjectType::zone_minee_par_dispersion );
//    param.AddItem( Tools::ToString( EnumObjectType::fosse_anti_char ).ascii()           , EnumObjectType::fosse_anti_char );
//    param.AddItem( Tools::ToString( EnumObjectType::abattis ).ascii()                   , EnumObjectType::abattis );
//    param.AddItem( Tools::ToString( EnumObjectType::barricade ).ascii()                 , EnumObjectType::barricade );
//    param.AddItem( Tools::ToString( EnumObjectType::eboulement ).ascii()                , EnumObjectType::eboulement );
//    param.AddItem( Tools::ToString( EnumObjectType::destruction_route ).ascii()         , EnumObjectType::destruction_route );
//    param.AddItem( Tools::ToString( EnumObjectType::destruction_pont ).ascii()          , EnumObjectType::destruction_pont );
//    param.AddItem( Tools::ToString( EnumObjectType::pont_flottant ).ascii()             , EnumObjectType::pont_flottant );
//    param.AddItem( Tools::ToString( EnumObjectType::poste_tir ).ascii()                 , EnumObjectType::poste_tir );
//    param.AddItem( Tools::ToString( EnumObjectType::zone_protegee ).ascii()             , EnumObjectType::zone_protegee );
//    param.AddItem( Tools::ToString( EnumObjectType::zone_implantation_canon ).ascii()   , EnumObjectType::zone_implantation_canon );
//    param.AddItem( Tools::ToString( EnumObjectType::zone_implantation_cobra ).ascii()   , EnumObjectType::zone_implantation_cobra );
//    param.AddItem( Tools::ToString( EnumObjectType::zone_implantation_lrm ).ascii()     , EnumObjectType::zone_implantation_lrm );
//
...
//-----------------------------------------------------------------------------
// Name: void UnitMissionInterface::CreateMission_Test_DestroyObject
...
//-----------------------------------------------------------------------------
// Name: void UnitMissionInterface::CreateMission_Test_CreateBypass
// Created: APE 2004-05-27
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Name: void UnitMissionInterface::CreateMission_Test_Fire
// Created: APE 2004-05-27
//-----------------------------------------------------------------------------
...
//
//    ParamComboBox< Mission_Pion_Test_Fire_munitions::Root >& param = CreateVarList( asnMission.munitions, "Munitions" );
...
//-----------------------------------------------------------------------------
// Name: void UnitMissionInterface::CreateMission_Test_ChangePosture
// Created: APE 2004-05-27
//-----------------------------------------------------------------------------
...
//
//    ParamComboBox< Mission_Pion_Test_ChangePosture_posture::Root >& param = CreateVarList( asnMission.posture, "Lock" );
...
//
//    ParamComboBox< Mission_Pion_Test_FindPosition_type_objectif::Root >& param = CreateVarList( asnMission.type_objectif, "Type objectif" );
...
//
//    ParamComboBox< Mission_Pion_Test_FindPosition_type_operation::Root >& param2 = CreateVarList( asnMission.type_operation, "Type operation" );
...
//
//    ParamComboBox< EnumUnitIdentificationLevel::Root >& param3 = CreateVarList( asnMission.niveau_identification, "Niveau identification" );
