   ...
   || ( options.nDrawVisionSurfaces_ == Options::eAuto && nState == eHighlighted && bAggregated ) )
        ...
        || ( nState == eSelected && (MainWindow::GetMainWindow().GetOptions().nDisplayLogLinks_ == Options::eAuto ))))
    {
        ...
        if ( agent.nTC2_ != 0 )
        {
            ...
            DrawArc( App::GetApp().GetModel().GetAgent( agent.nTC2_ ).GetAggregatedPos(), agentPos, offset, true );
        ...
        if ( agent.nLogMaintenanceSuperior_ != 0 )
        {
            ...
            DrawArc( App::GetApp().GetModel().GetAgent( agent.nLogMaintenanceSuperior_ ).GetAggregatedPos(), agentPos, offset , true );
        ...
        if ( agent.nLogMedicalSuperior_ != 0 )
        {
            ...
            DrawArc( App::GetApp().GetModel().GetAgent( agent.nLogMedicalSuperior_ ).GetAggregatedPos(), agentPos, offset, true );
        ...
        if ( agent.nLogSupplySuperior_ != 0 )
        {
            ...
            DrawArc(  App::GetApp().GetModel().GetAgent( agent.nLogSupplySuperior_ ).GetAggregatedPos(), agentPos, offset, true );
