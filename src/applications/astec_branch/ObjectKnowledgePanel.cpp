...
void ObjectKnowledgePanel::UpdateSelected()
{
    ...
    display_->Group( "Détails" )
                ...
                .Display( "Objet associé:", ( k.pRealObject_.IsSet() && k.pRealObject_ != 0 ) ? Display::Id( k.pRealObject_->GetID() ) : "" )
                ...
                .Display( "En préparation:", IfSet( k.bEnPreparation_, Display::YesNo( k.bEnPreparation_ ) ) )
                .Display( "Perçu:", IfSet( k.bIsPerceived_, Display::YesNo( k.bIsPerceived_ ) ) )
    ...
    if( k.nSiteFranchissementLargeur_.IsSet() )
        display_->Group( "Site de franchissement" )
                    ...
                    .Display( "Berges à aménager:", Display::YesNo( k.nSiteFranchissementBergesAAmenager_ ) );
    ...
    if( k.nLogRouteFlow_.IsSet() ) 
        display_->Group( "Itinéraire logistique" )
                    ...
                    .Display( "Equipé:",        Display::YesNo( k.bLogRouteEquipped_ ) );
}
