...
// $Archive: /MVW_v10/Build/SDK/Light2/src/RawVisionDataIterator.cpp $
// $Author: Age $
// $Modtime: 22/03/05 11:19 $
// $Revision: 3 $
// $Workfile: RawVisionDataIterator.cpp $
//
//*****************************************************************************
...
//-----------------------------------------------------------------------------
// Name: RawVisionData::Iterator::AlignFirstPointOnGrid
// Created: JVT 03-06-23
// Last modified: JVT 03-06-24
//-----------------------------------------------------------------------------
void RawVisionData::Iterator::AlignFirstPointOnGrid()
{
...
*/
RawVisionData::Iterator::Iterator( const MT_Vector3D& vBeginPos, const MT_Vector3D& vEndPos )
: data_             ( App::GetApp().GetRawVisionData() )
...
, pCurrentMeteo_    ( 0 )
{
    ...
    const RawVisionData::sCell& cell = data_( vBeginPos.rX_, vBeginPos.rY_ );
    ...
    nCurrentEnv_  = ( ( rEnvCoeff_ < 0. ) || ( rEnvCoeff_ * rDy < 0. ) ) ? cell.e : (RawVisionData::envBits)RawVisionData::eVisionEmpty;
}

//-----------------------------------------------------------------------------
// Name: RawVisionData::Iterator::operator ++
// Created: JVT 03-03-29
// Last modified: JVT 03-06-24
//-----------------------------------------------------------------------------
RawVisionData::Iterator& RawVisionData::Iterator::operator ++ ()
{
    assert( !End() );
    ...
    const RawVisionData::sCell& cell = data_( (uint)nRealCellCol, (uint)nRealCellRow );
    ...
    nCurrentEnv_  = ( ( rEnvCoeff_ < 0. ) || ( rEnvCoeff_ * rOldEnvCoeff < 0. ) ) ? cell.e : (RawVisionData::envBits)RawVisionData::eVisionEmpty;
